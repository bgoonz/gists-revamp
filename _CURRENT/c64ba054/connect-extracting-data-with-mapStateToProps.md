...
<table style="width:41%;"><colgroup><col style="width: 17%" /><col style="width: 24%" /></colgroup><thead><tr class="header"><th></th><th><code class="language-js &gt;(state) =&gt; stateProps&lt;/code&gt;&lt;/th&gt;&lt;th&gt;&lt;code class=" data-language-js="">(state, ownProps) =&gt; stateProps</code></th></tr></thead><tbody><tr class="odd"><td><code class="language-js &gt;mapStateToProps&lt;/code&gt; runs when:&lt;/td&gt;&lt;td&gt;store &lt;code class=" data-language-js="">state</code> changes</td><td>store <code class="language-js &gt;state&lt;/code&gt; changes&lt;br /&gt; or&lt;br /&gt; any field of &lt;code class=" data-language-js="">ownProps</code> is different</td></tr><tr class="even"><td>component re-renders when:</td><td>any field of <code class="language-js &gt;stateProps&lt;/code&gt; is different&lt;/td&gt;&lt;td&gt;any field of &lt;code class=" data-language-js="">stateProps</code> is different<br />
or<br />
any field of &lt;code class="language-js &gt;ownProps is different</td></tr></tbody></table>
