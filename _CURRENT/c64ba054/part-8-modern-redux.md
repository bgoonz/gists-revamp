...
<span class="token plain"></span><span class="token keyword module" style="color: #f92672">import</span><span class="token plain"> </span>todosReducer<span class="token plain"> </span><span class="token keyword module" style="color: #f92672">from</span><span class="token plain"> </span><span class="token string" style="color: #a6e22e">‘./features/todos/todosSlice’</span><span class="token plain"></span>

<span class="token plain"></span><span class="token keyword module" style="color: #f92672">import</span><span class="token plain"> </span>filtersReducer<span class="token plain"> </span><span class="token keyword module" style="color: #f92672">from</span><span class="token plain"> </span><span class="token string" style="color: #a6e22e">‘./features/filters/filtersSlice’</span><span class="token plain"></span>
...
<span class="token plain"></span><span class="token keyword module" style="color: #f92672">import</span><span class="token plain"> </span>rootReducer<span class="token plain"> </span><span class="token keyword module" style="color: #f92672">from</span><span class="token plain"> </span><span class="token string" style="color: #a6e22e">‘./reducer’</span><span class="token plain"></span>
...
<span class="token keyword module" style="color: #f92672">import</span><span class="token plain"> </span><span class="token imports punctuation" style="color: #f8f8f2">{</span> createSlice <span class="token imports punctuation" style="color: #f8f8f2">}</span><span class="token plain"> </span><span class="token keyword module" style="color: #f92672">from</span><span class="token plain"> </span><span class="token string" style="color: #a6e22e">‘<span class="citation" data-cites="reduxjs/toolkit">@reduxjs/toolkit</span>’</span><span class="token plain"></span>
...
createSelector<span class="token imports punctuation" style="color: #f8f8f2">,</span>
...
- <a href="#store-setup" class="table-of-contents__link">Store Setup</a>
  - <a href="#using-configurestore" class="table-of-contents__link">Using &lt;code class="language-js &gt;configureStore</a>
...
- <a href="#writing-slices" class="table-of-contents__link">Writing Slices</a>
  - <a href="#using-createslice" class="table-of-contents__link">Using &lt;code class="language-js &gt;createSlice</a>
...
- <a href="#writing-thunks" class="table-of-contents__link">Writing Thunks</a>
  - <a href="#using-createasyncthunk" class="table-of-contents__link">Using &lt;code class="language-js &gt;createAsyncThunk</a>
- <a href="#normalizing-state" class="table-of-contents__link">Normalizing State</a>
  - <a href="#using-createentityadapter" class="table-of-contents__link">Using &lt;code class="language-js &gt;createEntityAdapter</a>
