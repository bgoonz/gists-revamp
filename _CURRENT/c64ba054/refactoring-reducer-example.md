...
<span class="token plain"></span><span class="token punctuation" style="color: #f8f8f2">}</span>Now it’s *very* clear what’s happening in each case. We can also start to see some patterns emerging.
