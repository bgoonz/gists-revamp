...
- <a href="#reducers" class="table-of-contents__link">Reducers</a>
  - <a href="#how-do-i-share-state-between-two-reducers-do-i-have-to-use-combinereducers" class="table-of-contents__link">How do I share state between two reducers? Do I have to use &lt;code class="language-js &gt;combineReducers?</a>
  - <a href="#do-i-have-to-use-the-switch-statement-to-handle-actions" class="table-of-contents__link">Do I have to use the &lt;code class="language-js &gt;switch statement to handle actions?</a>
