...
Redux FAQ: Store Setup<a href="#redux-faq-store-setup" class="hash-link" title="Direct link to heading">#</a>

Table of Contents<a href="#table-of-contents" class="hash-link" title="Direct link to heading">#</a>
...
Store Setup<a href="#store-setup" class="hash-link" title="Direct link to heading">#</a>

###

Can or should I create multiple stores? Can I import my store directly, and use it in components myself?<a href="#can-or-should-i-create-multiple-stores-can-i-import-my-store-directly-and-use-it-in-components-myself" class="hash-link" title="Direct link to heading">#</a>
...
Further information<a href="#further-information" class="hash-link" title="Direct link to heading">#</a>
...
Further information<a href="#further-information-1" class="hash-link" title="Direct link to heading">#</a>
...
How do I subscribe to only a portion of the state? Can I get the dispatched action as part of the subscription?<a href="#how-do-i-subscribe-to-only-a-portion-of-the-state-can-i-get-the-dispatched-action-as-part-of-the-subscription" class="hash-link" title="Direct link to heading">#</a>
...
Further information<a href="#further-information-2" class="hash-link" title="Direct link to heading">#</a>
...
- <a href="#store-setup" class="table-of-contents__link">Store Setup</a>
  ...
  - <a href="#is-it-ok-to-have-more-than-one-middleware-chain-in-my-store-enhancer-what-is-the-difference-between-next-and-dispatch-in-a-middleware-function" class="table-of-contents__link">Is it OK to have more than one middleware chain in my store enhancer? What is the difference between <code class="language-js &gt;next&lt;/code&gt; and &lt;code class=" data-language-js="">dispatch</code> in a middleware function?</a>
