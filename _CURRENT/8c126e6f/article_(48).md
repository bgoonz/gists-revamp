...
_!_ let json = JSON.stringify(student); _/!_

alert(typeof json); // we’ve got a string!

alert(json); _!_ /\* JSON-encoded object: { “name”: “John”, “age”: 30, “isAdmin”: false, “courses”: \[“html”, “css”, “js”\], “wife”: null } _/_ /!\* \`\`\`
...
_!_ JSON.stringify(meetup); // Error: Converting circular structure to JSON _/!_ \`\`\`
...
alert( JSON.stringify(meetup, _!_\[‘title’, ‘participants’, ‘place’, ‘name’, ‘number’\]_/!_) ); / _{ “title”:“Conference”, “participants”:\[{“name”:“John”},{“name”:“Alice”}\], “place”:{“number”:23} }_ / \`\`\`
...
\`\`\`js run let room = { number: 23, _!_ toJSON() { return this.number; } _/!_ };

let meetup = { title: “Conference”, room };

_!_ alert( JSON.stringify(room) ); // 23 _/!_

alert( JSON.stringify(meetup) ); / _{ “title”:“Conference”,_ ! _“room”: 23_ /! _}_ / \`\`\`
...
_!_ let meetup = JSON.parse(str, function(key, value) { if (key == ‘date’) return new Date(value); return value; }); _/!_
