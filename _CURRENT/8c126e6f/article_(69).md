...
\`\`\`js run class CoffeeMachine { _!_ \#waterLimit = 200; _/!_

_!_ \#fixWaterAmount(value) { if (value &lt; 0) return 0; if (value &gt; this.\#waterLimit) return this.\#waterLimit; } _/!_
...
_!_ // can’t access privates from outside of the class coffeeMachine.\#fixWaterAmount(123); // Error coffeeMachine.\#waterLimit = 1000; // Error _/!_ \`\`\`
