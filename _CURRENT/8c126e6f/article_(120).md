...
\`\``warn header="Page without scripts should be usable" Please note: if you're using`defer`or`async\`, then user will see the the page _before_ the script loads.
