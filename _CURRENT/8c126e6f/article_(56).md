...
There are also advanced browser-related use cases of zero-delay timeout, that we’ll discuss in the chapter <a href="info:event-loop" class="uri">info:event-loop</a>.
