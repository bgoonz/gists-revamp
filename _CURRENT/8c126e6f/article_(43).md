...
_!_ // That’s what got written! alert( visitsCountObj\[“\[object Object\]”\] ); // 123 _/!_ \`\`\`
...
_!_ let map = new Map(Object.entries(obj)); _/!_
...
_!_ let obj = Object.fromEntries(map.entries()); // make a plain object (_)_ /!\*
