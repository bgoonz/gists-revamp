...
Now we can see errors, and that’s enough for a start. We’ll come back to developer tools later and cover debugging more in-depth in the chapter <a href="info:debugging-chrome" class="uri">info:debugging-chrome</a>.
