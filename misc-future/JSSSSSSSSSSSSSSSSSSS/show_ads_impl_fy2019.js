(function(sttc) {
    ...
    */
    ...
    function fb(a) {
        return a instanceof cb && a.constructor === cb && a.l === eb ? a.j : "type_error:Const"
    }
    ...
    function nb(a) {
        return a instanceof kb && a.constructor === kb ? a.j : "type_error:TrustedResourceUrl"
    }
    ...
    function ub(a, b) {
        if (b) a = a.replace(vb, "&amp;").replace(wb, "&lt;").replace(xb, "&gt;").replace(yb, "&quot;").replace(zb, "&#39;").replace(Ab, "&#0;");
        else {
            if (!Bb.test(a)) return a; - 1 != a.indexOf("&") && (a = a.replace(vb, "&amp;")); - 1 != a.indexOf("<") && (a = a.replace(wb, "&lt;")); - 1 != a.indexOf(">") && (a = a.replace(xb, "&gt;")); - 1 != a.indexOf('"') && (a = a.replace(yb, "&quot;")); - 1 != a.indexOf("'") && (a = a.replace(zb, "&#39;")); - 1 != a.indexOf("\x00") && (a = a.replace(Ab, "&#0;"))
        }
        return a
    }
    var vb = /&/g,
    ...
    var Hb = RegExp('^(?:audio/(?:3gpp2|3gpp|aac|L16|midi|mp3|mp4|mpeg|oga|ogg|opus|x-m4a|x-matroska|x-wav|wav|webm)|font/\\w+|image/(?:bmp|gif|jpeg|jpg|png|tiff|webp|x-icon)|video/(?:mpeg|mp4|ogg|webm|quicktime|x-matroska))(?:;\\w+=(?:\\w+|"[\\w;,= ]+"))*$', "i"),
    ...
    const Ub = RegExp("^[-,.\"'%_!# a-zA-Z0-9\\[\\]]+$"),
        Tb = RegExp("\\b(url\\([ \t\n]*)('[ -&(-\\[\\]-~]*'|\"[ !#-\\[\\]-~]*\"|[!#-&*-\\[\\]-~]*)([ \t\n]*\\))", "g"),
        Sb = RegExp("\\b(calc|cubic-bezier|fit-content|hsl|hsla|linear-gradient|matrix|minmax|repeat|rgb|rgba|(rotate|scale|translate)(X|Y|Z|3d)?|var)\\([-+*/0-9a-z.%\\[\\], ]+\\)", "g"),
        Vb = /\/\*/;
    ...
    function ec() {
        return u("Safari") && !(fc() || u("Coast") || bc() || u("Edge") || u("Edg/") || u("OPR") || dc() || u("Silk") || u("Android"))
    }
    ...
    function hc() {
        ...
        var d = ma(Wa, c);
        return bc() ? a(["Version", "Opera"]) : u("Edge") ? a(["Edge"]) : u("Edg/") ? a(["Edg"]) : fc() ? a(["Chrome", "CriOS", "HeadlessChrome"]) : (b = b[2]) && b[1] || ""
    }
    ...
    function kc(a) {
        return a instanceof lc && a.constructor === lc ? a.j : "type_error:SafeHtml"
    }
    ...
    function rc(a) {
        ...
        const d = [],
            e = f => {
                Array.isArray(f) ? f.forEach(e) : (f = mc(f), d.push(kc(f).toString()), f = f.Aa(), 0 == c ? c = f : 0 != f && c != f && (c = null))
            };
        a.forEach(e);
                            ...
                            if (!(c instanceof Pb)) {
                                ...
                                for (let g in c)
                                    if (Object.prototype.hasOwnProperty.call(c, g)) {
                                        ...
                                        let h = c[g];
                                        null != h && (h = Array.isArray(h) ? h.map(Rb).join(" ") : Rb(h), f += `${g}:${h};`)
                                    }
                                c =
                                    f ? new Pb(f, Ob) : Qb
                            }
                            c = c instanceof Pb && c.constructor === Pb ? c.j : "type_error:SafeStyle"
                        } else {
    ...
    function Bc() {
        var a = t.document;
        return a.querySelector ? (a = a.querySelector("script[nonce]")) && (a = a.nonce || a.getAttribute("nonce")) && Ac.test(a) ? a : "" : ""
    };
    ...
    function Dc(a, b) {
        ...
        return a.replace(Ec, function(e, f) {
            ...
            g || (g = nc(e + " ", null), yc(d, g), g = d.firstChild.nodeValue.slice(0, -1));
            return c[e] = g
        })
    }
    var Ec = /&([^;\s<&]+);?/g;
    ...
    var Nc = bc(),
        ...
        Pc = u("Edge"),
        Qc = Pc || Oc,
        Rc = u("Gecko") && !(-1 != Yb.toLowerCase().indexOf("webkit") && !u("Edge")) && !(u("Trident") || u("MSIE")) && !u("Edge"),
    ...
    gc();
    fc();
    var cd = ec() && !(u("iPhone") && !u("iPod") && !u("iPad") || u("iPad") || u("iPod"));
    var dd = {},
        ed = null,
        fd = Rc || Sc,
    ...
    function od(a) {
        return pd(a, b => b, b => new Uint8Array(b))
    }

    function qd(a, b, c) {
        return "object" === typeof a ? nd && !Array.isArray(a) && a instanceof Uint8Array ? c(a) : pd(a, b, c) : b(a)
    }
    ...
    function pd(a, b, c) {
        ...
        d = {};
        for (e in a) Object.prototype.hasOwnProperty.call(a, e) && (f = a[e], null != f && (d[e] = qd(f, b, c)));
        return d
    }

    function td(a) {
        return pd(a, b => "number" === typeof b ? isFinite(b) ? b : String(b) : b, b => id(b))
    }
    ...
    function y(a, b, c) {
        ...
        a: {
            ...
            if (d && (d = this.A[a], !(null === d || "object" != typeof d || Array.isArray(d) || nd && d instanceof Uint8Array))) {
                this.D = a - this.C;
                this.B = d;
                break a
            }
        ...
        if (c)
            for (b = 0; b < c.length; b++) a = c[b], a < this.D ? (a += this.C, (d = this.A[a]) ? sd(d) : this.A[a] = xd) : (yd(this), (d = this.B[a]) ? sd(d) : this.B[a] = xd)
    }
    ...
    function Pd() {
        var a, b;
        if (void 0 === Od) try {
            Od = null !== (b = null === (a = Nd()) || void 0 === a ? void 0 : a.createPolicy("google#safe", {
                createHTML: c => c,
                createScript: c => c,
                createScriptURL: c => c
            })) && void 0 !== b ? b : null
    ...
    function Sd(a) {
        var b, c = null === (b = Pd()) || void 0 === b ? void 0 : b.createScript(a);
    ...
    function Zd(a) {
        var b;
        const c = null === (b = Pd()) || void 0 === b ? void 0 : b.createScriptURL(a);
    ...
    function ae(a) {
        var b;
        a = $d(a);
        return (null === (b = Nd()) || void 0 === b ? 0 : b.isScriptURL(a)) ? TrustedScriptURL.prototype.toString.apply(a) : a
    };
    ...
    function ge(a, b) {
        b = b instanceof Qd ? Td(b) : b instanceof ib && b.constructor === ib ? b.j : "type_error:SafeScript";
        a.textContent = b;
        fe(a)
    }
    ...
    function le(a, b, c, d) {
        return a.removeEventListener ? (a.removeEventListener(b, c, ke(d)), !0) : !1
    };
    ...
    function ne(a) {
        return Ld(this, function*() {
            var b = "https://pagead2.googlesyndication.com/getconfig/sodar" + `?sv=${200}&tid=${a.j}` + `&tv=${a.l}&st=` + `${a.Ga}`;
            let c = void 0;
            try {
                c = yield oe(b)
            } catch (g) {}
    ...
    function Oe(a) {
        ...
        return Oc && Zc("10") && a.pageYOffset != b.scrollTop ? new Ie(b.scrollLeft, b.scrollTop) : new Ie(a.pageXOffset || b.scrollLeft, a.pageYOffset || b.scrollTop)
    }
    ...
    var jf = za(() => Ia(["Google Web Preview", "Mediapartners-Google", "Google-Read-Aloud", "Google-Adwords"], pf) || 1E-4 > Math.random());
    const pf = a => -1 != Yb.indexOf(a);
    var qf = /^([0-9.]+)px$/,
        rf = /^(-?[0-9.]{1,30})$/;

    function sf(a, b) {
        return rf.test(a) && (a = Number(a), !isNaN(a)) ? a : void 0 == b ? null : b
    }
        ...
        df(f => {
            ...
            for (let l = 0; l < g.length; l++) try {
                a: {
                    var h = g[l];
                    try {
                        var k = h.contentWindow || (h.contentDocument ? Pe(h.contentDocument) : null);
                        break a
                    } catch (m) {}
                    k =
                    null
    ...
    function Yf(a, b) {
        var c = Xf(a, b);
        if (!c || !c.height || !c.width) return [new Wf(a.left, a.top, a.width, a.height)];
        c = [];
        var d = a.top,
            e = a.height,
            f = a.left + a.width,
            ...
            h = b.left + b.width,
            k = b.top + b.height;
        b.top > a.top && (c.push(new Wf(a.left, a.top, a.width, b.top - a.top)), d = b.top, e -= b.top - a.top);
    ...
    Wf.prototype.contains = function(a) {
        return a instanceof Ie ? a.x >= this.left && a.x <= this.left + this.width && a.y >= this.top && a.y <= this.top + this.height : this.left <= a.left && this.left + this.width >= a.left + a.width && this.top <= a.top && this.top + this.height >= a.top + a.height
    };
    ...
    function bg() {
        const a = ag();
        return a && ea(a.rootBounds) ? new Je(a.rootBounds.width, a.rootBounds.height) : null
    }
        ...
        const f = g => {
            if (a.ampInaboxInitialized) g = !0;
                ...
                a.ampInaboxPendingMessages && !k && (h = /^amp-(\d{15,20})?/.exec(g.data)) && (a.ampInaboxPendingMessages.push(g), g = h[1], a.ampInaboxInitialized ||
                    g && !/^\d{15,20}$/.test(g) || a.document.querySelector('script[src$="amp4ads-host-v0.js"]') || ff(a.document, g ? qb(gb("https://cdn.ampproject.org/rtv/%{ampVersion}/amp4ads-host-v0.js"), {
                        ampVersion: g
    ...
    const gg = [fg("data"), fg("http"), fg("https"), fg("mailto"), fg("ftp"), new eg(a => /^[^:]*([/?#]|$)/.test(a))];
    ...
    function jg(a, b) {
        ...
        if (!c) {
            var d = Hc(b);
            c = d;
            void 0 === a.style[d] && (d = (Sc ? "Webkit" : Rc ? "Moz" : Oc ? "ms" : null) + Ic(d), void 0 !== a.style[d] && (c = d));
            kg[b] = c
        }
        return c
    }
    ...
    function og(a) {
        ...
        d = !Oc || 9 <= Number(bd) || "CSS1Compat" == Ke(d).j.compatMode ? d.documentElement : d.body;
        if (a == d) return c;
        a = ng(a);
        b = Oe(Ke(b).j);
        c.x = a.left + b.x;
    ...
    function qg(a) {
        var b = a.offsetWidth,
            c = a.offsetHeight,
            d = Sc && !b && !c;
        return (void 0 === b || d) && a.getBoundingClientRect ? (a = ng(a), new Je(a.right - a.left, a.bottom - a.top)) : new Je(b, c)
    }
    ...
    var vg = (a, b) => {
        ...
        zg = a => Object.entries(Bg(a)).map(([b, c]) => `${b}=${encodeURIComponent(String(c))}`).join("&"),
        Bg = a => {
            const b = {};
            vg(a,
                (c, d) => {
    ...
    var P = () => {
            if (Hg && !cf(Ig)) {
                let a = "." + Ee.domain;
                try {
                    for (; 2 < a.split(".").length && !cf(Ig);) Ee.domain = a = a.substr(a.indexOf(".") + 1), Ig = window.parent
                } catch (b) {}
                cf(Ig) || (Ig = window)
            }
            return Ig
        ...
        Pg = (a, b) => a.source !== b.contentWindow &&
    ...
    const Rg = RegExp("^https?://(\\w|-)+\\.cdn\\.ampproject\\.(net|org)(\\?|/|$)");
    var Sg = class {
            constructor(a, b) {
                this.j = a;
                this.l = b
    ...
    function $g(a, b, c, d, e, f) {
        if ((d ? a.j : Math.random()) < (e || .01)) try {
            let g;
            c instanceof Zg ? g = c : (g = new Zg, lf(c, (k, l) => {
                var m = g,
                    n = m.B++;
                k = Ug(l, k);
                m.j.push(n);
    ...
    function jh(a) {
        a && gh && ih() && (gh.clearMarks(`goog_${a.label}_${a.uniqueId}_start`), gh.clearMarks(`goog_${a.label}_${a.uniqueId}_end`))
    }

    function kh(a) {
        a.j = !1;
        a.events != a.l.google_js_reporting_queue && (ih() && Ea(a.events, jh), a.events.length = 0)
    }
            ...
            try {
                ...
                do {
                    ...
                    if (cf(l)) {
                        ...
                        b =
                            l.document && l.document.referrer || null
                    } else m = b, b = null;
                    k.push(new Tg(m || "", l));
                    try {
                        d = l.parent
    ...
    function xh() {
        var a;
        const b = Td(yh);
        var c = (null === (a = Nd()) || void 0 === a ? 0 : a.isScript(b)) ? TrustedScript.prototype.toString.apply(b) : b;
        return Zd(URL.createObjectURL(new Blob([c], {
    ...
    zh.j = () => {};
    zh.A = !0;
    "complete" == Ah.document.readyState ? Ah.google_measure_js_timing || kh(th) : th.j && L(Ah, "load", () => {
        ...
        Kh = (a, b, c, d, e) => {
            if (Array.isArray(a)) {
                ...
                if (b.doesReturnAnotherSchema())
                    if (f = b.getSchema(a)) {
                        if (b = f, b.doesReturnAnotherSchema()) return Kh(a, b, c, d, e)
                    } else throw new Jh;
                f = {};
                for (g in a)
    ...
    function Ph(a, b) {
        ...
        t.setTimeout(S(220, Kg(() => {
            ff(c.document, de(b))
        })), 0)
    };
    var Qh = (a, b = !1) => {
        try {
            return b ? (new Je(a.innerWidth, a.innerHeight)).round() : Ne(a || window).round()
        } catch (c) {
    ...
    var Th = (a, b) => {
        var c;
        var d;
        c = (d = (d = $f()) && (c = d.initialLayoutRect) && "number" === typeof c.top && "number" === typeof c.left && "number" === typeof c.width && "number" === typeof c.height ? new Wf(c.left, c.top, c.width, c.height) : null) ? new Ie(d.left, d.top) : (c = ag()) && ea(c.rootBounds) ? new Ie(c.rootBounds.left + c.boundingClientRect.left, c.rootBounds.top + c.boundingClientRect.top) : null;
        if (c) return c;
        try {
            var e = new Ie(0, 0),
                f = Pe(Me(b));
    ...
    var $h = () => {
        ...
        ai = () => {
            ...
            try {
                const a = Ng(t);
                if (a && -1 !== a.location.hash.indexOf("auto_ads_logging") || t.localStorage.getItem("auto_ads_logging")) Zh = !0
            } catch (a) {}
            return Zh
        },
        bi = (a, b = []) => {
            ...
            c && $h() && ff(t.document,
                ob(fb(gb("https://pagead2.googlesyndication.com/pagead/js/logging_library.js"))))
        };
    ...
    function ci() {
        ...
        if (!window.__google_ad_urls_id) {
            ...
            let d;
            !0 === c ? d = 2 : !1 !== c && (d = hf([0], a), null == d && ((d = hf([2], b)) || (d = 3)));
            if (!d) return 0;
    ...
    var mi = () => {
        const a = P();
        a && "undefined" != typeof a.google_measure_js_timing && (a.google_measure_js_timing || kh(li))
    };
    (() => {
        const a = P();
        a && a.document && ("complete" == a.document.readyState ? mi() : li.j && L(a, "load", () => {
            mi()
        }))
    })();
    var oi = () => {
            var a = ni;
            const b = P() || t;
            return b.google_osd_loaded ? !1 : (ff(b.document, a), b.google_osd_loaded = !0)
        },
        pi = (a, b, c) => {
        ...
        ri = ob(fb(gb("https://www.googletagservices.com/activeview/js/current/osd.js")));
    ...
    class ti {
        ...
        registerAdBlock(a,
            ...
            f = t.pageYOffset;
            0 <= f || (f = -1);
            c && d ? c(d, a, b, !1, void 0, !1, g, e, f) : (g = new ui(a, b, d, g, e, f), this.j.push(g), pi(d, g.C, !0), ni || (Pf(t, "//pagead2.googlesyndication.com/pagead/gen_204?id=osd&r=om" + `&rs=${b}` + `&req=${a}`), ni = ri), oi() && yg())
        }
    ...
    function Sj(a) {
        a.google_reactive_ads_global_state ? null == a.google_reactive_ads_global_state.floatingAdsStacking && (a.google_reactive_ads_global_state.floatingAdsStacking = new Tj) : a.google_reactive_ads_global_state = new Uj;
    ...
    var Vj = 728 * 1.38,
        Wj = (a, b = 420) => (a = W(a).clientWidth) ? a > b ? 32768 : 320 > a ? 65536 : 0 : 16384,
        Xj = a => {
        ...
        Yj = (a, b) => {
            const c = W(a);
            return b ? c.scrollHeight == W(a).clientHeight ? c.offsetHeight : c.scrollHeight : c.offsetHeight
        },
        bk = (a, b) => ak(b) || 10 === b || !a.adCount ? !1 : 1 == b || 2 == b ? !(!a.adCount[1] &&
            !a.adCount[2]) : (a = a.adCount[b]) ? 1 <= a : !1,
        ck = (a, b) => a && a.source ? a.source === b || a.source.parent === b : !1,
        dk = a => void 0 === a.pageYOffset ? (a.document.documentElement || a.document.body.parentNode || a.document.body).scrollTop : a.pageYOffset,
        ek = a => void 0 === a.pageXOffset ? (a.document.documentElement || a.document.body.parentNode || a.document.body).scrollLeft : a.pageXOffset,
        fk = a => {
            const b = {};
            let c;
    ...
    var Bl = (a, b, c) => {
        ...
        Dl = a => {
            let b = 0;
            try {
                b |= a != a.top ? 512 : 0, $e() || (b |= 1048576), 1200 >= Math.floor(a.document.body.getBoundingClientRect().width) || (b |= 32768), Cl(a) && (b |= 33554432)
            } catch (c) {
                b |= 32
            }
            return b
    ...
    class gm {
        ...
        map(a) {
            return null != this.j ? (a = a(this.j.value), a instanceof gm ? a : fm(a)) : this
        }
    };
    ...
    function mm() {
        var a = P(),
            b = $f(a);
        if (b) return (b = b || $f()) ? (a = b.pageViewId, b = b.clientId, "string" === typeof b && (a += b.replace(/\D/g, "").substr(0, 6))) : a = null, +a;
        a = Kj(a, !1).X;
    ...
    function nm() {
        ...
        return null != b && "object" == typeof b && null != b.S && "object" == typeof b.S ? om = b : a.google_persistent_state_async = om = new pm
    }
    ...
    q.set = function(a, b, c) {
        let d, e, f, g = !1,
            h;
        "object" === typeof c && (h = c.Yh, g = c.qe || !1, f = c.domain || void 0, e = c.path || void 0, d = c.Ec);
    ...
    q.clear = function() {
        ...
        const b = [],
            c = [];
        let d, e;
        for (let f = 0; f < a.length; f++) e = tb(a[f]), d = e.indexOf("="), -1 == d ? (b.push(""), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1)));
    ...
    function Hm(a) {
        if (Gm(a))
            if (!1 !== a.gdprApplies && "tcunavailable" !== a.tcString && void 0 !== a.gdprApplies && "string" === typeof a.tcString && a.tcString.length) {
                ...
                0 === b ? a = !1 : a.purpose && a.vendor ? (b = a.vendor.consents, (b = !(!b || !b["755"])) && a.purposeOneTreatment && ("DE" === a.publisherCC || "CH" === a.publisherCC) ? a = !0 : (b && (a = a.purpose.consents, b = !(!a || !a["1"])), a = b)) : a = !0
            }
        else a = !0;
        else a = !1;
        return a
    ...
    function Mm(a, b) {
        ...
        Km(a, "addEventListener", f => {
            f && (c = f, c.internalErrorState = Fm(c), Gm(c) && (0 != c.internalErrorState && (c.tcString = "tcunavailable"), Km(a, "removeEventListener", null, c.listenerId), e && (clearTimeout(e), e = 0), d()))
        })
    }
    ...
    function Nm(a, b) {
        ...
        Km(a, "addEventListener", (f, g) => {
            ...
            if (0 != c.internalErrorState || Gm(c)) Km(a, "removeEventListener", null, c.listenerId), d()
        })
    }
    ...
    class Pm extends Em {
        ...
        addEventListener(a) {
            ...
            const e = (f, g) => {
                clearTimeout(d);
                f ? (b = f, b.internalErrorState = Fm(b), g && 0 === b.internalErrorState || (b.tcString = "tcunavailable",
    ...
    var Sm = ({
        ...
        b = nm();
        (b = X(b, 24, void 0)) ? (b = ym(new zm, Hm(b)), a = Rm(a, b)) : a = new gm(null, Error("tcunav"));
        return a
    };
        ...
        if (!(d = !d && Jm(new Pm(a)))) {
            if (c = !c) {
                if (b) {
                    a = xm(a);
                    if (null != a.j)
                        if ((a = a.j.value) && A(a, 1)) b: switch (a = z(a, 1), a) {
                            case 1:
                                a = !0;
                                break b;
                            default:
    ...
    function Xm(a) {
        V(wi) && T("abg_adsensesettings_lserr", {
            s: a,
            g: V(xi),
            c: Um(),
            r: .01
    ...
    const Kn = new Jn("IMG AMP-IMG IFRAME AMP-IFRAME HR EMBED OBJECT VIDEO AMP-VIDEO INPUT BUTTON SVG".split(" "));
    var Nn = (a, b) => {
        const c = new Ln(a, b);
        return () => Mn(c)
    };
    ...
    class Xn {
        ...
        init(a, b) {
            null == a ? (this.C = a = Yj(this.j, !0), this.j.addEventListener("scroll", this.F), null != b && b(a)) : this.B = this.j.setTimeout(() => {
                this.init(void 0, b)
            }, a)
        }
        kb() {
    ...
    var lo = a => {
        ...
        no = a => {
            var b = mo(a);
            a = [];
            for (let c of b) b = String(c.Ja), a.push(c.ua + "." + (20 >= b.length ? b : b.slice(0, 19) + "_"));
            return a.join("~")
        };
    const mo = a => {
            const b = [],
    ...
    function uo(a) {
        return null == a ? null : new so(null, {
    ...
    var Jo = (a, b) => {
        ...
        Lo = (a, b, c) => {
            a = a.style;
            "rtl" == b ? V(fj) ? a.setProperty("margin-right", c, "important") :
                a.marginRight = c : V(fj) ? a.setProperty("margin-left", c, "important") : a.marginLeft = c
        };
    const Mo = (a, b, c) => {
        a = Jo(b, a);
    ...
    const Xo = (a, b) => {
        if (3 == b.nodeType) return 3 == b.nodeType ? (b = b.data, a = -1 != b.indexOf("&") ? Dc(b, a.document) : b, a = /\S/.test(a)) : a = !1, a;
        if (1 == b.nodeType) {
    ...
    function tp(a, b, c, d) {
        ...
        switch (z(a, 8)) {
            case 1:
                return k = k.vd || null, new up(f, new mp(jp(H(a, Jk, 3), null)), k, g, 0, h, e, c, b, d, a);
            case 2:
                return new up(f, new pp(a), k.Od || new rp("text"), g, 1, h, e, c, b, d, a)
        }
        return null
    }
    ...
    function Bp(a, b = null, c = null) {
        return new up(a.H, b || a.D, c || a.O, a.I, a.Ca, a.Xb, a.Ta, a.l, a.Z, a.F, a.A, a.C, a.R)
    }
    class up {
    ...
    function Dp(a, b, c, d) {
        ...
        b = [];
        for (const f of c) c = Da(e, f), 0 > c || b.push(new Ep(a, [f], c, f, 3, Ve(f).trim(), d));
        return b
    }
    ...
    function Fp(a, b, c) {
        ...
        for (let n = 0; n < g; n++) {
            ...
            if (1 == l.nodeType || 3 == l.nodeType) {
                ...
                m ? (d.length && k && e.push(new Ep(a, d, n - 1, m, 0, k, c)), d = [], h = n + 1, k = "") : (d.push(l), l = Ve(l).trim(), k += l && k ? " " + l : l)
            }
        }
    ...
    function Hp(a) {
        const b = Kk();
        return new up(new op(a.Gb, a.Hb), new mp({
            clearBoth: !0
    ...
    function Ip(a) {
        return Na(a.B ? Fp(a.j, a.na, a.l) : [], a.A ? Dp(a.j, a.A, a.na, a.l) : []).filter(b => {
            var c = b.Gb.tagName;
            c ? (c = Cp[c.toUpperCase()], b = null != c && c.La.contains(b.Hb)) : b = !1;
            return !b
        })
    }
    class Jp {
            ...
            for (const l of e) {
                ...
                if (d.B || e.sb) {
                    if (d.j.length) {
                        ...
                        b: {
                            var g = f.L();
                            var h = f.Ka[f.Ka.length - 1];f = e.Cb.Ka[0];
                            if (!h || !f) {
                                g = !1;
                                break b
                            }
                    ...
                    g ? (d.j.push(e), e.sb && d.l.push(e.Cb)) : (d.j = [e], d.l = e.sb ? [e.Cb] : [])
                }
                if (b.l.length >= c) {
        ...
        Qp = (a, b) => {
            ...
            a.forEach(d => {
                ...
                if (e) {
                    ...
                    e = c.get(f);
                    (d = (d = H(d, tk, 2)) ? z(d, 7) : null) ? e.ib = e.ib ? e.ib + "," + d : d: e.vc = !0
                }
            });
            return Fn(c).map(d => {
    ...
    const Sp = a => {
        ...
        Vp = (a, b) => a.na.getBoundingClientRect().top - b.na.getBoundingClientRect().top;
    var Wp = a => (null == a ? 0 : a.google_ad_slot) ? fm(new ko(1, {
            dd: a.google_ad_slot
        ...
        Yp = a => {
            switch (a.Ca) {
                ...
                case 1:
                    var b = a.A;
                    null == b ? a = null : (a = b.V(), null == a ? a = null : (b = b.j(), a = null == b ? null : new ko(0, {
                        mc: [a],
                        Oc: b
                    })));
                    return null != a ? fm(a) : hm("Missing dimension when creating placement id");
                case 2:
                    return a = Xp(a), null != a ? fm(a) : hm("Missing dimension when creating placement id");
                default:
        ...
        try {
            ...
            for (f = 0; f < d.length; f++) {
                ...
                var C =
                    ...
                    I = e[f];
                c.push(new bq(I.Kc, I.anchorElement, new Rn(C.left + b, C.top + k, C.right - C.left)))
            }
        } finally {
    ...
    function fq(a, b, c) {
        return new up(new op(b, c), new mp({}), null, !0, 2, [], null, a.j, null, null, null, a.C.j, null)
    }
    var eq = class {
        constructor(a, b, c) {
            this.j = a;
            ...
            if (!this.l) {
                if (this.A >= this.B.length) var a = null;
                else {
                    {
                        ...
                        ea(b) && 1 == b.nodeType ? a = fq(this, b, 0) : (a = this.j.document.createElement("div"), O(a, {
                            display: "none"
                        }), b.parentNode.insertBefore(a, b), a = fq(this, a, 3))
                    }
    ...
    var Cq = (a, b) => {
        ...
        let l = [].concat(Oa(b.document.querySelectorAll("iframe[id^=aswift_],iframe[id^=google_ads_frame]")), Oa(b.document.querySelectorAll("ins.adsbygoogle")));
        b = [];
        for (const [m, n] of [
                [a.pb, c],
                [a.Ba, d],
    ...
    const Dq = a => {
        ...
        xq = a => Oa(a.document.querySelectorAll('ins.adsbygoogle[data-anchor-shown="true"]')),
        yq = a => Oa(a.document.querySelectorAll("ins.adsbygoogle[data-ad-format=autorelaxed]")),
        zq = a => (Dq(a) || Oa(a.document.querySelectorAll("div[id^=div-gpt-ad]"))).concat(Oa(a.document.querySelectorAll("iframe[id^=google_ads_iframe]"))),
        Aq = a => Oa(a.document.querySelectorAll("div.trc_related_container,div.OUTBRAIN,div[id^=rcjsload],div[id^=ligatusframe],div[id^=crt-],iframe[id^=cto_iframe],div[id^=yandex_], div[id^=Ya_sync],iframe[src*=adnxs],div.advertisement--appnexus,div[id^=apn-ad],div[id^=amzn-native-ad],iframe[src*=amazon-adsystem],iframe[id^=ox_],iframe[src*=openx],img[src*=openx],div[class*=adtech],div[id^=adtech],iframe[src*=adtech],div[data-content-ad-placement=true],div.wpcnt div[id^=atatags-]"));
    var Bq = a => {
        const b = [];
        for (const c of a) {
            a = !0;
    ...
    var Eq = S(453, Cq),
        Fq = S(454, (a, b) => {
            ...
            return Bq([].concat(!0 === a.pb ? c : [], !0 === a.Ba ? d : [], !0 === a.Md ? e : [], !0 === a.qb ? f : [], !0 === a.rb ? g : [], !0 === a.Jd ? h : [], !0 === a.Ld ? b : []))
        });
    ...
    function Iq(a, b, c) {
        return void 0 != b && a.length <= (void 0 != c ? c : 8) ? Nq(a, b) : Ga(a, d => new wq(d.box, 1))
    }
    ...
    function Sq(a, b) {
        ...
        b.forEach(e => {
            if (Jd(e, wk, 1, zk)) {
                ...
                H(e, uk, 3) && H(e, uk, 3).V() && (f = Tq(a, H(e, uk, 3).V())) && c.set(fa(f), H(e, uk, 3).j())
            } else Jd(e, xk, 2, zk) ? Uq(a, Jd(e, xk, 2, zk), c) : Jd(e, yk, 3, zk) && Vq(a, Jd(e, yk, 3, zk), d)
        });
        return new Wq(c, d)
    }
    class Wq {
    ...
    const Uq = (a, b, c) => {
            H(b, tk, 1) && (a = Xq(a, H(b, tk, 1))) && a.forEach(d => {
                d = fa(d);
                c.set(d, 1);
                c.set(d, 4);
                c.set(d, 2);
    ...
    class Jr {
        ...
        B(a) {
            ...
            b.err = this.C.join();
            b.warn = this.D.join();
            this.A && (b.excp_n = this.A.name, b.excp_m = this.A.message && this.A.message.substring(0, 512), b.excp_s = this.A.stack && oh(this.A.stack, ""));
    ...
    function Mr(a, b, c, d) {
        ...
        return f && 0 != f.length ? (b = H(b, Ak, 27)) ? H(b, Bk, 2) ? fm(new Nr(a, f, b, c, d)) : hm("No AudioSenseConfig.PlacementConfig found") : hm("No AudioSenseConfig found") : hm("No ArticleStructure found")
    }
    ...
    function Pr(a) {
        return (a = H(a.l, Dk, 3)) ? J(a, Ek, 1).some(b => 1 === Ad(b, 1, 0)) : !1
    }
    ...
    var Wr = (a, b) => (b = H(b, Sk, 6)) ? Rp(J(b, Tk, 1), a).map(c => Hp(c)) : [];
    ...
    function es(a) {
        const b = c => {
            c.some(d => -1 < d.oldValue.indexOf("gsc-results-wrapper-visible") && !d.target.classList.contains("gsc-results-wrapper-visible")) && as(a.C)
        };
        a.j.__gcse || (a.j.__gcse = {});
        a.j.__gcse.initializationCallback = () => {
            const c = document.getElementsByClassName("gsc-results-wrapper-overlay")[0];
            c && (new MutationObserver(b)).observe(c, {
        ...
        a.j.__gcse.searchCallbacks = {
            web: {
                rendered: () => {
                    $r(a.C);
                    a.j.document.getElementsByClassName("gsc-above-wrapper-area")[0].style.display =
                        "block"
                }
            }
        }
    ...
    function fs(a) {
        ...
        oa("google.ads.autorscse.innerPerformSearch", (d, e, f) => {
            ...
            if (d = a.j.document.getElementsByClassName("gsc-result-info-container")[0]) {
                ...
                e = Cc(g).replace(new RegExp(`\\{${k}[\\w&#;]+\\}`, "g"), la(e.A, e, []));
                e = nc(e, null);
    ...
    var gs = class {
        ...
        init() {
            if (0 != this.B.length && !this.j.document.querySelector('script[src*="cse.google.com/cse"]')) {
                ...
                b.setAttribute("data-as_sitesearch",
                    this.j.location.host);
    ...
    function ls(a, b) {
        ...
        ms(a, c);
        zc(c, "https://www.gstatic.com/adsense/autoads/icons/gpp_good_24px_grey_800.svg");
        O(c, {
    ...
    function os(a, b, c) {
        ...
        zc(d, "https://www.gstatic.com/adsense/autoads/icons/arrow_left_24px_grey_800.svg");
    ...
    var ys = (a, b, c = null, d, e = !1) => {
            let f = 0;
            try {
                f = d ? f | (a.innerHeight >= d ? 0 : 1024) : f | (a.innerHeight >= a.innerWidth ? 0 : 8), f |= Wj(a, 3E3), f |= Xj(a)
            } catch (g) {
                f |= 32
            }
            switch (b) {
        ...
        ws = (a, b, c = null) => {
            ...
            b = zs(d, b ? Math.max(2, Math.min(10, Math.ceil(d / 300))) + 1 : 3, 0, Math.min(Math.round(a.innerWidth / 320 * 50), As) + 15);
            return Bs(a, b, c)
        },
        xs = (a, b, c = null) => {
            const d = a.innerWidth,
                e = a.innerHeight,
                f = Math.min(Math.round(a.innerWidth / 320 * 50), As) +
                15;
            b = zs(d, b ? Math.max(2, Math.min(10, Math.ceil(d / 300))) + 1 : 3, e - f, e);
            25 < f && b.push({
                x: d - 25,
                y: e - 25
            });
    ...
    function Es(a, b, c = null) {
        ...
        return (d = d.elementFromPoint(e, f)) ? Fs(d, a, b, c) || Gs(d, a, b, c) || null : null
    }
    ...
    class Qs {
        ...
        init() {
            this.I ? (this.A = new is(this.C, this.I, this.K, this.H), this.A.init(), ho(this.B, this.A.F()), go(this.D, 1), null == this.j && (this.j = new Xn(this.C), this.j.init(2E3)), Vn(this.j, () => {
                Os(this);
                Ps(this)
            })) : Ps(this)
        }
    ...
    var Rs = (a, b, c, d, e) => {
        a = new Qs(a, vs(a, e), new us(b, d, "#FFF", "#4A4A4A", "normal"), new qs(b, c, d), "google-dns-link-placeholder");
        a.init();
        return a
    };
    ...
    class et {
        ...
        Oa(a, b, c, d) {
            c = Zs(a);
            const e = at(a, "https://www.gstatic.com/adsense/autoads/icons/gpp_good_24px_grey_800.svg", d),
                f = at(a, "https://www.gstatic.com/adsense/autoads/icons/gpp_good_24px_grey_800.svg", this.l),
                g = bt(this, a),
                h = at(a, "https://www.gstatic.com/adsense/autoads/icons/close_24px_grey_700.svg", b, this.C);
            O(h, {
                "margin-left": "auto"
            });
            c.appendChild(e);
    ...
    function ft(a) {
        gt(a.l, b => {
            ...
            (new Qs(c, vs(c, a.A), new us(d, b, "#1A73E8", "#FFF", "bold", "https://www.gstatic.com/adsense/autoads/icons/gpp_good_24px_blue_600.svg", "2px solid #ECEDED", f), new et(d, e, f, b), "google-revocation-link-placeholder")).init()
        }, () => {
            as(a.j)
        })
    }
    ...
    function it(a) {
        if (!0 !== a.j.adsbygoogle_ama_fc_has_run) {
            var b = !1;
            vm(a.l) && (b = new ht(a.j, a.C, a.B || J(a.l, Nk, 4), a.A), $r(b.j), ft(b), b = !0);
            var c;
            a: if ((c = a.l) && A(c, 3)) switch (c = z(c, 3), c) {
                case 1:
                    c = !0;
                    break a;
                case 2:
    ...
    function ot(a) {
        const b = qb(gb("https://fundingchoicesmessages.google.com/i/%{id}?ers=%{ers}"), {
            id: a.l,
            ers: 2
        });
        lt(a.j, b, () => {}, () => {})
    ...
    var qt = (a, b, c) => {
        ...
        if (!d) return [];
        c = Rp(J(d, Tk, 1), c);
        return (a = el(a)) && B(a, 11) ? c.map(e => Hp(e)) : c.map(e => {
            const f = Kk();
            return new up(new op(e.Gb, e.Hb), new Zo, new np(b), !0, 2, [], f, e.l, null, null, null, e.A, e.j)
        })
    };
    ...
    var wt = (a, b, c) => {
        ...
        e ? (d = f.l || (f.l = W(f.A).scrollHeight || null), e = !d || 0 > d ? -1 : f.l * e - Mq(f)) : e = void 0;
        a = null == e || 50 <= e ? zt(b, f, {
            types: a
        }, c) : null;
        return {
            fb: f,
    ...
    var At = a => {
        ...
        Ct = a => {
            ...
            c && (b = ro(a.J, b), d = Qo(a.j.document, a.F, null, null, {}, b)) && (Go(d.za, c, 2, 256), Bt(a, d, b))
        },
        Et = (a, b) => {
            var c = At(a);
            c.ec = [5];
    ...
    ut[8] = function(a) {
        var b = a.L().document;
        if ("complete" != b.readyState) return b.addEventListener("readystatechange", () => ut[8](a), {
            once: !0
        }), !0;
        if (!a.B) return !1;
        if (!a.ub()) return !0;
    ...
    ut[9] = function(a) {
        ...
        for (var c of b.Sa) {
            var d = c;
            var e = a.A.Pb || null;
            null == e ? d = null : (e = Bp(d.N, new Ft, new Gt(e, a.L())), d = new bq(e, d.V(), d.P));
            if (d && !(Ap(d.N) > b.hb) && yt(a, d, {
                    Dc: b.hb,
                    yd: !0
    ...
    function St(a, b, c) {
        30 >= c.length ? a.j[b] = Tt(c) : (a.j[b] = Tt(c.slice(0, 30)), a.j[b + "_c"] = c.length.toString())
    }
    ...
    function ju(a, b) {
        ...
        Zt(b, d.list, d.Ea);
        let f, g;
        $t(b, a.H.map(h => null == (f = a.j.get(h)) ? void 0 : f.xb).map(h => null != (g = a.l.get(h)) ? g : null))
    }
    var eu = new class {
        constructor() {
            this.C = null;
    ...
    function nu(a, b) {
        const c = a.B.filter(d => En(d.jb).every(e => d.jb.get(e) === b.get(e)));
        return 0 === c.length ? (a.l.push(19), null) : c.reduce((d, e) => d.jb.Pa() > e.jb.Pa() ? d : e, c[0])
    }
    ...
    var ru = class {
        constructor(a) {
            ...
            this.A = new Gn;
            let b;
            this.B = ((null == (b = H(a, Xk, 2)) ? void 0 : J(b, Yk, 1)) || []).map(c => {
                const d = lo(K(c, 1)),
                    e = Ad(c, 2, 0);
                return {
                    jb: d,
    ...
    function vu(a, b) {
        return b.sort((c, d) => {
            const e = c.N.F,
                f = d.N.F;
            var g;
            null == e || null == f ? g = null == e && null == f ? tu(a, c) - tu(a, d) : null == e ? 1 : -1 : g = e - f;
            return g
        })
    }
    class wu {
    ...
    class xu {
        ...
        find(a, b) {
            ...
            k = ao(ao(ao(ao(ao(ao(ao(k, cr(c), yu(1, b)), dr(a.Na || []), yu(2, b)), gr(a.Ob || []), yu(3, b)), hr(a.Xh || []), yu(4,
                b)), ir(a.ec || []), yu(5, b)), er(a.dc || []), yu(6, b)), ya(wp), yu(7, b));
            let l = k = k.apply(Yq(this.j));
            null !== d && (l = a.gb && a.qc ? ao(l, br(d, a.qc, this.j, a.fb), zu(16, b)) : ao(l, ar(d, this.j, a.fb), zu(9, b)));
            l = ao(l, ma(kr, e, f), zu(10, b));
            a.eb && (l = ao(l, jr(this.j.document, a.eb), zu(11, b)));
            l = ao(ao(l, Zq(this.j), zu(12, b)), fr(g, this.j), zu(13, b));
            a.Wa ? l = vu(this.l, l) : a.ve ? (l = su(this.l, l), $n(k, m => {
                du(m);
                var n;
                null != (n = this.l.j) && (n = ou(n, m), null != (null == n ? void 0 : n.Fa) && hu(m, n.Fa))
            }), $n(l, m => fu(m))) : l = uu(this.l, l);
            a.Ua && (l = co(l, Gc(this.j.location.href +
                this.j.localStorage.google_experiment_mod)));
            1 === c.length && Kt(this.B, c[0], {
                qd: k.j.length,
                we: l.j.length
            });
            return l.j.slice(0)
    ...
    function Du(a) {
        ...
        for (var C of E) {
            ...
            if (C.className && -1 != C.className.indexOf("adsbygoogle-ablated-ad-slot")) {
                ...
                G = G ? G.width : 0
            } else if (I = E.bottom - E.top, G = E.right - E.left, 1 >= I || 1 >= G) continue;
            g.push(I);
            k.push(G);
            l.push(I * G);
            C.className && -1 != C.className.indexOf("google-auto-placed") ? (x += 1, C.className && -1 != C.className.indexOf("pedestal_container") && (w = I)) : (v = Math.min(v, Q), n.push(E), r += 1, h.push(I), m.push(I * G));
            D = Math.min(D, Q);
            p.push(E)
        }
        v = Infinity === v ? null : v;
    ...
    function Hu(a) {
        return He.apply(null, Fa(a, b => 0 < b)) || null
    }
    ...
    function Lu(a) {
        ...
        c = Eq({
            Ba: !1
        }, a).map(d => d.getBoundingClientRect()).filter(Kq).filter(la(Mu, null, c));
        b.gd = c.length;
        a = Du(a);
        c = null != a.j.Mb ? a.j.Mb :
            null;
        null != c && (b.Td = c);
    ...
    function xt(a) {
        var b;
        let c;
        if (0 == (null != (c = null == (b = a.l.l.j) ? void 0 : [...z(b.j, 1)].length) ? c : 0)) return !1;
    ...
    function yt(a, b, c) {
        ...
        if (k = !l && !(!k && 2 == h && !Cu(g))) g = 1 == h || 2 == h ? g : g.parentNode, k = !(g && !yo(g) && 0 >= g.offsetWidth);
        if (!k) return !1;
        g = null == d ? null : new so(null, {
            google_max_responsive_height: d
        });
        h = to(z(c.Ta, 2) || 0);
        k = c.F;
        k = null == k ? null : new so(null, {
            google_ml_rank: k
        });
        l = Nu(a,
            c);
            ...
            if (h) {
                ...
                if (l.top != l) var p = Ng(l) ? 3 : 16;
                    ...
                    if (l.innerHeight >= l.innerWidth)
                        if (p = W(l).clientWidth, !p || .3 < (p - k) / p) p = 6;
                        else {
                            if (p = "true" != n.google_full_width_responsive) c: {
                ...
                if (!0 !== p) k = p;
                    ...
                    n ? V(Wi) || l.location && "#bffwroe2etoq" == l.location.hash ? k = !0 : (l = W(l).clientWidth, k = l - k, k = l && 0 <= k ? !0 : l ? -10 > k ? 11 : 0 > k ? 14 : 12 : 10) : k = 9
                }
                if (k) {
                    k = a.j;
                    l = h.ea;
                    if (m = No(k, l)) l.style.border = l.style.borderStyle = l.style.outline = l.style.outlineStyle = l.style.transition = "none", l.style.borderSpacing =
                        l.style.padding = "0", Lo(l, m, "0px"), l.style.width = W(k).clientWidth + "px", Oo(k, l, m), l.style.zIndex = 30;
                    k = !0
                } else Do(h.za), k = !1
            } else k = !1;
            k = !k
    ...
    function Ou(a) {
        if (V(Ki)) return [];
        const b = Pu(a);
        return null == b || null == b.placed ? [] : b.placed.map(c => c.index).filter(c => 0 <= c && c < a.l.A.j.length)
    }

    function Nu(a, b) {
        return jm(lm(Yp(b).map(uo), () => {
            a.C.push(18)
        }))
    }
    ...
    function $u(a) {
        return In(a.j.document.querySelectorAll("INS.adsbygoogle-placeholder")).map(b => new up(new op(b, 1), new mp(Zu), a.l, !1, 0, [], null, a.j, null))
    }
    class av {
        constructor(a, b) {
            this.j = a;
    ...
    function fv(a, b) {
        const c = b.N;
        return !a.D && c.A && A(c.A, 8) && 1 == z(c.A, 8) ? [] : c.B ? (c.J || []).map(d => Un(Sn(d, a.j))) : [Un(new Tn(b.P.j, 0))]
    }
        ...
        a.F.forEach(b => {
            switch (b) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    (b = H(a.j, Pk, 18)) && it(new jt(a.l, a.ca || new pt(a.l, a.C), b, new Zr(a.l), J(a.j, Nk, 1)));
                    break;
                case 3:
                    qv(a)
            }
    ...
    function pv(a) {
        ...
        a: {
            var c = a.l;
            var d = lq(c);c = W(c).clientHeight || iq[d];
            var e = oq(J(b, kk, 2), d);
            if (e && (e = rq(e, c))) {
                d = e;
                break a
        ...
        if (a.A.T && A(a.A.T, 10) && (c = zd(H(a.A.T, nl, 10), 1), null !== c && void 0 !== c)) {
            var f = a.l;
            d = c;
            c = lq(f);
            e = W(f).clientHeight || iq[c];
            var g = void 0;
            b && (g = (g = (g = oq(J(b, kk, 2), c)) ? H(g, mk, 7) : void 0) ? sq(g, e) : void 0);
            var h = lq(f);
            f = W(f).clientHeight || iq[h];
            const N = qq(jq[h].ic, f);
            f = null ===
                N ? mq(h, f) : new nq(N, N, tq(N, N, 8), 8, .3, g);
            g = qq(jq[c].Tc, e);
            h = qq(jq[c].ic, e);
            e = qq(jq[c].Sc, e);
            c = f.A;
        ...
        if (A(a.j, 26)) {
            ...
            var m;
            l = g ? [] : null != (m = pq(null == c ? void 0 : J(c, lk, 3), f)) ? m : d.D;
            var n;
            m = null != (n = null == c ? void 0 : z(c, 4)) ? n : d.l;
            var p;
            n = null != (p = null == c ? void 0 : zd(c, 6)) ? p : d.B;
            var r;
            p = null != (r = (null == c ? 0 : A(c, 7)) ? sq(H(c, mk, 7), f) : null) ? r : d.j;
        ...
        c = V(Oi);
        e = !1;
        cl(m) && 1 === z(cl(m), 1) && (f = H(cl(m), ol, 6)) && (k = z(f, 2) || 0, 1 === z(f, 1) && (e = !0));
        var v, D;
        f = (null == (x = H(m, Vk, 24)) ? void 0 : null == (v = H(x, Zk, 3)) ? void 0 :
            null == (D = H(v, $k, 3)) ? void 0 : Jd(D, al, 2, bl)) || !1;
        if (c || e || f) x = Xu(new Yu(a.l)), n = n.concat(x), eu.I = !0, eu.B = x.length;
        ...
        n = V(Pi);
        el(a.j) ? (p = el(a.j), n = n || Bd(p, 14, !1), m = Bd(p, 2, !1), l = Bd(p, 3, !1), k = Bd(p, 4, !1), d = Bd(p, 5, !1), c = Bd(p, 6, !1), e = zd(p, 8), p = {
            Ua: n,
            Wa: m,
            sc: l,
            Uc: k,
        ...
        var w,
            E;
        (null == (w = Pu(a.B)) ? 0 : null == (E = w.optimization) ? 0 : E.ablatingThisPageview) && !xt(a.B) && Vo(a.l);
        w = a.A.T ? z(a.A.T, 2) : [];
        E = z(b, 1);
        b = a.B;
        w = Su(E, w, {
        ...
        w = a.H;
        b = new An;
        for (w.j.B = !0; 0 < w.l.length;) E = w, (x = ut[w.l[0]]) ? E = x(E.j) : (E.j.ia(12), E = !0), E || w.j.ia(5), w.l.shift();
        try {
        ...
        km(Mr(a.l, a.j, a.la, {
            ...
            if (d) {
                ...
                if (0 < e.document.getElementsByTagName("google-read-aloud-player").length) e =
                    ...
                    ge(l, nr `window.ga=window.ga||function(){(ga.q=ga.q||[]).push(arguments)};ga.l=+new Date;`);
                    k.appendChild(l);
                    pr(h, k, gb("https://www.google-analytics.com/analytics.js"));
                    pr(h, k, gb("https://www.gstatic.com/readaloud/player/web/api/audiosense/js/api.js"));
                    ...
                    f && (A(f, 1) && 0 != Ad(f, 1, 0) && h.setAttribute("data-docking-begin-trigger", qr[Ad(f, 1, 0)]), A(f, 2) && h.setAttribute("data-experiment", K(f, 2)));
                    k.appendChild(h);
                    aq(d, k);
                    e = fm(e.document.getElementsByTagName("google-read-aloud-player")[0])
                }
                null != e.j ? (b.A = e.j.value, c && Or(b), Qr(b, {
                    sts: "ok",
                    pp: d.P.j
                })) : Qr(b, {
                    sts: "wf"
    ...
    function uv(a) {
        return a.A.T && A(a.A.T, 10) ? .5 <= (zd(H(a.A.T, nl, 10), 1) || 0) : !0
    }

    function vv(a, b) {
        for (var c = Hr(Hr(new Ot(b.xa), b.errors), a.K), d = b.Xa, e = 0; e < d.length; e++) a: {
        ...
        if (c = b.Ib) a.l.as_count = c.ed, a.l.d_count = c.Fd, a.l.ng_count = c.Yd, a.l.am_count = c.jd, a.l.atf_count = c.gd, a.l.mdns = Pt(c.Td), a.l.alldns = Pt(c.hd);
        c = b.Db;
        null != c && (a.l.allp = c);
        if (c = b.Hd) {
            d = [];
            for (var h of En(c)) 0 < c.get(h).length && (e = c.get(h)[0], d.push("(" + [h, e.qd, e.we].join() + ")"));
            a.l.fd = d.join(",")
        }
        h = b.$b;
        null != h && (a.l.pgh = h);
    ...
    function wv(a, b) {
        var c = vv(a, b);
        Kr(a.D, 0 < b.errors.length || 0 < a.K.length || void 0 !== b.exception ? 0 < a.J ? Br : zr : 0 < a.J ? Ar : yr, c);
        if (H(a.j, Vk, 24)) {
            if (null != (b = a.B.l.l.j)) {
                eu.C = [...z(b.j, 1)];
                var d;
                let l;
                eu.F = !!(null == (d = H(b.j, Zk, 3)) ? 0 : null == (l = H(d, $k, 3)) ? 0 : Jd(l, al, 2, bl));
                d = new Gn;
                var e;
                let m;
                for (const n of null != (m = null == (e = H(b.j, Xk, 2)) ? void 0 : J(e, Yk, 1)) ? m : []) d.set(K(n, 1), Ad(n, 2, 0));
                eu.l = d
            }
            e = Pu(a.B);
            var f;
            eu.A = !!(null == e ? 0 : null == (f = e.optimization) ? 0 : f.ablationFromStorage);
            var g;
            if (null == e ? 0 : null == (g = e.optimization) ?
                0 : g.ablatingThisPageview) eu.D = !0;
            let k;
            eu.J = !!(null == e ? 0 : null == (k = e.optimization) ? 0 : k.availableAbg);
            var h;
            f = eu;
            c = new au(c);
            f.C ? (g = null != (h = f.C) ? h : [], c.j.sl = g.join("~"), c.j.ab = Rt(f.D), c.j.rr = Rt(f.I), c.j.oab = Rt(f.F), null != f.A && (c.j.sab = Rt(f.A)), c.j.ls = Rt(f.J), Qt(c, f.l.Pa()), null != f.B && (c.j.rp = Rt(f.B)), ju(f, c)) : (h = c, f = "irr".replace(RegExp("~", "g"), ""), h.j.e = h.j.e ? h.j.e + ("~" + f) : f);
            h = c;
            Kr(a.D, Er, h)
        }
    }
    ...
    function xv(a) {
        return cl(a.j) && 1 === z(cl(a.j), 1) ? !(H(cl(a.j), ol, 6) && 1 <= (z(H(cl(a.j), ol, 6), 3) || 0)) : !1
    }
        ...
        if (rv(a)) {
            ...
            Vn(a.I, c => {
                ...
                if (null == (d = a.j) ? 0 : null == (e = el(d)) ? 0 : Bd(e, 21, !1)) {
                    ...
                    try {
                        let h;
                        if (null == (h = a.F) ? 0 : h.includes(0)) a.J++, pv(a), sv(a, "r", tv(a), c)
                    } catch (h) {
                        sv(a, "f", tv(a), c), Kr(a.D, Br, Ir(Nt(Mt(Gr(new Ot(0), a.C), a.j), a.F).ia(1), h))
                    }
                }
            })
        }
    ...
    function rv(a) {
        let b, c, d;
        return null != (d = null == (b = a.j) ? void 0 : null == (c = el(b)) ? void 0 : Bd(c, 18, !1)) ? d : !1
    }
                ...
                S(753, () => {
                    if (V(Ii) && null != this.B) {
                        ...
                        var f = {
                            ...
                            g = bv(f.Qb, "gapsMeasurementWindow") ||
                            bv(f.mb, "gapsPerMeasurementWindow") || bv(f.yb, "maxGapsToReport");
                        e = null != g ? hm(g) : -1 == f.mb && -1 == f.yb ? hm("ShouldHaveLimits") : fm(new iv(d, e, f));
                        d = Xa(c);
                        if (null != e.j) {
                            e = e.j.value;
                            ...
                            f = gv(g);
                            g = new Gn;
                            for (h = 0; h < f.length; ++h) k = f[h], l = e.H ? 0 : Math.floor(k.va / e.B), Cn(g, l) || g.set(l, []), g.get(l).push(k);
                            f = hv(e, g);
    ...
    function Lv(a) {
        !a.A || a.j.__uspapi || a.j.frames.__uspapiLocator || (a.j.__uspapiManager = "fc", nt(a.j, "__uspapiLocator"), oa("__uspapi", (...b) => Mv(a, ...b)))
    }
    ...
    class Kv {
        constructor(a) {
            this.j = a;
            this.l = a.document;
            this.A = (a = (a = Hv(this.l)) ? H(a, Gv, 5) || null : null) ? z(a, 2) : null;
    ...
    var Sv = (a, b, c, d, e, f = null, g) => {
        ...
        if (d = m) {
            ...
            if (Nl(a, 2))
                if (bi(5, [d.toJSON()]), e = Pv(c), c = (c = n.T) && z(c, 4) || "", e.google_package = c, e = new so(["google-auto-placed"], e), c = new Lr(a), e = void 0 === e ? null : e, m = new Xn(a), f = void 0 === f ? null : f, g = {
                        url: a.location.href,
                        Va: g
                    ...
                    if (d) {
                        ...
                        H(d, Ak, 27) && 1 == Ad(H(d, Ak, 27), 1, 0) &&
                            l.push(3);
                        try {
                            ov(new Cv(a, c, b, d, n, l, e, k, m, f, g))
                        } catch (p) {
                            ai() && bi(15, [p]), Kr(c, zr, Ir(Nt(Mt(Gr(new Ot(0), b), d), l).ia(1), p))
                        }
    ...
    `https://support.google.com/adsense/#topic=3373519`, Uv = /[\s!'",:;\\(\\)\\?\\.]/, Vv = "\u00bf\u00a1\u037e\u061f\u3002\uff0c\u00b7\u2019".split(""), Wv = ["ja", "zh_CN", "zh_TW"];
    class Xv {
        constructor() {
            this.l = null;
            this.j = Infinity
    ...
    function Yv(a, b, c, d, e, f, g, h) {
        ...
        for (let I = 0; I < b.childNodes.length; I++) {
            ...
            if (l.nodeType === Node.TEXT_NODE && "" !== l.textContent) {
                a: {
                    ...
                    for (;;) {
                        ...
                        for (const N of J(x, Jl, 2))
                            for (const va of J(N, Hl, 2)) {
                                ...
                                for (var C = Q; C < r.length;) {
                                    C = r.indexOf(Ma, C);
                                    if (-1 === C) break;
                                    if (C > w || C === w && null !== da && Ma.length < da.length) break;
                                    if (!Zv(r.charAt(C - 1)) || !Zv(r.charAt(C + Ma.length))) break;
                                    if (v.j +
                                        $v(r.substr(Q, C - Q)) >= Ad(x, 5, 0)) {
                                        w = C;
                                        da = Ma;
                                        E = K(N, 1);
                                        break
                        ...
                        if (null === da) {
                            ...
                            Q < r.length && (n = r.substr(Q), G.push(m.document.createTextNode(n)), v.j += $v(n));
                            m = G;
                            break a
                        }
                ...
                a: if (m = l, m.nodeType !== Node.ELEMENT_NODE || m.classList.contains("google-adfil-skip")) m = !1;
                    else switch (m.tagName) {
                        case "A":
                        case "IFRAME":
                        case "BUTTON":
                        case "CANVAS":
            ...
            a: {
                ...
                if (null != g) {
                    ...
                    if (a.performance) {
                        ...
                        if (null !== (f = h.classList) && void 0 !== f && f.contains && !h.hasAttribute("data-google-affiliate-annotated")) {
                            ...
                            0 < f.j && (k = a.document, l = k.createElement("SCRIPT"), l.setAttribute("async", "async"), he(l, vh `https://www.google.com/adsense/search/ads.js`), k.body.appendChild(l));
                            k = Ad(e, 8, 0);
                            T("adfil-imp", {
                                wp: d,
                                c: g,
    ...
    function jw(a) {
        return a ? (a = /^([\w-=:]+)&([A-Za-z0-9\+\/=]+)&([A-Za-z0-9\+\/=]+)$/.exec(a)) ? {
            yc: a[1],
            domain: ld(a[2]),
            path: ld(a[3])
        } : null : null
    ...
    function pw(a, b, c) {
        return S(629, d => {
            if ("string" === typeof d) {
                ...
                var k = f._value_;
                if (k) {
                    if ("string" !== typeof k || "number" !== typeof g || "string" !== typeof h) throw Error("Invalid JSONP response");
                    e = new Ae;
                    e = F(e, 1, k);
                    e = F(e, 2, g);
                    e = F(e, 3, h);
                ...
                if (V(ij) && (f = f._gpid_)) {
                    if ("string" !== typeof f || "number" !== typeof g || "string" !== typeof h) throw Error("Invalid JSONP response");
                    var l = new Be;
                    var m = h;
                    k = kd(d);
                    m = kd(m);
            ...
            e && (d = e, b && (lw(c, "__gads", d, b), B(b, 5) && .01 > c.j.Math.random() && (h = kw(c, b), Sf({
                domain: d.F(),
    ...
    function qw(a, b, c) {
        ...
        if (0 === a.l) {
            if (kw(a, b)) var e = !0;
            else if (e = a.j, B(b, 5) && "null" !== e.origin && (new Am(e.document)).set("GoogleAdServingTest", "Good", void 0), e = "Good" === Dm("GoogleAdServingTest", b, a.j)) {
                var f = a.j;
                B(b, 5) && "null" !== f.origin && (new Am(f.document)).remove("GoogleAdServingTest", void 0, void 0)
            }
            a.l = e ? 2 : 1
        }
        2 === a.l && (d = pw(c, b, a));
    ...
    function rw(a, b, c, d) {
        ...
        const f = lb(ob(fb(gb("https://partner.googleadservices.com/gampad/cookie.js"))), d),
            g = qw(b, a, c);
        g ? new Promise(h => {
            c._gfp_s_ = k => {
                g(k).then(h)
    ...
    var sw = (a, b, c) => {
        ...
        if (e) {
            ...
            e ? Promise.resolve() : V(Ai) ? (c = `${"https://partner.googleadservices.com/gampad/cookie.js"}?domain=${b.location.hostname}&client=${c}`, (e = kw(d, a) || "") && (c += `&cookie=${e}`), (b = qw(d, a, b)) ? ow(c).then(b) : Promise.resolve()) :
                rw(a, d, b, c)
    ...
    var xw = (a, b, c, d) => {
            switch (c) {
                ...
                case 2:
                    return 0 === tw(a, c);
                case 8:
                    return b = "on" === b.google_adtest || Sl(a.location, "google_ia_debug") ? -1 : 3600, 0 == (uw(a) | vw(a, b, d));
                case 9:
                    return b = !("on" === b.google_adtest || Sl(a.location, "google_scr_debug")), !xl(a, b, d);
                case 30:
                    return 0 == Dl(a);
                case 26:
                    return 0 == ik(a);
        ...
        yw = (a, b, c, d) => {
            switch (c) {
                ...
                case 2:
                    return tw(a, c);
                case 8:
                    return b = "on" === b.google_adtest || Sl(a.location,
                        "google_ia_debug") ? -1 : 3600, uw(a) | vw(a, b, d);
                case 9:
                    return xl(a, !("on" === b.google_adtest || Sl(a.location, "google_scr_debug")), d);
                case 16:
        ...
        Ew = (a, b) => {
            ...
            null != c && null == c.debugCard && vg(Ql, d => {
                !c.debugCardRequested && "number" === typeof d && Ul(d, a.location) && (c.debugCardRequested = !0, Dw(a, b, e => {
        ...
        Fw = (a, b, c, d) => {
            ...
            let h = !1;
            vg(f.reactiveTypeDisabledByPublisher,
                (k, l) => {
                    String(c) === l && (h = !0)
                });
        ...
        Lw = (a, b, c) => {
            b = S(b, c);
            return ur(1, P(), lb(de(a), ii(Hj).j(Ci.j, Ci.defaultValue) ? {
    ...
    const Mw = a => {
        a.adsbygoogle || (a.adsbygoogle = [], ff(a.document, de(vh `https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js`)))
    };
    var Nw = (a, b) => {
            L(a, "load", () => {
                Mw(a);
    ...
    var Tw = (a, b, c, d, e, f, g) => {
        ...
        Xw = (a, b, c, d, e, f) => {
            ...
            for (let h = 0; h < a.length; h++) {
                ...
                l && n && m ? (k.pubVars = Ww(e, k), delete k.google_reactive_sra_index, g.push(l), Dh(466, () => n.verifyAndProcessConfig(b, k, f))) : T("rasra::ivc", {
                    af: l,
                    ak: m,
                    c
                }, .1)
    ...
    */
    ...
    function cx(a, b) {
        ...
        if (a.j != c) {
            ...
            a = um();
            for (const d of a)
                if (d.cc.offsetWidth != d.offsetWidth || d.G.google_full_width_responsive_allowed) d.offsetWidth = d.cc.offsetWidth, Dh(467, () => {
                    var e = d.cc,
                        f = d.G;
                    const g = ax(e, f);
                    ...
                    P().google_spfd(e, f, b);
                    const h = ax(e, f);
                    !h && g && 1 == e.childNodes.length ? (bx(g, !1), V(ej) ? f.rss = 1 : (f.google_reactive_ad_format = 16, f.google_ad_section = "responsive_resize"), e.dataset.adsbygoogleStatus = "reserved", e.className += " adsbygoogle-noablate", Mw(b), b.adsbygoogle.push({
                        element: e,
                        params: f
                    })) : h && g ? h != g && (bx(g, !1), bx(h, !0)) : T("auto_size_refresh", {
    ...
    class dx {
        ...
        init(a) {
            const b = nm();
            X(b, 27, !1) || (b.S[qm(27)] = !0, this.j = a.innerHeight >= a.innerWidth ? 0 : 90, L(a, "resize", () => cx(this, a)))
        }
    };
    var ex = class {
        constructor(a, b, c) {
    ...
    function jx(a, b, c) {
        ...
        const d = b.msg_type;
        let e;
        "string" === typeof d && (e = a.$a[d]) && qh(a.la, 168, () => {
            e.call(a, b, c)
        })
    }
    class kx extends Em {
        constructor(a) {
            ...
            this.ud = rh(this.la, 169, (c, d) => gk(this.j, "ras::xsf", this.$c, c, d));
            this.ma = [];
            this.O(this.$a);
            ...
            a["adsense-labs"] = b => {
                if (b = fk(b).settings) try {
                    ...
                    if (A(c, 1)) {
                        ...
                        null !== c && (g[e] = c.toJSON());
                        try {
                            d.localStorage.setItem("google_adsense_settings", JSON.stringify(g))
                        } catch (h) {}
                    }
                } catch (h) {}
            }
    ...
    class sx extends lx {
        constructor(a, b) {
            ...
            this.ad = Ca(S(651, () => {
                ...
                var c = this.I;
                this.I = dk(this.j);
                this.A < this.D ? (c = this.I - c, 0 < c && (this.ha += c, this.ha >= this.bd ? (nx(this),
                    px(this, this.D)) : (this.A = Math.min(this.D, this.A + c), px(this, c), ox(this)))) : le(this.j, "scroll", this.K)
            }), this);
            this.K = () => {
                var c = this.ad;
        ...
        O(a) {
            a["expand-on-scroll"] = (b, c) => {
                Pg(c, this.l) && (b = fk(b), this.ca = b.i_expid, this.qa = b.qid, this.Ya = b.gen204_fraction, this.Za || (this.Za = !0, b = qx(this, b), "0" === b && L(this.j, "scroll", this.K, ie), c.source.postMessage(JSON.stringify({
                        ["msg_type"]: "expand-on-scroll-result",
                        ["eos_success"]: "0" === b,
                        googMsgType: "sth"
                    }), "*"),
            ...
            a["expand-on-scroll-force-expand"] = (b, c) => {
                Pg(c, this.l) && !this.bb && (this.bb = !0, nx(this), le(this.j, "scroll", this.K))
            }
        }
        B() {
    ...
    class ux extends Em {
        ...
        F() {
            ...
            if (a && !this.A) {
                ...
                c && (Nh(c, "ig", b, "*", 2), 10 <= ++this.D && this.j && le(this.l, "scroll", this.j, ie))
            }
            this.A = a
        }
    };
    class vx extends lx {
        ...
        O(a) {
            a.interscroller = (b, c) => {
                if (Pg(c, this.l) && (c = fk(b), b = c.i_h, c = c.i_f, null != b && "" !== b && null != c && "" !== c)) {
    ...
    class zx extends lx {
        constructor(a, b) {
            ...
            this.ha = S(636, () => {
                ...
                d + c > this.C ? (d = d + c - this.C, c = Math.min(d,
                    this.ca), d = this.D - d, d = Math.max(0, d), 0 >= d ? ig(this.l, {
                    position: "absolute",
                    top: "0px",
                    bottom: "auto"
                }) : ig(this.l, {
        ...
        O(a) {
            a["parallax-scroll"] = (b, c) => {
                ...
                !this.J && Pg(c, this.A) && (this.J = !0, b = xx(this, b), c.source.postMessage(JSON.stringify({
    ...
    function Ax(a, b) {
        ...
        var e = Bx(a, b, c, a.j.j.elementsFromPoint(Fe(c.left + c.width / 2, c.left, c.right - 1), Fe(c.bottom - 1 - 2, c.top, c.bottom - 1)), 1, []),
            f = Bx(a, b, c, a.j.j.elementsFromPoint(Fe(c.left + c.width / 2, c.left, c.right - 1), Fe(c.top + 2, c.top, c.bottom - 1)), 2, e.ra),
            g = Bx(a, b, c, a.j.j.elementsFromPoint(Fe(c.left + 2, c.left, c.right - 1), Fe(c.top + c.height / 2,
                c.top, c.bottom - 1)), 3, [...e.ra, ...f.ra]);
        const h = Bx(a, b, c, a.j.j.elementsFromPoint(Fe(c.right - 1 - 2, c.left, c.right - 1), Fe(c.top + c.height / 2, c.top, c.bottom - 1)), 4, [...e.ra, ...f.ra, ...g.ra]);
        var k = Cx(a, b, c),
        ...
        e = [...Ga(e, n => new Wf(n.elementRect.left,
            n.elementRect.top, n.elementRect.width, n.elementRect.height)), ...Qa(Ga(l, n => Yf(m, n.elementRect))), ...Fa(Yf(m, new Wf(0, 0, d.width, d.height)), n => 0 <= n.top && n.top + n.height <= d.height)];
        return {
            entries: k,
    ...
    function Cx(a, b, c) {
        ...
        for (b = b.parentElement; b; b = b.parentElement) {
            ...
            if (f) {
                var e = gf(b, a.j.L());
                e && "visible" !== e.overflow && ("auto" !== e.overflowY && "scroll" !== e.overflowY && c.bottom > f.bottom + 2 ? d.push(Hx(a, c, b, f, 5, 1)) : (e = "auto" === e.overflowX || "scroll" === e.overflowX, !e && c.left < f.left - 2 ? d.push(Hx(a, c, b, f, 5, 3)) : !e && c.right > f.right + 2 && d.push(Hx(a, c, b, f, 5, 4))))
            }
        }
        return d
    }
    ...
    function Dx(a, b) {
        ...
        for (let d = 1; d < 1 << b.length; d++) {
            let e = a,
                f = 0;
            for (let g = 0; g < b.length && (!(d & 1 << g) || (f++, e = Xf(e, b[g]), e)); g++);
        ...
        if (Ka(a.A, e) && Ka(a.l, f)) {
            ...
            if ((a = Lx(a, c)) && Vf(b, a)) c = 4;
                ...
                if (Oc) {
                    ...
                    e = new Tf(k, f, l, e)
                } else e = lg(c, "paddingLeft"), f = lg(c, "paddingRight"), k = lg(c, "paddingTop"), l = lg(c, "paddingBottom"), e = new Tf(parseFloat(k), parseFloat(f), parseFloat(l), parseFloat(e));
                Vf(b, new Tf(a.top +
                    e.top, a.right - e.right, a.bottom - e.bottom, a.left + e.left)) ? c = 3 : (c = Mx(c, d), c = Vf(b, c) ? 2 : 1)
            }
            h.overlapDepth = c
        }
    ...
    function Lx(a, b) {
        ...
        a.setEndAfter(c);
        a = a.getBoundingClientRect();
        return 0 === a.width || 0 === a.height ? null : new Tf(a.top, a.right, a.bottom, a.left)
    }
    ...
    function Mx(a, b) {
        ...
        return new Tf(b.top + c.top, b.right - 1 - c.right, b.bottom - 1 - c.bottom, b.left + c.left)
    }
    class Ox {
        constructor(a, b = Px) {
            this.j = Ke(a);
    ...
    function Qx(a, b) {
        Array.isArray(b) || (b = [b]);
        b = b.map(function(c) {
            return "string" === typeof c ? c : c.ac + " " + c.duration + "s " + c.timing + " " + c.delay + "s"
        });
    ...
    var Rx = za(function() {
        ...
        !0 === $a.div ? b += ">" : (e = tc(d), b += ">" + kc(e).toString() + "</div>", e = e.Aa());
    ...
    function Vx(a, b, c, d) {
        return "" != a.A || b ? null : "" == a.j.replace(Wx, "") ? null != c && a.l[0] || null != d && a.l[1] ? !1 : !0 : !1
    }
    ...
    function ey(a) {
        ...
        a.H && (a.K ? (Qx(c, iy), Qx(a.K, iy)) : Qx(c, "opacity 1s cubic-bezier(.4, 0, 1, 1), width .2s cubic-bezier(.4, 0, 1, 1) .3s, height .5s cubic-bezier(.4, 0, 1, 1)"));
    ...
    function jy(a) {
        if (a.B && !a.qa || null == a.A && null == a.l && null == a.R && a.B) return a.j;
        var b = a.B;
        a.B = !1;
        Zx(a);
        a.B = b;
    ...
    function cy(a, b) {
        ...
        "absolute" == b.position ? (Tx(a.j, "a"), c = !0) : "fixed" == b.position && (Tx(a.j, "f"), c = !0);
        return c
    }
    ...
    function ay(a, b, c, d) {
        ...
        k = !m && by(d);
        v = m || v || k || !(f || n || d && (!ly(String(d.minWidth)) || !my(String(d.maxWidth))));
        l = m || g || k || l || !(h || x || d && (!ly(String(d.minHeight)) || !my(String(d.maxHeight))));
        ...
        if (a.bb) {
            ...
            (f = null != a.l && d && p && Math.round(p) !== a.l) && !(f = !h) && (f = p, f = (V(Ui) || b.location && "#gffwroe2ettq" == b.location.hash) && Math.round(f) < .8 * Math.round(b.innerHeight));
            f = f && "100%" !== d.minHeight;
            if (c = a.B && !c && f) c = !(a.Ya && d && (V(Ti) || b.location && "#gffwroe2etoq" == b.location.hash) && Math.round(uf(d.minHeight)) === Math.round(b.innerHeight));
            c && (e.setProperty("height", "auto", "important"), d && !ly(String(d.minHeight)) && e.setProperty("min-height", "0px", "important"), d && !my(String(d.maxHeight)) && a.l && Math.round(p) < a.l && e.setProperty("max-height", "none", "important"))
        } else ny(a, 1, l, c, "height", h, a.D, a.l), oy(a, 1, "d", l, e, d, "height", x, a.D, a.l), oy(a, 1, "m", l, e, d, "minHeight", e && e.minHeight,
            a.D, a.l), oy(a, 1, "M", l, e, d, "maxHeight", e && e.maxHeight, a.D, a.l);
        return m
    }
    ...
    function oy(a, b, c, d, e, f, g, h, k, l) {
        if (null != l) {
            f = f && f[g];
            "string" != typeof f || ("m" == c ? ly(f) : my(f)) || (f = uf(f), null == f ? Tx(a.j, "p") : null != k && Tx(a.j, f == k ? "E" : "e"));
            if ("string" == typeof h) {
    ...
    function sy(a, b, c) {
        var d;
        (d = a.j) && !(d = !a.B) && (c ? (b = a.l + Math.min(b, ry(a.sa())), a = a.j && b >= a.A) : a = a.j && a.l >= a.A, d = a);
        return d
    }
    var py = class {
        constructor(a) {
    ...
    function fy(a, b, c) {
        null !== b && null !== sf(a.getAttribute("width")) && a.setAttribute("width", b);
        null !== c && null !== sf(a.getAttribute("height")) && a.setAttribute("height", c);
        null !== b && (a.style.width = b + "px");
        null !== c && (a.style.height = c + "px")
    }
    var gy = "margin-left margin-right padding-left padding-right border-left-width border-right-width".split(" "),
        hy = "margin-top margin-bottom padding-top padding-bottom border-top-width border-bottom-width".split(" ");
    let wy = "opacity 1s cubic-bezier(.4, 0, 1, 1), width .2s cubic-bezier(.4, 0, 1, 1), height .3s cubic-bezier(.4, 0, 1, 1) .2s",
        xy = gy;
    for (let a = 0; a < xy.length; a++) wy += ", " + xy[a] + " .2s cubic-bezier(.4, 0, 1, 1)";
    xy = hy;
    for (let a = 0; a < xy.length; a++) wy += ", " + xy[a] + " .3s cubic-bezier(.4, 0, 1, 1) .2s";
    var iy = wy;

    function ry(a) {
        return "string" === typeof a ? sf(a) : "number" === typeof a && isFinite(a) ? a : null
    };
    ...
    function yy(a, b, c, d, e, f, g, h, k, l) {
        ...
        if (qy(n, f, d, k)) {
            ...
            l.r_cui && tf(l.r_cui.toString()) && O(r, {
            ...
            l.err = "0";
            zy(a, l, n);
            Ia(ii(kn).l(), v => Ka([248427477, 248427478], v)) && a.j === m && Fx(new Ox(a.j, void 0), r).then(v => {
                bi(8, [v]);
                return v
            }).then(v => {
                T("resize-ovlp", {
    ...
    function Ay(a, b, c) {
        ...
        b && (d.str = sy(b, sf(c.r_nh), tf(c.r_cab)), d.ad_y = b.l, d.vph = b.A);
        vg(c, (e, f) => {
            d[f] = e
        });
        return d
            ...
            a["resize-me"] = (b, c) => {
                if (ck(c, this.l.contentWindow)) {
                    ...
                    if (null == d || "" === d) {
                        ...
                        var h = b.r_str;
                        h = h ? h : null;
                        e = yy(this, d, e, f, g, h, tf(b.r_ao), tf(b.r_ifr),
                            tf(b.r_cab), b);
                        d = {
    ...
    var Ly = a => {
        ...
        c = b.length;
        for (d = 0; d < c; ++d)
            if (e = b[d], e.hasAttribute("href") && (e = e.getAttribute("href"), Jy.test(e) || Ky.test(e))) return 6;
        ...
        for (a = 0; a < c; ++a)
            if (d = b[a], "stylesheet" == d.getAttribute("rel") && d.hasAttribute("href") && (d = d.getAttribute("href"), Hy.test(d))) return 2;
        return 0
    };
    let My = navigator;
    var Ny = a => {
    ...
    function Uy(a) {
        return !!a && ("object" === typeof a || "function" === typeof a) && Ty(a) && wg(a.nq) && wg(a.nqa) && wg(a.al) && wg(a.rl)
    }
    ...
    class Wy {
        ...
        I(a, b) {
            0 != this.j || 0 != this.B.length || b && b != window ? this.C(a, b) : (this.j = 2, this.F(new Xy(a, window)))
        }
        C(a, b) {
    ...
    const oz = (a = {}, b = 0) => {
        ...
        var l = !(Z[3] >= na()) && 0 != b;
        if (k || d || l) d = na(), e = d + 1E3 * e, f = d + 1E3 * f, 1E-5 > Math.random() && Pf(t, "https://pagead2.googlesyndication.com/pagead/gen_204?id=imerr" +
            `&err=${b}`), h[5] = b, h[1] = c, h[2] = e, h[3] = f, h[4] = g, h[6] = a, kz();
        if (k || !mz.Rb()) {
            b = mz.wc();
    ...
    function wz(a, b) {
        a = V(Fj) ? a.map(c => c.issuerOrigin) : a.filter(c => 6 === c.state).map(c => c.issuerOrigin);
        ...
        b && 0 < Object.keys(b).length && (a.additionalSigningData = kd(JSON.stringify(b), 3));
        return a
    }
    ...
    function Az(a) {
        ...
        return window.fetch(b, c).then(d => {
            ...
            d && "NoModificationAllowedError" === d.name ? yz(a.issuerOrigin, 6) : yz(a.issuerOrigin, 5)
        })
    }
    ...
    function Cz() {
        ...
        return document.hasTrustToken(sz.issuerOrigin).then(a => a ? Az(sz) : Bz(sz, !0))
    }
    ...
    function Dz(a) {
        if (document.hasTrustToken && !V(Dj) && (!V(Ej) || a.l)) {
            ...
            var b = [];
            V(Fj) ? rz() && b.push(Cz()) : a.j.forEach(c => {
    ...
    class Ez extends Em {
        constructor(a = !1) {
            ...
            if (document.hasTrustToken && !V(Dj) && !Array.isArray(window.goog_tt_state)) {
                const b = xz(this);
    ...
    var Iz = (a, b) => {
            ...
            e ? (e = e.toString(), 0 == e.indexOf("http://") ? e = e.substring(7, e.length) : 0 == e.indexOf("https://") && (e = e.substring(8, e.length)), d = e.indexOf("/"), -1 == d && (d = e.length), e = e.substring(0, d).split("."), d = !1, 3 <= e.length && (d = e[e.length - 3] in Cy), 2 <= e.length && (d = d || e[e.length - 2] in Cy), e = d) : e = !1;
            ...
            d.google_ad_client && Hz.test(f) && (p = "/pagead/lopri?");
            e = `https://${e}${p}`;
            a = Bd(a.U, 9) && c.google_debug_params ? c.google_debug_params : "";
            a = Ag(b, e + a);
            return c.google_ad_url = a
        },
        Jz = a => encodeURIComponent("RS-" + a.google_reactive_sra_index + "-") + "&" + zg({
        ...
        Mz = (a, b) => {
            a = (a = Ng(a.pubWin)) && a.document ? Rh(a.document, a) : new Ie(-12245933, -12245933);
    ...
    var Oz = a => {
        ...
        Pz = (a, b, c) => {
            ...
            var h;
            (h = $f(e)) && ea(h.data) && "string" === typeof h.data.type ? (h = h.data.type.toLowerCase(), h = "doubleclick" == h || "adsense" == h ? null : h) : h =
                null;
            ...
            Yy && Ty(Yy) ? g = Yy : (g = Lj(), h = g.google_jobrunner, g = Uy(h) ? Yy = h : g.google_jobrunner = Yy = new Wy(g));
            ...
            if (!Mg(d)) {
                ...
                g = "";
                if (c.documentMode &&
                    (h = Ze(new Le(c), "IFRAME"), h.frameBorder = "0", h.style.height = 0, h.style.width = 0, h.style.position = "absolute", c.body)) {
            ...
            try {
                v =
                    e.screen.availWidth, D = e.screen.availTop
            } catch (R) {}
            ...
            if (!Aw(d) && (e = Og(d))) {
                ...
                a: {
                    try {
                        ...
                        if (E = C) {
                            C = [];
                            I = 0;
                            for (var Q = Date.now(); 100 >= ++I && 50 > Date.now() - Q && (E = Kz(E));) 1 === E.nodeType && C.push(E);
                            var da = C;
                            b: {
                                for (Q = 0; Q < da.length; Q++) {
                                    c: {
                                        var N = da[Q];
                                        try {
                                            if (N.parentNode && 0 < N.offsetWidth && 0 < N.offsetHeight && N.style && "none" !== N.style.display && "hidden" !== N.style.visibility && (!N.style.opacity || 0 !== Number(N.style.opacity))) {
                            ...
                            if (Ma) {
                                b: {
                                    const R = Date.now();Ma = /^html|body$/i;va = /^fixed/i;
                                    for (N = 0; N <
                                        da.length && 50 > Date.now() - R; N++) {
                                        const nf = da[N];
                                        if (!Ma.test(nf.tagName) && va.test(nf.style.position || mg(nf, "position"))) {
                                            var Fd = nf;
                                            break b
                                        }
                                    }
                ...
                Fd && Fd.offsetWidth * Fd.offsetHeight <= 4 * e.width * e.height && (w = 1);
                b.pfx = w
            }
            a: {
        ...
        Qz = (a, b) => {
            ...
            a.location && a.location.ancestorOrigins ?
                c = a.location.ancestorOrigins.length : df(() => {
                    c++;
                    return !1
                }, !0, !0, a);
            c && (b.nhd = c)
        ...
        Sz = (a, b, c) => {
            ...
            if ("_gfp_a_" in a.pubWin) {
                ...
                if (e) {
                    ...
                    V(jj) && "1" === (c ? Dm("__gpi_opt_out", c, e.j) : null) && (b.gpico = "1")
                }
            }
            k = nm();
            h = X(k, 8, {});
            ...
            if ($f()) var D = P().gaGlobal || {};
                ...
                l = -1 < k.indexOf("__utmb=" +
                    c);
                (r = (cg() || P()).gaGlobal) || (r = {}, (cg() || P()).gaGlobal = r);
                x = !1;
                if (n) {
                    var w = k.split("__utma=" + c + ".")[1].split(";")[0].split(".");
                    ...
                    if (!r.vid) {
                        ...
                        g ? w += g.width + "x" + g.height + g.colorDepth : t.java && t.java.awt &&
                            (g = t.java.awt.Toolkit.getDefaultToolkit().getScreenSize(), w += g.screen.width + "x" + g.screen.height);
                        w = w + k + (f || "");
                ...
                if (!r.cid) {
                    b: for (e = h, w = 999, e && (e = 0 == e.indexOf(".") ? e.substr(1) : e, w = e.split(".").length), e = 999, k = k.split(";"), h = 0; h < k.length; h++)
    ...
    const Tz = (a, b) => {
        ...
        c && (b.npa = 1);
        a && (A(a, 3) && (b.gdpr = B(a, 3) ? "1" : "0"), (c = z(a, 1)) && (b.us_privacy = c), (c = z(a, 2)) && (b.gdpr_consent = c), (c = z(a, 4)) && (b.addtl_consent = c), (a = z(a, 7)) && (b.tcfe = a))
    };
    var Uz = (a, b) => {
            const c = a.G;
            Tz(a, b);
            ...
            Aw(c) && (a = Ow(c), b.fa = a);
            b.pi || null == c.google_ad_slot || (a = Wp(c), null != a.j && (a = no(a.j.value), b.pi = a))
        },
        Vz = (a, b) => {
            var c = bg() || Qh(a.pubWin.top);
            c && (b.biw = c.width, b.bih = c.height);
            c = a.pubWin;
            c.top != c && (a = Qh(a.pubWin)) && (b.isw = a.width, b.ish = a.height)
        },
        Wz = (a, b) => {
            var c = a.pubWin;
            null !== c && c != c.top ? (a = [c.document.URL], c.name && a.push(c.name), c = Qh(c, !1), a.push(c.width.toString()), a.push(c.height.toString()), a = of (a.join(""))) : a = 0;
            0 !== a && (b.ifk = a)
        },
        Xz = (a, b) => {
        ...
        $z = (a, b) => {
            (a = tz(a.pubWin)) && 0 < a.length && (b.tt_state = kd(JSON.stringify(a), 3))
        },
        aA = (a, b) => {
        ...
        bA = (a, b) => {
            try {
                const d = a.pubWin && a.pubWin.external && a.pubWin.external.getHostEnvironmentValue &&
    ...
    function fA(a, b, c, d) {
        ...
        return "function" === typeof(null === (e = a.gmaSdk) || void 0 === e ? void 0 : e.getQueryInfo) ? (L(a, "message", r), p = c(a.gmaSdk), n.promise) : "function" === typeof(null === (h = null === (g = null === (f = a.webkit) || void 0 === f ? void 0 : f.messageHandlers) || void 0 === g ? void 0 : g.getGmaQueryInfo) || void 0 === h ? void 0 : h.postMessage) || "function" ===
            typeof(null === (m = null === (l = null === (k = a.webkit) || void 0 === k ? void 0 : k.messageHandlers) || void 0 === l ? void 0 : l.getGmaSig) || void 0 === m ? void 0 : m.postMessage) ? (p = String(Math.floor(2147483647 * kf(a))), L(a, "message", r), b(a.webkit.messageHandlers, p), n.promise) : null
    }
    ...
    function iA(a) {
        var b;
        return "function" === typeof(null === (b = a.l) || void 0 === b ? void 0 : b.__uspapi) || null != hA(a)
    }
    ...
    function sA(a) {
        a.D || (a.l || (a.j.googlefc ? a.l = a.j : a.l = Bf(a.j, "googlefcPresent")), a.D = !0);
        return !!a.l
    }
    ...
    var wA = class extends Em {
        ...
        xA = (a, b, c, d) => {
            ...
            const e = H(b, nA, 3);
            b = H(b, qA, 2);
            return e && b && 1 === z(b, 1) && 2 === z(e, 1) ? vA(a, "getM25Consent").then(f => {
                var g = H(f, pA, 4);
                if (g) {
                    if (f = d, c) {
                        const h = z(g, 1);
    ...
    const yA = (a, b) => {
        try {
            ...
            var h = new xe(e, f, g),
                k = null !== (d = null === (c = H(b, ue, 5)) || void 0 === c ? void 0 : K(c, 1)) && void 0 !== d ? d : "";
            h.Ra = k;
            h.X = a;
            var l = h.build();
            pe(l)
    ...
    function zA(a, b) {
        a.goog_sdr_l || (Object.defineProperty(a, "goog_sdr_l", {
            value: !0
        }), "complete" === a.document.readyState ? yA(a, b) : L(a, "load", () => void yA(a, b)))
    };
    ...
    function CA(a) {
        ...
        if (a.parent === a.top && BA(a.document.referrer)) return Promise.resolve({
            status: 3
        });
        const c = new rr;
    ...
    var FA = async a => {
            ...
            Dh(639, () => {
                {
                    ...
                    if (m && 1 === k.google_responsive_auto_format && !0 === k.google_full_width_responsive_allowed) {
                        var l;
                        (l = (l = m.document.getElementById(k.google_async_iframe_id)) ? Xe(l, "INS", "adsbygoogle") : null) ? (k = new ex(m, l, k), k.l = t.setInterval(la(k.F,
                            k), 500), k.F(), k = !0) : k = !1
                    } else k = !1
                }
                return k
        ...
        EA = a => {
            ...
            var b = nm(),
                c = X(b, 22, !1);
            c || (b.S[qm(22)] = !0);
            c || (c = a.G, b = a.U, ii(kn).j(13), ii(kn).j(11), c = Ml(c), (b = K(b, 10)) && c.push(b));
            b = nm();
        ...
        if (!cc() && !u("Edge")) {
            ...
            if (!(0 >= b)) {
                ...
                await Promise.race([c, Of(b, "timeout")]).then(f => {
                    "timeout" === f ? T("adsense_td_worker_timeout", {
                        wait_ms: a,
                        timeout_ms: b
    ...
    function MA(a, b, c) {
        if (!c || 0 > b) return !1;
        var d = a.G;
        if (!ak(d.google_reactive_ad_format) && (Aw(d) || d.google_reactive_ads_config) || !Sh(c) || IA(a, c) <= b) return !1;
        var e = nm();
        const f = X(e, 8, {});
        e = X(e, 9, {});
        ...
        a.F = new t.IntersectionObserver((h, k) => {
            Ea(h, l => {
                0 >= l.intersectionRatio || (k.unobserve(l.target), Dh(294, () => {
                    HA(a)
                }))
            })
        }, {
    ...
    var HA = async a => {
            ...
            Dh(161, () => {
                ...
                e = (new Date).getTime();
                Array.isArray(c.google_color_bg) && (c.google_color_bg = iw(a, c.google_color_bg, e));
                Array.isArray(c.google_color_text) && (c.google_color_text = iw(a, c.google_color_text, e));
                Array.isArray(c.google_color_link) && (c.google_color_link = iw(a, c.google_color_link, e));
                Array.isArray(c.google_color_url) &&
                    (c.google_color_url = iw(a, c.google_color_url, e));
                Array.isArray(c.google_color_border) && (c.google_color_border = iw(a, c.google_color_border, e));
                Array.isArray(c.google_color_line) && (c.google_color_line = iw(a, c.google_color_line, e))
            });
            SA(a);
            Aw(a.G) && (Tl() && (a.G.google_adtest = a.G.google_adtest || "on"), a.G.google_pgb_reactive = a.G.google_pgb_reactive || 3);
            TA(a.M);
            return UA(a)
        },
        SA = a => {
            a.M && (Ew(a.M, a.$.Cd), Cw(a.M.location) && Nw(a.M, {
    ...
    var YA = (a, b, c) => 9 == a.G.google_reactive_ad_format && Xe(a.Y, null, "fsi_container", void 0) ? (a.W.appendChild(b), Promise.resolve(b)) : Lw(a.$.Mc, 525, d => {
        a.W.appendChild(b);
    ...
    function ZA(a, b, c, d) {
        zA(a.pubWin, re(Kd(Kd(qe(new se, te(new ue, String(Kf(a.pubWin)))), 4), 2), K(a.U, 2)));
        const e = a.M;
        ...
        aB(a, b);
        V(jj) && bB(a, b);
        !e || Aw(a.G) && !Pw(a.G) || (f(new vx(a, b)), f(new By(e, b, a.G)), f(new zx(a, b)), f(new sx(a, b)), f(e.IntersectionObserver ? null : new ux(e, b, a.W)));
        e && (f(new mx(e, b)), a.l.push(Zw(e, a.G)), ii(dx).init(e),
            a.l.push(ix(e, a.Y, b)));
        V(yj) || cB(a, c, b);
        b && b.setAttribute("data-google-container-id", d);
        c = a.G.iaaso;
        null != c && (d = a.Y, f = d.parentElement, (f && Jg.test(f.className) ? f : d).setAttribute("data-auto-ad-size", c));
        c = a.Y;
            ...
            Hh(a.pubWin, "gpi-uoo", (c, d) => {
                if (d.source === b.contentWindow) {
                    ...
                    if (c.clearAdsData && (c = a.A)) {
                        e = Dm("__gpi", c, d.j);
                        var f = jw(e);
                        f && (d = d.j, e = f.path, f = f.domain, B(c, 5) && "null" !== d.origin && (new Am(d.document)).remove("__gpi", e, f))
                    }
                }
            })
        };
    const dB = a => {
        ...
        $A = (a, b, c, d) => {
            Fx(new Ox(a, void 0), c).then(e => {
                bi(8, [e]);
                return e
            }).then(e => {
                const f = c.parentElement;
                (f && Jg.test(f.className) ? f : c).setAttribute("data-overlap-observer-io", e.isOverlappingOrOutsideViewport);
                return e
            }).then(e => {
                const f = b.G.armr || "",
                    g =
                    ...
                    l = Ga(e.entries, D => `${D.overlapType}:${D.overlapDepth}:${D.overlapDetectionPoint}`),
    ...
    var eB = a => {
        ...
        fB = (a, b, c) => {
            ...
            if (V(nj)) {
                n = a.pubWin.document;
                V(oj) ? p = (p = window.navigator.userAgent.match(/Chrome\/([0-9]+)/)) &&
                    92 > Number(p[1]) ? "conversion-measurement" : "attribution-reporting" : p = "conversion-measurement";
                var x;
                if (null == (x = n.featurePolicy) ? 0 : x.features().includes(p)) l.allow = p
            }
            k ? (l.name = "", x = VA(l), c = YA(a, x, c)) : c = XA(d, f, l, a);
            e && (e = a.$.xe, b = {
                id: f,
                url: d,
                width: g,
                ...
                Pd: e.toString(),
                Sb: a.pubWin
            }, b = !b.id || !b.url || 0 >= b.width || 0 >= b.height || !b.oc || !b.Sb ? void 0 : Mh(b.Sb, ma(Oh, b, e)), b && a.l.push(b));
            return c
        },
        cB = (a, b, c) => {
            const d = !cc() || 0 <= Cb(hc(), 11) ? si() : ji();
            d.getOseId() && (P().Goog_AdSense_getAdAdapterInstance = si, d.registerAdBlock(b, 1, "", c), a.l.push(() => {
    ...
    async function gB(a) {
        ...
        f = "";
        Qw(b) ? (f = a.$.ye.toString() +
            "#" + Jz(b), Rz(b, nm()), iB(b)) : (5 == b.google_pgb_reactive && b.google_reactive_ads_config || !Bw(b) || zw(c, b, e)) && iB(b) && (f = Iz(a, d));
        bi(2, [b, f]);
        if (!f) return Promise.resolve();
        b.google_async_iframe_id || Dg(c);
        e = Eg(b);
        b = t.window === t.window.top ? "a!" + e.toString(36) : `${e.toString(36)}.${Fc()}`;
        c = 0 < IA(a, a.W, !0);
        e = {
            ["ifi"]: e,
            ["uci"]: b
    ...
    const hB = a => "aa" !== a.google_loader_used && "sa" !== a.google_loader_used || !(ec() ? 0 <= Cb(hc(), 11) : dc() && 0 <= Cb(hc(), 65)) ? (pz(null), Promise.resolve()) : new Promise(b => {
            pz(b.bind(null, !0))
        }),
        jB = a => {
            const b = new mA(a);
        ...
        lB = a => {
            ...
            t.googlefc && !b && T("adsense_fc_has_namespace_but_no_iframes", {
                publisherId: a
            }, 1)
        },
        mB =
        a => sA(a) ? vA(a, "loaded") : Promise.resolve(),
        nB = (a, b) => {
            const c = b.ue,
                d = b.uspString;
            b = b.le;
        ...
        oB = a => {
            ...
            const c = Dh(809, () => gA(a));
            return c ? Promise.race([c.catch(() => "0"), Of(b, "0")]) : Promise.resolve()
        },
        pB = a => {
            var b = Ij(Di);
            if (0 >= b) return Promise.resolve();
    ...
    var rB = async a => {
            ...
            var b = new wA(a.pubWin),
                c = await mB(b);
            b = [kB(a.pubWin), jB(a.pubWin), xA(b, c, a.G.google_ad_client, Bd(a.U, 6))];
        ...
        UA = a => {
                ...
                a: {
                    ...
                    if (/Win|Mac|Linux|iPad|iPod|iPhone/.test(k) && !/^Opera/.test(h)) {
                        const p = (l.exec(h) || [0, 0])[1],
                            r = (m.exec(h) || [0, 0])[1];
                        if (/Win/.test(k) && /Trident/.test(h) && 11 <= b.documentMode || !p && "Gecko" === c.product && 27 <= r && !n.test(h) || 536 <= p) {
                            var g = !0;
                            break a
                        }
                    }
            ...
            V(yj) ? a.C = 2 : (b = Ij(bj), ni = ri, ei = .02, di = b, b = !cc() || 0 <= Cb(hc(), 11) ? si() : ji(), d = nm(), a.C = b.setupOse(X(d, 7, mm())));
            return rB(a)
        };
    ...
    var iB = a => {
        ...
        RA = a => {
            const b = a.M;
            if (b && !Ll(b).ads_density_stats_processed && !$f(b) && (Ll(b).ads_density_stats_processed = !0, V($i) || .01 > kf(b))) {
                const c = () => {
                    if (b) {
                        var d = Iu(Du(b), a.G.google_ad_client, b.location.hostname, pn(a.G).split(","));
                        T("ama_stats", d, 1)
                    }
                };
        ...
        TA = a => {
            a && !Ll(a).host_pinged_back &&
                (Ll(a).host_pinged_back = !0, T("abg_host", {
    ...
    ((a, b, c) => {
        ...
        return {
            ...
            Mc: a ? vh `https://pagead2.googlesyndication.com/pagead/managed/js/adsense/${a}/reactive_library${c}.js` : vh `https://pagead2.googlesyndication.com/pagead/js/${K(b,2)}/${d}/reactive_library${c}.js`,
            Cd: a ? vh `https://pagead2.googlesyndication.com/pagead/managed/js/adsense/${a}/debug_card_library${c}.js` : vh `https://pagead2.googlesyndication.com/pagead/js/${K(b,2)}/${d}/debug_card_library${c}.js`,
            ...
            Va: a ? vh `https://pagead2.googlesyndication.com/pagead/managed/js/adsense/${a}/slotcar_library${c}.js` : vh `https://pagead2.googlesyndication.com/pagead/js/${K(b,2)}/${d}/slotcar_library${c}.js`
        }
    });
}).call(this, "[2019,\"r20210908\",\"\/r20110914\",null,[],null,null,null,null,null,[],null,[]]");