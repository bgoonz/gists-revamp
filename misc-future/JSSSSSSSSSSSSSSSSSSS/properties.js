  ...
  set: function (v) {
    ...
    if (valueType === external_dependency_parsers_0.TYPES.ANGLE) {
      return this._setProperty(
        "azimuth",
        external_dependency_parsers_0.parseAngle(v)
      );
    }
...
var backgroundColor_local_var_parse = function parse(v) {
  ...
  if (
    external_dependency_parsers_0.valueType(v) ===
      external_dependency_parsers_0.TYPES.KEYWORD &&
...
var backgroundAttachment_local_var_isValid =
...
var backgroundPosition_local_var_parse = function parse(v) {
  ...
  if (parts.length === 1) {
    if (
      types[0] === external_dependency_parsers_0.TYPES.LENGTH ||
      types[0] === external_dependency_parsers_0.TYPES.PERCENT
    ) {
      return v;
    }
    ...
    if (types[0] === external_dependency_parsers_0.TYPES.KEYWORD) {
      if (
        backgroundPosition_local_var_valid_keywords.indexOf(v.toLowerCase()) !==
          -1 ||
        v.toLowerCase() === "inherit"
      ) {
        return v;
  ...
  if (
    (types[0] === external_dependency_parsers_0.TYPES.LENGTH ||
      types[0] === external_dependency_parsers_0.TYPES.PERCENT) &&
    (types[1] === external_dependency_parsers_0.TYPES.LENGTH ||
      types[1] === external_dependency_parsers_0.TYPES.PERCENT)
  ) {
    return v;
  }

  if (
    types[0] !== external_dependency_parsers_0.TYPES.KEYWORD ||
    types[1] !== external_dependency_parsers_0.TYPES.KEYWORD
  ) {
    return undefined;
  }

  if (
    backgroundPosition_local_var_valid_keywords.indexOf(parts[0]) !== -1 &&
    backgroundPosition_local_var_valid_keywords.indexOf(parts[1]) !== -1
  ) {
    return v;
  }
...
backgroundPosition_export_definition = {
  set: function (v) {
    this._setProperty(
      "background-position",
      backgroundPosition_local_var_parse(v)
    );
  },
  get: function () {
...
background_export_definition = {
  set: external_dependency_parsers_0.shorthandSetter(
    "background",
    background_local_var_shorthand_for
  ),
  get: external_dependency_parsers_0.shorthandGetter(
    "background",
    background_local_var_shorthand_for
  ),
  enumerable: true,
...
borderWidth_export_definition = {
  set: external_dependency_parsers_0.implicitSetter(
    "border",
    "width",
    borderWidth_local_var_isValid,
    borderWidth_local_var_parser
  ),
  get: function () {
...
borderStyle_export_isValid = function parse(v) {
  return (
    typeof v === "string" &&
    (v === "" || borderStyle_local_var_styles.indexOf(v) !== -1)
  );
};
...
borderStyle_export_definition = {
  set: external_dependency_parsers_0.implicitSetter(
    "border",
    "style",
    borderStyle_local_var_isValid,
    borderStyle_local_var_parser
  ),
  get: function () {
...
borderColor_export_isValid = function parse(v) {
  ...
  return (
    ...
    external_dependency_parsers_0.valueType(v) ===
      external_dependency_parsers_0.TYPES.COLOR
  );
};
...
borderColor_export_definition = {
  set: external_dependency_parsers_0.implicitSetter(
    "border",
    "color",
    borderColor_local_var_isValid,
    borderColor_local_var_parser
  ),
  get: function () {
...
var border_local_var_myShorthandSetter =
  external_dependency_parsers_0.shorthandSetter(
    "border",
    border_local_var_shorthand_for
  );
var border_local_var_myShorthandGetter =
  external_dependency_parsers_0.shorthandGetter(
    "border",
    border_local_var_shorthand_for
  );
...
var borderBottomWidth_local_var_isValid = (borderBottomWidth_export_isValid =
  borderWidth_export_isValid);
...
var borderBottomColor_local_var_isValid = (borderBottomColor_export_isValid =
  borderColor_export_isValid);
...
borderBottom_export_definition = {
  set: external_dependency_parsers_0.shorthandSetter(
    "border-bottom",
    borderBottom_local_var_shorthand_for
  ),
  get: external_dependency_parsers_0.shorthandGetter(
    "border-bottom",
    borderBottom_local_var_shorthand_for
...
var borderLeftWidth_local_var_isValid = (borderLeftWidth_export_isValid =
  borderWidth_export_isValid);
...
var borderLeftColor_local_var_isValid = (borderLeftColor_export_isValid =
  borderColor_export_isValid);
...
borderLeft_export_definition = {
  set: external_dependency_parsers_0.shorthandSetter(
    "border-left",
    borderLeft_local_var_shorthand_for
  ),
  get: external_dependency_parsers_0.shorthandGetter(
    "border-left",
    borderLeft_local_var_shorthand_for
...
var borderRightWidth_local_var_isValid = (borderRightWidth_export_isValid =
  borderWidth_export_isValid);
...
var borderRightColor_local_var_isValid = (borderRightColor_export_isValid =
  borderColor_export_isValid);
...
var borderSpacing_local_var_parse = function parse(v) {
  ...
  parts.forEach(function (part) {
    if (
      external_dependency_parsers_0.valueType(part) !==
      external_dependency_parsers_0.TYPES.LENGTH
    ) {
      return undefined;
    }
  });
...
var borderTopColor_local_var_isValid = (borderTopColor_export_isValid =
  borderColor_export_isValid);
...
borderTop_export_definition = {
  set: external_dependency_parsers_0.shorthandSetter(
    "border-top",
    borderTop_local_var_shorthand_for
  ),
  get: external_dependency_parsers_0.shorthandGetter(
    "border-top",
    borderTop_local_var_shorthand_for
...
bottom_export_definition = {
  set: function (v) {
    this._setProperty(
      "bottom",
      external_dependency_parsers_0.parseMeasurement(v)
    );
  },
  get: function () {
...
clear_export_definition = {
  set: function (v) {
    this._setProperty(
      "clear",
      external_dependency_parsers_0.parseKeyword(
        v,
...
flexGrow_export_isValid = function isValid(v, positionAtFlexShorthand) {
  return (
    external_dependency_parsers_0.parseNumber(v) !== undefined &&
    positionAtFlexShorthand ===
      external_dependency_constants_1.POSITION_AT_SHORTHAND.first
  );
};
...
flexGrow_export_definition = {
  set: function (v) {
    this._setProperty(
      "flex-grow",
      external_dependency_parsers_0.parseNumber(v)
    );
  },
  get: function () {
...
flexShrink_export_isValid = function isValid(v, positionAtFlexShorthand) {
  return (
    external_dependency_parsers_0.parseNumber(v) !== undefined &&
    positionAtFlexShorthand ===
      external_dependency_constants_1.POSITION_AT_SHORTHAND.second
  );
};
...
var flex_local_var_myShorthandSetter =
  external_dependency_parsers_0.shorthandSetter(
    "flex",
    flex_local_var_shorthand_for
  );

flex_export_isValid = function isValid(v) {
  return (
    external_dependency_parsers_0.shorthandParser(
      v,
      flex_local_var_shorthand_for
    ) !== undefined
  );
...
floodColor_export_definition = {
  set: function (v) {
    this._setProperty(
      "flood-color",
      external_dependency_parsers_0.parseColor(v)
    );
  },
  get: function () {
...
fontFamily_export_isValid = function isValid(v) {
  ...
  for (i = 0; i < len; i++) {
    ...
    if (
      type === external_dependency_parsers_0.TYPES.STRING ||
      type === external_dependency_parsers_0.TYPES.KEYWORD
    ) {
      return true;
    }
  }
...
fontSize_export_isValid = function (v) {
  ...
  return (
    type === external_dependency_parsers_0.TYPES.LENGTH ||
    type === external_dependency_parsers_0.TYPES.PERCENT ||
    (type === external_dependency_parsers_0.TYPES.KEYWORD &&
      fontSize_local_var_absoluteSizes.indexOf(v.toLowerCase()) !== -1) ||
    (type === external_dependency_parsers_0.TYPES.KEYWORD &&
      fontSize_local_var_relativeSizes.indexOf(v.toLowerCase()) !== -1)
  );
};
...
lineHeight_export_isValid = function isValid(v) {
  ...
  return (
    ...
    v.toLowerCase() === "inherit" ||
    type === external_dependency_parsers_0.TYPES.NUMBER ||
    type === external_dependency_parsers_0.TYPES.LENGTH ||
    type === external_dependency_parsers_0.TYPES.PERCENT
  );
};
...
var font_local_var_setter = external_dependency_parsers_0.shorthandSetter(
  "font",
  font_local_var_shorthand_for
);
font_export_definition = {
  set: function (v) {
    var short = external_dependency_parsers_0.shorthandParser(
      v,
      font_local_var_shorthand_for
    );
    ...
    if (
      external_dependency_parsers_0.valueType(v) ===
        external_dependency_parsers_0.TYPES.KEYWORD &&
      font_local_var_static_fonts.indexOf(v.toLowerCase()) !== -1
    ) {
...
var margin_local_var_isValid = function (v) {
  ...
  var type = external_dependency_parsers_0.valueType(v);
  return (
    type === margin_local_var_TYPES.LENGTH ||
    type === margin_local_var_TYPES.PERCENT ||
    (type === margin_local_var_TYPES.INTEGER && (v === "0" || v === 0))
  );
};
...
var margin_local_var_mySetter = external_dependency_parsers_0.implicitSetter(
  "margin",
  "",
  margin_local_var_isValid,
  margin_local_var_parser
);
var margin_local_var_myGlobal = external_dependency_parsers_0.implicitSetter(
  "margin",
  "",
  function () {
    return true;
...
marginBottom_export_definition = {
  set: external_dependency_parsers_0.subImplicitSetter(
    "margin",
    "bottom",
    {
...
var padding_local_var_isValid = function (v) {
  var type = external_dependency_parsers_0.valueType(v);
  return (
    type === padding_local_var_TYPES.LENGTH ||
    type === padding_local_var_TYPES.PERCENT ||
    (type === padding_local_var_TYPES.INTEGER && (v === "0" || v === 0))
  );
};
...
var padding_local_var_mySetter = external_dependency_parsers_0.implicitSetter(
  "padding",
  "",
  padding_local_var_isValid,
  padding_local_var_parser
);
var padding_local_var_myGlobal = external_dependency_parsers_0.implicitSetter(
  "padding",
  "",
  function () {
    return true;
