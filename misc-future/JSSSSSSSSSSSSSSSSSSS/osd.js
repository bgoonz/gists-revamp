(function(window, document) {
    ...
    */
    ...
    function Ya(a) {
        return a instanceof Ta && a.constructor === Ta && a.g === Xa ? a.Eb : "type_error:Const"
    }
    var Xa = {},
        Ua = {};
    ...
    function eb() {
        return A("Safari") && !(fb() || A("Coast") || A("Opera") || A("Edge") || A("Edg/") || A("OPR") || db() || A("Silk") || A("Android"))
    }
    ...
    ob.prototype.end = function() {
        var a = this.g,
            b = this.h;
        this.h = 0;
        return 0 === b ? lb || (lb = new Uint8Array(0)) : kb ? a.slice(0, b) : new Uint8Array(a.subarray(0, b))
    };
    ...
    var vb = A("Opera"),
        B = A("Trident") || A("MSIE"),
        wb = A("Edge"),
        xb = A("Gecko") && !(x(z, "WebKit") && !A("Edge")) && !(A("Trident") || A("MSIE")) && !A("Edge"),
    ...
    function Ib(a) {
        return tb(a, function() {
            for (var b = 0, c = $a(String(Hb)).split("."), d = $a(String(a)).split("."), e = Math.max(c.length, d.length), f = 0; 0 == b && f < e; f++) {
                var g = c[f] || "",
                    h = d[f] || "";
                do {
                    g = /(\d*)(\D*)(.*)/.exec(g) || ["", "", "", ""];
    ...
    function Rb(a, b, c) {
        if (null != c) {
            ...
            nb = d;
            c = mb;
            for (b = nb; 0 < b || 127 < c;) a.push(c & 127 | 128), c = (c >>> 7 | b << 25) >>> 0, b >>>= 7;
            a.push(c)
        }
    };
    ...
    function Tb(a, b, c) {
        return "object" === typeof a ? Sb && !Array.isArray(a) && a instanceof Uint8Array ? c(a) : Ub(a, b, c) : b(a)
    }
    ...
    function Ub(a, b, c) {
        ...
        d = {};
        for (e in a) Object.prototype.hasOwnProperty.call(a, e) && (f = a[e], null != f && (d[e] = Tb(f, b, c)));
        return d
    }
    ...
    function Zb(a, b, c) {
        ...
        a: {
            ...
            if (d && (d = this.g[a], !(null === d || "object" != typeof d || Array.isArray(d) || Sb && d instanceof Uint8Array))) {
                this.j = a - this.i;
                this.h = d;
                break a
            }
        ...
        if (c)
            for (b = 0; b < c.length; b++) a = c[b], a < this.j ? (a += this.i, (d = this.g[a]) ? Vb(d) : this.g[a] = $b) : (ac(this), (d = this.h[a]) ? Vb(d) : this.h[a] = $b)
    }
    ...
    function yc(a, b) {
        return /-[a-z]/.test(b) ? !1 : wc && a.dataset ? b in a.dataset : a.hasAttribute ? a.hasAttribute("data-" + ib(b)) : !!a.getAttribute("data-" + ib(b))
    };
    var Ac = B || yb;
    ...
    function Dc() {
        var a = document;
        a.getElementsByClassName ? a = a.getElementsByClassName("GoogleActiveViewContainer")[0] : (a = document, a = a.querySelectorAll && a.querySelector ? a.querySelector(".GoogleActiveViewContainer") : Ec(a, "*", "GoogleActiveViewContainer", void 0)[0] || null);
        return a || null
    }
    ...
    function Hc(a) {
        var b = a.scrollingElement ? a.scrollingElement : yb || "CSS1Compat" != a.compatMode ? a.body || a.documentElement : a.documentElement;
        a = a.parentWindow || a.defaultView;
        return B && Ib("10") && a.pageYOffset != b.scrollTop ? new J(b.scrollLeft, b.scrollTop) : new J(a.pageXOffset || b.scrollLeft, a.pageYOffset || b.scrollTop)
    }
    ...
    function Jc(a, b, c) {
        var d = arguments,
            ...
            f = d[1],
            g = Kc(e, String(d[0]));
        f && ("string" === typeof f ? g.className = f : Array.isArray(f) ? g.className = f.join(" ") : Fc(g, f));
    ...
    function Mc(a) {
        try {
            return a.contentWindow || (a.contentDocument ? Ic(a.contentDocument) : null)
        } catch (b) {}
        return null
    }
    ...
    Qc.prototype.g = function() {
        return Rc() && D.performance.now ? D.performance.now() : M.prototype.g.call(this)
    };
    Qc.prototype.i = function() {
        return Rc() && D.performance.memory ? D.performance.memory.totalJSHeapSize || 0 : M.prototype.i.call(this)
    };
    Qc.prototype.j = function() {
        return Rc() && D.performance.memory ? D.performance.memory.usedJSHeapSize || 0 : M.prototype.j.call(this)
    };
    Qc.prototype.h = function() {
        return Rc() && D.performance.memory ? D.performance.memory.jsHeapSizeLimit || 0 : M.prototype.h.call(this)
    };
    var Sc = xa(function() {
        var a = !1;
        try {
    ...
    function gd(a, b, c) {
        b instanceof J ? (a.left += b.x, a.h += b.x, a.top += b.y, a.g += b.y) : (a.left += b, a.h += b, "number" === typeof c && (a.top += c, a.g += c));
        return a
    };
    ...
    function id(a) {
        if (jd()) hd(window, a, !0);
            ...
            if (b.body) {
                ...
                c || (c = Kc(document, "IFRAME"), c.style.display = "none", c.id = "goog-srcless-iframe", b.body.appendChild(c));
                b = c
            } else b = null;
    ...
    function md(a, b) {
        ...
        do {
            if (d == b) {
                ...
                h = !B || 9 <= Number(Lb) || "CSS1Compat" == Bc(h).g.compatMode ? h.documentElement : h.body;
                e != h && (e = ld(e), f = Hc(Bc(f).g), g.x = e.left + f.x, g.y = e.top + f.y)
    ...
    function O() {
        if (qd && !$c(rd)) {
            var a = "." + C.domain;
            try {
                for (; 2 < a.split(".").length && !$c(rd);) C.domain = a = a.substr(a.indexOf(".") + 1), rd = window.parent
            } catch (b) {}
            $c(rd) || (rd = window)
        }
        return rd
    ...
    function Nd(a, b, c, d, e) {
        if ((d ? a.i : Math.random()) < (e || a.g)) try {
            ...
            else f = new wd, ad(c, function(h, n) {
                var m = f,
                    l = m.j++;
                h = xd(n, h);
                m.g.push(l);
    ...
    function ee() {
        var a = O();
        a && "undefined" != typeof a.google_measure_js_timing && !a.google_measure_js_timing && (a = Yd, a.g = !1, a.h != a.i.google_js_reporting_queue && (Ud() && v(a.h, Wd), a.h.length = 0))
    }(function() {
        Zd = new Md;
        de = new Xd;
        var a = O();
        a && a.document && ("complete" == a.document.readyState ? ee() : Yd.g && Uc(a, "load", function() {
            ee()
        }))
    })();
    ...
    function we(a) {
        for (var b = 0, c = a, d = 0; a && a != a.parent;) a = a.parent, d++, $c(a) && (c = a, b = d);
        return {
            B: c,
            level: b
        }
    ...
    function Ce(a, b, c) {
        try {
            ...
            try {
                if (void 0 === c ? 0 : c) var f = (new K(e.innerWidth, e.innerHeight)).round();
                else {
    ...
    function Ge(a, b) {
        b && (a(b), b.frames && v(b.frames, function(c) {
            Ge(a, c)
        }))
    }
        ...
        if (b && a)
            if (c && 0 < c.length)
                for (c = za(c, function(e) {
                        ...
                        return e === D.top || f
                    }), a = ha(c), c = a.next(); !c.done; c = a.next()) Fe(b, c.value);
            else {
                c = [];
                var d = Mc(a);
                d && c.push(d);
                if (0 === c.length) try {
                    c = Aa(Ec(document, "IFRAME".toString().toLowerCase(), void 0, a), function(e) {
                        return Mc(e)
                    })
                } catch (e) {}
                a = ha(c);
    ...
    function Pe() {
        this.i = !$c(D.top);
        this.D = !this.i;
        this.m = Yc() || !Yc() && (A("iPod") || A("iPhone") || A("Android") || A("IEMobile"));
        var a = td();
    ...
    function Qe(a) {
        D && D.document && (a.h = Ce(!1, D, a.m), a.g = Ce(!0, D, a.m), Se(a, D), Re(a, D))
    }
    ...
    function Ve(a) {
        Q();
        a.g = Dd(0, Id(R().j.g, he(143, function() {
            a.h++;
            a.i.sample()
        })), oe())
    };
    ...
    function We(a, b, c) {
        if (!a.C || (void 0 === c ? 0 : c)) a.C = !0, a.L = b, a.m = 0, a.g != a || Xe(a)
    }
    k.H = function() {
        return this.g.T
    };
    ...
    function $e(a) {
        a.s = a.j.length ? Ca(a.j, function(b) {
            return b.U()
        }) : !1
    }
    ...
    k.fa = function(a) {
        ...
        b !== this.g ? (this.o = this.g.o, Xe(this)) : this.o !== this.g.o && (this.o = this.g.o, Xe(this))
    };
    k.V = function(a) {
        if (a.h === this.g) {
            var b = this.i,
    ...
    function lf(a) {
        var b = a.h;
        a = a.g;
        return "" === a ? b : "boolean" === typeof a ? a ? b : "" : Array.isArray(a) ? 0 === a.length ? b : b + "=" + a.join() : b + "=" + (Ga(["mtos", "tos", "p"], b) ? a : encodeURIComponent(a))
    };
    ...
    function yf(a, b, c) {
        v(a.i, function(d) {
            ...
            if (!d.s && (d.m(b, c), d.o())) {
                ...
                e = e.toString();
                /&v=[^&]+/.test(e) || (e = (f = of ()) ? e + "&v=" + encodeURIComponent(f) : e);
                e = e.substring(0, h);
                Ed(e)
            }
        })
    ...
    function If() {
        ...
        this.i = new zf;
        this.h = -1;
        this.j = new Cf([1, .9, .8, .7, .6, .5, .4, .3, .2, .1, 0])
    }
    ...
    function Mf(a, b) {
        ...
        for (var c = 0; null !== a && 100 > c++;) {
            ...
            try {
                a: {
                    var d = void 0;
                    if (Ac && !(B && Ib("9") && !Ib("10") && u.SVGElement && a instanceof u.SVGElement) && (d = a.parentElement)) {
                        var e = d;
                        break a
                    }
    ...
    function Nf(a, b, c) {
        ...
        if (!a) return !1;
        b = (b = (b = L(c)) && b.defaultView && b.defaultView.frameElement) && Mf(b, a);
        d = a === c;
    ...
    function Of(a, b, c, d) {
        return U().i ? !1 : 0 >= dd(a) || 0 >= ed(a) ? !0 : c && d ? ge(208, function() {
            return Nf(a, b, c)
        }) : !1
    };
        ...
        if (a.Aa() && a.G) {
            ...
            if (b = d.g) {
                ...
                var f = e.l.g,
                    g = null,
                    h = null;
                null != e.i && f && (g = e.j, g = new J(g.left - f.left, g.top - f.top), h = new K(f.h - f.left, f.g - f.top));
                c = {
                    W: b.H(),
                    K: g,
                    Za: h,
    ...
    k.Xa = function(a, b, c, d, e, f, g) {
        this.s || (this.Aa() && (e = new hc, e.i = c, e.h = Ie(), e.A = 0 === this.L && 1 === I(this.l, "opac") ? 0 : a, e.g = this.ba(), e.j = g, a = this.i, c = this.j, d = d && this.j.A >= (this.ba() ? .3 : .5), a.h = Math.max(a.h, e.A), Gf(a.j, e.j, c.j, e.i, f, d), Gf(a.g, e.A, c.A, e.i, f, d), d = d || c.g != e.g ? c.isVisible() && e.isVisible() : c.isVisible(), c = !e.isVisible() || e.i, Af(a.i, d, f, c), this.Db = b, 0 < e.A && (-1 === this.xa && (this.xa = b), this.Ib = b), -1 == this.Jb && W(this.i) && (this.Jb = b), -2 == this.qa && (this.qa = Lf(Sf(this)) ? e.A : -1), this.j = e), this.Ja(this))
    };
    k.ba = function() {
        return !1
    };
    ...
    function Wf(a) {
        a.h.g && (a.m.Ca = Ae(a.h.g, "mouseover", function() {
            a.T = T()
        }, 149), a.m.Ba = Ae(a.h.g, "mouseout", function() {
    ...
    function Rf(a) {
        a.h.g && (a.m.Ca && (Vc(a.h.g, "mouseover", a.m.Ca), a.m.Ca = null), a.m.Ba && (Vc(a.h.g, "mouseout", a.m.Ba), a.m.Ba = null))
    };
    Za(Ya(new Ta(Ua, "https://www.googletagservices.com/activeview/js/current/osd.js")));
    ...
    function bg(a) {
        return eb() ? (a = (a = L(a)) && Ic(a), !!(a && a.location && a.location.ancestorOrigins && 0 < a.location.ancestorOrigins.length && a.location.origin == a.location.ancestorOrigins[0])) : !0
    };
    var cg = "StopIteration" in u ? u.StopIteration : {
    ...
    jg.prototype.g = function() {
        ...
        if (b = a) {
            b = this.j;
            if (sb(a, "parentElement") && null != a.parentElement && a != a.parentElement) var c = a.parentElement;
            else if (b) {
                var d = void 0 === d ? bg : d;
                if (d(a)) try {
                    var e = L(a),
                ...
                if (!g) {
                    ...
                    if ("undefined" !== typeof g) d = g;
                        ...
                        if (!h) {
                            var n = hb();
                            h = n;
                            void 0 === d.style[n] && (n = (yb ? "Webkit" : xb ? "Moz" : B ? "ms" : null) + jb(n), void 0 !== d.style[n] && (h = n));
                            kd.opacity = h
                        }
                        d = g[h] || ""
                    }
    ...
    function mg(a, b) {
        if (b) {
            if (0 == a.u)
                if (a.h.h) {
                    var c = a.h.h._adk_;
                    c || (c = (c = xc(a.h.h, "googleAvAdk")) && !/[^0-9]/.test(c) ? parseInt(c, 10) : 0)
                } else c = 0;
            else c = a.u;
            a.u = c;
            ...
            "" == a.vb && (a.vb = String(b._aviextcxn_ || xc(b, "googleAvExtCxn") || ""));
    ...
    k.ia = function() {
        this.N || (this.Ma = Qd(), void 0 !== this.ca && this.ca(!1, this.qa), null != this.o && "" != this.o && (id(this.o), this.o = ""));
    ...
    k.Xa = function(a, b, c, d, e, f, g) {
        ...
        Qf.prototype.Xa.call(this, a, b, c, d, e, f, g); - 1 == this.ea && -1 != this.j.h ? this.ea = this.j.h : 0 == this.ea && 1 == this.j.h && (this.ea = 1);
        a = W(this.i);
        ...
        if (this.h) {
            ...
            try {
                ...
                var d = c.h - c.left,
                    ...
                    g = f.x,
                    h = f.y;
                var n = new N(Math.round(h), Math.round(g + d), Math.round(h + e), Math.round(g))
            } catch (m) {
                n = fd(Jf)
            }
            this.g = n
    ...
    k.Y = function() {
        ...
        if (this.h && "number" === typeof this.h.videoWidth && "number" === typeof this.h.videoHeight) {
            ...
            var c = dd(a),
                ...
                e = b.width;
            b = b.height;
            0 >= e || 0 >= b || 0 >= c || 0 >= d || (e /= b, a = fd(a), e > c / d ? (c /= e, d = (d - c) / 2, 0 < d && (d = a.top + d, a.top = Math.round(d), a.g = Math.round(d + c))) : (d *= e, c = Math.round((c - d) / 2), 0 < c && (c = a.left + c, a.left = Math.round(c), a.h = Math.round(c + d))));
            this.g = a
        }
        this.ib();
        a = this.g;
        c = this.o;
        a = a.left <= c.h && c.left <= a.h && a.top <= c.g && c.top <= a.g ? new N(Math.max(a.top, c.top), Math.min(a.h, c.h), Math.min(a.g, c.g), Math.max(a.left, c.left)) : new N(0, 0, 0, 0);
        c = a.top >= a.g || a.left >= a.h ? new N(0, 0, 0, 0) : a;
        a = this.i.i;
        b = e = d = 0;
        0 < (this.g.g - this.g.top) * (this.g.h - this.g.left) && (this.tb(c) ? c = new N(0, 0, 0, 0) : (d = U().o, b = new N(0, d.height, d.width, 0), d = Kf(c, this.g), e = Kf(c, U().g), b = Kf(c, b)));
        c = c.top >= c.g || c.left >= c.h ? new N(0, 0, 0, 0) : gd(c, -this.g.left, -this.g.top);
        Te() || (e = d = 0);
    ...
    function Ng(a) {
        ...
        var b = a.h,
            c = a.i.g.B,
            d = R().j.g;
        a.j = new c.IntersectionObserver(Id(d, function(e) {
            return Pg(a, e)
        }), Lg);
        d = Id(d, function() {
            a.j.unobserve(b);
        ...
        c.ResizeObserver ? (a.m = new c.ResizeObserver(d), a.m.observe(b)) : c.MutationObserver && (a.l = new u.MutationObserver(d), a.l.observe(b, {
            attributes: !0,
            childList: !0,
            characterData: !0,
            subtree: !0
        ...
        try {
            if (b.length) {
                ...
                var c = Qg(b),
                    ...
                    e = d.x,
                    f = d.y;
                a.g = new N(Math.round(f), Math.round(e) + c.boundingClientRect.width, Math.round(f) + c.boundingClientRect.height, Math.round(e));
    ...
    Sg.prototype.X = function() {
        var a = Tg();
        this.m !== a && (this.g != this && a > this.g.m && (this.g = this, Xe(this)), this.m = a);
        return 2 == a
    };
        ...
        if (!a.done)
            if (a.h.cancel(), 0 == b.length) a.l = !1;
                ...
                try {
                    ...
                    e.o = d;
                    if (null != P(Hg).g)
                        for (e = 0; e < b.length; e++) Uf(b[e], d, c);
                    else ie(a.m, {
    ...
    Yg.prototype.j = function() {
        var a = Te(),
            b = T();
        a ? (ne || (le = b, v(X.h, function(c) {
            return c.i.m(b, !c.o())
        })), ne = !0) : (this.u = dh(this, b), ne = !1, v(X.h, function(c) {
            c.Aa() && c.i.l(b)
        }));
        this.l = !0;
        ah(this, Dg(), !a)
    ...
    function fh(a, b, c) {
        if (!a.i || c) {
            ...
            try {
                ...
                h.deb = [1, a.g.gb, a.g.fb, a.g.jb, a.g.za, De, a.h.h, a.g.Ob, a.g.Nb, a.g.Pb].join("-");
                h.tvt = dh(a, e);
                f.j && (h.inapp = 1);
                if (null !== b && b != b.top) {
        ...
        if (1 == I(p.i, "prf")) {
            ...
            if (null != q) {
                ...
                if (0 === d) nb = 0 < 1 / d ? 0 : 2147483648, mb = 0;
                ...
                else if (1.7976931348623157E308 < d) nb = (q << 31 | 2146435072) >>> 0, mb = 0;
                else if (2.2250738585072014E-308 > d) c = d / Math.pow(2, -1074), nb = (q << 31 | c / 4294967296) >>> 0, mb = c >>> 0;
                else {
                    e = d;
                    c = 0;
                    if (2 <= e)
                    ...
                    d *= Math.pow(2, -c);
                    nb = (q << 31 | c + 1023 << 20 | 1048576 * d & 1048575) >>> 0;
            ...
            if (0 === m) b = new Uint8Array(0);
                ...
                q = b.h;
                c = q.length;
                for (d = l = 0; d < c; d++) e = q[d], 0 !== e.length && (m.set(e, l), l += e.length);
                q = b.g;
                c = q.h;
    ...
    k.Pa = function() {
        ...
        var b = this,
            c = new N(0, this.B.innerWidth || this.B.width, this.B.innerHeight || this.B.height, 0),
            d = Hc(document),
    ...
    k.Ra = function() {
        ...
        U().C = !0;
        this.B.document.readyState && "complete" == this.B.document.readyState ? qh(this) : Ae(this.B, "load", function() {
            Dd(Q(), he(292, function() {
                return qh(a)
            }), 100)
        }, 292);
        return !0
    ...
    function th(a) {
        "string" === typeof a.h.I.AFMA_LIDAR ? (a.G = !0, uh(a)) : (a.h.ya = 3, a.l = "nc", We(a, "w"))
    }
    ...
    function xh(a, b) {
        try {
            var c = P(oh);
            c.D = !0;
            var d = a ? new N(a.y, a.x + a.width, a.y + a.height, a.x) : new N(0, 0, 0, 0);
            var e = T(),
                f = Te();
            var g = new pe(e, f, c);
            g.g = d;
    ...
    function Ch(a, b, c) {
        ...
        if (a = "string" === typeof a ? document.getElementById(a) : a) {
            ...
            var q = 0,
                ...
                y = a = !1;
            l = {};
            for (var Va = 0; Va < n.length; l = {
                    ka: l.ka
                }, Va++) {
                var E = n[Va];
                if (!("IMG" != E.tagName || !E.complete || E.naturalWidth && E.naturalHeight ? Bh.test(E.getAttribute("width")) && Bh.test(E.getAttribute("height")) : 1)) {
    ...
    k.Ub = function(a, b, c, d, e, f, g, h, n) {
        ...
        if (eh(D)) {
            ...
            X.g.push(l);
            ++Y.g.fb;
            e.h ? this.Qa(l, e.h) : ((b = P(Hg).g) && Tf(l, b), Rh(this), e.h || (d ? (Uh(l), l.ia()) : a && Ch(a, function() {
                l.ha() || (Uh(l), l.ia())
            }, function(q, p, y) {
                Ae(q, p, y, 130)
            }), Y.l || Y.j()))
                ...
                if (Sh(a)) {
                    ...
                    if (Ig(d, function(g) {
                        ...
                        if (!Y.done) {
                            ...
                            Th(a);
                            var f;
                            (f = U().j || x(z, "CrKey") || x(z, "PlayStation") || x(z, "Roku") || Me() || x(z, "Xbox") || Ne() || Oe()) || (Q(), f = 0 !== Wc());
    ...
    function Zh(a, b, c) {
        ...
        if (!Y.done) {
            ...
            a.g || (a.g = new Xf);
            if (2 == ag(a.g) || a.i)
                for (a = X.g, c && 0 < a.length && ah(Y, a, !0), c = ha(a), a = c.next(); !a.done; a = c.next()) {
                    a = a.value;
                    var d = {};
                    og(a, 1, (d.r = b, d));
                    a.g && a.g.O()
    ...
    k.Qb = function(a) {
        a && W(a.i) && (0 >= Lf(Sf(a)) ? 0 : sg(a) && !a.zb) && (id(a.M), a.zb = !0)
    };
    ...
    function $h(a, b) {
        if (b && b.data && b.source) {
            ...
            if (c = d)
                if (e = c[0], Ga("goog_creative_loaded goog_dom_content_loaded goog_listener_status goog_maybe_stop_monitoring goog_provide_mode goog_request_monitoring goog_stop_monitoring".split(" "), e) && (d = Ag(new Pc(c[4], c[12]))))
                    if (h = c[33], 0 < h && -1 == d.wa && (d.wa = h), "goog_stop_monitoring" === e) Gg(d);
                    else if ("goog_maybe_stop_monitoring" !== e || void 0 !== d.ca) {
                if (Ga(d.aa, b.source) || d.aa.push(b.source), "goog_request_monitoring" === e || !d.Fb)
    ...
    function Vh(a) {
        if (!a.m) {
            Ae(D, "message", function(c) {
                return $h(a, c)
            }, 132);
            var b = bi().contentWindow;
            b && Ae(b, "message", function(c) {
                return $h(a, c)
            }, 132);
            a.m = !0
        }
    ...
    k.Mb = function(a, b) {
        a && b && sa(a) && 1 == a.nodeType && sa(b) && 1 == b.nodeType && (a = Bg(a)) && (O(), Rf(a), a.h.g = b, Wf(a), mg(a, b), a.g && (a = a.g, a.O(), a.h = b, a.ma(), a.Y()))
    };
    ...
    ge(155, function() {
        ...
        Y.m = "osd";
        ci(a);
        pd() ? a.qb() : (Qh(a), Ae(O(), "load", function() {
            Dd(Q(), he(153, function(b) {
                for (var c = [], d = 0; d < arguments.length; ++d) c[d] = arguments[d];
