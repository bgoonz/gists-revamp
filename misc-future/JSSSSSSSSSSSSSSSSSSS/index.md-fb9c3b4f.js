  ...
  return {
    c() {
      (o = h("h1")),
        ...
        (c = p("Gitpod")),
        (l = p(
          " is a container-based development platform that puts developer experience first. Gitpod provisions "
        )),
        (d = h("strong")),
        ...
        (j = h("p")),
        (N = p(
          "Gitpod enables development teams to describe their dev environment as code and "
        )),
        (W = h("strong")),
        (R = p(
          "start configurable and fresh development environments for each new task"
        )),
        ...
        (pe = h("strong")),
        (fe = p(
          "blazingly fast, ephemeral and secure development environments"
        )),
        (me = p(".")),
        (ye = f()),
        (ve = h("h3")),
        ...
        (Ne = p(
          ", from any git context, at any time, from any device. No more waiting for NPM or Maven to download the Internet."
        )),
        (We = f()),
        (Re = h("p")),
        (Ie = p(
        ...
        (Me = h("strong")),
        (Te = p(
          "automate, version-control and share consistent dev environments across your team"
        )),
        ($e = p(". We call this ")),
        (Ce = h("a")),
    ...
    l(e) {
      ...
      (R = v(
        ...
        (I = v(
          Do,
          " entirely in the cloud. Think CI/CD for dev environments."
        )),
        Do.forEach(g),
        (M = b(e)),
        (T = m(e, "H2", { id: !0 }));
      ...
      (X = v(Vo, "always ready-to-code")),
        ...
        (ee = m(e, "H2", { id: !0 }));
      var Uo = y(ee);
      (oe = v(Uo, "Your computer in the cloud")),
        (re = m(Uo, "A", { href: !0 }));
      var Jo = y(re);
      (ae = m(Jo, "SPAN", { class: !0 })),
        y(ae).forEach(g),
        Jo.forEach(g),
        Uo.forEach(g),
        (te = b(e)),
      ...
      (le = v(
        ...
        (ue = m(e, "P", {}));
      var Zo = y(ue);
      (he = v(Zo, "Leveraging the power of the cloud Gitpod provisions ")),
        (pe = m(Zo, "STRONG", {}));
      var _o = y(pe);
      (fe = v(
        _o,
      ...
      (Te = v(
        ...
        (Ce = m(nr, "A", { href: !0 }));
      var sr = y(Ce);
      (Le = v(sr, "dev-environments-as-code")),
        sr.forEach(g),
        (Oe = v(nr, ".")),
        nr.forEach(g),
        (De = b(e)),
