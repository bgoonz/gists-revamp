...
function y(e) {
  ...
  return {
    ...
    l(e) {
      (i = t(e, "IMG", { src: !0, alt: !0, height: !0, width: !0, class: !0 })),
        this.h();
    },
    h() {
      i.src !== (n = "https://github.com/" + e[8] + ".png") && d(i, "src", n),
        ...
        d(
          ...
          "class",
          (s =
            "inline rounded-full border border-solid border-off-white " + e[2])
        );
    },
    m(e, n) {
      h(e, i, n);
    ...
    p(e, n) {
      4 & n &&
        s !==
          (s =
            "inline rounded-full border border-solid border-off-white " +
            e[2]) &&
        d(i, "class", s);
    },
    d(e) {
...
function A(e) {
  ...
  return {
    ...
    h() {
      d(i, "href", e[5](e[8])),
        d(i, "target", "_blank"),
        d(i, "class", (p = "no-underline transition-none " + e[1])),
        c(i, "showAvatar", e[3]);
    },
    m(e, a) {
    ...
    p(e, a) {
      e[3]
        ...
        e[0]
          ...
          : g && (g.d(1), (g = null)),
        2 & a &&
          p !== (p = "no-underline transition-none " + e[1]) &&
          d(i, "class", p),
