    ...
    l(e) {
      ...
      (r = o(f, "rect", { width: !0, height: !0, fill: !0 }, 1)),
        ...
        (h = o(
          f,
          "rect",
          { x: !0, y: !0, width: !0, height: !0, fill: !0 },
          1
        )),
        l(h).forEach(n),
        (c = o(
    ...
    l(e) {
      ...
      (i = o(d, "rect", { width: !0, height: !0, fill: !0 }, 1)),
        ...
        (h = o(
          d,
          "rect",
          { x: !0, y: !0, width: !0, height: !0, rx: !0, fill: !0 },
          1
        )),
        l(h).forEach(n),
        (c = o(
      ...
      y = o(
        u,
        "linearGradient",
        { id: !0, x1: !0, y1: !0, x2: !0, y2: !0, gradientUnits: !0 },
        1
      );
      var g = l(y);
      ...
      var V = l(I);
      (z = o(V, "rect", { width: !0, height: !0, fill: !0 }, 1)),
        l(z).forEach(n),
        V.forEach(n),
        u.forEach(n),
        f.forEach(n),
    ...
    D && (a = new D({})),
    {
      ...
      i(e) {
        I ||
          ...
          k(() => {
            g && g.end(1),
              u || (u = C(r, _, { duration: 1500, easing: q })),
              u.start();
          }),
          (I = !0));
      },
...
function se(e) {
  ...
  return {
    ...
    h() {
      p(r, "class", "container svelte-1bzlj62"),
        p(t, "class", "aspect svelte-1bzlj62"),
        w(t, "--width", oe),
        w(t, "--height", le);
    },
    m(i, s) {
    ...
    p(e, [i]) {
      20 & i &&
        ((v = e[2]),
        m(),
        (u = z(u, i, E, 1, e, v, g, r, D, ie, null, re)),
        x()),
        e[0]
          ? $
            ? $.p(e, i)
...
function he(e, t, r) {
  ...
  function c() {
    0 !== n
      ? (r(2, (l = [o[h], ...l.slice(0, 1)])), (h = (h + 1) % o.length), n--)
      : r(2, (l = [o[h], ...l]));
  }
  return (
    S(() => {
    ...
    (e.$$set = (e) => {
      "alt" in e && r(0, (a = e.alt)),
        "iterations" in e && r(5, (s = e.iterations));
    }),
    [
      a,
      i,
...
function fe(e) {
  ...
  return (
    (H = new L({
      props: { source: U, dark: !0, shadow: !1, narrow: !0, skipToEnd: !0 },
    })),
    {
      c() {
        (t = i("div")),
      ...
      l(e) {
        ...
        (w = o(s, "IMG", {
          ...
          (k = o(a, "H2", { class: !0 }));
        var f = l(k);
        (C = h(f, "Collaboration with workspace sharing")),
          f.forEach(n),
          (G = c(a)),
          (I = o(a, "P", { class: !0 }));
        var d = l(I);
        ...
        var u = l(D);
        (j = h(u, "More about collaboration.")),
          u.forEach(n),
          a.forEach(n),
          (B = c(i)),
          (M = o(i, "DIV", { class: !0 }));
        ...
        var $ = l(W);
        (Y = h($, "Learn more about sudo/Docker in Gitpod.")),
          $.forEach(n),
          p.forEach(n),
          i.forEach(n),
          this.h();
      ...
      h() {
        w.src !== (m = "/images/features/features-3.svg") &&
          p(w, "src", "/images/features/features-3.svg"),
  ...
  return {
    ...
    l(e) {
      ...
      (z = o(a, "IMG", {
        ...
        (j = o(a, "H2", { class: !0 }));
      var s = l(j);
      (B = h(s, "Customize your workspace")),
        s.forEach(n),
        (L = c(a)),
        (H = o(a, "P", { class: !0 }));
      var f = l(H);
      (O = h(
        ...
        (U = o(a, "A", { href: !0 }));
      var d = l(U);
      (_ = h(d, "More about customization.")),
        d.forEach(n),
        a.forEach(n),
        (q = c(i)),
        (R = o(i, "DIV", { class: !0 }));
      ...
      (X = o(p, "IMG", {
        ...
        (K = o(p, "H2", { class: !0 }));
      var m = l(K);
      (Z = h(m, "GitLab, GitHub, and Bitbucket integration")),
        m.forEach(n),
        (J = c(p)),
        (ee = o(p, "P", { class: !0 }));
      var y = l(ee);
      (te = h(
        ...
        (ie = o(p, "A", { href: !0 }));
      var E = l(ie);
      (ae = h(E, "More about integrations.")),
        E.forEach(n),
        p.forEach(n),
        (se = c(i)),
        (oe = o(i, "DIV", { class: !0 }));
      ...
      (le = o(x, "IMG", {
        ...
        (ge = o(x, "H2", { class: !0 }));
      var $ = l(ge);
      (pe = h($, "Code reviews within the IDE")),
        $.forEach(n),
        (we = c(x)),
        (ve = o(x, "P", { class: !0 }));
      var F = l(ve);
      (me = h(
        ...
        (Ee = o(x, "A", { href: !0 }));
      var b = l(Ee);
      (xe = h(b, "More about code reviews.")),
        b.forEach(n),
        x.forEach(n),
        i.forEach(n),
        ($e = c(e)),
        (Fe = o(e, "SECTION", { class: !0 }));
      var S = l(Fe);
      be = o(S, "H2", {});
      var M = l(be);
      (ke = h(M, "VS Code and extensions in your browser")),
        M.forEach(n),
        (Ce = c(S)),
        (Ge = o(S, "P", { class: !0 }));
      var A = l(Ge);
      ...
      Be = o(T, "H2", {});
      var N = l(Be);
      (Me = h(N, "Get started with screencasts")),
        N.forEach(n),
        (Le = c(T)),
        (Ae = o(T, "DIV", { class: !0 }));
      var Q = l(Ae);
    ...
    h() {
      z.src !== (S = "/images/features/features-5.svg") &&
        p(z, "src", "/images/features/features-5.svg"),
        ...
        p(I, "class", "card"),
        X.src !== (W = "/images/features/features-6.svg") &&
          p(X, "src", "/images/features/features-6.svg"),
        ...
        p(R, "class", "card"),
        le.src !== (he = "/images/features/features-7.svg") &&
          p(le, "src", "/images/features/features-7.svg"),
        ...
        Se.src !== (Ve = "/images/features/gitpod-extensions.jpg") &&
          p(Se, "src", "/images/features/gitpod-extensions.jpg"),
    ...
    p(e, [t]) {
      ...
      if ((32 & t && (r.$$scope = { dirty: t, ctx: e }), k.$set(r), 1 & t)) {
        ...
        for (Ue = e[0], r = 0; r < Ue.length; r += 1) {
          ...
          _e[r]
            ? (_e[r].p(i, t), F(_e[r], 1))
            : ((_e[r] = de(i)), _e[r].c(), F(_e[r], 1), _e[r].m(Ae, null));
        }
