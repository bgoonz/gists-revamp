  ! function ( e ) {
      ...
      684: function ( e, t, r ) {
        ...
        var n = {
            ...
            _CSS_TYPES: [ "css", "less", "scss", "sass", "stylus", "postcss", "text/css", "text/x-sass",
              "text/x-scss", "text/x-less", "text/x-styl"
            ],
            _JS_TYPES: [ "js", "javascript", "coffeescript", "livescript", "typescript", "babel", "text/javascript",
              "text/x-coffeescript", "text/x-livescript", "text/typescript"
            ],
            ...
            _getType: function ( e ) {
              return -1 !== this._HTML_TYPES.indexOf( e ) ? "html" : -1 !== this._CSS_TYPES.indexOf( e ) ? "css" :
                -1 !== this._JS_TYPES.indexOf( e ) ? "js" : this._CUSTOM_EDITOR_TYPES[ e ] ? this
                ._CUSTOM_EDITOR_TYPES[ e ] : "unknown"
            }
          },
          i = function e( t ) {
          ...
          a = [ "title", "description", "tags", "html_classes", "head", "stylesheets", "scripts" ],
          o = function ( e ) {
          ...
          f = function ( e ) {
            var t = "";
            for ( var r in e ) "prefill" !== r && ( "" !== t && ( t += "&" ), t += r + "=" + encodeURIComponent( e[
              r ] ) );
            return t
          },
          m = function ( e ) {
          ...
          h = function ( e, t ) {
            ...
            n.appendChild( y( e ) ), "prefill" in e && ( r = v( e, t ), n.appendChild( r ) ), g( t, n ), r && r
              .submit()
          },
          _ = function ( e, t ) {
          ...
          v = function ( e, t ) {
            ...
            for ( var i in e.data = function ( e ) {
                if ( e.hasAttribute( "data-prefill" ) ) {
                  ...
                  for ( var i in r = JSON.parse( decodeURI( r ) || "{}" ) ) a.indexOf( i ) > -1 && ( t[ i ] = r[
                    i ] );
              ...
              }( t ), e ) "prefill" !== i && r.appendChild( _( "input", {
              type: "hidden",
              name: i,
              value: e[ i ]
            } ) );
          ...
          y = function ( e ) {
            ...
            return "prefill" in e == !1 && ( n.loading = "lazy" ), e[ "slug-hash" ] && ( n.id = "cp_embed_" + e[
              "slug-hash" ].replace( "/", "_" ) ), _( "iframe", n )
          },
          g = function ( e, t ) {
            if ( e.parentNode ) {
        ...
        x.readme = "2019-01-18 - added version number back in.", window.__cp_eijs_version = "3.1.0", window
          .__cp_domReady = i, window.__CPEmbed = x, i( x )
      }
    } );