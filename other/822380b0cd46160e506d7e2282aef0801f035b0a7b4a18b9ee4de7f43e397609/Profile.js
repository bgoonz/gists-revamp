        ...
        <div className="row">
            <div className="col-sm-3">
                ...
                <div className="text-center mb-4">
                    <img src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" className="avatar mb-4" alt="avatar"/>
                ...
                <div className="panel panel-default">
                    ...
                    <div className="panel-body text-center ">
                        <i className="fa fa-facebook fa-2x mr-6"></i> <i className="fa fa-twitter fa-2x mr-6"></i>  <i className="fa fa-instagram fa-2x mr-6"></i>
                    </div>
                </div>
            </div>
            <div className="col-sm-9">
                <ul className="nav nav-tabs">
                    ...
                    <li className="nav-item"><a className="nav-link" data-toggle="tab" href="#settings">Revenue</a></li>
