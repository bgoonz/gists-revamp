...
class Purchase extends Component {
  ...
  purchase = (user) => {
    return fetch("http://localhost:8080/purchase",
            ...
            <div className="form-group">
              <tr key={index}>
                <td>
                  ...
                  <input id={index} onChange={this.handleChangecomp(index)} type="text" className="form-control" value={prodarray.company} />
                ...
                <td><lable className="text-muted">Product</lable>
                  <select
                    onInput={this.handleChangeProd(index)} type="option"
                ...
                <td>
                  ...
                  <select
                    onChange={this.handleChangeBatch(index)} type="option"
                    className="form-control"
