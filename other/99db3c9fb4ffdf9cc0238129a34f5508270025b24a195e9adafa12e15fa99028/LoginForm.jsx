...
messaging.getToken({ vapidKey: 'BKftX8XPzM_RpzGkx1QXpEwbIR2Fhvnj3DW8srsHCIyJ-nwQWeHNoLuVm65E8c4GARZ2Xcsb3wZNICg2v6_bHnY' }).then((currentToken) => {
  if (currentToken) {
...
<button
  ...
  type="button" className="btn btn-primary" data-toggle="modal" data-target="#staticBackdrop">
...
<div
  ...
  className="modal fade show" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
