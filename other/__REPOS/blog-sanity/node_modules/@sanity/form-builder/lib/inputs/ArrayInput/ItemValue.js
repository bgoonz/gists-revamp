...
class RenderItemValue extends _react.default.PureComponent {
  ...
  renderEditItemForm(item) {
    ...
    var childPresence = presence.filter(child => child.path.length > 1);
    ...
    if (options.editModal === 'fold') {
      return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_fold.default, {
        title: title,
        onClose: this.handleEditStop
      }, /*#__PURE__*/_react.default.createElement(_presence.PresenceOverlay, null, content)));
    }
  ...
  renderItem() {
    ...
    var hasItemFocus = PathUtils.isExpanded(pathSegmentFrom(value), focusPath);
    var memberType = this.getMemberType();
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      className: _ItemValue.default.inner
    ...
    }), !readOnly && /*#__PURE__*/_react.default.createElement(_ConfirmButton.default, {
      kind: isGrid ? undefined : 'simple',
