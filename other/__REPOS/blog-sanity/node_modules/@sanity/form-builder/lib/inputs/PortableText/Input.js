...
function PortableTextInput(props) {
  ...
  var _useState5 = (0, _react.useState)(false),
      ...
      showValidationTooltip = _useState6[0],
      setShowValidationTooltip = _useState6[1];

  var _useState7 = (0, _react.useState)(undefined),
      _useState8 = _slicedToArray(_useState7, 2),
      initialSelection = _useState8[0],
      setInitialSelection = _useState8[1]; // This will open the editing interfaces automatically according to the focusPath.
  // eslint-disable-next-line complexity


  (0, _react.useEffect)(() => {
    if (focusPath && objectEditData === null) {
      var isChild = focusPath[1] === 'children';
      var isMarkdef = focusPath[1] === 'markDefs';
      var blockSegment = focusPath[0]; // Annotation focus paths

      if (isMarkdef && blockSegment && typeof blockSegment === 'object') {
        var block = value && value.find(blk => blk._key === blockSegment._key);
        var markDefSegment = focusPath[2]; // eslint-disable-next-line max-depth

        if (block && markDefSegment && typeof markDefSegment === 'object') {
          var span = block.children.find(child => Array.isArray(child.marks) && child.marks.includes(markDefSegment._key)); // eslint-disable-next-line max-depth
      ...
      if (focusPath && (isChild && focusPath.length > 3 || !isChild && focusPath.length > 1)) {
        ...
        var path = focusPath.slice(0, 1); // eslint-disable-next-line max-depth
  ...
  function handleCloseValidationResults() {
    setShowValidationTooltip(false);
  }

  function handleToggleValidationResults() {
  ...
  function renderBlock(block, blockType, attributes, defaultRender) {
    ...
    if (block._type === ptFeatures.types.block.name) {
      ...
      // Object blocks
      var blockMarkers = markers.filter(marker => typeof marker.path[0] === 'object' && marker.path[0]._key === block._key);
  ...
  function renderChild(child, childType, attributes, defaultRender) {
    ...
    var inlineMarkers = markers.filter(marker => typeof marker.path[2] === 'object' && marker.path[2]._key === child._key);
  ...
  function renderAnnotation(annotation, annotationType, attributes, defaultRender) {
    // eslint-disable-next-line react/prop-types
    var annotationMarkers = markers.filter(marker => typeof marker.path[2] === 'object' && marker.path[2]._key === annotation._key);
  ...
  var renderEditObject = (0, _react.useCallback)(() => {
  ...
  var ptEditor = /*#__PURE__*/_react.default.createElement(_Editor.default, {
    hotkeys: hotkeys,
  ...
  }, isFullscreen ? /*#__PURE__*/_react.default.createElement(_portal.Portal, null, /*#__PURE__*/_react.default.createElement(_stackedEscapable.default, {
