...
async function initSanity(args, context) {
  ...
  if (reconfigure) {
    ...
    const newProps = {
      root: true,
      api: _objectSpread(_objectSpread({}, projectManifest.api || {}), {}, {
        projectId,
        dataset: datasetName
      }),
    ...
    projectManifest = _objectSpread(_objectSpread(_objectSpread({}, newProps), projectManifest), newProps);
    ...
    if (hasNodeModules) {
      ...
      try {
        await yarn(['install'], _objectSpread(_objectSpread({}, output), {}, {
          rootDir: workDir
        }));
      } catch (err) {
        throw err;
  ...
  async function getOrCreateProject() {
    ...
    if (isUsersFirstProject) {
      ...
      }).then(response => _objectSpread(_objectSpread({}, response), {}, {
