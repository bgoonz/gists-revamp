...
export class RentalCreate extends React.Component {
  ...
  createRental(values) {
    this.props.dispatch(actions.createRental(values)).then(
      (res) => {if (res && res.rental) this.setState({redirect: true})});
  }
        ...
        <div className="bwm-form">
          <div className="row">
            <div className="col-md-5">
              ...
              <RentalCreateForm errors={errors} options={this.categories} submitCb={this.createRental}/>
            </div>
