import { REQUEST_BOOKING,
         ...
         REQUEST_BOOKINGS,
         RECIEVE_BOOKINGS,
         RECIEVE_BOOKINGS_FAIL } from '../actions/types';
...
export const bookingsReducer = (state = INITIAL_STATE.bookings, action) => {
  switch(action.type) {
    case REQUEST_BOOKINGS:
      return Object.assign({}, state, {isFetching: true, items: [], errors: []});
    case RECIEVE_BOOKINGS:
      return Object.assign({}, state, {isFetching: false, items: action.bookings});
