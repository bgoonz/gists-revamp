...
describe('reducer', function () {
  ...
  it('should remove an array value from by predicate', function () {
    ...
    }, _extends({}, (0, _actions.removeArrayValue)('myField', function (field) {
  ...
  it('should not change array on swap with out of bounds index', function () {
    var _testForm11, _expect$toEqual39;

    var state = (0, _reducer2.default)({
      testForm: (_testForm11 = {
        myField: [(0, _fieldValue.makeFieldValue)({
          value: 'foo'
        }), (0, _fieldValue.makeFieldValue)({
          value: 'bar'
        ...
        _active: undefined,
        _asyncValidating: false
      }, _testForm11[_reducer.globalErrorKey] = undefined, _testForm11._initialized = false, _testForm11._submitting = false, _testForm11._submitFailed = false, _testForm11)
    }, _extends({}, (0, _actions.swapArrayValues)('myField', 1, 4), {
      form: 'testForm'
    }));
    (0, _expect2.default)(state.testForm).toEqual((_expect$toEqual39 = {
      myField: [{
        value: 'foo',
        _isFieldValue: true
      }, {
  ...
  it('should set submitting on startSubmit', function () {
    ...
    (0, _expect2.default)(state.foo).toEqual((_expect$toEqual44 = {
      ...
      _active: undefined,
      _asyncValidating: false
    }, _expect$toEqual44[_reducer.globalErrorKey] = undefined, _expect$toEqual44._initialized = false, _expect$toEqual44._submitting = true, _expect$toEqual44._submitFailed = false, _expect$toEqual44));
  });

  it('should set submitting on startSubmit, and NOT reset submitFailed', function () {
    var _foo18, _expect$toEqual45;
    ...
    (0, _expect2.default)(state.foo).toEqual((_expect$toEqual45 = {
      ...
      _active: undefined,
      _asyncValidating: false
    }, _expect$toEqual45[_reducer.globalErrorKey] = undefined, _expect$toEqual45._initialized = false, _expect$toEqual45._submitting = true, _expect$toEqual45._submitFailed = true, _expect$toEqual45));
  });

  it('should set asyncError on nested fields on stopAsyncValidation', function () {
    var _foo19, _expect$toEqual46;
  ...
  it('should unset asyncValidating on stopAsyncValidation and set global error', function () {
    var _foo23, _stopAsyncValidation, _expect$toEqual50;
    ...
    (0, _expect2.default)(state.foo).toEqual((_expect$toEqual50 = {
      ...
      _active: undefined,
      _asyncValidating: false
    }, _expect$toEqual50[_reducer.globalErrorKey] = 'This is a global error', _expect$toEqual50._initialized = false, _expect$toEqual50._submitting = false, _expect$toEqual50._submitFailed = false, _expect$toEqual50));
    (0, _expect2.default)((0, _fieldValue.isFieldValue)(state.foo.myField)).toBe(true);
    (0, _expect2.default)((0, _fieldValue.isFieldValue)(state.foo.myOtherField)).toBe(true);
  });

  it('should unset submitting on stopSubmit', function () {
    var _foo24, _expect$toEqual51;
    ...
    (0, _expect2.default)(state.foo).toEqual((_expect$toEqual51 = {
      ...
      _active: undefined,
      _asyncValidating: false
    }, _expect$toEqual51[_reducer.globalErrorKey] = undefined, _expect$toEqual51._initialized = false, _expect$toEqual51._submitting = false, _expect$toEqual51._submitFailed = false, _expect$toEqual51));
  });

  it('should set submitError on nested fields on stopSubmit', function () {
    var _foo25, _expect$toEqual52;
  ...
  it('should set submitError on array fields on stopSubmit', function () {
    ...
    (0, _expect2.default)(state.foo).toEqual((_expect$toEqual53 = {
      ...
      _active: undefined,
      _asyncValidating: false
    }, _expect$toEqual53[_reducer.globalErrorKey] = undefined, _expect$toEqual53._initialized = false, _expect$toEqual53._submitting = false, _expect$toEqual53._submitFailed = true, _expect$toEqual53));
    (0, _expect2.default)((0, _fieldValue.isFieldValue)(state.foo.bar)).toBe(false);
    (0, _expect2.default)((0, _fieldValue.isFieldValue)(state.foo.bar[0])).toBe(true);
    (0, _expect2.default)((0, _fieldValue.isFieldValue)(state.foo.bar[1])).toBe(true);
  });
  ...
  it('should unset submitting and set submit errors on stopSubmit', function () {
    ...
    (0, _expect2.default)(state.foo).toEqual((_expect$toEqual55 = {
      ...
      _active: undefined,
      _asyncValidating: false
    }, _expect$toEqual55[_reducer.globalErrorKey] = undefined, _expect$toEqual55._initialized = false, _expect$toEqual55._submitting = false, _expect$toEqual55._submitFailed = true, _expect$toEqual55));
    (0, _expect2.default)((0, _fieldValue.isFieldValue)(state.foo.myField)).toBe(true);
    (0, _expect2.default)((0, _fieldValue.isFieldValue)(state.foo.myOtherField)).toBe(true);
  });

  it('should unset submitting and set submit global error on stopSubmit', function () {
    var _foo29, _stopSubmit, _expect$toEqual56;
    ...
    (0, _expect2.default)(state.foo).toEqual((_expect$toEqual56 = {
      ...
      _active: undefined,
      _asyncValidating: false
    }, _expect$toEqual56[_reducer.globalErrorKey] = 'This is a global error', _expect$toEqual56._initialized = false, _expect$toEqual56._submitting = false, _expect$toEqual56._submitFailed = true, _expect$toEqual56));
    (0, _expect2.default)((0, _fieldValue.isFieldValue)(state.foo.myField)).toBe(true);
    (0, _expect2.default)((0, _fieldValue.isFieldValue)(state.foo.myOtherField)).toBe(true);
  });

  it('should mark fields as touched on touch', function () {
    var _foo30, _expect$toEqual57;
  ...
  it('should mark index-less array subfields as touched on touch', function () {
    ...
    (0, _expect2.default)(state.foo).toEqual((_expect$toEqual68 = {
      myFields: [{
        name: {
          value: 'initialValue',
          _isFieldValue: true
      ...
      _active: undefined,
      _asyncValidating: false
    }, _expect$toEqual68[_reducer.globalErrorKey] = undefined, _expect$toEqual68._initialized = false, _expect$toEqual68._submitting = false, _expect$toEqual68._submitFailed = false, _expect$toEqual68));
    (0, _expect2.default)((0, _fieldValue.isFieldValue)(state.foo.myFields)).toBe(false);
    (0, _expect2.default)((0, _fieldValue.isFieldValue)(state.foo.myFields[0])).toBe(false);
    (0, _expect2.default)((0, _fieldValue.isFieldValue)(state.foo.myFields[0].name)).toBe(true);
    (0, _expect2.default)((0, _fieldValue.isFieldValue)(state.foo.myFields[1])).toBe(false);
