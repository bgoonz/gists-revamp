    ...
    render() {
        ...
        return (
            <div className="filter-content">
                <p> <span className={isActive0} onClick={this.setFilterType(types.FILTER_COMPANY)}>COMPANY</span> |
                    <span className={isActive1} onClick={this.setFilterType(types.FILTER_ADRESS)}>ADRESS</span></p>
            </div>
        )
    }
};
