...
const defaultView = {
	...
	players: [
		{id: 1, name: "Filip", score: 3, isCzar: false, isPlaying: true, isWinner: false},
		{id: 2, name: "Rolo", score: 1, isCzar: false, isPlaying: true, isWinner: false},
		{id: 3, name: "David", score: 4, isCzar: true, isPlaying: false, isWinner: false},
		{id: 4, name: "Tomas", score: 2, isCzar: false, isPlaying: true, isWinner: false}
	],
	messages: [
