  ...
  _createClass(ToastContainer, [{
    ...
    value: function renderToast() {
      ...
      return Object.keys(toastToRender).map(function (position) {
        ...
        var props = {
          className: (0, _classnames2.default)('Toastify__toast-container', 'Toastify__toast-container--' + position, className, { 'Toastify__toast-container--rtl': _this5.props.rtl }),
