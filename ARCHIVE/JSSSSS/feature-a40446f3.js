    ...
    $(() => {
      ...
      function g() {
        ...
        r(5, (s.width = l * c), s),
          ...
          c < 500
            ? ((t = 12),
              (e = 19),
              (i = { top: 52 + e, right: 10, bottom: 15, left: 15 }))
            : ((t = o ? 16 : 18),
              (e = o ? 28 : 33),
              (i = {
                top: 52 + e,
      ...
      function $() {
        let t = (function (t) {
          ...
          for (let a of n)
            (a.input.characters = c(a.input)),
              (a.output.characters = c(a.output));
          return n;
        })(l);
        d = u
          ? {
              tick: -1,
              line: t.length - 1,
              character: t[t.length - 1].input.characters - 1,
              lines: t,
              ...
              x(d.triggers.character) &&
                (d.character < d.lines[d.line].input.characters - 1
                  ? ((d.character += 1),
                    (d.triggers.character = d.tick + v(2, 3)))
                  : d.line < d.lines.length - 1 &&
                    (d.lines[d.line + 1].output.characters
                      ? (d.triggers.line = d.tick + v(20, 30))
                      : (d.triggers.line = d.tick + v(2, 3)))),
              (function (t) {
                m.clearRect(0, 0, c, h);
                let r = 0;
                d.line * e + i.top >= h - i.bottom &&
                  (r = d.line * e - h + i.top + i.bottom);
                for (let a = 0; a <= d.line; a++) {
                  let n = 0;
                  for (let t of d.lines[a].output)
                    (m.fillStyle = t.color),
                      m.fillText(t.text, i.left + n * f, i.top + e * a - r),
                      (n += t.text.length);
                  let s = n;
                  for (let l of d.lines[a].input) {
                    if (((m.fillStyle = l.color), a === d.line)) {
                      ...
                      m.fillText(l.text, i.left + n * f, i.top + e * a - r);
                    n += l.text.length;
                  }
                }
              })(r)));
...
function S(t) {
  ...
  return {
    ...
    h() {
      o(r, "href", t[1].href),
        o(r, "class", I(`btn-${t[1].type || "primary"}`) + " svelte-1i79qs2"),
        o(e, "class", "mt-xx-small md:mt-x-large");
    },
    m(t, a) {
  ...
  let e,
    ...
    j =
      ...
      (function (t) {
        ...
        return (
          (e = new M({
            props: { source: t[4].source, skipToEnd: t[4].skipToEnd },
          })),
          {
            c() {
              v(e.$$.fragment);
    ...
    q =
      ...
      (function (t) {
        ...
        return {
          ...
          h() {
            e.src !== (r = t[5].src) && o(e, "src", r),
              o(e, "alt", t[5].alt),
              o(e, "class", "block rounded-2xl shadow-medium");
          },
          m(t, r) {
            u(t, e, r);
          },
    ...
    h() {
      o(m, "class", "h3"),
        ...
        o(
          C,
          "class",
          "preview w-full col-start-1 row-start-1 md:col-start-auto md:row-start-auto svelte-1i79qs2"
        ),
        o(
          e,
          "class",
          "feature grid justify-center items-center md:grid-cols-2 lg:gap-32 gap-small"
        );
    },
    m(t, a) {
      u(t, e, a),
...
function B(t) {
  ...
  return (
    (e = new V({
      props: {
        className: "feature-container-section",
        $$slots: { default: [G] },
        $$scope: { ctx: t },
      },
    })),
