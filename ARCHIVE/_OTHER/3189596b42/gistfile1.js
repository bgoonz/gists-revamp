...
// JPG
                        ...
                        variable_length_segment: {
                                ...
                                height: 'uint16',
                                width: 'uint16',
                                data: ['array', 'uint8', function(){
                                        return this.current.segment_length - 7;
                                }]
                        },
                        segment: function(){
                                var marker = this.parse('marker'), segment, next_marker;
                                // end-of-file?
                                ...
                                if (marker[1] == "0xc0" || marker[1] == "0xc2") {
                                        ...
                                        } while (!((next_marker[0] == '0xff' && next_marker[1] != '0x0') || (next_marker[1] == '0xff')));
                                        this.seek(this.tell()-1);
