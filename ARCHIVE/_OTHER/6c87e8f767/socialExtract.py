...
allLinks = []
for link in ['','/about', '/contact','/news','/blog', '/contactus', '/news', '/team', '/portfolio']:
    try:
...
#             allLinks.append(a.get('href'))
        ...
        filters = allLinks.str.contains('@|twitter.com|linkedin.com|medium.com|facebook.com|producthunt.com|angel.co|instagram.com|youtube.com|itunes', regex=True)
        filteredLinks = allLinks[filters.index.where(filters == True).dropna().astype(int)]
