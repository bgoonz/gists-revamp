...
if __name__ == "__main__":
    ...
    schools_without_energy, school_list = loop.run_until_complete(get_schools())
    ...
    for data in (f.result() for f in school_detail_list):
        ...
        print("{} {} {}".format(school["cidade"], school["estado"], school["regiao"]))
        ...
        if int(detail["salasExistentes"]) > 1:
            ...
            print("Sanitário Fora Predio: {}".format(detail["sanitarioForaPredio"]))
