...
(function(){
	...
	function doAutoscrollEvent() {
		var evt, hash = document.location.hash.replace(/^#/,"");
	...
	if (!("onautoscroll" in window)) {
		...
		if (window.addEventListener) {
			window.addEventListener("load",function __load__(){
...
(function(){
	...
	window.addEventListener("autoscroll",function __autoscroll__(evt){
		// unbind the event, for cleanliness sake
