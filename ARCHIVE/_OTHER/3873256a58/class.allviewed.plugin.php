...
class AllViewedPlugin extends Gdn_Plugin {
   ...
   function GetCommentCountSince($DiscussionID, $DateSince) {
      ...
      // Never runs this, because DiscussionModel_AfterAddColumns_Handler never runs.
      echo "test";
    ...
    * [CHRIS]: Checked this, it's there. class.discussionmodel.php line 208
    */
   ...
   function UserModel_UpdateAllViewed_Create(&$Sender) {
      ...
      // Had to add
      // $Configuration['Plugins']['DiscussionPrefix']['Enabled'] = TRUE;
      if (!C('Plugins.AllViewed.Enabled')) return;
      ...
      // Works
      // echo $Session->User->DateAllViewed;
