!(function (r) {
  ...
  function J(r, n, e) {
    ...
    for (var l = 0; e >= 128; ) {
      ...
      for (a = 0; a < 80; a++) {
        ...
        for (
          o = M(w[7], X(w[4]), q(w[4], w[5], w[6]), Yr[a], y[a % 16]),
            c[7] = M(o, V(w[0]), I(w[0], w[1], w[2])),
            c[3] = M(c[3], o),
            f = 0;
          f < 8;
          f++
  ...
  function Q(r, n, e) {
    ...
    for (
      a[e] = 128,
        e = 256 - 128 * (e < 112 ? 1 : 0),
        a[e - 9] = 0,
        i(a, e - 8, new sr((f / 536870912) | 0, f << 3)),
        J(o, a, e),
        t = 0;
      t < 64;
      t++
  ...
  function fr(r, n) {
    ...
    return (
      ...
      m(t, o)
        ? -1
        : (B(r[0]) === n[31] >> 7 && T(r[0], pr, r[0]), Y(r[3], r[0], r[1]), 0)
    );
  }
  function ur(r, n, e, t) {
    var o,
  ...
  function yr() {
    ...
    for (n = 0; n < arguments.length; n++)
      if (
        "[object Uint8Array]" !==
        (r = Object.prototype.toString.call(arguments[n]))
      )
  ...
  (r.lowlevel = {
    ...
    (r.secretbox.open = function (r, n, e) {
      ...
      for (
        ...
        t[i + Or] = r[i];
      return (
        !(t.length < 32) && 0 === A(o, t, t.length, n, e) && o.subarray(Pr)
      );
    }),
    (r.secretbox.keyLength = zr),
    (r.secretbox.nonceLength = Rr),
    (r.secretbox.overheadLength = Or),
    ...
    (r.scalarMult.scalarLength = Nr),
    (r.scalarMult.groupElementLength = Fr),
    ...
    (r.box.publicKeyLength = Cr),
    (r.box.secretKeyLength = Mr),
    (r.box.sharedKeyLength = Gr),
    (r.box.nonceLength = Zr),
    ...
    (r.sign.detached = function (n, e) {
      for (
        var t = r.sign(n, e), o = new Uint8Array(Ir), i = 0;
        i < o.length;
        i++
      )
        o[i] = t[i];
    ...
    (r.sign.keyPair.fromSeed = function (r) {
      ...
      for (
        var n = new Uint8Array(Vr), e = new Uint8Array(Xr), t = 0;
        t < 32;
        t++
      )
        e[t] = r[t];
    ...
    (r.sign.publicKeyLength = Vr),
    (r.sign.secretKeyLength = Xr),
    (r.sign.seedLength = Dr),
    (r.sign.signatureLength = Ir),
    (r.hash = function (r) {
      yr(r);
      var n = new Uint8Array(Hr);
      return Q(n, r, r.length), n;
    }),
    (r.hash.hashLength = Hr),
