...
(function ($, win, doc) {
  ...
  $.anythingSlider = function (el, options) {
    ...
    base.init = function () {
      ...
      base.regex = o.hashTags
        ? new RegExp("panel" + base.runTimes + "-(\\d+)", "i")
        : null;
      if (base.runTimes === 1) {
        base.makeActive();
      ...
      base.currentPage =
        base.targetPage =
        o.startPanel =
          parseInt(o.startPanel, 10) || 1; // make sure this isn't a string
      ...
      base.$wrapper.bind("mouseenter mouseleave", function (e) {
        ...
        $(this)[e.type === "mouseenter" ? "addClass" : "removeClass"](
      ...
      $(doc).keyup(function (e) {
        ...
        if (
          o.enableKeyboard &&
          base.$wrapper.hasClass("activeSlider") &&
          !e.target.tagName.match("TEXTAREA|INPUT|SELECT") &&
          !$("#carousel_inner:hover").length
        ) {
      ...
      base.currentPage =
        (o.hashTags ? base.gotoHash() : "") || o.startPanel || 1;
    ...
    base.updateSlider = function () {
      ...
      base.navTextVisible =
        base.$nav.find("span:first").css("visibility") !== "hidden";
      base.$nav.empty();
      ...
      base.$items
        ...
        .bind("focus.AnythingSlider", function (e) {
          ...
          if (
            indx !== -1 &&
            (indx >= base.currentPage + o.showMultiple ||
              indx < base.currentPage)
          ) {
            base.gotoPage(indx);
            e.preventDefault();
          }
      ...
      if (o.buildNavigation && base.pages > 1) {
        ...
        base.$items.filter(":not(.cloned)").each(function (j) {
          ...
          a =
            '<a class="panel' +
            i +
            (base.navTextVisible ? '"' : " " + o.tooltipClass + '" title="@"') +
            ' href="#"><span>@</span></a>';
    ...
    base.setDimensions = function () {
      ...
      var w,
        ...
        pw =
          o.showMultiple > 1 && o.mode === "horizontal"
            ? base.width || base.$window.width() / o.showMultiple
            : base.$window.width(),
        ph =
          o.showMultiple > 1 && o.mode === "vertical"
            ? base.height / o.showMultiple ||
              base.$window.height() / o.showMultiple
            : base.$window.height();
      if (o.expand) {
      ...
      base.$el.css(
        o.mode === "vertical" ? "height" : "width",
        o.mode === "fade" ? base.width : edge
      );
    };
    ...
    base.goForward = function (autoplay, rtl) {
      ...
      base.gotoPage(
        base[o.allowRapidChange ? "targetPage" : "currentPage"] +
          o.changeBy * (rtl ? -1 : 1),
        autoplay
      );
    };
    ...
    base.goBack = function (autoplay) {
      base.gotoPage(
        base[o.allowRapidChange ? "targetPage" : "currentPage"] - o.changeBy,
        autoplay
      );
    };
    ...
    base.gotoPage = function (page, autoplay, callback, time) {
      ...
      if (
        o.stopAtEnd &&
        !o.infiniteSlides &&
        page > base.pages - o.showMultiple
      ) {
    ...
    base.endAnimation = function (page, callback, time) {
      if (page === 0) {
        base.$el.css(
          base.dir,
          o.mode === "fade" ? 0 : -base.panelSize[base.pages][2]
        );
        page = base.pages;
    ...
    base.fadeIt = function (el, toOpacity, time, callback) {
      ...
      if (o.resumeOnVisible) {
        ...
        el.filter(":not(:animated)")[toOpacity === 0 ? "fadeOut" : "fadeIn"](
          t,
          callback
        );
      }
    ...
    base.setCurrentPage = function (page, move) {
      ...
      if (o.buildArrows && !o.infiniteSlides && o.stopAtEnd) {
        base.$forward[
          page === base.pages - base.adjustMultiple ? "addClass" : "removeClass"
        ]("disabled");
      ...
      if (!move) {
        ...
        base.$wrapper
          ...
          .add(base.$window)
          .scrollLeft(0)
          .scrollTop(0); // reset in case tabbing changed this scrollLeft - probably overly redundant
        base.$el.css(
          base.dir,
          o.mode === "fade"
            ? 0
      ...
      if (n === null && !/^#&/.test(h) && !/#!?\//.test(h) && !/\=/.test(h)) {
        ...
        n =
          $(h).length && $(h).closest(".anythingBase")[0] === base.el
            ? base.$items.index($(h).closest(".panel")) + base.adj
            : null;
      } else if (n !== null) {
        // #&panel1-3&panel3-3
    ...
    base.startStop = function (playing, paused) {
      ...
      if (playing) {
        ...
        base.timer = win.setInterval(function () {
          if (
            !!(doc.hidden || doc.webkitHidden || doc.mozHidden || doc.msHidden)
          ) {
