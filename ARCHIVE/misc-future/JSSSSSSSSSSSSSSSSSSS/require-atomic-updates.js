...
module.exports = {
  ...
  create(context) {
    ...
    class AssignmentTrackerState {
      ...
      merge(other) {
        const initialAssignmentsWithoutReadsCount =
          this.openAssignmentsWithoutReads.size;
        const initialAssignmentsWithReadsCount =
          this.openAssignmentsWithReads.size;

        other.openAssignmentsWithoutReads.forEach((assignment) =>
          this.openAssignmentsWithoutReads.add(assignment)
        );
        other.openAssignmentsWithReads.forEach((assignment) =>
          this.openAssignmentsWithReads.add(assignment)
        );

        return (
          this.openAssignmentsWithoutReads.size >
            initialAssignmentsWithoutReadsCount ||
