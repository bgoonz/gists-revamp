...
function _(t) {
  ...
  return {
    ...
    l(t) {
      ...
      var i = o(u);
      (m = h(i, "provide feedback on GitHub")),
        i.forEach(n),
        ($ = h(t, " 🙏.")),
        this.h();
    },
    h() {
      d(u, "href", "https://github.com/gitpod-io/website/issues/461"),
        d(u, "target", "__self");
    },
    m(t, s) {
  ...
  return {
    ...
    l(t) {
      e = r(
        t,
        "svg",
        { viewBox: !0, height: !0, width: !0, fill: !0, xmlns: !0 },
        1
      );
      var l = o(e);
...
function C(t, e, a) {
  ...
  return [
    `https://gitpod.io#https://github.com/gitpod-io/website/tree/main/src/routes${
      "/docs" === s.path ? `${s.path}/index` : s.path
    }.md`,
...
function K(t) {
  ...
  return {
    ...
    h() {
      d(e, "href", t[0].prev.path),
        d(e, "title", `Previous: ${t[0].prev.title}`),
        d(e, "class", "svelte-1kanmwt");
    },
    m(t, s) {
      l(t, e, s), i(e, a);
    },
...
function q(t) {
  ...
  return {
    ...
    h() {
      d(e, "href", t[0].next.path),
        d(e, "title", `Next: ${t[0].next.title}`),
        d(e, "class", "svelte-1kanmwt");
    },
    m(t, s) {
      l(t, e, s), i(e, a);
  ...
  return {
    ...
    h() {
      d(
        e,
        "class",
        "flex justify-between pt-xx-small border-t border-solid border-gray-400"
      );
    },
    m(t, s) {
...
function X(t) {
  ...
  return (
    ...
    (I = new J({})),
    {
      ...
      h() {
        d(e, "rel", "stylesheet"),
          d(e, "href", "/prism-solarized-light.min.css"),
          d(f, "class", "content-docs");
      },
      m(t, s) {
        i(document.head, e),
          l(t, a, s),
...
function Y(t, e, a) {
  ...
  return (
    (t.$$set = (t) => {
      "section" in t && a(1, (n = t.section)),
        "title" in t && a(0, (l = t.title)),
        "$$scope" in t && a(2, (o = t.$$scope));
    }),
    (t.$$.update = () => {
      2 & t.$$.dirty && A(I, (s = n), s);
    }),
