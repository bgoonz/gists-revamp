...
function U(e, t, s) {
  ...
  a(e, P, (e) => s(1, (l = e)));
  const o =
    "undefined" != typeof window && "www.gitpod.io" === window.location.hostname
      ? "5aJzy2ASNbqx8I0kwppRflDZpL7pS1GO"
      : "Xe5zR3MbnyxHsveZr4HvrY35PL9iT0EH";
  return (
    r(async () => {
    ...
    (e.$$.update = () => {
      3 & e.$$.dirty &&
        ...
        "undefined" != typeof window &&
          (null === s(0, (c = window.analytics)) || void 0 === c || c.page()));
    }),
    [c, l]
  );
}
...
function se(e) {
  return [
    () =>
      window.analytics.track("dashboard_clicked", { context: "header_button" }),
  ];
}
class ae extends e {
  constructor(e) {
    ...
    h() {
      f(t, "href", e[1]),
        ...
        f(
          t,
          "class",
          "text-black text-p-large sm:text-dark-grey sm:hover:text-black sm:focus:text-black svelte-qtdv9u"
        ),
        x(t, "active", e[0]),
        x(t, "highlighted", e[2]);
    },
...
function le(e, t, s) {
  ...
  return (
    ...
    (e.$$.update = () => {
      32 & e.$$.dirty &&
        s(0, (r = "/" === l.path ? /\/$/.test(o) : o.indexOf(l.path) >= 0));
    }),
    [
      r,
      o,
    ...
    (a = new ae({})),
    {
      ...
      h() {
        f(
          t,
          "class",
          "nav-items absolute flex flex-col pt-10 pb-16 w-screen items-center bg-off-white space-y-xx-small z-10 shadow-md svelte-1aoyuzy"
        );
      },
      m(e, l) {
        h(e, t, l);
      ...
      p(e, a) {
        if (3 & a) {
          ...
          for (l = e[0], r = 0; r < l.length; r += 1) {
            ...
            v[r]
              ? (v[r].p(c, a), d(v[r], 1))
              : ((v[r] = fe(c)), v[r].c(), d(v[r], 1), v[r].m(t, s));
          }
  ...
  return {
    ...
    l(e) {
      t = o(
        e,
        "svg",
        { width: !0, height: !0, viewBox: !0, fill: !0, xmlns: !0 },
        1
      );
      var r = n(t);
      (s = o(r, "rect", { width: !0, height: !0, rx: !0, fill: !0 }, 1)),
        ...
        (a = o(
          r,
          "rect",
          { y: !0, width: !0, height: !0, rx: !0, fill: !0 },
          1
        )),
        n(a).forEach(i),
        r.forEach(i),
  ...
  return {
    ...
    l(e) {
      t = o(
        e,
        "svg",
        { xmlns: !0, fill: !0, width: !0, height: !0, viewBox: !0 },
        1
      );
      var a = n(t);
      (s = o(
        a,
        "path",
        { fill: !0, "fill-rule": !0, d: !0, "clip-rule": !0 },
        1
      )),
        n(s).forEach(i),
        a.forEach(i),
...
function me(e) {
  ...
  return {
    ...
    h() {
      f(t, "aria-label", "Show / hiide nav items"),
        f(
          t,
          "class",
          "flex justify-center items-center h-6 w-12 rounded-xl bg-black svelte-z7a2ag"
        );
    },
    m(r, l) {
      ...
      h() {
        f(a, "href", "/"),
          ...
          f(
            v,
            "class",
            "nav-items hidden px-2 space-x-6 items-center md:space-x-12 svelte-tcyliy"
          ),
          ...
          f(
            ...
            "class",
            (C =
              B((e[0] ? "bg-off-white " : "") + "mx-auto w-full") +
              " svelte-tcyliy")
          );
      },
      m(c, o) {
        ...
        p(s, g),
          ...
          (F = !0),
          V ||
            ((H = [$(a, "contextmenu", T(e[2])), $(a, "click", e[3])]),
            (V = !0));
      },
      p(e, [s]) {
        if (3 & s) {
          ...
          for (P = e[1], t = 0; t < P.length; t += 1) {
            ...
            z[t]
              ? (z[t].p(a, s), d(z[t], 1))
              : ((z[t] = xe(a)), z[t].c(), d(z[t], 1), z[t].m(v, null));
          }
...
function Ie(e) {
  ...
  return {
    ...
    l(e) {
      t = o(e, "A", { href: !0, class: !0 });
      var a = n(t);
      (s = o(a, "IMG", { src: !0, alt: !0, height: !0, width: !0 })),
        (r = k(a)),
        a.forEach(i),
        this.h();
    },
...
function Le(e) {
  ...
  return {
    ...
    l(e) {
      ...
      ut = o(vs, "DIV", { class: !0 });
      var ds = n(ut);
      (gt = o(ds, "IMG", { src: !0, alt: !0, height: !0, width: !0 })),
        (pt = k(ds)),
        ds.forEach(i),
        vs.forEach(i),
        ($t = o(hs, "SPAN", { class: !0 }));
    ...
    h() {
      f(l, "class", "svelte-1ivs93t"),
        ...
        gt.src !== (mt = "/svg/logo-textless.svg") &&
          f(gt, "src", "/svg/logo-textless.svg"),
        f(gt, "alt", "Gitpod"),
        f(gt, "height", "24"),
        f(gt, "width", "24"),
        ...
        f(
          ht,
          "class",
          "footer__bottom flex justify-between border-t border-solid border-sand-dark pt-xx-small md:pt-x-small svelte-1ivs93t"
        ),
        f(
          s,
          "class",
          "footer py-large m-auto px-xx-small md:max-w-3xl md:py-small md:px-xx-small svelte-1ivs93t"
        ),
    ...
    p(e, [t]) {
      if (1 & t) {
        ...
        for (At = e[0], s = 0; s < At.length; s += 1) {
          ...
          Dt[s]
            ? Dt[s].p(a, t)
            : ((Dt[s] = Ie(a)), Dt[s].c(), Dt[s].m(Et, null));
        }
...
function Ce(e, t, s) {
  ...
  return (
    ...
    (e.$$set = (e) => {
      "storageKey" in e && s(3, (c = e.storageKey)),
        "location" in e && s(0, (o = e.location)),
        "$$scope" in e && s(4, (l = e.$$scope));
    }),
    [
      o,
      n,
  ...
  return {
    ...
    l(e) {
      ...
      (s = m(
        ...
        (a = o(c, "A", { href: !0 }));
      var f = n(a);
      (r = m(f, "privacy policy")),
        f.forEach(i),
        (l = m(c, " for more info.")),
        c.forEach(i),
        (v = k(e)),
        (d = o(e, "BUTTON", { class: !0 }));
      var h = n(d);
      (u = m(h, "Accept Cookies")), h.forEach(i), this.h();
    },
    h() {
      f(a, "href", "/privacy"),
        f(t, "class", "w-7/12 md:w-9/12"),
        f(
          d,
          "class",
          "px-3 py-1 bg-off-white rounded-lg md:px-6 hover:bg-white"
        );
    },
    m(c, o) {
      h(c, t, o),
