  ...
  })(
    {
                  ...
                  return (
                    ...
                    (function (e) {
                      for (var t, n, i, r = "", o = 0; o < e.length; o++)
                        ...
                        n <= 57343
                          ? ((r += f(1024 * (t - 55296) + n - 56320 + 65536)),
                            o++)
                          : ((i = s[t]), (r += !i && q(t) ? e[o] : i || f(t)));
                      return r;
                    })(r) +
                    '"'
                  );
      ...
      5: [
        function (e, t, n) {
          ...
          for (var O = new Array(256), F = new Array(256), d = 0; d < 256; d++)
            (O[d] = f(d) ? 1 : 0), (F[d] = f(d));
          function h(e, t) {
            (this.input = e),
          ...
          var M = {
            YAML: function (e, t, n) {
              var i, r, o;
              null !== e.version && _(e, "duplication of %YAML directive"),
                1 !== n.length &&
                ...
                (r = parseInt(i[1], 10)),
                (o = parseInt(i[2], 10)),
                1 !== r && _(e, "unacceptable YAML version of the document"),
                (e.version = n[0]),
          ...
          function T(e, t, n, i) {
            ...
            if (t < n) {
              if (((s = e.input.slice(t, n)), i))
                ...
                c.test(s) &&
                  _(e, "the stream contains non-printable characters");
              e.result += s;
            }
          }
          function L(e, t, n, i) {
          ...
          function D(e, t, n, i, r, o, a, s) {
            ...
            if (
              ...
              if (Array.isArray(o))
                for (c = 0, u = o.length; c < u; c += 1) L(e, t, o[c], n);
              else L(e, t, o, n);
            else
              e.json ||
                y.call(n, r) ||
          ...
          function q(e, t, n) {
            for (var i = 0, r = e.input.charCodeAt(e.position); 0 !== r; ) {
              ...
              if (!j(r)) break;
              for (
                U(e), r = e.input.charCodeAt(e.position), i++, e.lineIndent = 0;
                32 === r;
          ...
          function Y(e) {
            ...
            return !(
              ...
              ((n += 3), 0 !== (t = e.input.charCodeAt(n)) && !S(t))
            );
          }
          function R(e, t) {
            1 === t
          ...
          function B(e, t) {
            ...
            for (
              ...
              0 !== i && 45 === i && S(e.input.charCodeAt(e.position + 1));
          ...
          function P(e) {
            ...
            if (
              ...
              (i = e.input.slice(t, e.position)),
                u.test(i) &&
                  _(e, "tag suffix cannot contain flow indicator characters");
            }
            return (
              i &&
                !p.test(i) &&
                _(e, "tag name cannot contain such characters: " + i),
              o
                ? (e.tag = i)
                : y.call(e.tagMap, n)
                ? (e.tag = e.tagMap[n] + i)
          ...
          function W(e) {
            ...
            for (
              null !== e.anchor && _(e, "duplication of an anchor property"),
                  ...
                  ? (s &&
                            ...
                            if (
                              ...
                              if (e.line === o) {
                                for (s = e.input.charCodeAt(e.position); I(s); )
                                  s = e.input.charCodeAt(++e.position);
                                if (58 === s)
                                  S((s = e.input.charCodeAt(++e.position))) ||
                                    _(
                                      e,
                    ...
                    : ((a &&
                        (function (e, t) {
                          ...
                          if (I(o)) {
                            for (; I((o = e.input.charCodeAt(++e.position))); );
                            if (35 === o)
                              for (
                                ;
                      ...
                      (function (e, t) {
                        ...
                        ? (function (e, t, n) {
                            var i,
                              ...
                              f = e.result;
                            if (
                              S((l = e.input.charCodeAt(e.position))) ||
                              E(l) ||
                              35 === l ||
                              38 === l ||
                              42 === l ||
                            ...
                            if (
                              (63 === l || 45 === l) &&
                              (S((i = e.input.charCodeAt(e.position + 1))) ||
                                (n && E(i)))
                            )
                              return !1;
                            for (
          ...
          function $(e) {
            ...
            for (
              ...
              0 !== r && U(e),
                y.call(M, n)
                  ? M[n](e, n, i)
                  : N(e, 'unknown document directive "' + n + '"');
            }
            q(e, !0, -1),
              0 === e.lineIndent &&
          ...
          (t.exports.loadAll = G),
            ...
            (t.exports.safeLoadAll = function (e, t, n) {
              if ("function" != typeof t)
                return G(e, g.extend({ schema: o }, n));
              G(e, t, g.extend({ schema: o }, n));
            }),
            (t.exports.safeLoad = function (e, t) {
              return V(e, g.extend({ schema: o }, t));
            });
        },
        {
          "./common": 2,
