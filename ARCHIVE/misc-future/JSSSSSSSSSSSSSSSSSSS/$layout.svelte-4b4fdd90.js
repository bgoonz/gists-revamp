...
function Q(t, e, l) {
  ...
  return (
    (t.$$set = (t) => {
      l(2, (e = n(n({}, e), g(t)))),
        "href" in t && l(0, (i = t.href)),
        "$$scope" in t && l(5, (o = t.$$scope));
    }),
    (t.$$.update = () => {
      16 & t.$$.dirty &&
        l(
          3,
          (s = /self-hosted\/\d\.\d\.\d/.test(c.path)
            ? c.path.replace(/\d\.\d\.\d/, "latest")
            : c.path)
        ),
    ...
    p(t, l) {
      if (1 & l) {
        ...
        for (s = t[0].subMenu, r = 0; r < s.length; r += 1) {
          ...
          n[r]
            ? (n[r].p(c, l), $(n[r], 1))
            : ((n[r] = Z(c)), n[r].c(), $(n[r], 1), n[r].m(e, null));
        }
...
function tt(t) {
  ...
  return {
    ...
    h() {
      v(l, "class", "menu-container svelte-kua03s"),
        h(l, "isActiveSection", t[1]),
        v(e, "class", "menu-item svelte-kua03s");
    },
    m(t, r) {
    ...
    (t.$$.update = () => {
      5 & t.$$.dirty &&
        l(
          ...
          (s = n
            ? r.path.indexOf(
                /self-hosted\/\d\.\d\.\d/.test(n)
                  ? n.replace(/\d\.\d\.\d/, "latest")
                  : n
              ) >= 0
            : /\/docs\/?$/.test(r.path))
        );
    ...
    p(t, [l]) {
      if (1 & l) {
        ...
        for (s = t[0], r = 0; r < s.length; r += 1) {
          ...
          n[r]
            ? (n[r].p(c, l), $(n[r], 1))
            : ((n[r] = nt(c)), n[r].c(), $(n[r], 1), n[r].m(e, null));
        }
        for (M(), r = s.length; r < n.length; r += 1) i(r);
        j();
      }
...
function it(t) {
  ...
  return {
    ...
    l(t) {
      ...
      var s = a(e);
      (l = c(s, "IMG", { class: !0, src: !0, alt: !0, width: !0, height: !0 })),
        s.forEach(o),
        this.h();
    },
    h() {
    ...
    p(t, [e]) {
      if (3 & e) {
        ...
        for (n = t[0], s = 0; s < n.length; s += 1) {
          ...
          i[s]
            ? (i[s].p(r, e), $(i[s], 1))
            : ((i[s] = pt(r)), i[s].c(), $(i[s], 1), i[s].m(l, null));
        }
  ...
  return {
    ...
    h() {
      ...
      v(i, "class", "toggle-button__label svelte-1dtjh89"),
        v(
          ...
          "class",
          (g =
            L("toggle-button__icon-arrow " + (t[2] ? "open" : "")) +
            " svelte-1dtjh89")
        ),
        ...
        v(
          x,
          "class",
          (C = L("px-4 " + (t[2] ? "block" : "hidden")) + " svelte-1dtjh89")
        ),
        v(x, "id", "sub-menu"),
    ...
    p(t, e) {
      ...
      if (
        ...
        let l;
        for (
          K = null == (s = t[0]) ? void 0 : s.subMenu, l = 0;
          l < K.length;
          l += 1
        ) {
          const s = wt(t, K, l);
          P[l]
            ? (P[l].p(s, e), $(P[l], 1))
            : ((P[l] = xt(s)), P[l].c(), $(P[l], 1), P[l].m(y, null));
        }
        for (M(), l = K.length; l < P.length; l += 1) G(l);
        j();
      }
      (!A || (1 & e && V !== (V = null == (r = t[0]) ? void 0 : r.title))) &&
        v(x, "aria-label", V),
        (!A ||
          (4 & e &&
            C !==
              (C =
                L("px-4 " + (t[2] ? "block" : "hidden")) +
                " svelte-1dtjh89"))) &&
          v(x, "class", C);
    },
    i(t) {
  ...
  return {
    ...
    h() {
      v(e, "rel", "stylesheet"),
        v(
          e,
          "href",
          "https://cdn.jsdelivr.net/npm/docsearch.js@" +
            Vt +
        ...
        l.src !==
          (s =
            "https://cdn.jsdelivr.net/npm/docsearch.js@" +
            Vt +
            "/dist/cdn/docsearch.min.js") && v(l, "src", s),
        v(f, "for", Ct),
        v(f, "class", "sr-only"),
        v(p, "class", "input-icon svelte-123f4xb"),
        p.src !== (m = "/svg/mag-glass.svg") &&
          v(p, "src", "/svg/mag-glass.svg"),
        v(p, "alt", "Search"),
        ...
        v(
          ...
          (E =
            L(
              "input-container relative bg-white rounded-xl w-full mb-12 " +
                (t[3] ? "topics-active" : "")
            ) + " svelte-123f4xb")
        );
    },
    m(s, r) {
      I(document.head, e),
        ...
        t[8](b),
        x ||
          ((y = [D(l, "load", t[4]), D(document.body, "keydown", t[5])]),
          (x = !0));
    },
    p(t, [e]) {
  ...
  return (
    K(() => {
      if (!navigator.userAgent.toLowerCase().match(/mobile/i)) {
        const t = /(Mac|iPhone|iPod|iPad)/i.test(navigator.platform)
          ? "⌘"
          : "Ctrl";
        l(2, (a += ` ${t}+K`));
      }
...
function qt(t) {
  ...
  (n = new at({ props: { MENU: O } })),
    (d = new At({})),
    (g = new St({ props: { MENU: O } }));
  const N = t[1].default,
    U = s(N, t, t[0], null);
  return {
    c() {
    ...
    h() {
      v(l, "class", "menu svelte-ynf0i0"),
        v(h, "class", "doc-contents svelte-ynf0i0"),
        v(e, "class", "docs-layout row svelte-ynf0i0");
    },
    m(t, s) {
      u(t, e, s),
        I(e, l),
