...
function E(e) {
  ...
  return {
    ...
    l(e) {
      ...
      var s = r(l);
      (a = t(s, "DIV", { "aria-label": !0, class: !0, style: !0 })),
        r(a).forEach(o),
        s.forEach(o),
        this.h();
    },
    h() {
      c(
        a,
        "aria-label",
        (h = `${"blog" === e[2] ? "Blog post" : "Guide"}: ${e[0].title}`)
      ),
        c(
          a,
          "class",
        ...
        c(
          a,
          "style",
          (u = `background-image: url(/images/${e[2]}/${e[0].slug}/${e[0].image});`)
        ),
...
function D(e) {
  ...
  return {
    ...
    h() {
      c(a, "href", (u = "/" + e[2] + "/" + e[0].slug)),
        c(a, "sveltekit:prefetch", ""),
        c(a, "class", "svelte-i5xvka"),
        c(l, "class", "svelte-i5xvka");
    },
    m(e, s) {
      i(e, l, s), n(l, a), n(a, h);
    ...
    p(e, l) {
      1 & l && d !== (d = e[0].title + "") && p(h, d),
        5 & l && u !== (u = "/" + e[2] + "/" + e[0].slug) && c(a, "href", u);
    },
    d(e) {
      e && o(l);
    },
...
function A(e) {
  let l,
    ...
    F = e[0].excerpt + "",
    J =
      new Date(Date.parse(e[0].date)).toLocaleDateString(void 0, {
        year: "numeric",
        month: "short",
        day: "numeric",
      }) + "",
  ...
  return (
    ...
    })),
    {
      ...
      l(e) {
        ...
        v(V.$$.fragment, f),
          (G = d(f)),
          (B = t(f, "A", { href: !0, class: !0, "sveltekit:prefetch": !0 }));
        var u = r(B);
        (H = g(u, J)),
          u.forEach(o),
          f.forEach(o),
