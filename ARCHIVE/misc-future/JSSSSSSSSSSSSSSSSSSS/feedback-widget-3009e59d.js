...
function D(t) {
  ...
  return {
    ...
    l(t) {
      ...
      var s = o(e);
      (a = r(s, "IMG", { src: !0, alt: !0, title: !0, class: !0 })),
        (n = h(s)),
        s.forEach(i),
        this.h();
    },
    h() {
      a.src !== (l = "/images/docs/feedback-widget/" + (t[12] + 1) + ".svg") &&
        f(a, "src", l),
    ...
    h() {
      f(b, "class", "mb-6 text-center justify-center w-full"),
        f(
          a,
          "class",
          "bg-white shadow-normal rounded-2xl max-w-md py-small px-xx-small m-auto"
        ),
