...
!(function (e, r) {
  ...
  function C(e, r) {
    ...
    return (
      ...
      e.host !== undefined &&
        t.push(
          m(v(String(e.host), n), n).replace(n.IPV6ADDRESS, function (e, r, n) {
            return "[" + r + (n ? "%25" + n : "") + "]";
          })
        ),
      "number" == typeof e.port && (t.push(":"), t.push(e.port.toString(10))),
  ...
  function y(e) {
    for (var r = []; e.length; )
      ...
      else if (e.match(ee)) (e = e.replace(ee, "/")), r.pop();
      else if ("." === e || ".." === e) e = "";
      else {
        var n = e.match(re);
    ...
    if ((o && o.serialize && o.serialize(e, r), e.host))
      if (n.IPV6ADDRESS.test(e.host));
        ...
        try {
          e.host = r.iri
            ? Y.toUnicode(e.host)
            : Y.toASCII(e.host.replace(n.PCT_ENCODED, d).toLowerCase());
        } catch (u) {
          e.error =
            e.error ||
  ...
  function O(e, r) {
    return (
      e && e.toString().replace(r && r.iri ? N.PCT_ENCODED : F.PCT_ENCODED, d)
    );
  }
  function I(e) {
    var r = d(e);
  ...
  var F = u(!1),
    ...
    ie = "[0-9A-Fa-f]",
    ue = n(
      n("%[EFef][0-9A-Fa-f]%" + ie + ie + "%" + ie + ie) +
        "|" +
        n("%[89A-Fa-f][0-9A-Fa-f]%" + ie + ie) +
        "|" +
        n("%" + ie + ie)
    ),
    se = r(
    ...
    le = {
      ...
      serialize: function (e, r) {
        ...
        for (var g in d)
          d[g] !== oe[g] &&
            l.push(
              g.replace(ce, I).replace(ce, o).replace(he, h) +
                "=" +
                d[g].replace(ce, I).replace(ce, o).replace(de, h)
            );
