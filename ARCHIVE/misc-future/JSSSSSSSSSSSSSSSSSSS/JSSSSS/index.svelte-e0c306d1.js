  ...
  return {
    ...
    l(t) {
      ...
      (X = w(et, "Star")),
        ...
        (Q = o(s, "DIV", { class: !0 }));
      var at = r(Q);
      (tt = o(at, "IMG", { src: !0, alt: !0, width: !0, height: !0 })),
        at.forEach(i),
        s.forEach(i),
        this.h();
    },
    h() {
      c(n, "class", "homeh1"),
        ...
        q.src !== (Y = "/svg/bitbucket.svg") &&
          c(q, "src", "/svg/bitbucket.svg"),
        ...
        tt.src !== (et = "/images/illustration-large.jpg") &&
          c(tt, "src", "/images/illustration-large.jpg"),
...
function tt(t, e, a) {
  let s;
  u(async () => {
    (await B(() => import("../chunks/buttons.esm-5c49e7fd.js"), void 0)).render(
      s,
      (t) => {
...
function st(t) {
  ...
  return {
    ...
    l(t) {
      ...
      var s = r(e);
      (a = o(s, "IMG", { src: !0, alt: !0, width: !0, height: !0 })),
        (l = E(s)),
        (g = w(s, u)),
        (p = E(s)),
        s.forEach(i),
  ...
  return {
    ...
    h() {
      c(a, "class", "mb-small text-center text-h2"),
        ...
        g.src !== (p = "/images/gitpod-editor.jpg") &&
          c(g, "src", "/images/gitpod-editor.jpg"),
        c(g, "alt", "Gitpod"),
        c(g, "height", "819"),
        c(g, "width", "1269"),
...
function it(t) {
  ...
  return {
    ...
    h() {
      c(e, "class", "flex overflow-x-scroll space-x-6 svelte-13fysql"),
        c(e, "dir", "ltr");
    },
    m(t, s) {
...
function gt(t) {
  ...
  return {
    ...
    l(t) {
      e = o(t, "A", { href: !0, target: !0, rel: !0, class: !0 });
      var s = r(e);
      (a = o(s, "IMG", { src: !0, alt: !0, style: !0, class: !0 })),
        s.forEach(i),
        this.h();
    },
    h() {
...
function pt(t, e, a) {
  ...
  return (
    ...
    [
      ...
      s,
      () =>
        window.analytics.track("socialproof_clicked", { type: "logo", url: n }),
    ]
  );
}
class dt extends t {
    ...
    p(t, [a]) {
      if (0 & a) {
        ...
        for (n = z, s = 0; s < n.length; s += 1) {
          ...
          l[s]
            ? (l[s].p(o, a), p(l[s], 1))
            : ((l[s] = ut(o)), l[s].c(), p(l[s], 1), l[s].m(e, null));
        }
  ...
  return {
    ...
    l(s) {
      ...
      (n = o(h, "DIV", {})),
        ...
        (g = o(h, "DIV", { class: !0 }));
      var d = r(g);
      (p = o(d, "IMG", { src: !0, alt: !0, class: !0, width: !0, height: !0 })),
        (f = E(d)),
        (u = o(d, "DIV", { class: !0 }));
      var v = r(u);
      m = o(v, "P", { class: !0 });
...
function bt(t, e, a) {
  ...
  return (
    (t.$$set = (t) => {
      "testimonial" in t && a(8, (s = t.testimonial)),
        "position" in t && a(0, (g = t.position));
    }),
    [
      g,
      n,
      ...
      () =>
        window.analytics.track("socialproof_clicked", {
          type: "tweet",
          url: `https://twitter.com/${c}/status/${h}`,
          position: g,
        }),
    ]
  );
    ...
    p(t, a) {
      if (1 & a) {
        ...
        for (s = t[0], r = 0; r < s.length; r += 1) {
          ...
          n[r]
            ? (n[r].p(o, a), p(n[r], 1))
            : ((n[r] = yt(o)), n[r].c(), p(n[r], 1), n[r].m(e.parentNode, e));
        }
...
function Et(t) {
  ...
  return (
    (b = new ht({
      props: { $$slots: { default: [xt] }, $$scope: { ctx: t } },
    })),
    (y = new vt({})),
    {
      c() {
        (e = s("div")),
          (a = s("h2")),
          (u = v("Used by 400,000+ developers.")),
          (m = x()),
          n(b.$$.fragment),
          (k = x()),
          n(y.$$.fragment),
...
function _t(t) {
  ...
  return {
    ...
    l(s) {
      ...
      a = o(l, "DIV", { class: !0 });
      var c = r(a);
      (n = o(c, "IMG", { src: !0, alt: !0, class: !0, width: !0, height: !0 })),
        (g = E(c)),
        (p = o(c, "P", { class: !0 }));
      var h = r(p);
      (d = w(h, t[2])),
    ...
    h() {
      n.src !== (l = `/${t[0]}`) && c(n, "src", l),
        ...
        c(
          p,
          "class",
          "leading-5 text-h6 text-gray-800 font-semibold transition duration-200 group-focus:text-black group-hover:text-black"
        ),
...
function Vt(t) {
  ...
  return {
    ...
    l(t) {
      e = o(t, "H3", {});
      var s = r(e);
      (a = w(s, "Launch an example workspace")),
        s.forEach(i),
        (n = E(t)),
        (l = o(t, "P", { class: !0 }));
      var c = r(l);
      (g = w(c, "Dive into one of our example workspaces")),
        c.forEach(i),
        (f = E(t)),
        (u = o(t, "DIV", { class: !0 }));
      var h = r(u);
    ...
    p(t, [e]) {
      if (0 & e) {
        ...
        for (b = O, a = 0; a < b.length; a += 1) {
          ...
          k[a]
            ? (k[a].p(s, e), p(k[a], 1))
            : ((k[a] = Lt(s)), k[a].c(), p(k[a], 1), k[a].m(u, null));
        }
    ...
    l(t) {
      ...
      (B = w(G, "GitHub Octocat")),
        ...
        (R = o(
          I,
          "path",
          { "fill-rule": !0, "clip-rule": !0, d: !0, fill: !0 },
          1
        )),
        r(R).forEach(i),
        I.forEach(i),
    ...
    h() {
      c(l, "class", "text-large"),
        ...
        c(
          y,
          "d",
          "M27.476 10.954l1.637 4.94c.148.449-.012.944-.403 1.223L14.584 27.214l12.892-16.26z"
        ),
        c(y, "fill", "#fff"),
        c(y, "fill-opacity", ".65"),
        c(
          _,
          "d",
          "M27.476 10.954h-7.527l3.24-9.793c.165-.5.888-.5 1.06 0l3.227 9.793z"
        ),
        c(_, "fill", "#fff"),
        c(
          D,
          "d",
          "M1.685 10.954l-1.63 4.94c-.148.449.012.944.403 1.223l14.127 10.097-12.9-16.26z"
        ),
        c(D, "fill", "#fff"),
        c(D, "fill-opacity", ".65"),
        c(
          C,
          "d",
          "M1.685 10.954H9.21L5.978 1.161c-.166-.5-.888-.5-1.06 0l-3.233 9.793z"
        ),
        c(C, "fill", "#fff"),
