! function(t) {
    ...
    e.mergeDeep = function() {
        ...
        return t.forEach(function(t) {
            Object.keys(t).forEach(function(n) {
                var i = r[n],
                    s = t[n];
                void 0 !== s && (Array.isArray(i) || Array.isArray(s) ? r[n] = s : o(i) && o(s) ? r[n] = e.mergeDeep(i, s) : r[n] = s)
            })
        }), r
        ...
        return new Promise(function(n, o) {
            e.onreadystatechange = function() {
                4 === e.readyState && (e.status >= 200 && e.status < 300 ? n(e.response) : o(new Error("Request failed with status " + e.status)))
    ...
    e.trackOperation = function(t, e) {
        return o(this, void 0, void 0, function() {
            return r(this, function(n) {
                switch (n.label) {
                    case 0:
                        if (!s || !t.widgetTrackerUrl || a.indexOf(e) >= 0 || u.indexOf(window.location.hostname) >= 0) return [2, !1];
                        n.label = 1;
                    case 1:
                        return n.trys.push([1, 3, , 4]), [4, i.request(t.widgetTrackerUrl + "/track/operation?key=" + t.key + "&operation=" + e + "&domain=" + window.location.hostname)];
                    case 2:
                        return n.sent(), [2, !0];
                    case 3:
                        return n.sent(), [2, !1];
        ...
        return o(this, void 0, void 0, function() {
            ...
            return r(this, function(o) {
                switch (o.label) {
                    case 0:
                        if (!s || !t.widgetTrackerUrl || u.indexOf(window.location.hostname) >= 0) return [2, !1];
                        if (0 === (n = e.filter(function(t) {
                                return c.indexOf(t) < 0
                            })).length) return [2, !1];
                        o.label = 1;
                    case 1:
                        return o.trys.push([1, 3, , 4]), [4, i.request(t.widgetTrackerUrl + "/track/options?key=" + t.key + "&options=" + n.join(",") + "&domain=" + window.location.hostname)];
                    case 2:
                        return o.sent(), [2, !0];
                    case 3:
                        return o.sent(), [2, !1];
    ...
    (function(t) {
        ...
        }, a.prototype.finally = o.a, a.all = function(t) {
    ...
    if (window.smartsupp || (window.smartsupp = function() {
        ...
        window.SMARTSUPP_LOADED = !0, window.$smartsupp = new o.SmartsuppLoader({
            widgetVersion: 1,
        ...
        for (var i = 0, s = ["create", "createWidget", "getChat", "getWidget", "setDefaults"]; i < s.length; i++) {
            var a = s[i];
            window.smartsupp[a] = window.$smartsupp[a].bind(window.$smartsupp)
        }!1 !== window.SMARTSUPP_AUTOCREATE && r(function() {
    ...
    (function(t, e) {
        ! function(t, n) {
            ...
            if (!t.setImmediate) {
                ...
                }) : f && "onreadystatechange" in f.createElement("script") ? (r = f.documentElement, o = function(t) {
                ...
                }, t.addEventListener ? t.addEventListener("message", a, !1) : t.attachEvent("onmessage", a), o = function(e) {
                    t.postMessage(s + e, "*")
    ...
    var o = n(3),
        ...
        s = function() {
            ...
            return t.prototype.setDefaults = function(t) {
                ...
                return c._initPromise = r.request(u.bootstrapUrl + "/widget/" + u.key + ".json").then(function(t) {
                    var n = r.parseJSON(t);
                    delete e.features, c.init(r.mergeDeep(n, n.config, e), n.features), e && e.key && o.trackOptions(c.options, Object.keys(e)), s && s(void 0, c), c.options.renderTo && c.render(c.options.renderTo)
                }).catch(function(t) {
                    s && s(t)
                }), c
                ...
                return a(u), r.request(u.bootstrapUrl + "/widget/" + u.key + ".json").then(function(a) {
                    var c = r.parseJSON(a),
                        l = s.widgets[t] = new i.SmartsuppWidget(t, u, n);
                    return delete e.features, l.init(r.mergeDeep(c, c.config, e), c.features), e && e.key && o.trackOptions(l.options, Object.keys(e)), l
                })
            }, t
        }();
    e.SmartsuppLoader = s;
    ...
    var s = n(3),
        ...
        c = function() {
            ...
            return t.prototype.setOptions = function(t) {
                ...
                return t.id = this.id + "-application", t.setAttribute("style", "display: none"), t.style.zIndex = this.options.zIndex ? "" + (this.options.zIndex + 1) : null, t.style.position = this.options.position, t
            }, t.prototype.createFrame = function() {
                var t = document.createElement("iframe");
                return t.id = this.id + "-application-iframe", t.setAttribute("title", "Smartsupp"), t.setAttribute("aria-hidden", "true"), t.setAttribute("style", "width: 100%; height: 100%; border: none"), t.style.zIndex = this.options.zIndex ? "" + (this.options.zIndex + 1) : null, t
                    ...
                    return i(this, function(n) {
                        switch (n.label) {
                            ...
                            case 2:
                                ...
                                if (!t && this.options.renderTo && (t = this.options.renderTo), t && (this.options.zIndex = null), !(e = a.resolveTargetElement(t))) throw new Error("target element not found");
                                return this.el = this.createContainer(), [4, this.renderFrame(this.el, e)];
                            case 3:
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return i(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return n = this.frame = this.createFrame(), t.appendChild(n), e.childNodes.length > 0 ? e.insertBefore(t, e.childNodes[0]) : e.appendChild(t), [4, a.request(this.getBaseUrl() + "/asset-manifest.json").then(function(t) {
                                    return a.parseJSON(t)
                                })];
                            case 1:
                                return o = i.sent(), (r = a.getFrameDocument(n)).open(), r.write('<!DOCTYPE html>\n\t\t<html lang="en">\n\t\t\t<head>\n\t\t\t\t<title>Smartsupp Chat</title>\n\t\t\t\t<meta charset="utf-8" />\n\t\t\t\t<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0" />\n\t\t\t</head>\n\t\t\t<body id="body" data-smartsupp-id="' + this.id + '">\n\t\t\t\t<div id="root" />\n\t\t\t</body>\n\t\t</html>'), s = r.getElementsByTagName("head")[0], o.entrypoints.forEach(function(t) {
                ...
                this.el && this.el.parentNode && (this.el.parentNode.removeChild(this.el), delete this.el)
                ...
                var e = this;
                if (this.api = t, u.smartsupp.api = t, this._pushApi && (this._pushApi.forEach(function(n) {
                        var o = Array.prototype.slice.call(n, 0);
                        try {
                            e.options.widgetTrackerEnabled && s.trackOperation(e.options, o[0]), t.execute(o)
                        } catch (t) {
                            console.log(t)
                        }
                ...
                this.options.smartlook && this.isAllowedSmartlook() && this.initSmartlook(o({}, this.options.smartlook, {
                    cookieDomain: this.options.cookieDomain,
                    cookiePath: this.options.cookiePath
                }))
            }, t.prototype.isAllowedSmartlook = function() {
                return !u.smartlook && (!(!this.options.smartlook || !this.options.smartlook.enabled) && !this.options.recordingOff)
            }, t.prototype.initSmartlook = function(t) {
                this.smartlook = u.smartlook = function() {
                    u.smartlook.api.push(arguments)
                }, u.smartlook.api = [];
                var e = window.document.getElementsByTagName("head")[0],
                    n = window.document.createElement("script");
                n.async = !0, n.type = "text/javascript", n.charset = "utf-8", n.crossOrigin = "anonymous", n.src = t.scriptUrl, e.appendChild(n), this.smartlook("init", t.key, {
                    host: t.serverHost,
                    cookieDomain: t.cookieDomain,
                    cookiePath: t.cookiePath
                }), this.smartlook("expertForms"), this.smartlook("expertAPI"), this.options.recordingDisable && this.smartlook("disable")
            }, t
        }();
    e.SmartsuppWidget = c
}, function(t, e, n) {
    ...
    t.exports = function() {
        ...
        return !i && o && o.addEventListener("DOMContentLoaded", e = function() {
