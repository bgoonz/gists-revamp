atwpjp([216, 210], {
  ...
  360: function (e, t, a) {
    ...
    var n = a(5);
    e.exports = function (e) {
      if (window.addthis_config && window.addthis_config._forceClientMobile)
        return !1;
      var t = n("mob", e),
        a = t && window.screen,
  ...
  453: function (e, t, a) {
    ...
    function s(e, t, a) {
      return (
        e.length > t &&
          ((e = e.slice(0, t - 1)), a && e[e.length - 1] !== a && e.push(a)),
        e
      );
    }
    ...
    function p(e, t) {
      if ((e = d(e))) {
        ...
        e.className.indexOf(t) !== -1 &&
          (e.className = e.className.split(t).join(" "));
      }
    }
    ...
    function g(e, t) {
      return (
        (e = d(e)),
        e && e.parentNode && (e.parentNode.className || "").indexOf(t) > -1
      );
    }
      ...
      return (
        e &&
          (window.innerHeight && window.scrollMaxY
            ...
            ? ((n = a.scrollWidth), (i = a.scrollHeight))
            : ((n = a.offsetWidth), (i = a.offsetHeight))),
        window.self && window.self.innerHeight
          ? ((o = window.self.innerWidth), (r = window.self.innerHeight))
          : t && t.clientHeight
          ? ((o = t.clientWidth), (r = t.clientHeight))
          : a && (a.clientWidth || a.clientHeight)
          ? ((o = a.clientWidth), (r = a.clientHeight))
          : a && ((o = a.clientWidth), (r = a.clientHeight)),
        [e !== !0 || n < o ? o : n, e !== !0 || i < r ? r : i]
      );
    }
    ...
    var k = a(18),
      ...
      U = function () {
        9 === _ate.maf.key
          ? (_ate.maf.key = null)
          : ((_ate.maf.key = null), addthis_close());
      },
      L = function (e, t) {
    ...
    if (!window._atw || l(window._atw)) {
      ...
      (window._atw = {
        ...
        clb: function () {
          return (
            (_atw.mck = 0),
            _atw.addthis_popup_mode
              ? window.close()
              : (h("at16lb"),
                h("at16p"),
                h("at15s"),
                p("at15s_head", "at15s_head_success"),
                h("at15s"),
                (_ate.maf || {}).pre && _ate.maf.pre.focus()),
            _atw.sta &&
              "compact" !== _atw.sta &&
              (_ate.ed.fire("addthis.menu.close", window.addthis || {}, {
                pane: _atw.sta,
        ...
        sho: function (e) {
          ...
          if (
            ...
            "share" === e || "" === e || "bkmore" === e
              ? ("bkmore" === e
                  ? ((l = c = !0), u(_atw.did, "mmborder"))
                  : ((e = "share"),
                    (i.style.display = ""),
                    p(_atw.did, "mmborder")),
                h(o),
                _atw.conf.ui_use_vertical_menu && h("at15s_head"),
                m(a),
                S.ipa && r("at16lb"),
                s && (s.innerHTML = addthis_caption_share))
              : (_atw.mck++,
                "more" !== e
                  ? (("bkemail" === e || _atw.ibm()) &&
                      (u(_atw.did, "mmborder"), (c = !0)),
                    _atw.rse(),
                    h(n),
                    (s.innerHTML = addthis_caption_email))
                  : (m(n), s && (s.innerHTML = addthis_caption_share)),
                (l = !0)),
            l || c)
          ) {
            var f = "bkmore" === e;
            ...
            if (
              (b(t, g[0] - C),
              v(t, g[1] - C),
              (o.style.marginTop = Math.max(0, x[1] / 2 - 222.5) + "px"),
              !f && (m(o), "more" === e))
            ) {
              b(o, 300);
              var k = d("at16filt");
          ...
          if (_atw.show-- > 0) {
            ...
            O && _atw.csl && (O = O.split(_atw.csl).shift().replace(/,$/, "")),
              O || _atw.crs || !_ || _ === addthis_options_default
                ? O && O !== _atw.crs && (E = window.addthis_ssh)
                : (I = A),
        ...
        dut: function (e, t) {
          ...
          return (
            (addthis_url = e),
            (addthis_title = t),
            ("" !== a && "[url]" !== a && "<data:post.url/>" !== a) ||
              (addthis_url = location.href),
            ("" !== n && "[title]" !== n && "<data:post.title/>" !== n) ||
              (addthis_title = document.title),
            [addthis_url, addthis_title]
          );
        },
        menu: function (e, t, n, r) {
          ...
          if (_atw.ost) {
            ...
            b && (b.innerHTML = y),
              v && (v.innerHTML = y),
              C && (C.innerHTML = window.addthis_caption_share),
              c("at15s_head", "backgroundColor", A),
              c("at16pt", "backgroundColor", A),
              c("at16ptx", "color", k),
              c("at16pt", "color", k),
              c("at16ptc", "color", k),
              c("at15s_brand", "color", k),
              c("at16ptc", "color", k),
              _atw.conf.ui_use_close_control
                ? (u("at15s_brand", "at15s_brandx"), p("at15sptx", "at15dn"))
                : (p("at15s_brand", "at15s_brandx"), u("at15sptx", "at15dn"));
          } else {
            if ((o(_atw.hkd), !_atc.ostm)) {
              if (
                !window.addthis_product ||
                0 !== window.addthis_product.indexOf("f")
              )
                for (V in window.addthis_conf)
                  window.addthis_conf.hasOwnProperty(V) &&
                    (_atc[V] = window.addthis_conf[V]);
            ...
            _atw.excluded = F;
            var G = (_atw.conf.services_compact || addthis_options_default)
              .replace(/\s/g, "")
              .replace(/\*/, "");
            "" === I() &&
              B.indexOf("ffext") == -1 &&
              B.indexOf("fxe") == -1 &&
              (G = G.replace(/^email(?:,)|,email/g, "")),
              (G = G.split(","));
            ...
            for (
              var X,
                ...
                $ = a(30).isBrandingReduced(),
                ee = !S.ipa && _atw.conf.ui_use_vertical_menu,
                te = m
                  .div(K.generateBranding($))
                  .css(ee ? "atm-f" : "")
                  .id("at15pf"),
                ae = m
                  .div(
                    m.span(addthis_caption_share).id("at15ptc"),
                    m
                      .span(_atw.conf.ui_cobrand)
                      .id("at15s_brand")
                      .css(
                        _atw.conf.ui_use_close_control ? "at15s_brandx" : ""
                      ),
                    m
                      .a("X")
                      .id("at15sptx")
                      .css(_atw.conf.ui_use_close_control ? "" : "at15dn")
                      .href("#")
                      .attr("tabindex", "9000")
                      .attr("onclick", "return _atw.clb()")
                      .attr(
                        "onkeydown",
                        "if(!e){var e = window.event||event;}if(e.keyCode){_ate.maf.key=e.keyCode;}else{if(e.which){_ate.maf.key=e.which;}}if(_ate.maf.key==9){ addthis_close(); _ate.maf.sib.tabIndex=9001;_ate.maf.sib.focus();}else{/*alert(_ate.maf.key)*/} _ate.maf.key=null"
                      )
                  )
                  .id("at15s_head"),
                ne =
                  "ja,fr,he,it,af,ga,el,tl,ro,ru,ms,mk,az,zh,sq,te,be,ta,uk,ml,eu,se,su,aze,gre,tra,fre,gdh,jpn,mac,mak,msa,may,ron,rum,rus,tam,tgl,ukr,zho",
            ...
            for (var V = 0; V < G.length; V++) {
              ...
              var se = _(),
                ...
                de = oe[le] || oe[E];
              if (E in _atw.list) {
                if (((T = _atw.list[E]), F[E] || "string" != typeof T))
                  continue;
                if (
                  ((O = M
                    ? R(E, M)
                    ...
                    ? ((X = m
                        .a(
                          ...
                          m
                            .span(
                              _atw.list[E] +
                                ("more" === E && ne.indexOf(se) === -1
                                  ? " (" + Q + ")"
                                  : "")
                            )
                            .css("at-label", de ? " at_bold" : "", "at-size-16")
                        )
                        .id("atic_" + E)
                        .href("#")),
                      (q = X.element),
                      q.addEventListener
                        ? (q.addEventListener("keypress", N, !1),
                          q.addEventListener("keydown", D, !1),
                          q.addEventListener("blur", U, !1),
                          q.addEventListener("click", L.bind(null, E), !1))
                        : q.attachEvent &&
                          (q.attachEvent("onkeypress", N),
                          q.attachEvent("onkeydown", D),
                          q.attachEvent("onblur", U),
                          q.attachEvent("onclick", L.bind(null, E))))
                    : (X = m
                        .a(
                          O,
                          m
                        ...
                        .css(
                          "at_item " +
                            (S.ipa ? "addthis_16x16_style " : "") +
                            (de ? " at_bold" : "") +
                            " at_col" +
                            (V % 2)
                        )
                        .attr("onclick", "return addthis_sendto('" + E + "');")
                        .attr("onmouseover", l.bro.ipa ? "" : "_atw.shv(this)")
                        .attr("onmouseout", l.bro.ipa ? "" : "_atw.rhv(this)")
                        .attr("tabindex", V + 2)),
                  re.push(X),
                  0 === V && (_ate.maf.firstCompact = "atic_" + E));
              }
            }
            ...
            var ce = m
                .div()
                .id("at20mc")
                .style("z-index:1000000;position:static")
                .css(S.ipa ? "ipad" : "")
                .html(P).element,
              he = m
                .div(re)
            ...
            var ue = m
              ...
              .id(_atw.did)
              .css(ee ? " atm" : "")
              .attr("onmouseover", "_atw.xwa()")
              .attr(
                "onmouseout",
                "if (this.className.indexOf('border')==-1) addthis_close()"
              )
              .style(
                "z-index:1000000;position:absolute;display:none;visibility:hidden;top:0px;left:0px;"
              ).element;
          ...
          e.getElementsByTagName &&
            ((pe = e.getElementsByTagName("img")),
            (fe = e.getElementsByTagName("span"))),
            (ge = g(e, "addthis_counter") && fe && fe[0]),
            pe && pe[0]
              ? (e = pe[0])
              : (ge || (f(e, "addthis_button") && fe && fe[0])) && (e = fe[0]);
          var be = (offLeft = void 0);
          if (
            ((be =
              "undefined" != typeof (window.addthis_config || {}).ui_offset_top
                ? (window.addthis_config || {}).ui_offset_top || 0
                : _atw.conf.ui_offset_top || 0),
            "undefined" != typeof (window.addthis_config || {}).ui_offset_left
              ? (offLeft = (window.addthis_config || {}).ui_offset_left || 0)
              : (offLeft = _atw.conf.ui_offset_left || 0),
            _atw.sho(t, n),
            "more" !== t && "bkemail" !== t && !f(_atw.did, "mmborder"))
          ) {
            ...
            if (Ie) {
              ...
              (xe = Ce[0] / 2 - je / 2),
                (ye =
                  Re && "" != Re.style.marginTop
                    ? Re.style.marginTop
                    : Math.max(0, Ce[1] / 2 - 222.5) + "px"),
                (ye = ye.split("px").shift() - 8);
            } else {
              ...
              (0 !== Ne.height && 0 !== Ne.width) ||
                (Ne = e.parentElement.getBoundingClientRect());
              var Be = Ne.top > 0.66 * Le,
                Fe = Ee !== -1 && !ze,
                Pe = Be && Fe;
              if (Me || 1 === Ee || Pe) {
            ...
            var Ve = _ate.util.parent(e, ".addthis_bar"),
              ...
              Je = function (e) {
                return (
                  !(!window.getComputedStyle || null == e || e == document) &&
          ...
          (_ate.maf.key = "9"),
            _ate.maf && _ate.maf.sib && (_ate.maf.sib.tabIndex = "1000");
          try {
        ...
        evar: function () {
          try {
            var e,
              ...
              a = I(),
              i = _atw.ibt();
            (_atw.conf && !l(_atw.conf)) ||
              (_atw.conf = window.addthis_config || {});
            var o = _atw.conf.services_custom;
            if (
              ((_atw.share = _atw.share || window.addthis_share || {}),
              (_ate.bro.xp || _ate.bro.mob) && delete _atw.list.mailto,
              t(_atw.conf, "ui_use_vertical_menu", !0),
              (vertical = !S.ipa && _atw.conf.ui_use_vertical_menu),
              t(window, "addthis_wpl"),
              t(window, "addthis_caption_email", _atw.lang(M, 3)),
              t(window, "addthis_caption", _atw.lang(M, 1)),
              t(window, "addthis_use_addressbook", !1),
              t(window, "addthis_product", "men-" + _atw.ver),
              (_atw.list.settings = _atw.lang(M, 47) + "..."),
              (_atw.list.more = _atw.lang(M, 2)),
              (_atw.list.email = _atw.lang(M, 4)),
              (_atw.list.favorites = _atw.lang(M, 5)),
              (_atw.list.print = _atw.lang(M, 22)),
              t(window, "addthis_popup", !1),
              t(window, "addthis_popup_mode", !1),
              t(window, "addthis_url", ""),
              t(
                window,
                "addthis_append_data",
                !a || "addthis" == a.toLowerCase()
              ),
              t(window, "addthis_brand", ""),
              t(window, "addthis_title", ""),
              t(window, "addthis_content", ""),
              t(window, "addthis_email_note", _atc.enote ? _atc.enote : ""),
              t(window, "addthis_email_from", ""),
              t(window, "addthis_email_to", ""),
              t(window, "addthis_use_personalization", !0),
              t(
                window,
                "addthis_options_default",
                T.getPopServices().split(",").slice(0, 11).join(",") + ",more"
              ),
              t(window, "addthis_options_rank", T.getPopServices()),
              t(window, "addthis_options", addthis_options_default),
              t(window, "addthis_exclude", ""),
              t(window, "addthis_ssh", ""),
              t(window, "addthis_logo", ""),
              t(window, "addthis_logo_background", ""),
              t(window, "addthis_logo_color", ""),
              t(window, "addthis_header_background", ""),
              t(window, "addthis_header_color", ""),
              t(window, "addthis_caption_share", addthis_caption),
              t(window, "addthis_caption_feed", _atw.lang(M, 14)),
              t(window, "addthis_share", {}),
              S.ipa &&
                (addthis_exclude &&
                  addthis_exclude.indexOf("print") == -1 &&
                  (addthis_exclude += ","),
                (addthis_exclude += "print")),
              t(_atw.share, "type", "link"),
              t(_atw.share, "url", addthis_url),
              t(_atw.share, "title", addthis_title),
              t(_atw.share, "description", ""),
              t(_atw.share, "swfurl", ""),
              t(_atw.share, "modules", {}),
              t(_atw.share, "screenshot", ""),
              t(_atw.share, "author", ""),
              t(
                _atw.share,
                "email_template",
                window.addthis_email_template || ""
              ),
              t(
                _atw.share,
                "email_vars",
                window.addthis_email_vars
                  ? "string" == typeof addthis_email_vars
                    ? _ate.util.fromKV(addthis_email_vars)
                    : addthis_email_vars
                  : {}
              ),
              t(_atw.conf, "ui_cobrand", addthis_brand),
              t(_atw.conf, "ui_disable", !1),
              t(_atw.conf, "ui_508_compliant", !1),
              t(_atw.conf, "ui_window_panes", !1),
              t(
                _atw.conf,
                "ui_close_control",
                !_atw.conf.ui_cobrand && (_atw.conf.ui_click || _atw.ver >= 200)
              ),
              t(_atw.conf, "ui_click", _atw.conf.ui_window_panes),
              t(_atw.conf, "ui_email_note", addthis_email_note),
              t(
                _atw.conf,
                "ui_email_from",
                _ate.cookie.rck("_atfrom") || addthis_email_from || ""
              ),
              t(_atw.conf, "ui_email_to", addthis_email_to),
              t(_atw.conf, "ui_hover_direction", 0),
              t(_atw.conf, "ui_compact_direction", -1),
              t(_atw.conf, "ui_delay", window.addthis_hover_delay),
              t(_atw.conf, "ui_header_color", addthis_header_color),
              t(_atw.conf, "ui_header_background", addthis_header_background),
              t(_atw.conf, "ui_icons", !0),
              t(_atw.conf, "ui_use_mailto", !1),
              t(_atw.conf, "ui_use_addressbook", addthis_use_addressbook || i),
              t(_atw.conf, "ui_use_close_control", _atw.conf.ui_close_control),
              t(_atw.conf, "ui_open_windows", !1),
              t(_atw.conf, "data_ga_tracker", null),
              t(_atw.conf, "data_ga_property", null),
              t(_atw.conf, "data_omniture_collector", ""),
              t(_atw.conf, "pubid", window.addthis_pub),
              t(_atw.conf, "username", _atw.conf.pubid),
              t(_atw.conf, "product", addthis_product),
              t(
                _atw.conf,
                "data_track_clickback",
                addthis_append_data ||
                  _atw.conf.data_track_linkback ||
                  _ate.track.ctp(_atw.conf.product)
              ),
              t(_atw.conf, "services_custom", []),
              t(_atw.conf, "services_localize", M),
              t(_atw.conf, "services_expanded", ""),
              t(_atw.conf, "services_compact_org", _atw.conf.services_compact),
              t(_atw.conf, "services_exclude", addthis_exclude),
              (_atw.conf.services_exclude = _atw.conf.services_exclude.replace(
                /\s/g,
                ""
              )),
              t(
                "_atw.conf, services_exclude_natural",
                _atw.conf.services_exclude
              ),
              _atw.conf.parentServices &&
                Object.keys(_atw.conf.parentServices).forEach(function (e) {
                  _atw.conf.services_exclude +=
                    (_atw.conf.services_exclude.length > 1 ? "," : "") + e;
                }),
              (_ate.dbm = 1),
              o)
            )
              for (
                _atw.custom_list = _atw.custom_list || {},
                ...
                r.name &&
                  ...
                  r.url &&
                  n(r.url) &&
                  ((r.code = r.url = r.url.replace(/ /g, "")),
                  0 === r.code.indexOf("http") &&
                    (r.code = r.code.substr(
                      0 === r.code.indexOf("https") ? 8 : 7
                    )),
                  (r.code = r.code
                    .split("?")
                    .shift()
                    ...
                    .shift()
                    .toLowerCase()),
                  (_atw.custom_list[r.code] = r),
                  (_atw.list[r.code] = r.name),
                  (_atw.css[r.code] = {
            ...
            (_atw.crs = s.crs),
              (_atw.csl = s.csl),
              (_atw.conf.services_compact = (s.conf || {}).services_compact),
              t(_atw.conf, "services_compact", addthis_options);
          } catch (e) {
        ...
        (_ate.menu = a(457)()),
        (addthis.menu = _ate.menu.open),
        (addthis.menu.close = _ate.menu.close),
        (_ate.ao = function (e, t, a, n, i, o, r) {
          ...
          if (
            ...
            a && _ate.usu(a);
            var s = _atw.dut(a, n);
            _atw.share || (_atw.share = {}),
              a && (_atw.share.url = s[0]),
              n && (_atw.share.title = s[1]);
            var d = _atw.conf.ui_delay;
            if (d && "" === t) {
              if (
                ((d = Math.min(500, Math.max(50, d))),
                _atw.xhwa(),
                (_atw.hwa = null),
                "hwe" !== e)
              )
                return (
                  (_atw.hwe = e),
                  void (_atw.hwa = setTimeout(function () {
                    _ate.ao(
                      "hwe",
                      t,
                      a || _atw.share.url,
            ...
            return (
              _atw.conf.ui_window_panes === !0
                ? _ate.as("more", _atw.conf, _atw.share)
                : _atw.menu(e, t, a, n),
              _atw.sta ||
                ("more" === t ? (t = "expanded") : t || (t = "compact"),
                (_atw.sta = t),
        ...
        (_ate.ac = function () {
          _atw.xhwa(),
            ...
            (_atw.cwa = setTimeout(_atw.clo, _atc.cwait));
        }),
        (_ate.as = function (e, t, a) {
          var n,
            ...
            o = E(t);
          return (
            (a = _ate.util.extend(i || {}, _atw.share || {})),
            (t = _ate.util.extend(o || {}, _atw.conf || {})),
            (n = _ate.util.extend(a, t)),
            _ate.share.cleanly(e, n),
            !1
          );
        });
      for (; _ate.plo && _ate.plo.length > 0; ) {
        ...
        switch (W) {
          ...
          case "send":
            var H, G;
            P.length > 2 && ((H = P[2]), (G = P[3])),
              addthis_sendto(P[1], H, G);
            break;
          case "span":
            var V = d(P[1]);
            V &&
              ...
              (V.innerHTML =
                ...
                _atr +
                'static/btn/v2/lg-bookmark-en.gif" width="125" height="16" style="border:none;padding:0px" alt="AddThis" /></a>'));
            break;
          case "deco":
  ...
  456: function (e, t) {
    ...
    var a = [
      ...
      "Don't show these",
      "Sending message...",
      'We hate spam too! Please <a id="at16ecmc" href="#" onclick="_atw.rse();_atw.cef();return true" target="_blank">click here</a>  to confirm you are a real-live person.',
      "Settings",
      "Sorry, we couldn't send this email. Please try again in a few minutes.",
      ...
      "Subject",
      "Send this email with different services",
      "Type the moving letters",
      "Sign in and make sharing easier",
      "Watch a video",
      "Successfully signed in!",
      "Closing window in XXX seconds...",
      "Customize",
      "Account",
      "Send Email",
      "Feedback",
      "Share an idea, report a bug, or just let us know what you think.",
      "Need help?",
      "Send Feedback",
      ...
      "Remove",
      "Save Changes",
      "Personalize AddThis by selecting up to 10 of your favorite places to share.",
      "",
      "",
      ...
      "Hi",
      "Connect social accounts to activate Instant Share for Twitter and Facebook.",
      "Watch the video",
      "All accounts can be used to sign in and access the rest.",
      "Connect another account",
      "We'd be sorry to see you go, but you can delete your account at any time.",
      "Delete Account",
      "Disconnect",
      "Re-order this list using arrows",
      "Share",
      "Please enter a shorter note.",
      "We weren't able to send your email.",
      "Ok",
      "Oops!",
      "Follow",
      "Thanks for sharing",
      ...
      "Your email address",
      "By clicking the button above, you agree to the information above being sent to AddThis US servers.",
      "{count, plural, one{# SHARE} other{# SHARES}}",
      "Whois Lookup",
      "HTML Validator",
      "Email App",
      "Save",
  ...
  499: function (e, t, a) {
    ...
    e.exports = function () {
      var e = document.documentElement || {},
        ...
        a = 0;
      return (
        i("mob") && n(t.availWidth)
          ? (a = t.availWidth)
          : n(window.innerWidth)
          ? (a = window.innerWidth)
          : n(e.clientWidth) && (a = e.clientWidth),
        a
      );
    };
  },
  504: function (e, t, a) {
    ...
    var n = a(505);
    e.exports = function e(t, a) {
      return a && (a instanceof Element || 1 === a.nodeType)
    ...
    (t = e.exports = a(329)()),
      t.push([
        ...
        '#addthissmartlayerscssready{color:#bada55!important}.addthis-smartlayers,div#at4-follow,div#at4-share,div#at4-thankyou,div#at4-whatsnext{padding:0;margin:0}#at4-follow-label,#at4-share-label,#at4-whatsnext-label,.at4-recommended-label.hidden{padding:0;border:none;background:none;position:absolute;top:0;left:0;height:0;width:0;overflow:hidden;text-indent:-9999em}.addthis-smartlayers .at4-arrow:hover{cursor:pointer}.addthis-smartlayers .at4-arrow:after,.addthis-smartlayers .at4-arrow:before{content:none}a.at4-logo{background:url(data:image/gif;base64,R0lGODlhBwAHAJEAAP9uQf///wAAAAAAACH5BAkKAAIALAAAAAAHAAcAAAILFH6Ge8EBH2MKiQIAOw==) no-repeat left center}.at4-minimal a.at4-logo{background:url(data:image/gif;base64,R0lGODlhBwAHAJEAAP9uQf///wAAAAAAACH5BAkKAAIALAAAAAAHAAcAAAILFH6Ge8EBH2MKiQIAOw==) no-repeat left center!important}button.at4-closebutton{position:absolute;top:0;right:0;padding:0;margin-right:10px;cursor:pointer;background:transparent;border:0;-webkit-appearance:none;font-size:19px;line-height:1;color:#000;text-shadow:0 1px 0 #fff;opacity:.2}button.at4-closebutton:hover{color:#000;text-decoration:none;cursor:pointer;opacity:.5}div.at4-arrow{background-image:url(data:image/png;base64,);background-repeat:no-repeat;width:20px;height:20px;margin:0;padding:0;overflow:hidden;text-indent:-9999em;text-align:left;cursor:pointer}#at4-recommendedpanel-outer-container .at4-arrow.at-right,div.at4-arrow.at-right{background-position:-20px 0}#at4-recommendedpanel-outer-container .at4-arrow.at-left,div.at4-arrow.at-left{background-position:0 0}div.at4-arrow.at-down{background-position:-60px 0}div.at4-arrow.at-up{background-position:-40px 0}.ats-dark div.at4-arrow.at-right{background-position:-20px -20px}.ats-dark div.at4-arrow.at-left{background-position:0 -20px}.ats-dark div.at4-arrow.at-down{background-position:-60px -20px}.ats-dark div.at4-arrow.at-up{background-position:-40px -20}.at4-opacity-hidden{opacity:0!important}.at4-opacity-visible{opacity:1!important}.at4-visually-hidden{position:absolute;clip:rect(1px,1px,1px,1px);padding:0;border:0;overflow:hidden}.at4-hidden-off-screen,.at4-hidden-off-screen *{position:absolute!important;top:-9999px!important;left:-9999px!important}.at4-show{display:block!important;opacity:1!important}.at4-show-content{opacity:1!important;visibility:visible}.at4-hide{display:none!important;opacity:0!important}.at4-hide-content{opacity:0!important;visibility:hidden}.at4-visible{display:block!important;opacity:0!important}.at-wordpress-hide{display:none!important;opacity:0!important}.addthis-animated{animation-fill-mode:both;animation-timing-function:ease-out;animation-duration:.3s}.slideInDown.addthis-animated,.slideInLeft.addthis-animated,.slideInRight.addthis-animated,.slideInUp.addthis-animated,.slideOutDown.addthis-animated,.slideOutLeft.addthis-animated,.slideOutRight.addthis-animated,.slideOutUp.addthis-animated{animation-duration:.4s}@keyframes fadeIn{0%{opacity:0}to{opacity:1}}.fadeIn{animation-name:fadeIn}@keyframes fadeInUp{0%{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}.fadeInUp{animation-name:fadeInUp}@keyframes fadeInDown{0%{opacity:0;transform:translateY(-20px)}to{opacity:1;transform:translateY(0)}}.fadeInDown{animation-name:fadeInDown}@keyframes fadeInLeft{0%{opacity:0;transform:translateX(-20px)}to{opacity:1;transform:translateX(0)}}.fadeInLeft{animation-name:fadeInLeft}@keyframes fadeInRight{0%{opacity:0;transform:translateX(20px)}to{opacity:1;transform:translateX(0)}}.fadeInRight{animation-name:fadeInRight}@keyframes fadeOut{0%{opacity:1}to{opacity:0}}.fadeOut{animation-name:fadeOut}@keyframes fadeOutUp{0%{opacity:1;transform:translateY(0)}to{opacity:0;transform:translateY(-20px)}}.fadeOutUp{animation-name:fadeOutUp}@keyframes fadeOutDown{0%{opacity:1;transform:translateY(0)}to{opacity:0;transform:translateY(20px)}}.fadeOutDown{animation-name:fadeOutDown}@keyframes fadeOutLeft{0%{opacity:1;transform:translateX(0)}to{opacity:0;transform:translateX(-20px)}}.fadeOutLeft{animation-name:fadeOutLeft}@keyframes fadeOutRight{0%{opacity:1;transform:translateX(0)}to{opacity:0;transform:translateX(20px)}}.fadeOutRight{animation-name:fadeOutRight}@keyframes slideInUp{0%{transform:translateY(1500px)}0%,to{opacity:1}to{transform:translateY(0)}}.slideInUp{animation-name:slideInUp}.slideInUp.addthis-animated{animation-duration:.4s}@keyframes slideInDown{0%{transform:translateY(-850px)}0%,to{opacity:1}to{transform:translateY(0)}}.slideInDown{animation-name:slideInDown}@keyframes slideOutUp{0%{transform:translateY(0)}0%,to{opacity:1}to{transform:translateY(-250px)}}.slideOutUp{animation-name:slideOutUp}@keyframes slideOutUpFast{0%{transform:translateY(0)}0%,to{opacity:1}to{transform:translateY(-1250px)}}#at4m-menu.slideOutUp{animation-name:slideOutUpFast}@keyframes slideOutDown{0%{transform:translateY(0)}0%,to{opacity:1}to{transform:translateY(350px)}}.slideOutDown{animation-name:slideOutDown}@keyframes slideOutDownFast{0%{transform:translateY(0)}0%,to{opacity:1}to{transform:translateY(1250px)}}#at4m-menu.slideOutDown{animation-name:slideOutDownFast}@keyframes slideInLeft{0%{opacity:0;transform:translateX(-850px)}to{transform:translateX(0)}}.slideInLeft{animation-name:slideInLeft}@keyframes slideInRight{0%{opacity:0;transform:translateX(1250px)}to{transform:translateX(0)}}.slideInRight{animation-name:slideInRight}@keyframes slideOutLeft{0%{transform:translateX(0)}to{opacity:0;transform:translateX(-350px)}}.slideOutLeft{animation-name:slideOutLeft}@keyframes slideOutRight{0%{transform:translateX(0)}to{opacity:0;transform:translateX(350px)}}.slideOutRight{animation-name:slideOutRight}.at4win{margin:0 auto;background:#fff;border:1px solid #ebeced;width:25pc;box-shadow:0 0 10px rgba(0,0,0,.3);border-radius:8px;font-family:helvetica neue,helvetica,arial,sans-serif;text-align:left;z-index:9999}.at4win .at4win-header{position:relative;border-bottom:1px solid #f2f2f2;background:#fff;height:49px;-webkit-border-top-left-radius:8px;-webkit-border-top-right-radius:8px;-moz-border-radius-topleft:8px;-moz-border-radius-topright:8px;border-top-left-radius:8px;border-top-right-radius:8px;cursor:default}.at4win .at4win-header .at-h3,.at4win .at4win-header h3{height:49px;line-height:49px;margin:0 50px 0 0;padding:1px 0 0;margin-left:20px;font-family:helvetica neue,helvetica,arial,sans-serif;font-size:1pc;font-weight:700;text-shadow:0 1px #fff;color:#333}.at4win .at4win-header .at-h3 img,.at4win .at4win-header h3 img{display:inline-block;margin-right:4px}.at4win .at4win-header .at4-close{display:block;position:absolute;top:0;right:0;background:url("data:image/gif;base64,R0lGODlhFAAUAIABAAAAAP///yH5BAEAAAEALAAAAAAUABQAAAIzBIKpG+YMm5Enpodw1HlCfnkKOIqU1VXk55goVb2hi7Y0q95lfG70uurNaqLgTviyyUoFADs=") no-repeat center center;background-repeat:no-repeat;background-position:center center;border-left:1px solid #d2d2d1;width:49px;height:49px;line-height:49px;overflow:hidden;text-indent:-9999px;text-shadow:none;cursor:pointer;opacity:.5;border:0;transition:opacity .15s ease-in}.at4win .at4win-header .at4-close::-moz-focus-inner{border:0;padding:0}.at4win .at4win-header .at4-close:hover{opacity:1;background-color:#ebeced;border-top-right-radius:7px}.at4win .at4win-content{position:relative;background:#fff;min-height:220px}#at4win-footer{position:relative;background:#fff;border-top:1px solid #d2d2d1;-webkit-border-bottom-right-radius:8px;-webkit-border-bottom-left-radius:8px;-moz-border-radius-bottomright:8px;-moz-border-radius-bottomleft:8px;border-bottom-right-radius:8px;border-bottom-left-radius:8px;height:11px;line-height:11px;padding:5px 20px;font-size:11px;color:#666;-ms-box-sizing:content-box;-o-box-sizing:content-box;box-sizing:content-box}#at4win-footer a{margin-right:10px;text-decoration:none;color:#666}#at4win-footer a:hover{text-decoration:none;color:#000}#at4win-footer a.at4-logo{top:5px;padding-left:10px}#at4win-footer a.at4-privacy{position:absolute;top:5px;right:10px;padding-right:14px}.at4win.ats-dark{border-color:#555;box-shadow:none}.at4win.ats-dark .at4win-header{background:#1b1b1b;-webkit-border-top-left-radius:6px;-webkit-border-top-right-radius:6px;-moz-border-radius-topleft:6px;-moz-border-radius-topright:6px;border-top-left-radius:6px;border-top-right-radius:6px}.at4win.ats-dark .at4win-header .at4-close{background:url("data:image/gif;base64,") no-repeat center center;background-image:url(' +
          a(649) +
          "),none;border-color:#333}.at4win.ats-dark .at4win-header .at4-close:hover{background-color:#000}.at4win.ats-dark .at4win-header .at-h3,.at4win.ats-dark .at4win-header h3{color:#fff;text-shadow:0 1px #000}.at4win.ats-gray .at4win-header{background:#fff;border-color:#d2d2d1;-webkit-border-top-left-radius:6px;-webkit-border-top-right-radius:6px;-moz-border-radius-topleft:6px;-moz-border-radius-topright:6px;border-top-left-radius:6px;border-top-right-radius:6px}.at4win.ats-gray .at4win-header a.at4-close{border-color:#d2d2d1}.at4win.ats-gray .at4win-header a.at4-close:hover{background-color:#ebeced}.at4win.ats-gray #at4win-footer{border-color:#ebeced}.at4win .clear{clear:both}.at4win ::selection{background:#fe6d4c;color:#fff}.at4win ::-moz-selection{background:#fe6d4c;color:#fff}.at4-icon-fw{display:inline-block;background-repeat:no-repeat;background-position:0 0;margin:0 5px 0 0;overflow:hidden;text-indent:-9999em;cursor:pointer;padding:0;border-radius:50%;-moz-border-radius:50%;-webkit-border-radius:50%}.at44-follow-container a.aticon{height:2pc;margin:0 5px 5px 0}.at44-follow-container .at4-icon-fw{margin:0}",
        "",
      ]);
  },
  649: function (e, t, a) {
  ...
  650: function (e, t, a) {
    ...
    (n = [a(651), a(662), a(673)]),
      (i = function (t, a, n) {
        ...
        e.exports = function (e) {
          window.addthis &&
            (window.addthis.user.ready(function () {
              window.addthis.user.getPreferredServices(function (n) {
                (0 !== n.length && "" !== n[0]) ||
                  (n = r.getDefaultBasicServices()),
                  (t.preferredServices = n
                    .filter(function (e) {
                      return o(e);
                    })
                    .concat("compact")),
                  (addthis.layers = i),
                  e(),
                  a.trigger("addthis.layers.ready", window.addthis, {
                    pco: t.pco,
                  }),
                  (i.utils = a);
              });
        ...
        var i = window,
          ...
          Y = {
            create: function () {
              var e = this,
                t = e.options,
                a = n.isString(t.position)
                  ? t.position.toLowerCase()
                  : e.position || "right",
                i =
                  "show" === t.showAnimation
                    ? "show"
                    : "top" === a
                    ? "slideInDown"
                    : "bottom" === a
            ...
            bindEvents: function () {
              return "disabled" === this.status
                ? this
                : (n.isString(this.element) &&
                    ((this.element = e(this.element)[0]),
                    this.element.setAttribute("at-event", "true")),
                  this.element &&
                    this.element.getAttribute &&
                    !this.element.getAttribute("at-event") &&
                    n.bindEvents.call(this, this.events),
                  this);
            },
            layerList: {
              addthis: {},
            ...
            eventInterceptors: {
              share: {
                buttonClick: function (e, t) {
                  (window.addthis_config && !window.addthis_config.ui_click) ||
                  t.className.indexOf("compact") === -1
                    ? Y.commonEventHandlers.share.buttonClick.call(this, e, t)
                    : (n.preventDefaultEvent(e),
                      Y.commonEventHandlers.share.showCompactMenu.call(
                        this,
                        e,
                        t
                      ));
                ...
                showCompactMenu: function (e, t) {
                  V ||
                    ...
                    window.addthis_config.ui_click ||
                    Y.commonEventHandlers.share.showCompactMenu.call(
                      this,
                      e,
                      t
              ...
              share: {
                buttonClick: function (e, t) {
                  var a = t.className.split(" "),
                    ...
                    l = t.parentNode;
                  for (
                    l && n.hasClass("at-share-btn", l) && (t = l),
                      a = t.className.split(" "),
                      i = a.length;
                    ++s < i;

                  )
                    0 === a[s].indexOf("at-svc-") && (r = a[s].substring(7));
                  this.superMethod("share", r, o), n.preventDefaultEvent(e);
                },
                buttonKeydown: function (e, t) {
                  var a =
                      "Enter" === e.key || 13 === e.which || 13 === e.keyCode,
                    n =
                      "Spacebar" === e.key ||
                      32 === e.which ||
                      32 === e.keyCode;
                ...
                showCompactMenu: function (e, t) {
                  if (!this.menuOpen) {
                    ...
                    if (
                      !r.ui_disable &&
                      (n.shownServices &&
                        n.shownServices.length &&
                        (r.services_exclude && (r.services_exclude += ","),
                        (r.services_exclude += n.shownServices.join())),
                      (this.menuOpen = !0),
                      addthis_open(t, "", s.shareUrl, s.shareTitle, r, s),
                      (a = document.getElementById("at15s")),
                      !a)
                    )
                      var l = i.setInterval(function () {
                        (a = document.getElementById("at15s")),
                          a && i.clearInterval(l);
                      });
                  }
                ...
                anticipateExpandedMenuClick: function (e) {
                  if (e && e.target) {
                    ...
                    if (t) {
                      var a,
                        n = (/\bat-svc-([a-z]+?)\b/.exec(t.className) || [])[1];
                      v(n) &&
                        ((a = i.addthis_share ? G.clone(i.addthis_share) : {}),
                        C(a));
                    }
                  }
                },
              ...
              mobile: {
                showExpandedMenu: function (e, t, a) {
                  ...
                  (i = e.data
                    ...
                    l && l.length && n.specialEvents.blur(l),
                    d && d.length && n.specialEvents.blur(d);
                },
              },
            },
            applyResponsiveClass: function () {
              "desktop" === n.getCurrentDevice(this) &&
              n.hasClass(this.mobileClass, this.element)
                ? n.removeClass(this.mobileClass, this.element)
                : "mobile" !== n.getCurrentDevice(this) ||
                  n.hasClass(this.mobileClass, this.element) ||
                  n.addClass(this.mobileClass, this.element);
            },
              ...
              Object.keys(o).forEach(function (s) {
                ...
                Object.keys(l).forEach(function (o) {
                  ...
                  if (((o = s.basename), "mobile" !== o)) {
                    (r = n.phone() ? "mobile" : n.getCurrentDevice(s)),
                      "desktop" === r &&
                        "mobile" === s.basename &&
                        n.isVisible(s.menu) &&
                        n.trigger("addthis.layers.mobilemenu.hide", H, s),
                      (e = s.device),
                      (t = s.element),
                      (a = s.container),
                      (i = s.openControl);
                    ...
                    "both" !== e &&
                      (e === r
                        ? n.isVisible(t) ||
                          n.isVisible(i) ||
                          (n.trigger(
                            "addthis.layers.responsive." + o + ".show"
                          ),
                          a !== P.body &&
                            a !== t &&
                            (n.removeClass(Y.hideClass, a),
                            n.removeClass(Y.hiddenClass, a)),
                          "closed" !== s.status
                            ? s.show()
                            : (s.requiresData !== !0 ||
                                (s.requiresData === !0 &&
                                  s.trendingLinksJson &&
                                  s.trendingLinksJson.length)) &&
                              s.show(i))
                        : (n.isVisible(t) || n.isVisible(i)) &&
                          (n.trigger(
                            "addthis.layers.responsive." + o + ".hide"
                          ),
                          a !== P.body && n.addClass(Y.hideClass, a),
                          n.addClass(Y.hideClass, t),
                          n.addClass(Y.hideClass, i)));
                  }
                });
              }),
            ...
            onloadShowLogic: function (e) {
              var a = e.namespace,
                ...
                m =
                  (e.openControl, n.phone() ? "mobile" : n.getCurrentDevice(e));
              e.isWhatsNextMobile === !0 ||
                ((e.rendered === !0 ||
                  e.showOnLoad === !1 ||
                  ("both" !== h && h !== m) ||
                  ("mobile" === i && !r)) &&
                l.showImmediately !== !0
                  ? (n.addClass("addthis-animated", o),
                    n.addClass(d, o),
                    n.addClass(Y.showClass, o),
                    n.addClass(Y.hideClass, o),
                    n.removeClass(Y.hiddenClass, o))
                  : n.isElement(o) &&
                    ("closed" !== e.status || l.showImmediately === !0
                      ? n.requestTimeout(function (t) {
                          n.addClass(Y.hideClass, o),
                            n.removeClass(Y.hiddenClass, o),
                            n.removeClass(Y.hiddenClass, s),
                            e.show(o, d, function () {
                      ...
                      : t(function () {
                          n.removeClass(Y.hiddenClass, o),
                            ...
                            (e.requiresData !== !0 ||
                              (e.requiresData === !0 &&
                                e.trendingLinksJson &&
                                e.trendingLinksJson.length)) &&
                              e.show(e.openControl);
                        }),
                    (e.rendered = !0),
                    n.trigger(
                      "addthis.layers." + e.name + ".rendered",
                      H,
                      this
                    )));
            },
            ...
            animate: function e(a, i, o) {
              if (a) {
                if (
                  ("show" === i
                    ? (i = Y.showClass)
                    : "hide" === i && (i = Y.hideClass),
                  (i !== Y.showClass && i !== Y.hideClass) ||
                    (a.__isAnimating = !1),
                  a.__isAnimating)
                )
                  return void (n.isFunction(o) && o.call(this));
                a.__isAnimating = !0;
                var r = [
                    "animationend",
                    "webkitAnimationEnd",
                  ...
                  p = function () {
                    t(function () {
                      c[i]
                        ? (n.removeClass(Y.hideClass, a),
                          n.addClass(Y.showClass, a))
                        : d[i] &&
                          (n.removeClass(Y.showClass, a),
                          n.addClass(Y.hideClass, a)),
                        n.removeClass(Y.visibleClass, a);
                    }),
                      n.isFunction(u) && u.call(this),
                      n.bindEvents.call(h, h, "remove"),
                      (a.__isAnimating = !1);
                  },
                ...
                (p = p.bind(this)),
                  f
                    ? (g.forEach(function (e) {
                      ...
                      m && (h.element = a),
                      (e.evts = h),
                      "none" === n.getCSSAttr(a, "display") &&
                        n.addClass(Y.visibleClass, a),
                      n.bindEvents.call(h, h),
                      n.addClass("addthis-animated", a),
                      n.addClass(i, a))
                    : p();
              }
            },
            processTrendingData: function (e, t, a) {
              a && ((Y.feeds[e + t] = a), (Y.feedsLoading[e + t] = !1)),
                this.dequeueTrending(e, t);
            },
            preRender: function () {
              var e = this,
                t = e.parentElement,
              ...
              n.isElement(i) &&
                (Y.addDeviceClassName(i, a),
                t.appendChild(i),
                (e.parentElement = e.container = i));
            },
            render: function () {
              var e,
                t,
              ...
              if (
                (u("render_layers_" + a.name, {
                  once: !0,
                }),
                "disabled" === a.status && a.finalize(),
                a.offset(),
                (i.audienceRules && !i.ruleSuccess) ||
                  (n.isFunction(a.generateJson) && !l
                    ? ((e = a.generateJson(a)), (r = N(e)))
                    : n.isFunction(a.generateElement) &&
                      !l &&
                      (r = a.generateElement())),
                r)
              ) {
                if (n.isElement(o)) {
                  if (
                    ((t = a.container = a.container || r),
                    n.addClass("addthis-smartlayers", t),
                    a.showOnLoad !== !1
                      ? n.addClass(Y.hiddenClass, t)
                      : n.addClass(Y.hideClass, t),
                    Y.addDeviceClassName(t, s),
                    n.supports.csstransitions()
                      ? ((i.showAnimation = i.showAnimation || "fadeIn"),
                        (i.hideAnimation = i.hideAnimation || "fadeOut"))
                      : ((i.showAnimation = "show"),
                        (i.hideAnimation = "hide")),
                    a.inline && o === P.body)
                  )
                    return;
                  o.appendChild(r),
                    o !== W && a.inline && (o.__containsLayer__ = !0),
                    Y.render_logic.call(a, r);
                }
              } else Y.render_logic.call(a);
            },
            render_logic: function () {
              var e = this;
              e.finalize().bindEvents().postEvents(),
                e.async === !0 && n.isFunction(e.imageResizing)
                  ? e.imageResizing(function () {
                      Y.onloadShowLogic(e);
                    })
                  : Y.onloadShowLogic(e);
            },
            addDeviceClassName: function (e, t) {
              ("mobile" !== t && "desktop" !== t) ||
                n.addClass("addthis-smartlayers-" + t, e);
            },
            postEvents: function () {
              ...
              n.isNumber(e) &&
                ...
                (n.isElement(s) &&
                  (t
                    ? n.setCSSAttr(s, "padding-right", e + "px")
                    : o && n.setCSSAttr(s, "right", e + "px")),
                E("ie10") &&
                  n.isElement(l) &&
                  (t || o) &&
                  n.setCSSAttr(l, r ? "padding-right" : "right", e + "px"));
            },
            offset: function () {
              var t,
                a,
              ...
              if (n) {
                ...
                (a = this.element),
                  this.openControl && (a += "," + this.openControl),
                  (a += " {"),
                  n.top &&
                    !o.top &&
                    (a +=
                  ...
                  n.right &&
                    ...
                    (a +=
                      ...
                      (n.left ? "" : "left:auto")),
                  (a += "}"),
                  t.styleSheet && void 0 !== t.styleSheet.cssText
            ...
            finalize: function () {
              var t = this,
                ...
                i =
                  !n.isIEQuirksMode() &&
                  n.isArray(t.services) &&
                  D.hasShareCounts(a);
              return (
                t.controlContainer &&
                  (t.controlContainer = e(t.controlContainer)[0]),
                t.closeControl && (t.closeControl = e(t.closeControl)[0]),
                t.openControl && (t.openControl = e(t.openControl)[0]),
                t.element && (t.element = e(t.elementSelector)[0]),
                "closed" === t.status && n.addClass(Y.hideClass, t.element),
                (t.container =
                  t.async === !0
                    ? t.parentElement
                    : _ate.util.parent(t.element, ".addthis-smartlayers") === P
                    ? t.element.parentNode
                    : _ate.util.parent(t.element, ".addthis-smartlayers")),
                i &&
                  n.shareCounters.getShareCounts(
                    {
            ...
            show: function (a, i, o) {
              ...
              t(function () {
                (i = i || l.showAnimation),
                  (a = a || (n.isElement(s) ? s : n.isString(s) ? e(s) : "")),
                  i && !n.isVisible(a)
                    ? r.animate(a, i, o)
                    : n.isFunction(o) && o();
              });
            ...
            feed: function (e) {
              ...
              return (
                r &&
                  r.length > 0 &&
                  (!a.filteredData || (e && !r[e.name])) &&
                  ((t =
                    a.filteredData =
                    a.feeds[o][e ? e.name : "filtered"] =
                      n.filter(r, function (t, a, i) {
                        if (t._removed) return !1;
                        if (
                          ((t._secureurl = n.has(t.url, "https:")),
                          t.image &&
                            ((t._secureimage = n.has(t.image, "https:")),
                            (t.image = t.image.replace(/(http:|https:)/, ""))),
                          d ===
                            t.url
                              .split("#")[0]
                              .replace(/\//g, "")
                  ...
                  this.personalize || n.randomize(t)),
                r
              );
            },
            feedName: function () {
            ...
            feedItem: function (e) {
              var t,
                a,
                n = e.feed || this.feed(e.test),
                i = [];
              if (
                ((n = n && n[e.test ? e.test.name : "filtered"]),
                (e.repeat = e.repeat || 0),
                n && n.length > 0)
              ) {
                for (; n.length > 0; )
                  if (
                    ((t = n.shift()),
                    i.push(t),
                    !t._displayed || t._displayed < e.repeat)
                  ) {
            ...
            retrieveTrendingData: function () {
              ...
              var e,
                t = i.addthis_config || {},
                a =
                  this.options.altRecommendedPubId ||
                  this.options.pubid ||
                  i.addthis_pub ||
                  t.pubid ||
                  "",
              ...
              return (
                ...
                this.options.dummyData
                  ? (this.queue(a, n, r),
                    void this.processTrendingData(a, n, this.options.dummyData))
                  : void (a
                      ? s.checkForContentFeed(a, n) ||
                        s.checkForContentFeedLoading(a, n)
                        ? s.checkForContentFeed(a, n) &&
                          !s.checkForContentFeedLoading(a, n) &&
                          this.dequeueTrending(a, n)
                        : ((s.feedsLoading[a + n] = !0),
                          this.personalize
                            ? _ate.feeds.recommend(e)
                            : _ate.feeds.trend(e),
                          setTimeout(function () {
                            s.feedsLoading[a + n] === !0 &&
                              ((s.feedsLoading[a + n] = !1), r(a, n, []));
                          }, 5e3))
                      : this.dequeueTrending(a, n))
              );
            },
            ...
            getTrendingFeedItems: function (e) {
              ...
              var a,
                ...
                l = [],
                d = e,
                c = n.isPlainObject(r.promotedUrls)
                  ? n.toArray(r.promotedUrls)
                  : n.isString(r.promotedUrls) && r.promotedUrls.length
                  ? [r.promotedUrls]
                  : r.promotedUrls || [],
                h = c.length > 0;
            ...
            generateTrendingJson: function (e, t) {
              ...
              if (s && i) {
                ...
                for (var b = 0; b < a.length; b++) {
                  var v = a[b];
                  v.image && (h = o.hasImage = !0),
                    v.title && (m = o.hasTitle = !0);
                }
                return (
                  a.forEach(function (t, a) {
                    if (((n = []), t && t.url)) {
                      if (
                        (o.normalizeTrendingItem(t, {
                          itemCount: i,
                          numItems: d,
                          pos: a,
                        }),
            ...
            resizeTrendingImage: function (e) {
              var t,
                ...
                s,
                l,
                d = e.parentNode.parentNode,
                c = 0;
              if (
                ("closed" === this.status
                  ? (n.addClass(Y.visibleClass, this.element),
                    n.removeClass(Y.hideClass, this.element))
                  : n.isElement(this.container) &&
                    n.addClass(Y.visibleClass, this.container),
                n.isUndefined(e.naturalHeight) &&
                  ((t = new Image()),
                  (t.src = e.src),
                ...
                if (
                  ...
                  (r = d.offsetHeight || i),
                  "closed" === this.status
                    ? (n.addClass(Y.hideClass, this.element),
                      n.removeClass(Y.visibleClass, this.element))
                    : n.isElement(this.container) &&
                      n.removeClass(Y.visibleClass, this.container),
                  (s = o / a),
                  (l = r / i),
                  s > l)
                ) {
            ...
            resizeTitle: function (e, t, a) {
              ...
              var n,
                ...
                d = i.innerHTML;
              if (s > r) {
                for (; i.offsetHeight > r && d.length - l > 0; )
                  (n = d.substr(0, d.length - l++)), (a.innerHTML = n + "...");
                (n = n.replace(/[\s\.,-\/#!$%\^&\*;:{=\-_`~(]+$/, "")),
                  (a.innerHTML = n + "...");
              }
            },
            ...
            titleResizer: function (e, t, a, i) {
              ...
              return (
                n.removeClass("at4-visually-hidden", l),
                (function l() {
                  a(t)
                    ? o.resizeTitle(e, t, i)
                    : r > 0 && (n.requestTimeout(l, s), r--);
                })(),
                o
              );
            },
            openShareMenu: function (e) {
              var t = this,
                a =
                  (n.mobile() ? "mobile" : n.getCurrentDevice(t),
                  s(window.addthis_share) || {}),
                i = s(window.addthis_config) || {},
                e = s(e) || {};
              return (
                r(e, a),
                z()
                  ? S(I("bookmark", 0, a, i), "_blank")
                  : (E("mob") || i.ui_508_compliant || k(),
                    (i.ui_pane = ""),
                    void M(P.body, "more", "", "", i, e))
              );
            },
            share: function (e, t) {
              var a = {
              ...
              return (
                ("email" === e || g(e)) &&
                  (a.hideEmailSharingConfirmation =
                    this.options.hideEmailSharingConfirmation),
                e.match(/^(addthis|more|bkmore|compact)$/)
                  ? Y.openShareMenu(a)
                  : c(e, a)
              );
            },
            ...
            follow: function (e, t, a, n) {
              ...
              return (
                (o.product = a),
                (o.username =
                  this.options.pubId || window.addthis_pub || o.pubid || ""),
                (o.pubid = o.username),
                (r.service = e),
                (r.followUrl = O(e, t.id)),
                "twitter" === e &&
                  E("mob") &&
                  n !== !0 &&
                  h(e, t, a, o, r, {
                ...
                ("twitter" === e && !E("mob")) || n === !0
                  ? (("twitter" !== e || E("mob")) &&
                      (o.ui_use_different_full_window = !0),
                    void h(e, t, a, o, r, {
                      track: !1,
                    }))
                  : void T(e, 1, r, o)
              ...
              return (
                ...
                (function u() {
                  ...
                  for (
                    ...
                    (p = t[v]),
                      n.isUndefined(p.naturalHeight) &&
                        ((f = new Image()),
                        (f.src = p.src),
                        f.height > 0 &&
                          ((p.naturalHeight = f.height),
                          (p.naturalWidth = f.width)),
                        (f = null)),
                      p.naturalHeight > 0 &&
                      p.naturalWidth > 0 &&
                      !p.__imageloaded__
                        ? ((p.__imageloaded__ = !0),
                          i.resizeTrendingImage(p),
                          w++)
                        : p.__imageloaded__
                        ? w++
                        : l === Math.floor(r / 2) &&
                          n.has(n.attr(p, "src"), "http:") &&
                          n.has(n.attr(P.location, "href"), "https:") &&
                          "true" === n.attr(p, "data-secure")
                        ? n.attr(
                            p,
                            "src",
                            "https:" + n.attr(p, "src").replace("http:", "")
                          )
                        : l === Math.floor(r / 2) &&
                          n.has(n.attr(p, "src"), "https:") &&
                          n.has(n.attr(P.location, "href"), "https:") &&
                          "false" === n.attr(p, "data-secure") &&
                          n.attr(
                            p,
                            "src",
                            "http:" + n.attr(p, "src").replace("https:", "")
                          );
                  l++,
                    w < (i.maxitems || 1) && l < r
                      ? n.requestTimeout(u, s)
                      : (o.hideBadImages !== !1 &&
                          ...
                          t.forEach(function (e) {
                            n.isImageBroken(e) &&
                              (i.showPlaceholderImages === !1
                                ? ((g = _ate.util.parent(
                                    e,
                                    ".at4-recommended-div-item"
                                  )),
                                  g !== P &&
                                    g !== P.body &&
                                    g.parentNode &&
                                  ...
                                  m >= i.maxitems &&
                                    n.addClass(
                                      Y.hideClass,
                                      i.container || i.element
                                    ))
                                : ((b = _ate.util.parent(
                                    e,
                                    ".at4-recommended-item-img"
                                  )),
                                  i.hasImage === !0 && m < i.maxitems
                                    ? (b !== P &&
                                        b !== P.body &&
                                        n.addClass(c[h] || "", b),
                                      (x[
                        ...
                        n.removeClass(Y.visibleClass, d),
                        n.isFunction(a) &&
                          n.requestTimeout(function () {
                            a();
                          }, 100));
            ...
            mappedDataAttributes: function () {
              if (Y.mappedDataAttributes.cachedOptions)
                return Y.mappedDataAttributes.cached;
              var e = {},
                t = function (t) {
                  e[t.toLowerCase()] = t;
                };
              for (var a in Y.defaultOptions)
                Y.defaultOptions.hasOwnProperty(a) &&
                  l(Y.defaultOptions[a]) &&
                  Object.keys(Y.defaultOptions[a]).forEach(t);
            ...
            getShareServices: function () {
              var e,
                ...
                i = this.options,
                o =
                  i.numPreferredServices ||
                  this.numServices ||
                  this.defaultShareServicesNum,
                r = {
                  more: 1,
                  addthis: 1,
                  compact: 1,
              ...
              if (
                ((o = Number(o)),
                n.isArray(this.services) && n.isPlainObject(i))
              ) {
                e = this.services;
                for (t in e)
                  if (e.hasOwnProperty(t)) {
                    var d,
                      c = e[t];
                    if (
                      ("pinterest" === c && (c = "pinterest_share"),
                      i.services_exclude[c] !== !0 &&
                        (f(c) || 1 === r[c] || (s === o && this.personalized)))
                    ) {
                      if (
                        "more" === c ||
                        "addthis" === c ||
                        (s === o && this.personalized)
                      )
                        i.services_exclude.more !== !0 &&
                          ((d = x("More", 2).replace("&nbsp;", " ")),
                          (c = "compact"));
                      else {
                        var h = a(510);
  ...
  652: function (e, t, a) {
    ...
    function i() {
      ...
      (a.product = e.productCode),
        (a.widgetId = e.widgetId),
        (a.pubid = e.pubId),
        (n.service = t),
        (n.url = void 0 !== e.url ? e.url : n.url),
        (n.title = void 0 !== e.title ? e.title : n.title),
        (n.description =
          void 0 !== e.description ? e.description : n.description),
        (0, c.default)(t, n, a),
        (0, r.default)(t) && (0, l.default)(e.paymentEndpoint),
        _ate.gat(t, n.url, a, n);
    }
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      (t.default = function (e) {
        ...
        return (
          ...
          (n.description = l),
          (n.media = d),
          (n.hideEmailSharingConfirmation = c),
          {
            atConfig: a,
            atShare: n,
          }
  ...
  656: function (e, t) {
    function a(e) {
      ...
      return (
        ...
        (a = e.match(/#[\w][\w-]*/)),
        a && ((a = a[0].replace(/#/, "")), t.setAttribute("id", a)),
        (i = e.match(/\.[\w][\w-]*/g)),
        i && ((i = i.join(" ").replace(/\./g, "")), (t.className = i)),
        t
      );
    }
    var n = document;
    e.exports = function e(t) {
      ...
      if (t) {
        ...
        if (
          ((r = t[o]), (s = a(o)), r && "object" == typeof r && "length" in r)
        ) {
          for (i in r)
        ...
        if (
          ...
          (u = function (e) {
            ...
            for (var t in m) if (e === m[t]) return !0;
            return !1;
          }),
          "string" == typeof d)
        )
          s.appendChild(document.createTextNode(d));
        else if (d && "object" == typeof d && 1 === d.nodeType)
          s.appendChild(d);
        else
          for (var l in d)
              ...
              if (
                ...
                if ("html" === l) s.appendChild(document.createTextNode(c));
                  ...
                  (_ate.bro.ie6 ||
                    _ate.bro.ie7 ||
                    (_ate.bro.msi &&
                      "backcompat" === n.compatMode.toLowerCase()))
                ) {
                  ...
                  "className" === l || "class" === l
                    ? (s.className = c)
                    : s.setAttribute(l, c);
              else if ("children" == l) for (var p in c) s.appendChild(e(c[p]));
              else {
  ...
  657: function (e, t, a) {
      ...
      switch (a) {
        case "ctbx":
          return (
            ...
            (t.counts = s(t)),
            (t.buttonColor = u(t)),
            (t.shareCountThreshold = t.shareCountThreshold || 0),
            t
          );
        case "tbx":
        case "sharetoolbox":
        ...
        case "jumboshare":
          return (
            ...
            (t.size = h(t)),
            (t.counts = "jumbo"),
            (t.label = t.label || t.title || "SHARES"),
            (t.countsFontSize = t.countsFontSize || "60px"),
            (t.titleFontSize = t.titleFontSize || "18px"),
            (t.counterColor = t.counterColor || t.color || "#555B64"),
            (t.buttonColor = u(t)),
            (t.borderRadius = c(t)),
            (t.shareCountThreshold = t.shareCountThreshold || 0),
            t
    ...
    function d(e) {
      var t = /\d+(\.\d*)?/i,
        a = e.match(t)[0],
        n = e.replace(/\d+(\.\d*)?/i, "");
      return a ? 9 + 0.075 * Number(a) + n : "11px";
    }
    ...
    function c(e) {
      return e.borderRadius
        ? e.borderRadius
        : e.shape
        ? C.borderRadius[e.shape]
        : C.borderRadius.square;
    }

    function h(e) {
      return e.size
        ? C.size[e.size] || e.size
        : "ctbx" === e.id
        ? "16px"
        : "32px";
    }
        ...
        shfs: function (e) {
          ...
          if ("hide" === t && "hide" !== a) {
            ...
            switch (n) {
              case "modern":
                (e.id = "smlsh"),
                  (e.background = e.buttonColor),
                  delete e.buttonColor;
                break;
              case "bordered":
      ...
      var e = (function () {
        ...
        function n(e) {
          for (var t = [], a = 0, n = e.length; a < n; ++a)
            f(e[a]) ? (t = t.concat(e[a])) : (t[t.length] = e[a]);
          return t;
        }
        ...
        function s(e, a, n, i, o, r, s, l, c, h, m) {
          ...
          if (a && "*" !== a && this[S] && this[S].toLowerCase() !== a)
            return !1;
        ...
        function c(e, t) {
          ...
          if (
            ((l = (g = g.slice(0)).pop()),
            g.length && (o = g[g.length - 1].match(M)) && (f = b(t, o[1])),
            !f)
          )
            return u;
          for (
            c = r(l),
              d =
                f !== t && 9 !== f[I] && v && /^[+~]$/.test(v[v.length - 1])
                  ? (function (e) {
                      for (; (f = f.nextSibling); )
                        1 == f[I] &&
                          (c[1] ? c[1] == f[S].toLowerCase() : 1) &&
                          (e[e.length] = f);
                      return e;
                    })([])
                  : f[_](c[1] || "*"),
        ...
        function h(e, t, a) {
          ...
          for (var i, o, l = t.split(","); (t = l.pop()); )
            if (
              ((i = q.g(t) || q.s(t, t.split(V))),
              (o = t.match(G)),
              (i = i.slice(0)),
              s.apply(e, r(i.pop())) && (!i.length || m(e, i, o, a)))
            )
              return !0;
          return !1;
        }
        ...
        function p(e) {
          ...
          e: for (t = 0; t < e.length; ++t) {
            for (a = 0; a < n.length; ++a) if (n[a] == e[t]) continue e;
            n[n.length] = e[t];
          }
          return n;
        }
        ...
        function b(e, t, a) {
          return 9 === e[I]
            ? e.getElementById(t)
            : e.ownerDocument &&
                (((a = e.ownerDocument.getElementById(t)) && K(a, e) && a) ||
                  (!K(e, e.ownerDocument) && x('[id="' + t + '"]', e)[0]));
        }
        ...
        function w(e, t) {
          return function (a) {
            ...
            return N.test(a)
              ? void (
                  9 !== e[I] &&
                  ((i = n = e.getAttribute("id")) ||
                    e.setAttribute("id", (i = "__qwerymeupscotty")),
                  (a = '[id="' + i + '"]' + a),
                  t(e.parentNode || e, a, !0),
                  n || e.removeAttribute("id"))
                )
              : void (a.length && t(e, a, !1));
          };
        }
        var x,
          y = document,
        ...
        var Z = new e(),
                ...
                ? (a(
                    ...
                    w(t, function (e, t) {
                      (o = e[A](t)),
                        1 == o.length
                          ? (r[r.length] = o.item(0))
                          : o.length && (r = r.concat(i(o)));
                    })
                  ),
                  n.length > 1 && r.length > 1 ? p(r) : r)
                : i(t[A](e));
            } catch (e) {}
            return ne(e, t);
          },
          ne = function (e, n) {
            ...
            if (((e = e.replace(D, "$1")), (o = e.match(R)))) {
              for (
                l = t(o[2]), i = n[_](o[1] || "*"), r = 0, s = i.length;
                r < s;
                r++
              )
                l.test(i[r].className) && (h[h.length] = i[r]);
              return h;
            }
            return (
              a(
                (d = e.split(",")),
                w(n, function (e, t, a) {
                  for (l = c(t, e), r = 0, s = l.length; r < s; r++)
                    (9 === e[I] || a || K(l[r], n)) && (h[h.length] = l[r]);
                })
              ),
  ...
  661: function (e, t, a) {
    ...
    (n = function () {
      ...
      for (
        ...
        (r = d[s]), null == i && (i = window[r + "RequestAnimationFrame"]);
      return (
        null == i &&
          ((t = "timer"),
          (e = 0),
          ...
          (i = function (t) {
            ...
            return null != n
              ? void n.push(t)
              : ((s = a()),
                (r = Math.max(0, 16.66 - (s - e))),
                (n = [t]),
                (e = s + r),
                (i = function () {
                  var t, a, i, o;
                  for (a = n, n = null, i = 0, o = a.length; i < o; i++)
                    (t = a[i])(e);
                }),
        ...
        i(function (e) {
          var t;
          null != (null != (t = window.performance) ? t.now : void 0) &&
          e < 1e12
            ? ((i.now = function () {
                return window.performance.now();
              }),
              (i.method = "native-highres"))
            : (i.now = a);
        }),
        (i.now =
          null != (null != (c = window.performance) ? c.now : void 0)
            ? function () {
                return window.performance.now();
              }
            : a),
      ...
      (i = function (e, t, n) {
        var i = {
          ...
          cloneObject: function (e) {
            var t = {};
            for (var a in e)
              i.isPlainObject(e[a]) && void 0 !== e[a]
                ? (t[a] = i.isElement(e[a]) ? e[a] : i.cloneObject(e[a]))
                : (t[a] = e[a]);
            return t;
          },
          isEmptyObject: a(665),
          ...
          isFunction: function (e) {
            return (
              !!e && "[object Function]" === Object.prototype.toString.call(e)
            );
          },
          isString: function (e) {
            return (
          ...
          match: function (e, t, a) {
            ...
            if (
              ((n = a + "//" + h.join("/")),
              (o = i.match[n] || (i.match[n] = {})),
              !o.matches)
            )
              for (
                r = o.matches || (o.matches = []),
                  o.keys = h,
                  o.values = o.values || t,
                  s = 0;
                s < t.length;
          ...
          filter: function (e, t, a) {
            ...
            for (var r = 0, s = e.length; r < s; r++)
              (n = e[r]), (i = t.call(a || n, n, r, e)), i && (o[o.length] = n);
            return o;
          },
          map: function (e, t, a) {
            var n,
            ...
            for (var o = 0, r = e.length; o < r; o++)
              (n = e[o]), (i[i.length] = t.call(a, n, o, e));
            return i;
          },
          every: a(663),
          some: a(362),
          ...
          queue: function (e, t, a) {
            var n =
              ((this._q = this._q || {}), (this._q[e] = this._q[e] || []));
            return (
              n.push({
                item: t,
                context: a || this,
          ...
          dequeue: function (e) {
            return (
              this._q && this._q[e] && this._q[e].length && this._q[e].shift()
            );
          },
            ...
            for (var n in e)
              if (e.hasOwnProperty(n) && e[n] instanceof Function) {
                ...
                if (o === -1)
                  i.has(n, "addthis")
                    ? "remove" !== t
                      ? _ate.ed.addEventListener(n, r)
                      : _ate.ed.removeEventListener(n, r)
                    : a &&
                      i.listenTo({
                        elem: a,
                        ev: n,
          ...
          listenTo: function (t) {
            var a = !1,
              ...
              l = t.callback,
              h =
                "remove" !== t.type ? "addEventHandler" : "removeEventHandler",
              m = t.originalEv;
            (r || o) &&
              s &&
              l &&
          ...
          addEventHandler: function (e) {
            ...
            ("mouseenter" !== o && "mouseleave" !== o) ||
              i.isMouseEventSupported(o) ||
              ((o = "mouseenter" === o ? "mouseover" : "mouseout"),
              (d = i.fixMouseEvent(d))),
              h.__callbacks || (h.__callbacks = {}),
              (h.__callbacks[s] = d),
              h.addEventListener
                ? h.addEventListener(o, d, !1)
                : h.attachEvent
                ? h.attachEvent("on" + o, d)
                : (h["on" + o] = d);
          },
          ...
          removeEvent: function (e) {
            ...
            t.removeEventListener
              ? t.removeEventListener(a, n, !1)
              : t.detachEvent
              ? t.detachEvent("on" + a, n)
              : (t["on" + a] = null);
          },
          isMouseEventSupported: function e(t) {
            ...
            return (
              (t = "on" + t),
              (a = t in n),
              a || (i.attr(n, t, "return;"), (a = i.isFunction(n[t]))),
              (e.isSupported = a),
              (e.tested = !0),
              (n = null),
              a
          ...
          once: function (e) {
            ...
            return function () {
              return a
                ? t
                : ((a = !0), (t = e.apply(this, arguments)), (e = null), t);
            };
          },
          ...
          scrollTop: function (e) {
            return (
              (e = e || d.documentElement || h), e.scrollTop || h.scrollTop
            );
          },
          elementInViewport: function (t) {
            ...
            for (
              var a = t.offsetTop,
                ...
                o = t.offsetWidth,
                l = t.offsetHeight,
                h = c.pageYOffset ? c.pageYOffset : d.documentElement.scrollTop,
                m = c.pageXOffset
                  ? c.pageXOffset
              ...
              (t = t.offsetParent), (a += t.offsetTop), (n += t.offsetLeft);
          ...
          getCurrentDevice: function (e) {
            var t = r(),
              ...
              n = a.responsive || {},
              o =
                (i.isString(n.minWidth)
                  ? i.has(n.minWidth, "px")
                    ? +n.minWidth.replace("px", "")
                    : +n.minWidth
                  : n.minWidth) || 0,
              s = i.isString(n.maxWidth)
                ? i.has(n.maxWidth, "px")
                  ? +n.maxWidth.replace("px", "")
                  : +n.maxWidth
                : n.maxWidth,
              l = "desktop";
            return (l =
          ...
          publicApi: function (e) {
            var t = {};
            for (var a in e)
              e.hasOwnProperty(a) && "_" !== a.charAt(0) && (t[a] = e[a]);
            return t;
          },
          ...
          supports: {
            csstransitions: function () {
              ...
              if (void 0 !== i.supports.csstransitions.supports)
                return i.supports.csstransitions.supports;
              if (i.isString(e[t]))
                return (i.supports.csstransitions.supports = !0), !0;
              t = t.charAt(0).toUpperCase() + t.substr(1);
              for (var n = 0; n < a.length; n++)
                if (i.isString(e[a[n] + t]))
                  return (i.supports.csstransitions.supports = !0), !0;
          ...
          addClass: function (e, t) {
            i.isElement(t) &&
              i.isString(e) &&
              (this.hasClass(e, t) ||
                (t.classList && i.isString(e) && e.length
                  ? t.classList.add(e)
                  : t.className
                  ? (t.className += " " + e)
                  : (t.className = e)));
          ...
          removeClass: function (e, t) {
            if (t && t.className && i.isElement(t) && i.isString(e)) {
              ...
              if (i.hasClass(e, t))
                if (t.classList && i.isString(e) && e.length)
          ...
          isVisible: function (e, t) {
            return (
              !!i.isElement(e) &&
              "none" !== i.getCSSAttr(e, "display") &&
              "hidden" !== i.getCSSAttr(e, "visibility") &&
              0 !== +i.getCSSAttr(e, "opacity", 1) &&
              !i.has(i.getCSSAttr(e, "filter", "alpha(opacity=0)"))
            );
          },
          getCSSAttr: function (e, t, a) {
            ...
            var n = e.currentStyle || c.getComputedStyle(e, null) || {},
              o = (function () {
                return c.getComputedStyle && n.getPropertyValue
                  ? n.getPropertyValue
          ...
          hasAttr: function (e, t) {
            if (i.isElement(e) && !i.isUndefined(t))
              return i.isUndefined(e.hasAttribute)
                ? !i.isUndefined(e.attributes[t])
                : e.hasAttribute(t);
          },
          attr: function (e, t, a) {
            if (i.isElement(e) && !i.isUndefined(t))
          ...
          fireDOMEvent: function (e, t) {
            ...
            return d.createEvent
              ? ((a = d.createEvent("HTMLEvents")),
                a.initEvent(t, !0, !0),
                !e.dispatchEvent(a))
              : ((a = d.createEventObject()), e.fireEvent("on" + t, a));
          },
          trigger: function (e, t, a, n) {
            i.isString(e) &&
              (i.has(e, "addthis")
                ? i.fireCustomEvent(e, t, a, n)
                : i.isElement(t) && i.fireDOMEvent(t, e));
          },
          ...
          serviceTemplate: function (e, t) {
            ...
            return (
              n &&
                ((a = i.getServiceName(n)),
                i.isString(e) && (e = e.replace(/\{\{service\}\}/, a))),
              e
            );
          },
          ...
          getTopService: function (e) {
            ...
            return i.isUndefined(e) || "preferred" === e
              ? ((e =
                  t.length > 0
                    ? t[0]
                    : {
          ...
          openWindow: function (e) {
            ...
            a.length &&
              (a.indexOf("://") < 0 && (a = "//" + a),
              (t = n ? window.open(a, "_blank") : window.open(a)),
              i && t.focus());
          },
          requestTimeout: function (e, a, n) {
            ...
            if (!i.supports.requestAnimationFrame)
          ...
          gradients: {
            ...
            mag: function (e) {
              return (
                (e = e || i.gradients.normalizeColor()),
                i.gradients.hex2num(e.substring(0, 2)) +
                  i.gradients.hex2num(e.substring(2, 4)) +
                  i.gradients.hex2num(e.substring(4, 6))
              );
            },
            normalizeColor: function (e) {
              ...
              if (
                ((e = t ? t : e.replace("#", "")), e && i.gradients.isValid(e))
              ) {
                if (3 === e.length) {
            ...
            isValid: function (e) {
              return (
                ...
                !!/(^[0-9,a-f]{3}$)|(^[0-9,a-f]{6}$)/.test(e) ||
                  i.gradients.checkString(e)
              );
            },
            index: function (e) {
              return e / 255;
            ...
            shadeOne: function (e, t) {
              return i.gradients.num2Hex(
                i.gradients.scaleUp(
                  i.gradients.index(i.gradients.hex2num(e)) * t
                )
              );
            },
            shade: function (e, t) {
              return (
                (t = t || i.gradients.normalizeColor()),
                e || (e = i.gradients.distance),
                "" + t in i.gradients.cache || (i.gradients.cache["" + t] = {}),
                "" + e in i.gradients.cache["" + t] ||
                  (i.gradients.cache["" + t][e] =
                    "" +
                    i.gradients.shadeOne(t.substring(0, 2), e) +
                    i.gradients.shadeOne(t.substring(2, 4), e) +
                    i.gradients.shadeOne(t.substring(4, 6), e)),
                i.gradients.cache[t][e]
              );
            },
            distance: 0.2,
            cssString: function (e, t) {
              (e = i.gradients.normalizeColor(e)),
                (t = t || i.gradients.distance),
                (i.gradients.mag(e) > 700 || i.gradients.mag(e) < 100) &&
                  (t = 0);
              var a = i.gradients.shade(1 - t, e),
                n =
                  (i.gradients.shade(1 + 2 * t, e),
                  i.gradients.shade(1 + t, e)),
                o = i.gradients.shade(0.9, e),
                r =
          ...
          validation: {
            patterns: {
              email:
                "^[a-zA-Z0-9._-]+@[a-zA-Z0-9][a-zA-Z0-9.-]*[.]{1}[a-zA-Z]{2,6}$",
            },
            validators: {
              ...
              isEmail: function (e) {
                return i.validation.validators.pattern(
                  e,
                  i.validation.patterns.email
                );
              },
            },
          },
          ...
          updateStyleSheet: function (t, a) {
            for (
              var n, i = d.getElementsByTagName("head")[0], o = e("#" + a);
              o && o.length;
          ...
          isCSSReady: function (e) {
            ...
            (t.id = "addthissmartlayerscssready"),
              (t.style.color = "#fff"),
              d.body.appendChild(t),
              (function a() {
                var n = i.getCSSAttr(t, "color");
                (n && "rgb(186, 218, 85)" === n) ||
                "#bada55" === n.toLowerCase()
          ...
          removeElement: function (e) {
            i.isElement(e) &&
              i.isElement(e.parentNode) &&
              (e.parentNode.__containsLayer__ === !0 &&
                (e.parentNode.__containsLayer__ = !1),
              e.parentNode.removeChild(e));
          },
          ...
          getScrollBarWidth: function e() {
            ...
            var t = 0;
            if (
              !i.isUndefined(i.getCSSAttr(h, "-ms-overflow-style")) &&
              o("msi")
            )
              "none" !== i.getCSSAttr(h, "-ms-overflow-style") &&
                (t = i.scrollBarWidth());
            else if (
              c.getComputedStyle &&
              ((t = i.scrollBarWidth()), 0 === t)
            ) {
              var a = document.createElement("style");
              (a.innerHTML = "::-webkit-scrollbar { width: 10px; }"),
                d.getElementsByTagName("head")[0].appendChild(a),
                (t = i.scrollBarWidth()),
                t > 0 && (t = t),
                d.getElementsByTagName("head")[0].removeChild(a);
            }
            return (e.width = t), t;
          },
          ...
          indexOf: function (e) {
            var t = function (e) {
              ...
              for (t = 0; t < this.length; t++)
                if (
                  this[t] === e ||
                  decodeURIComponent(this[t]) === decodeURIComponent(e)
                ) {
                  a = t;
                  break;
                }
            ...
            getShareCounts: function (e, t) {
              if (!i.isUndefined(e)) {
                var a = e.services || e.service || e,
                  ...
                  o =
                    n ||
                    (c.addthis_share || {}).trackurl ||
                    _ate.track.mgu({}.url || (c.addthis_share || {}).url, {
                      clean: 1,
                      defrag: 1,
                    });
          ...
          truncateCount: function (e) {
            ...
            return i.isNumeric(e)
              ? t < 4
                ? Math.round(e)
                : t < 7
                ? i.roundWithSuffix(e, 1e3, "K")
                : t < 10
                ? i.roundWithSuffix(e, 1e6, "M")
                : i.roundWithSuffix(e, 1e9, "B")
              : e;
          },
          ...
          endsWith: function (e, t) {
            return (
              !(t.length > e.length) &&
              (e.substring(e.length - t.length) === t || "" === t)
            );
          },
      ...
      if (((a = a || this), e && t))
        for (n in e)
          if (e.hasOwnProperty instanceof Function) {
            if (e.hasOwnProperty(n) && ((i = t.call(a, n, e[n], e)), i === !1))
              break;
            ...
            i = function (e) {
              ...
              if (
                ("[object String]" === Object.prototype.toString.call(a) &&
                  (t = a.split(".").pop()),
                t && window && window._ate && window._ate.cbs)
              ) {
                var n;
                try {
                ...
                "[object Function]" ===
                  Object.prototype.toString.call(window._ate.cbs[t]) &&
                  window._ate.cbs[t](n);
              }
            };
          t && t.countUrl && "https" === t.countUrl.substring(0, 5)
            ? n({
                method: "POST",
          ...
          if (n.data && n.data.children) {
            ...
            for (var l in t) {
              ...
              t.hasOwnProperty(l) &&
                ...
                void 0 !== d.data.downs &&
                void 0 !== d.data.ups &&
                ((o += d.data.ups), (r += d.data.downs), (s += d.data.score));
            }
            e.callbackFunc({
              elem: a.elem,
              service: a.service,
      ...
      (t.default = function (e, t, a, n) {
        ...
        if (
          ...
          "https" === t.substring(0, 5)
            ? i.push(t.replace("https", "http"))
            : "http" === t.substring(0, 4) &&
              i.push(t.replace("http", "https")),
          (0, l.string)(e) && (e = [e]),
          (0, l.array)(e))
        ) {
          var r = [],
              ...
              if (
                ...
                c[t.service]
                  ? "compact" !== t.service &&
                    ...
                    (c[t.service].countUrl2 ||
                      t.countUrl === c[t.service].countUrl ||
                      ((c[t.service].count += t.count),
                      (c[t.service].countUrl2 = t.countUrl)))
                  : (r.push(t), (c[t.service] = t)),
                h === e.length * i.length)
              ) {
                var n = a.bind(this, r);
                setTimeout(n, 0);
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      (t.default = function (e, t) {
        ...
        if (
          ...
          m === r.PENDING_RESPONSE)
        )
          d.putCallback(a, h, t);
        else if (m === r.RESPONDED)
          s({
            params: e,
          ...
          var p = function (t) {
              ...
              n.forEach(function (a) {
                ...
                d.putResponse(a, h, t),
                d.clearCallbacks(a, h),
                d.putStatus(a, h, r.RESPONDED),
                clearTimeout(u);
            },
          ...
          c.call(n, {
            ...
            d.putStatus(a, h, r.PENDING_RESPONSE),
            d.putCallback(a, h, t),
            (0, l.increment)();
        }
      });
  ...
  670: function (e, t, a) {
    ...
    var r = (function () {
      ...
      u = (function () {
        function e() {
          i(this, e),
            (this._statusMap = new l.default()),
            (this._responseMap = new l.default()),
            (this._callbackMap = new l.default());
        }
        return (
          r(e, [
            {
            ...
            },
            {
              ...
              value: function (e, t, a) {
                o(e, t),
                  this._statusMap.put(e, t, h),
                  this._responseMap.put(e, t, a);
              },
            },
            {
              key: "putCallback",
  ...
  672: function (e, t, a) {
    ...
    function i(e, t, a) {
      ...
      n.forEach(function (e) {
        ...
        m.putResponse(e, t, a),
        m.clearCallbacks(e, t),
        m.putStatus(e, t, o.RESPONDED);
    }
    Object.defineProperty(t, "__esModule", {
      value: !0,
    }),
      (t.default = function (e, t) {
        ...
        if (
          (n.forEach(function (e) {
            ...
            l === o.PENDING_RESPONSE
              ? m.putCallback(i, r, t)
              : l === o.RESPONDED
              ? t(m.getResponse(i, r))
              : l === o.NOT_REQUESTED &&
                (m.putStatus(i, r, o.PENDING_RESPONSE),
                m.putCallback(i, r, t),
                s.push({
                  service: e,
                  cacheKey: i,
          ...
          var f = function () {
            ...
            g = function (e) {
              s.forEach(function (t) {
                ...
                (0, l.default)(n)
                  ? (o.count = e[t.endpointKey])
                  : ((o.count = 0),
                    (o.error = "Service request failed on the server")),
                  i(t.cacheKey, r, o);
              });
            };
          d.sort();
          ...
          _ate.ajs(
            "https://api-public.addthis.com/url/serviceapi/shares.json?services=" +
              ...
              "&pubId=" +
              encodeURIComponent((0, c.default)()) +
              "&callback=" +
              v,
            1
          ),
  ...
  673: function (e, t, a) {
    ...
    var n = a(641),
      ...
      w = function e(t, a) {
        if (arguments.length) {
          if (o.isString(t) && o.isPlainObject(a) && !o.isEmptyObject(a))
            return void s.thirdPartyWidget.apply(this, arguments);
          t = t || {};
          var n = {},
            l = {},
            w = {
              ...
              _globalEventHandlers: function () {
                return (
                  o.bindEvents(r.globalEvents || {}),
                  o.mobile() || o.bindEvents(r.desktopEvents || {}),
                  this
                );
              },
              ...
              _removeConflicts: function (e, t, a) {
                  ...
                  s = o
                    .map(function (a) {
                      var n = a.positionProperty,
                        ...
                        o =
                          t.hasOwnProperty(a.layer) &&
                          t[a.layer].hasOwnProperty(n)
                            ? t[a.layer]
                            : e[a.layer];
                      if (!o) return !1;
                      var r = i ? i(o[n]) : o[n];
                ...
                l.forEach(function (e) {
                  e.shift();
                  var t = 0;
                  a && (t = Math.floor(Math.random() * e.length)),
                    e.splice(t, 1),
                    e.forEach(function (e) {
                      delete n[e];
                    });
              ...
              _createLayers: function (t, a, i) {
                ...
                if (
                  (delete c.addthis,
                  (s =
                    t.showMobileOnDesktop === !0
                      ? r.getAllLayers()
                      : r.layers()),
                  (r.language = m()),
                  /^en(?:$|\-)/.test(r.language) ||
                    Object.keys(r.translationIds)
                      .filter(function (e) {
                      ...
                      s[e]
                        ...
                        .filter(function (e) {
                          return (
                            t[e] !== !1 &&
                            b.addthis[e] &&
                            (((!d.hasToolConfigs() || "mobile" !== e) &&
                              b.addthis[e].plugin !== !0) ||
                              (b.addthis[e].plugin === !0 && void 0 !== t[e]))
                          );
                        })
                        .forEach(function (e) {
                          n[e] = !0;
                  ...
                  !d.hasToolConfigs() &&
                    ((o.isEmptyObject(t) && void 0 === t.mobile) ||
                      (t.share && t.share.mobile !== !1) ||
                      (t.follow && t.follow.mobile !== !1)) &&
                    t.responsive !== !1 &&
                    "desktop" === l &&
                    !o.isIEQuirksMode())
                ) {
                ...
                o.isPlainObject(c) && (n = o.extend(o.cloneObject(c), n)),
                  w._removeConflicts(a, t);
                var p = Object.keys(n)
                  .filter(function (t) {
                    var a =
                      !e[t] ||
              ...
              destroy: function (t) {
                var a,
                  ...
                  p = [];
                return (
                  Object.keys(r.enabledLayers).forEach(function (t) {
                    (m && m[t]) || (e[t] = !1);
                  }),
                  !n || (m && m[d])
                    ? (n
                        ? ((u = r.activeFloatingWidgets[d]
                            ? r.activeFloatingWidgets[d]
                            : [m[d]]),
                          (p = Object.keys(u).map(function (e) {
                            var t = u[e];
                            return t.inlineClass
                              ? i("." + t.inlineClass)
                              : _ate.util.parent(
                                  t.element,
                                  ".addthis-smartlayers"
                        ...
                        : ((u = m), (p = i(".addthis-smartlayers"))),
                      Object.keys(u || {}).forEach(function (t) {
                        var n = u[t];
                        o.isPlainObject(n) &&
                          !o.isEmptyObject(n) &&
                          ((a = o.extend(n.events || {}, n.customEvents || {})),
                          o.trigger(
                            l + "." + n.basename + ".destroy",
                            window.addthis || {},
                            n
                          ),
                          o.bindEvents.call(n, a, "remove"),
                          (e[n.basename] = !1),
                          (n.rendered = !1),
                          o.removeElement(n.openControl),
                          o.removeElement(n.placeholder));
                      }),
                      ...
                      n
                        ? (c.destroy(l, d),
                          r.activeFloatingWidgets[d] &&
                            delete r.activeFloatingWidgets[d])
                        : c.destroy(),
                      o.isEmptyObject(c.get()) &&
                        ((r.activeFloatingWidgets = {}),
                        (e.initialized = !1),
                        (r.initialized = !1)),
                      this)
                    : "not an active layer"
          ...
          if (t.pii === !0 && r.receivedConfigFromServer)
            return (
              r.pageConfigs.forEach(function (e, t) {
                for (var a in e)
                  if (e.hasOwnProperty(a)) {
                    var n = r.layerList.addthis;
                    n[a] &&
                      n[a].inlineClass &&
                      ((l[a] = e[a]), r.pageConfigs.splice(t, 1));
                  }
              }),
              void (
                Object.keys(l) > 0 &&
          ...
          if (!_ate.ipc || t.pi) {
            ...
            (t = o.isPlainObject(t) && !o.isEmptyObject(t) ? t : {}),
              w._init(t, function (t, n) {
                var i = n.length,
                  r = 0,
                  s = 0;
                return (
                  0 === i
                    ? (o.isFunction(a) && a.call(v, v),
                      o.trigger("addthis.layers.loaded"),
                      o.trigger("addthis.layers.rendered"))
                    : (_ate.ed.addEventListener(
                        "addthis.layer.loaded",
                        function () {
                          (s += 1),
                            s === i && o.trigger("addthis.layers.loaded");
                        }
                      ),
                      _ate.ed.addEventListener(
              ...
              for (var C in t._default.widgets)
                if (t._default.widgets.hasOwnProperty(C)) {
                  var k = t._default.widgets[C],
                    _ = k.id || C;
                  _ate.track.apc(_),
                    k.thankyou && "false" === k.thankyou && (k.thankyou = !1);
                  var A = u(_, k);
    ...
    (w.lastViewRegistered = new Date().getTime()),
      (w.refresh = function (e, t) {
        var a,
          i = _ate.track.gtf(),
          o = i.children[0],
          r = new Date().getTime();
        if (
          (o || _ate.log.error("Could not find the sh frame!"),
          (window.addthis_share = window.addthis_share || {}),
          f.rescan(),
          "string" == typeof e && e.length > 0
            ? (window.addthis_share.url = e)
            : (window.addthis_share.url = f.du),
          "string" == typeof t
            ? (window.addthis_share.title = t)
            : (window.addthis_share.title = f.title),
          (_ate.du = _ate.truncateURL(f.du)),
          r - w.lastViewRegistered > 500 && o)
        ) {
          (w.lastViewRegistered = r),
            (a = o.src),
            i.removeChild(o),
            (_ate.sid = l());
          var s = _ate.track.ctf();
          (s.src = a.replace(/sid\=[a-zA-Z0-9]+/, "sid=" + _ate.sid)),
            _ate.track.gtf().appendChild(s),
            (0, n.refreshCallLayers)();
        }
  ...
  674: function (e, t, a) {
    var n,
      i,
      o = a(429).elementRequiresFacebookSDK,
      r = a(430),
      s = a(18);
    (n = [a(660), a(662), a(651), a(675)]),
      (i = function (e, t, a, n) {
        var i = a.layerList;
        return {
          addthisWidget: function (e, a) {
            ...
            return (
              (i[o] = i[o] || {}),
              (i[o][r] = a),
              addthis.addEventListener("addthis.layers." + e, function (e) {
                var a = e.target.name,
          ...
          addthisComponent: function (e, t) {
            return (
              (a.defaultOptions[e] = t.defaultOptions || {}),
              (a.desktopLayers[e] = e),
              (a.mobileLayers[e] = e),
              this.addthisWidget.apply(this, arguments),
              t
            );
          },
          thirdPartyWidget: function (n, o) {
            ...
            if (!c)
              return void t.warn(
                "You must provide a namespace for your AddThis Smart Layers plugin"
              );
            if (!h)
              return void t.warn(
                "You must provide a basename for your AddThis Smart Layers plugin"
              );
            if (!t.isPlainObject(o))
              return void t.warn(
                "You must provide an object to create your AddThis Smart Layers plugin"
              );
            if ("addthis" === c)
              return void t.warn(
                'You cannot use the "addthis" namespace for your AddThis Smart Layers plugin'
              );
            if (i[c] && i[c][h])
              return void t.warn(
                'There is already an AddThis Smart Layers plugin with a(n) "' +
                  c +
                  '" namespace and a(n) "' +
                  h +
                  '" basename'
            ...
            if (
              (i[c] ? (i[c][h] = p) : ((i[c] = {}), (i[c][h] = p)),
              (a.defaultOptions[c] = a.defaultOptions[c] || {}),
              (a.defaultOptions[c][h] = p.options || {}),
              addthis.addEventListener("addthis.layers" + u, function (e) {
                (r = e.target.options || {}),
                  (s = e.target.extendedOptions || {}),
                  l.createWidget({
                    name: m,
                    props: p,
          ...
          createWidget: function (l) {
            function d(e, i) {
              ...
              if (
                (t.isElement(e) &&
                  ((e.className = e.className.replace("at-wordpress-hide", "")),
                  (h.parentElement = e)),
                u)
              ) {
                ...
                if (
                  ((d = (function () {
                    for (var e = {}, n = 0; n < c.length; n++) {
                      var o,
                        ...
                        l = a.mappedDataAttributes()[s]
                          ? a.mappedDataAttributes()[s]
                          : s;
                      try {
                  ...
                  "recommendedbox" === p &&
                    (t.hasClass("addthis-recommendedbox-horizontal", e)
                      ? (d.orientation = "horizontal")
                      : t.hasClass("addthis-recommendedbox-vertical", e) &&
                        (d.orientation = "vertical")),
                  "desktop" === m && d.desktop === !1)
                )
                  return;
                if ("mobile" === m && d.mobile === !1) return;
              }
              (d = (t.isEmptyObject(d) ? i : d) || i),
                (l = n.create(p, h, d, v)),
                u &&
                  (null === e.getAttribute("data-url") &&
                    l &&
                    !l.isFollowLayer &&
                    l.getShareUrl() &&
                    e.setAttribute("data-url", l.getShareUrl()),
                  null === e.getAttribute("data-title") &&
                    l &&
                    !l.isFollowLayer &&
                    l.getShareTitle() &&
                    e.setAttribute("data-title", l.getShareTitle()),
                  null === e.getAttribute("data-description") &&
                    l &&
                    !l.isFollowLayer &&
                    l.getShareDescription() &&
                    e.setAttribute("data-description", l.getShareDescription()),
                  null === e.getAttribute("data-media") &&
                    l &&
                    !l.isFollowLayer &&
                    l.getShareMedia() &&
                    e.setAttribute("data-media", l.getShareMedia()),
                  o(e) && r(s()));
            }
            var c,
              h = l.props,
            ...
            (m = (function () {
              ...
              t.isString(m) && (c = e(m)),
              t.isUndefined(m) || 0 === c.length
                ? n.create(p, h, b, v)
                : 1 === c.length
                ? d(c[0], b)
                : c.length > 1 &&
                  (w !== !0
                    ? t.isUndefined(i[f][g].__numCalls__) && d(c[0], b)
                    : w === !0 &&
                      t.isArray(c) &&
        ...
        var n = o(window.location.search),
          ...
          g = {
            create: function (o, r, h, m) {
              if (
                a.isPlainObject(r) &&
                (!n.addthisdash || r.inline) &&
                (r.inline ||
                  !e.activeFloatingWidgets[o] ||
                  !e.activeFloatingWidgets[o][h.widgetId || "defaultId"])
              ) {
                var u,
                  b,
                  v = function () {
                ...
                if ("addthis" === y) {
                  ...
                  x = a.extend(
                    a.extend(
                      a.cloneObject(O),
                      a.cloneObject(e.defaultOptions[C])
                    ) || {},
                    a.extend(
                      {
                        layers: T,
                ...
                else for (b in m) m.hasOwnProperty(b) && (T[b] = m[b]);
                if (
                  ("addthis" !== y &&
                    (x = a.extend(
                      a.extend(
                        a.cloneObject(O),
                        a.cloneObject(e.defaultOptions[y][C])
                      ) || {},
                      a.extend(
                        {
                          layers: T,
                  ...
                  a.isString(r.inheritsFrom) && r.inheritsFrom.length)
                ) {
                  if (
                    ((k.names = r.inheritsFrom.split(".")),
                    (k.namespace = k.names[0]),
                    (k.basename = k.names[1]),
                    k.namespace && k.basename && a.isPlainObject(f[y][C]))
                  )
                    (_ = a.cloneObject(f[k.namespace][k.basename])),
                      (S = a.extend(_, r)),
                      (E = a.cloneObject(
                        "addthis" === k.namespace
                          ? e.defaultOptions[k.basename]
                          : e.defaultOptions[k.namespace][k.basename]
                      )),
                      (A = a.extend(E, x));
                  else if (k.namespace && !k.basename) {
                    if (((_ = f.addthis[k.namespace]), !_)) return;
                    (S = f[y][C] = a.extend(a.cloneObject(_), r)),
                      (E = a.cloneObject(e.defaultOptions[k.namespace])),
                      (A = a.extend(E, x));
                  }
                  v = function () {
                ...
                return (
                  (f[y][C].__numCalls__ =
                    a.isUndefined(I) || r.multipleCalls !== !0 ? 1 : I + 1),
                  (v.prototype = e),
                  (u = new v()),
                  (u.element = u.element || "#addthis-smartlayers-" + o),
                  (u.__numCalls__ = f[y][C].__numCalls__),
                  u.__numCalls__ > 1 &&
                    ((u.element = u.element + u.__numCalls__),
                    (u.closeControl = u.closeControl
                      ? u.closeControl + u.__numCalls__
                      : u.closeControl),
                    (u.openControl = u.openControl
                      ? u.openControl + u.__numCalls__
                      : u.openControl)),
                  (u.elementSelector = u.element),
                  (u.name = o),
                  (u.mobile = a.mobile()),
                  (u._super = e),
                  (u.inheritedObj = _),
                  a.isString(u.parentElement) &&
                    (u.parentElement = t(u.parentElement)[0]),
                  r.inheritsFrom ? (u.options = A) : (u.options = x),
                  (u.options.pubid =
                    u.options.altRecommendedPubId ||
                    u.options.pubid ||
                    i.addthis_pub ||
                    w.pubid ||
                    ""),
                  (a.mobile() && u.options.mobile === !1) ||
                  (a.desktop() && u.options.desktop === !1)
                    ...
                    : ((u.qwery = t),
                      (u.utils = a),
                      (u.rendered = !1),
                      (u.device = u.device || "both"),
                      u.options.elements && !t(u.options.elements).length
                        ? (a.trigger("addthis.layer.loaded", {
                            layer: u,
                          }),
                          a.trigger("addthis.layer.rendered", {
                        ...
                        : (c("mob") &&
                            u.events &&
                            (u.events = s(u.events, function (e) {
                              return !/\bmouse/.test(e);
                            })),
                          u.create(),
                          (u.async === !0 || a.isFunction(u.prerender)) &&
                            e.preRender.call(u),
                          u.render(),
                          u.pco && l.addPCO(u.pco),
                          a.trigger(
                            "addthis.layers." + this.name + ".loaded",
                            p,
                            this
                          ),
                          a.trigger("addthis.layer.loaded", {
            ...
            isHiddenByConfig: function (e) {
              ...
              if (
                e.__hideOnHomepage &&
                !i.location.search &&
                ("/" === i.location.pathname || "" === i.location.pathname)
              )
                return !0;
              if (e.__hideOnUrls)
                for (
                  var n = a.stripHashFromPath(a.stripProtocol(i.location.href)),
                    o = 0;
                  o < e.__hideOnUrls.length;
                  o++
                ) {
                  var s = a.stripHashFromPath(
                    a.stripProtocol(a.trim(e.__hideOnUrls[o]))
                  );
                  if (r(n, s)) return !0;
                }
  ...
  676: function (e, t, a) {
    var n, i;
    a(677),
      (n = [a(662), a(674), a(651), a(660), a(679)]),
      (i = function (e, t, a, n) {
  ...
  679: function (e, t, a) {
    ...
    var o = a(45),
      ...
      l = a(680),
      d = a(657);
    (n = [a(662), a(674), a(651), a(660), a(681)]),
        ...
        return t.addthisWidget("sharedock", {
          ...
          events: {
            ...
            "addthis.layers.scroll": function () {
              var t = e.scrollBottomPercentage(),
                n =
                  (void 0 === this.options.scrollDepth
                    ? -1
                    : this.options.scrollDepth) / 100;
              this.locked ||
                a.drawerIsVisible === !0 ||
                (t >= n
                  ? (this.show(),
                    e.removeClass(this.hideClass, this.wrapperElement),
                    e.removeClass(this.hideClass, this.element.parentElement))
                  : this.hide());
            },
          },
          iconSizes: {
          ...
          generateElement: function () {
            var t = this.getShareServices(),
              ...
              v = 100 / b;
            if (
              ((this.shareButtonElements = o(t, function (e) {
                var t = e.svc,
                  a = e.name,
                  n = r({
                    code: t,
                ...
                return s
                  ...
                  .style("width:" + v + "%;")
                  .role("button")
                  .attr("tabIndex", l.getATConfig("ui_tabindex", 0))
                  .title(a)
                  .css("at-share-btn", "at-svc-" + t).element;
              })),
              h)
            ) {
              var w = "width:" + v + "%;",
                x = "";
              m &&
                ((w += "background-color: " + m + ";"),
                (x += "color:" + u + ";")),
                (this.label = s
                  .span("SHARES")
                  .style(x)
                  .css("at4-share-label").element),
                (this.counter = s.span().style(x).css("at4-counter").element),
                (this.countElement = s
                  .a(this.counter, this.label)
                  .style(w)
                  .href("#")
                  .title(name)
                  .css("at4-count").element),
                this.shareButtonElements.unshift(this.countElement);
            }
            ...
            return s
              .div(
                s
                  .div("AddThis Sharing")
                  .id("at-share-dock-label")
                  .css(this.hideClass),
                s
                  .div(this.shareButtonElements)
                  .id(this.elementSelector.slice(1))
                  .css("at-share-dock", a, i, f)
              )
              .css("at-share-dock-outer", y, _ ? this.hiddenClass : "")
          ...
          renderShareCounts: function (t) {
            var a = t.reduce(function (e, t) {
              ...
              n = 0;
            if (
              (this.options.shareCountThreshold &&
                e.isNumber(this.options.shareCountThreshold) &&
                (n = this.options.shareCountThreshold),
              a < n)
            ) {
              var i = this.getShareServices(),
                o = 100 / i.length;
              e.setCSSAttr(this.countElement, "display", "none");
              for (var r = 0; r < this.shareButtonElements.length; r++)
                e.setCSSAttr(this.shareButtonElements[r], "width", o + "%");
            }
        ...
        return t.addthisWidget("share", {
          create: function () {
            var t,
              n = this.options,
              o = (function () {
                return i.addthis_config && e.isPlainObject(i.addthis_config)
                  ? i.addthis_config.services_exclude || ""
                  : "";
              })(),
              s = {},
              d = this.events || {},
            ...
            return (
              ...
              n.services
                ? ((this.personalized = !1),
                  (this.services = n.services.replace(/ /g, "").split(",")),
                  (n.numPreferredServices = this.services.length))
              ...
              e.isString(o) &&
                ...
                (this.options.services_exclude = s)),
              l("mob") ||
                ((t = c
                  ? function (e) {
                      c.apply(this, arguments),
                        a.commonEventHandlers.share.anticipateExpandedMenuClick(
                          e
                        );
                    }.bind(this)
                  : a.commonEventHandlers.share.anticipateExpandedMenuClick),
                (this.events = r({}, this.events, {
          ...
          events: {
            ...
            ".at-share-close-control click": function (t) {
              _ate.ed.fire("addthis.layers.share.hide", h, this),
                e.preventDefaultEvent(t);
            },
            "!.at-share-open-control click": function (t) {
              _ate.ed.fire("addthis.layers.share.show", h, this),
                e.preventDefaultEvent(t);
            },
            "addthis.layers.share.show": function (e) {
              (e.data && e.data.elementSelector !== this.elementSelector) ||
          ...
          generateElement: function () {
            var t,
              ...
              S = l.buttonSize || "48px";
            r.forEach(function (e) {
              _.shownServices || (_.shownServices = []),
                _.shownServices.push(e.svc);
            }),
              (t = d
                .div(d.div("Show").css("at4-arrow", "at-" + p))
                .id(C)
                .css(
                  "at-share-open-control",
                  "at-share-open-control-" + y,
                  c,
                  "at4-hide"
                )
                .attr("title", "Show")),
              (n = d
                .div(d.div("Hide").css("at4-arrow", "at-" + y))
                .id(k)
                .css("at-share-close-control", c, w, "at4-show")
                .attr("title", "Hide")),
              (i = d(r, function (t) {
                var a = t.svc,
                  n = t.name,
                          ...
                          d
                            .span(
                              d
                                ...
                                .css("at4-visually-hidden")
                            )
                            .css("at4-share-count")
                        )
                        .css("at4-share-count-container", w)
                    : null,
                  l = "Share to " + n;
                ...
                return (
                  r && c.appendChild(r.element),
                  d
                    .a(d.span(l).css("at4-visually-hidden"), c)
                    .role("button")
                    .attr("tabIndex", s.getATConfig("ui_tabindex", 0))
                    .css("at-share-btn", "at-svc-" + a)
                );
              })),
            ...
            return d
              .div(
                d.div("AddThis Sharing Sidebar").id("at4-share-label"),
                d
                  .div(x ? d.div(x).css("at4-share-title") : null, i, n)
                  .id(this.elementSelector.slice(1))
                  .css("at4-share", "addthis_32x32_style", f, g),
                t
              )
              .css("at4-share-outer" + (u ? "-right" : ""))
              .css(T ? this.hideAnimation : "")
              .css(T ? this.hideClass : "")
              .aria("labelledby", "at4-share-label")
              .role("region").element;
          },
          generateCounter: function (e, t, a) {
            return (
              (this.shareCountSumElement = d
                .div()
                .css("at-custom-sidebar-count")
                .style("color:" + e).element),
              (this.shareCountWrapperElement = d
                .div(
                  this.shareCountSumElement,
                  d
                    .div(t)
                    .css("at-custom-sidebar-text")
                    .style("color:" + e)
                )
                .css("at-custom-sidebar-counter")
                .style("width: " + a + ";word-wrap: break-word").element),
              this.shareCountWrapperElement
            );
          },
          ...
          renderShareCounts: function (e) {
            this.showIndividualCounts() && this.renderIndividualShareCounts(e),
              this.showTotalCounts() && this.renderTotalCounts(e);
          },
          renderTotalCounts: function (t) {
            ...
            this.options.shareCountThreshold &&
              ...
              (n = this.options.shareCountThreshold),
              a < n &&
                e.setCSSAttr(this.shareCountWrapperElement, "display", "none"),
              (this.shareCountSumElement.innerHTML = e.truncateCount(a)),
              e.removeClass(this.hideClass, this.wrapperElement);
          },
          renderIndividualShareCounts: function (t) {
            ...
            this.options.shareCountThreshold &&
              e.isNumber(this.options.shareCountThreshold) &&
              (p = this.options.shareCountThreshold),
              t
                .filter(function (e) {
                  return (
                    s.counts !== c.CountType.BOTH ||
                    ("addthis" !== e.service && "compact" !== e.service)
                  );
                })
                .filter(function (t) {
                  var a = t.service,
                ...
                .forEach(function (t) {
                  var o = t.service,
                    r = t.count;
                  if (
                    ((a = n(d + " .at-svc-" + o + " .at4-share-count")[0]),
                    !a &&
                      h[o] &&
                      (a = n(d + " .at-svc-" + h[o] + " .at4-share-count")[0]),
                    e.isElement(a))
                  ) {
                    if (
                      ((i = _ate.util.parent(a, ".at-share-btn")),
                      0 === o.indexOf("pinterest"))
                    ) {
                      if (u) return;
                      u = !0;
                    }
                    i !== m &&
                      i !== m.body &&
                      e.isElement(i) &&
                      e.addClass("at4-share-count-anchor", i),
                      a.appendChild(m.createTextNode(e.truncateCount(r)));
                  }
                }),
              (o = n(d + " .at4-share-count-container")),
              o.length &&
                o.forEach(function (t) {
                  e.removeClass(l, t),
                    r.show(t, "fadeIn", function () {
    ...
    e.exports = i.addthisWidget("drawer", {
      ...
      prerender: function () {
        var e = this,
          ...
          m = s
            .div(s.div().id("at-drawer-open-arrow"))
            .id("at-drawer-arrow")
            .css(a, d, h, o.hideClass);
        return (
          (n.isString(t.elements) && t.elements.length) ||
            (l.body.appendChild(m.element), (m = ""), (c = "")),
          s.div(m).id("at4-drawer-outer-container").css(r, c, a).element
        );
      },
      events: {
      ...
      showdrawer: function () {
        ...
        "right" === s &&
          h &&
          n.trigger("addthis.layers.whatsnext.hide", d, this),
          "right" === s &&
            m &&
            n.trigger("addthis.layers.toaster.hide", d, this),
          n.addClass("at4-drawer-shown", e.container),
          n.addClass(o.hideClass, e.openControl),
          "push" === t.animationType
            ? requestAnimationFrame(function () {
                n.isElement(i) &&
                  (n.addClass("at4-drawer-push-animation-" + s, i),
                  n.addClass("at4-drawer-push-content-" + s + "-back", i),
                  n.requestTimeout(function () {
                    n.addClass("at4-drawer-push-content-" + l, i);
                  }, 0)),
                  n.removeClass(o.hideClass, a),
                  n.removeClass("at4-drawer-push-animation-" + s, a),
                  n.removeClass("at4-drawer-push-animation-" + s + "-back", a),
                  n.requestTimeout(function () {
                    n.addClass("at4-drawer-push-animation-" + s, a);
                  }, 0);
              })
            : e.show(e.element, t.showAnimation),
          (o.drawerIsVisible = !0);
      },
      hidedrawer: function () {
        var e = this,
        ...
        "push" === t.animationType
          ? requestAnimationFrame(function () {
              n.isElement(s) &&
                (n.addClass("at4-drawer-push-content-" + l + "-back", s),
                n.requestTimeout(function () {
      ...
      (i = function (e, t, a) {
        ...
        return t.addthisWidget("follow", {
          create: function () {
            ...
            var a = [];
            return (
              t && t.services && t.services.length
                ? s(t.services, function (e) {
                    a.push(e.service);
                  })
          ...
          events: {
            ...
            ".at4-follow-close-control click": function (t) {
              e.trigger("addthis.layers.follow.hide", n, this),
                (this.locked = !0),
                e.preventDefaultEvent(t);
            },
            "!.at-follow-open-control click": function (t) {
              e.trigger("addthis.layers.follow.show", n, this),
                (this.locked = !0),
                e.preventDefaultEvent(t);
            },
            ...
            ".at-follow-btn keydown": function (t, a) {
              if ("enter" === e.KEYCODES[t.keyCode]) {
                ...
                "twitter" === n.svc &&
                  (e.preventDefaultEvent(t),
                  e.stopEventPropagationImmediately(t));
              }
            },
            ...
            "addthis.layers.resize": function () {
              "desktop" === e.getCurrentDevice(this) &&
              e.hasClass(this.mobileClass, this.element)
                ? e.removeClass(this.mobileClass, this.element)
                : "mobile" !== e.getCurrentDevice(this) ||
                  e.hasClass(this.mobileClass, this.element) ||
                  e.addClass(this.mobileClass, this.element);
            },
          },
          generateElement: function () {
                ...
                f &&
                  ...
                  n.push(
                    l
                      ...
                      .href(y)
                      .target("_blank")
                      .css("at-follow-btn", "at-circular-element")
                  ));
              }
            return l
              .div(
                l
                  .div(
                    l.div("Follow").id("at4-follow-label"),
                    l
                      .div(
                        l
                          .div(
                            l
                              .div("Hide")
                              .title("Hide")
                              .css("at4-arrow", "at-right")
                          )
                          .id(h)
                          .css("at4-follow-close-control"),
                        l
                          .div(l.span(i.title || "").css("at-follow-label"), n)
                          .css("at4-follow-container", "addthis_24x24_style")
                      )
                      .css("at4-follow-inner")
                  )
                  .role("region")
                  .aria("labelledby", "at4-follow-label")
                  .id(this.elementSelector.slice(1))
                  .css("at4-follow", "at4-follow-24", s, m),
                l
                  .div(l.div("Show").title("Show").css("at4-arrow", "at-left"))
                  .id(c)
                  .css("at-follow-open-control", s, a.hideClass)
              )
            ...
            return (
              (n = e.filter(n, function (e) {
                if (e.id && e.service) {
                  ...
                  return (
                    !!(t && a && r) &&
                    ((e.svc = e.service), (e.name = n), (e.followUrl = r), !0)
                  );
                }
              })),
              "vertical" === c && (this.pco = this.pco.replace("flwh", "flwv")),
              "custom" === i && (this.pco = "c" + this.pco),
              a
                .div(
                  a.p(a.span(this.options.title)),
                  a
                    .div(
                      a(n, function (e) {
                        var t = e.followUrl,
                        ...
                        return a
                          .a(
                            ...
                            a
                              .span(
                                a.span("Follow on ").css("at4-visually-hidden"),
                                e.name
                              )
                              .css("addthis_follow_label")
                          )
                          .css("at300b", "at-follow-btn")
                          .data("svc", e.svc)
                          .data("svc-id", e.id)
                          .attr("title", "Follow on " + e.name)
                          .attr("href", t)
                          .attr("target", "_blank");
                      }),
                      a.div().css("atclear")
                    )
                    .css("addthis_toolbox", h)
                )
                .id(this.element.substring(1))
                .css("at-follow-tbx-element").element
            );
          },
          events: {
  ...
  696: function (e, t, a) {
    ...
    e.exports = {
      ...
      events: {
        ...
        ".at-svc-compact.at-share-btn mouseover":
          i.eventInterceptors.share.showCompactMenu,
        "!.at-svc-compact.at-share-btn mouseleave":
          i.commonEventHandlers.share.hideCompactMenu,
        "addthis.layers.resize": function () {
          var e = this.getOptions();
          e.style === f.RESPONSIVE &&
            ("desktop" === n.getCurrentDevice(this) &&
            n.hasClass(this.mobileClass, this.element)
              ? n.removeClass(this.mobileClass, this.element)
              : "mobile" !== n.getCurrentDevice(this) ||
      ...
      generateElement: function () {
        var e = this.getOptions(),
          t = e.theme || !1;
        return e.thirdPartyButtons || e.style === f.ORIGINAL
          ? ((this.pco = "scopl-300"), this.generateThirdPartyElement())
          : ("custom" === t && (this.pco = "c" + this.pco),
            this.generateShareElement());
      },
      ...
      generateShareElement: function () {
        var e = this,
          ...
          m =
            r && "mobile" === n.getCurrentDevice(this) ? this.mobileClass : "",
          u = a.size || "32px",
          g = a.borderRadius,
        ...
        return (
          this.getShareServices().forEach(function (a) {
            var n = a.svc,
              i = a.name,
              o = [];
            x || o.push(e.getLabel(i, y)),
              t.push(
                d(
                  n,
                  i,
              ...
              e.shownServices.push(n);
          }),
          (this.parentElement.style.clear = "both"),
          o === p.JUMBO && (this.parentElement.style.display = "none"),
          o !== p.JUMBO
            ? s
                .div(
                  s
                    .span("AddThis Sharing Buttons")
                    .id(C)
                    .css("at4-visually-hidden"),
                  s.div(t).css("at-share-btn-elements")
                )
                .id(this.elementSelector.replace("#", ""))
                .css(c, l, m)
                .aria("labelledby", C)
                .role("region").element
            : ((this.countElement = this.generateJumboCountInnerElement("0")),
              (this.outerCountElement = this.generateJumboCountOuterElement(
                this.countElement
              )),
              (this.shareButtonElements = s
                .td(t)
                .css(
                  c,
              ...
              s
                .div(
                  s
                    .div(
                      s.div("AddThis Sharing").id(C).css("at4-hide"),
                      s.table(
                        s.tr(this.outerCountElement, this.shareButtonElements)
                      )
                    )
                    .css(m)
                )
                .id(this.elementSelector.replace("#", ""))
                .css("at4-jumboshare", l, m)
                .aria("labelledby", C)
                .role("region").element)
        );
      },
      ...
      generateJumboCountOuterElement: function (e) {
        ...
        return s
          .td([
            s.div([o, e]).css("at4-count").style(l),
            s
              .div(a)
              .css("at4-title")
              .style(r + l),
          ])
          .css("at4-count-container").element;
      },
      renderShareCounts: function (e) {
        var t = this,
          a = this.getOptions(),
        ...
        if (i === p.SUM || i === p.JUMBO) {
          ...
          o > 0 && o >= n && t.insertCount(u.shareService, o),
            i === p.JUMBO &&
              (this &&
                this.outerCountElement &&
                this.outerCountElement.style &&
                (o <= 0 || o < n) &&
                ((this.outerCountElement.style.display = "none"),
                this.shareButtonElements &&
                  ((this.shareButtonElements.style =
                    this.shareButtonElements.style || {}),
                  (this.shareButtonElements.style.paddingLeft = "0"))),
              this &&
                this.parentElement &&
                this.parentElement.style &&
                (this.parentElement.style.removeProperty
                  ? this.parentElement.style.removeProperty("display")
                  : this.parentElement.style.removeAttribute("display")));
        } else
          i === p.EACH &&
            e.forEach(function (e) {
      ...
      insertCount: function (e, t) {
        ...
        if ((u && (b += "color:" + u + ";"), d === p.JUMBO)) {
          ...
          r === f.RESPONSIVE
            ? ((w = s
                .span(n.truncateCount(t))
                .css("at4-share-count-container")
                .style(b).element),
              x.appendChild(w))
            : r === f.FIXED &&
              ((w = s
                .span(n.truncateCount(t))
                .css("at_flat_counter")
                .style("line-height:" + m + ";font-size:" + g).element),
              x.parentNode.insertBefore(w, x.nextSibling));
        }
      },
      generateThirdPartyElement: function () {
        var e = this.getOptions(),
          ...
          n = a.map(function (t) {
            ...
            if ("pinterest_pinit" === t)
              return s
                .a()
                .css(a)
                .attr("pi:pinit:layout", "horizontal")
                .attr("pi:pinit:url", e.url || window.location.href)
                .attr("pi:pinit:media", e.media || "");
            var n, i;
            switch (t) {
              case "facebook_like":
  ...
  697: function (e, t, a) {
    ...
    (n = [a(661)]),
      (i = function (e) {
        var t = function (e) {
          (e = e || {}),
            (this.start = parseInt(e.start, 10) || 0),
            (this.current = this.start),
            (this.end = parseInt(e.end, 10) || 0),
        ...
        return (
          (t.prototype.step = function () {
            ...
            e(function () {
              var e = new Date().getTime(),
                a = e - t.startTime;
              (t.current = Math.min(t.end, (a / t.duration) * t.end)),
                t.trigger("step", t.current),
                t.current != t.end ? t.step() : t.trigger("done", t.current);
            });
          }),
          ...
          (t.prototype.off = function (e, t) {
            void 0 === t
              ? (this.listeners[e] = [])
              : this.listeners[e] &&
                this.listeners[e].splice(this.listeners[e].indexOf(t), 1);
          }),
          (t.prototype.trigger = function (e, t) {
            var a,
              n = Array.prototype.slice.call(arguments, 1);
            if (this.listeners[e])
              for (a = 0; a < this.listeners[e].length; a++)
                this.listeners[e][a].apply(this, n);
          }),
          t
        );
      }.apply(t, n)),
  ...
  698: function (e, t, a) {
    ...
    function n(e, t) {
      ...
      (t.buttonHeight = void 0),
        (t.buttonWidth = void 0),
        (t.backgroundColor = null),
        (t.borderRadius = null),
        (t.borderWidth = null),
        (t.borderStyle = null),
        (t.borderColor = null),
        void 0 === a.backgroundColor && (a.backgroundColor = l(e));
      var n = "";
      for (var i in a)
    ...
    function i(e, t, a) {
      ...
      return o
        .a(h)
        .role("button")
        .attr("tabIndex", r.getATConfig("ui_tabindex", 0))
        .css("at-icon-wrapper", "at-share-btn", "at-svc-" + e)
        .style(l);
    }
    Object.defineProperty(t, "__esModule", {
      value: !0,
  ...
  699: function (e, t, a) {
    ...
    e.exports = i.addthisWidget("recommended", {
      ...
      generateElement: function () {
        if (
          "recommendedbox" === this.name &&
          n.isElement(this.parentElement.parentNode) &&
          this.parentElement.parentNode.__containsRecommended__ === !0
        )
          return !1;
        "recommendedbox" === this.name &&
          n.isElement(this.parentElement.parentNode) &&
        ...
        var e = a(331)({
          ...
          v =
            this.options.textonly === !0 || "true" === this.options.textonly
              ? "at4-recommended-text-only"
              : "",
          w = o.themes[r.theme] || "",
          x = this.position
            ? "right" === this.position
              ? "at4-" + this.basename + "-right"
              : "at4-" + this.basename + "-left"
            : "",
          y = p + "-logo",
          C = this.position,
          k = "left" === this.position ? "right" : "left",
          _ = (this.trendingLinksJson = this.superMethod(
            "generateTrendingJson",
            this.pco,
            u * c
          ));
        ...
        A = d
          ? s
              ...
              .css(
                ...
                "vertical" === r.orientation ? "at-vertical" : ""
              )
          : s
              .div("AddThis Recommended")
              .css("at-h3", "at-recommended-label", o.hiddenClass);
        var E = null;
        this.showCloseButton === !0 &&
          (E = s
            .button("x")
            .title("Close")
            .css("at4-closebutton", this.basename + "-close"));
        var S = null;
        this.closeControl &&
          (S = s
            .div(
            ...
            .title("Hide")
            .id("at4-" + this.basename + "-close-control")
            .css("at4-recommended-control", o.hideClass));
        var I = null;
        this.openControl &&
          (I = s
            .div(
            ...
            .id("at4-" + this.basename + "-open-control")
            .css("at4-recommended-control", o.hideClass, w));
        for (var O = [], T = {}, M = 0; M < c; M++)
          (T[".at4-recommended-container." + p] = _.slice(M * u, (M + 1) * u)),
            O.push(l(T));
        return s
          .div(
            I,
            s
              .div(
                ...
                E,
                O,
                s.div(s.div(i).css("at4-logo-container")).css("at-logo", y),
                S
              )
              .role("region")
              .aria("labelledby", "at-recommended-label")
              .id(this.elementSelector.substring(1))
              .css(
                "at4-" + this.basename + "-class",
                "at4-recommended",
                g,
                b,
                w,
          ...
          .css("at4-" + this.basename + "-outer", x).element;
      },
      ...
      calcMaxRecItems: function (e, t, a) {
        ...
        return n.isString(h) && !parseInt(h, 10)
          ? ("vertical" === e.orientation
              ? ((i = "at4-recommended-vertical"),
                (o = "offsetHeight"),
                (r = m.offsetHeight))
              : ((i = "at4-recommended-horizontal"),
                (o = "offsetWidth"),
                (r = m.offsetWidth)),
            (c = s
              .div(
                s
                  .div(s.div().css("at4-recommended-item"))
                  .css("at4-recommended-container", i)
              )
              .id(u)
              .css("temp-elem", "at4-recommended", t, a).element),
            d.appendChild(c),
            (l = c[o]),
            d.removeChild(c),
            0 === l || r < l ? 4 : Math.floor(r / l))
          : n.isNumber(parseInt(h, 10))
          ? e.maxitems
          : void 0;
      },
    });
  ...
  702: function (e, t, a) {
    var n, i;
    a(700),
      (n = [a(662), a(674), a(651), a(660), a(699)]),
      (i = function (e, t, a, n) {
        return t.addthisWidget("recommendedbox", {
          create: function () {
            var e = this.options || {},
              t = e.orientation;
            "vertical" === t &&
              ((this.pco = "smlrebv-1.0"), (this.options.size = "large")),
              this.superMethod("create");
          },
          pco: "smlrebh-1.0",
  ...
  703: function (e, t, a) {
    ...
    var n = a(485),
      ...
      s = a(332);
    a(704),
      (e.exports = o.addthisWidget("recommendedjumbo", {
        pco: "jrcf-1.0",
        device: "both",
        ...
        events: {
          "addthis.layers.resize": function () {
            "desktop" === i.getCurrentDevice(this) &&
            i.hasClass(this.mobileClass, this.element)
              ? i.removeClass(this.mobileClass, this.element)
              : "mobile" !== i.getCurrentDevice(this) ||
                i.hasClass(this.mobileClass, this.element) ||
                i.addClass(this.mobileClass, this.element),
              this.imageResizing();
          },
        },
        prerender: function () {
          return s
            .div()
            .id("at-" + this.basename + "-outer-container")
            .css("at-" + this.basename + "-outer-container").element;
        },
        render: function () {
          return (
            this.queueTrending(
              ...
              .div(
                s
                  .div(
                    s
                      .a(
                        s.img().src(h.image).id("at-recommendedjumbo-footer-bg")
                      )
                      .id("bg-link")
                      .href(m),
                    s
                      .div(
                        s
                          .div(
                            s.div(t).id("at-recommendedjumbo-label").title(t)
                          )
                          .css("at-recommendedjumbo-footer-inner")
                          .id("at-recommendedjumbo-label-holder"),
                        s
                          .div(
                            s
                              .div(s.a(h.title).href(m))
                              .title(h.title)
                              .id("at-recommendedjumbo-content-title")
                          )
                          .css("at-recommendedjumbo-footer-inner")
                          .id("at-recommendedjumbo-title-holder"),
                        s
                          .small(h.domain)
                          .css("at-recommendedjumbo-footer-inner")
                      )
                      .id("at-recommendedjumbo-top-holder"),
                    d
                      .generateBranding(c)
                      .css("at-recommendedjumbo-footer-inner at-logo-container")
                  )
                  .css("at-recommendedjumbo-footer")
              )
              .id(e)
              .css("at-recommendedjumbo " + o).element;
          }
          return l;
        },
        imageResizing: function (e) {
          if (this.hasFeed && this.element) {
            ...
            t.superMethod("titleResizer", o, s, d),
              t.superMethod("titleResizer", a, n, d, i),
              l.__imageloaded__
                ? t.superMethod("resizeTrendingImage", l)
                : t.superMethod("imageResizer", [], [l], e);
          }
        },
      }));
  },
        ...
        return t.addthisWidget("thankyou", {
          ...
          events: {
            "addthis.menu.share": function (e, t) {
              if (n.active_layers.addthis.share) {
                ...
                a && i && i.length
                  ? this.triggerPostActionEvent(e, "share-follow")
                  : this.triggerPostActionEvent(e, "share-trending");
              }
            },
            "addthis.menu.follow": function (e, t) {
              n.active_layers.addthis.follow &&
                this.triggerPostActionEvent(e, "follow-trending");
            },
            ...
            "addthis.postaction": function (t, a) {
              ...
              if (
                !(
                  n.lastShown ||
                  "pinterest_share" == t.data.service ||
                  "pinterest" == t.data.service ||
                  (e.isPlainObject(t.data) &&
                    e.isString(t.data.type) &&
                    (o.layers[n.POSTACTION_SURFACES[t.data.type].type] || {})
                      .thankyou === !1)
                ) &&
                ((n.lastShown = new Date().valueOf()),
                t && t.data && t.data.service && t.data.type)
              ) {
                var r,
                  s = (t.data.service, t.data.type);
                e.removeChildren(i("#at4-thankyou .at4-thankyou-layer")[0]),
                  (r = this.POSTACTION_SURFACES[s].display),
                  (s = this.POSTACTION_SURFACES[s].type),
                  n.hold ? (n.hold = !this.hold) : n.display(s, r);
              }
            },
            click: function (t, a) {
            ...
            ".at-follow-btn click": function (t, a) {
              ...
              this.superMethod("follow", n, r, o),
                e.trigger("addthis.thankyou.hold", addthis, {
                  action: "share/follow",
                }),
                "twitter" !== n ||
                  e.mobile() ||
          ...
          triggerPostActionEvent: function (t, a, n) {
            if (t && t.data && t.data.service) {
              ...
              r
                ? (this.blacklist[r] && !n) ||
                  ((i = c.activeElement.nodeName.toLowerCase()),
                  c.activeElement &&
                    "iframe" === i &&
                    "activeElement" in c &&
                    (d.focus(), c.activeElement.blur()),
                  (o = function () {
          ...
          display: function (t, a) {
            (this.title && this.description) ||
              ((this.title = i("#at4-thankyou .thankyou-title")[0]),
              (this.description = i("#at4-thankyou .thankyou-description")[0]));
            var n = this.title,
              o = this.description;
            if ((e.addClass("at-thankyou-shown", this.element), t && n && o))
              if (
                (e.bindEvents.call(this, this.customEvents, "remove"),
                "share" === t)
              )
                switch (a) {
                  case "follow":
                    (n.innerHTML = this.options.layers.share.postShareTitle),
                      (o.innerHTML =
                  ...
                  case "trending":
                    (n.innerHTML = this.options.layers.share.postShareTitle),
                      (o.innerHTML =
                        this.options.layers.share.postShareRecommendedMsg),
                      this.postactionTrending();
                }
              else if ("follow" === t)
                switch (a) {
                  case "trending":
                    (n.innerHTML = this.options.layers.follow.postFollowTitle),
                      (o.innerHTML =
                        this.options.layers.follow.postFollowRecommendedMsg),
                      this.postactionTrending();
                }
          },
          postactionFollow: function () {
            var e = this.generateFollowHtml();
            e && i("#at4-thankyou .at4-thankyou-layer")[0].appendChild(e),
              this.superMethod("showControl", i("#at4-palogo")[0]),
              this.superMethod("showControl", i(".at4x")[0]),
              this.show();
          },
          postactionTrending: function () {
            ...
            return (
              !!a.length &&
              (e.addClass(n.hiddenClass, o),
              e.removeClass(n.hideClass, o),
              addthis.layers(
                {
                  recommendedbox: r,
                  pi: !0,
                ...
                function () {
                  e.addClass(n.hideClass, o),
                    e.removeClass(n.hiddenClass, o),
                    t.show();
                }
              ),
              void 0)
          ...
          generateJson: function () {
            var t = a(331)(),
              ...
              o = {},
              r = this.themes[this.options.theme]
                ? "." + this.themes[this.options.theme]
                : "";
            return (
              (o[
                "div#at4-thankyou.at4-thankyou.at4-thankyou-background." +
                  n.hideClass +
                  r +
                  (e.mobile()
                    ? " .at4-thankyou-mobile"
                    : ".at4-thankyou-desktop")
              ] = {
                role: "dialog",
              ...
              .map(function (t) {
                ...
                if (a && n && o) {
                  ...
                  return (
                    ...
                    (c.svcId = n),
                    "rss" === a
                      ? ((c.href = 0 !== n.indexOf("http") ? "http://" + n : n),
                        (c.target = "_blank"))
                      : "twitter" !== a || e.mobile()
                      ? ((c.href = o), (c.target = "_blank"))
                      : (c.href = "//twitter.com/" + n),
                    {
    ...
    e.exports = i.addthisWidget("toaster", {
      ...
      events: {
        ...
        "addthis.layers.scroll": function () {
          ...
          this.locked ||
            ...
            (e < t
              ? n.trigger("addthis.layers.toaster.hide", d, this)
              : e > t && n.trigger("addthis.layers.toaster.show", d, this));
        },
        "addthis.layers.toaster.show": function (e) {
          var t = this;
          (e.data &&
            e.data.elementSelector &&
            e.data.elementSelector !== this.elementSelector) ||
            n.hasClass(o.showClass, this.element) ||
            n.isVisible(this.element) ||
            (h(this.openControl, this.options.showAnimation),
            this.hide(this.openControl, this.options.hideAnimation),
            this.show(null, null, function () {
        ...
        "addthis.layers.toaster.hide": function (e) {
          ...
          (e.data &&
            e.data.elementSelector &&
            e.data.elementSelector !== this.elementSelector) ||
            (!n.hasClass(o.hideClass, this.element) &&
              n.isVisible(this.element) &&
              (this.hide(null, null, function () {
                c(t.element, o.hideClass);
              }),
              h(this.openControl, this.options.hideAnimation),
              this.show(this.openControl, this.options.showAnimation),
              (this.status = "closed")));
        },
      },
      generateElement: function () {
        var e = this.options,
          ...
          C = (this.trendingLinksJson = this.superMethod(
            "generateTrendingJson",
            this.pco,
            n
          ));
        ...
        return s
          .div(
            ...
            s
              .div(
                s.div(t).css("at-recommended-label", f),
                k,
                s.div(s.div(y).css("at4-logo-container")).css("at-logo", p),
                s
                  .div(
                    s
                      .div()
              ...
              .aria("labelledby", "at-recommended-label")
              .id(i)
              .css("at4-recommended", "at4-recommended", g, f, m, u, c, h)
          )
          .css("at4-toaster-outer").element;
      },
      postEvents: function () {
        var e = this,
  ...
  718: function (e, t, a) {
    ...
    var n = a(44),
      ...
      u = window.addthis;
    a(719),
      (e.exports = d.addthisWidget("whatsnext", {
        render: function () {
          return (
            this.queueTrending(
              this.options.pubid,
        ...
        events: {
          ...
          ".at-whatsnext-close-control click": function () {
            l.trigger("addthis.layers.whatsnext.hide", u, this),
              (this.locked = !0);
          },
          "!.at-whatsnext-open-control click": function () {
            l.trigger("addthis.layers.whatsnext.show", u, this),
              (this.locked = !0);
          },
          "addthis.layers.scroll": function () {
            ...
            this.locked ||
              ...
              (e < t
                ? l.trigger("addthis.layers.whatsnext.hide", u, this)
                : e > t && l.trigger("addthis.layers.whatsnext.show", u, this));
          },
          "addthis.layers.whatsnext.show": function (e) {
            ...
            (e.data &&
              e.data.elementSelector &&
              e.data.elementSelector !== this.elementSelector) ||
              l.hasClass(c.showClass, this.element) ||
              l.isVisible(this.element) ||
              (s(this.openControl, this.options.showAnimation),
              this.hide(this.openControl, this.options.hideAnimation),
              this.show(null, null, function () {
          ...
          "addthis.layers.whatsnext.hide": function (e) {
            ...
            (e.data &&
              e.data.elementSelector &&
              e.data.elementSelector !== this.elementSelector) ||
              (!l.hasClass(c.hideClass, this.element) &&
                l.isVisible(this.element) &&
                (this.hide(null, null, function () {
                  r(t.element, c.hideClass);
                }),
                s(this.openControl, this.options.hideAnimation),
                this.show(this.openControl, this.options.showAnimation),
                (this.status = "closed")));
          },
        },
                    ...
                    m
                      .a(
                        m
                          ...
                          .attr(
                            "data-secure",
                            e.image._secureimage ? "true" : ""
                          )
                          .alt(e.title)
                          .title(e.title)
                          .src(e.image)
                          .css("at-whatsnext-img", "at-tli")
                      )
                      .attr("surface", "whatsnext")
                      .href(l)
                      .css("at-whatsnext-img-lnk")
                  )
                  .css("at-whatsnext-content-img"))
              : (b = "at-whatsnext-nophoto"),
            m
              .div(
                m
                  .div("Show")
                ...
                m
                  .div(
                    m.div("AddThis What's Next").id("at4-whatsnext-label"),
                    m
                      .div(
                        v,
                        m
                            ...
                            m
                              .div(
                                m
                                  ...
                                  .css("at-recommendedTitle")
                              )
                              .css("at-h3"),
                            m.small(e.domain || "").id("at-whatsnext-dom")
                          )
                          .css("at-whatsnext-content-inner"),
                        m.a(g).href(n(i)).target("_blank").title("AddThis")
                      )
                      .css("at-whatsnext-content"),
                    m
                      .div("Hide")
                      .title("Hide")
                      .id(u)
                      .css(
                        "at-whatsnext-close-control",
                        "at4-arrow",
                        "at-down",
                        c.hideClass
                      )
  ...
  721: function (e, t, a) {
    ...
    var n = a(44),
      ...
      h = window.addthis;
    a(722),
      (e.exports = s.addthisWidget("whatsnextmobile", {
        render: function () {
          return (
            this.queueTrending(
              this.options.pubid,
        ...
        events: {
          ".at-close-control click": function () {
            r.trigger("addthis.layers.whatsnextmobile.hide", h, this),
              (this.locked = !0);
          },
          "addthis.layers.scroll": function () {
            ...
            this.locked ||
              l.drawerIsVisible === !0 ||
              (e > t &&
                r.trigger("addthis.layers.whatsnextmobile.show", h, this));
          },
          "addthis.layers.whatsnextmobile.show": function (e) {
            (e.data &&
              ...
              ("open" !== this.status &&
                ((this.status = "open"),
                this.show(),
                r.removeClass(this.hideClass, this.element)));
          },
        ...
        generateElement: function () {
          ...
          return c
            .div(
              c.div("AddThis What's Next").id("at4-whatsnext-label"),
              c
                .div(
                  c.button("×").css("close").aria("hidden", !0).type("button")
                )
                .id(m)
                .css("at-close-control"),
              c
                .div(
                  c
                    .div(
                      c
                        .a(
                          c
                            .img()
                            .id("at-whatsnextmobile-img")
                            .data("secure", e.image._secureimage ? "true" : "")
                            .src(e.image)
                            .alt(e.title)
                            .title(e.title)
                            .css("at-tli")
                        )
                        .id("at-whatsnextmobile-img-lnk")
                        .href(d)
                        .attr("surface", "whatsnext")
                    )
                    .css("at-whatsnext-content-img", "col-2"),
                  c
                    .div(
                      c.div(s).css("at-h6"),
                      c
                    ...
                    .css("at-whatsnext-content-inner", "col-2")
                )
                .css("at-whatsnext-content"),
              c
                .div(
                  c.small(e.domain || "").id("at-whatsnext-dom"),
                  c.small(c.a(f).href(n(i)).target("_blank").title("AddThis"))
                )
                .css("footer")
            )
            .id(h)
            .css("at4-whatsnextmobile", "at4-whatsnext-outer", r).element;
        },
        postEvents: function () {
          var e = this,
            t = d(".at-recommendedTitle", e.element);
          this.element &&
            (r.removeClass(l.hideClass, this.element.parentElement),
            r.removeClass(l.hideClass, this.element),
            r.addClass(this.hideClass, this.element)),
            e.superMethod("imageResizer", t, []),
            e.superMethod("postEvents"),
            this.element &&
              (r.addClass(l.hideClass, this.element),
              r.removeClass(l.showClass, this.element));
        },
      }));
  },
  722: function (e, t, a) {
      ...
      (i = function (e, t, a, n, i) {
        return t.addthisWidget("custommobilebar", {
            ...
            var t = this.options,
              ...
              w = s(v, function (e) {
                ...
                return r
                  .a(n)
                  .role("button")
                  .attr("tabIndex", d.getATConfig("ui_tabindex", 0))
                  .title(a)
                  .css("at-share-btn", "at-svc-" + t);
              });
                ...
                .div(
                  r
                    .div(
                      r
                        .div("AddThis Sharing")
                        .css("at-custom-mobile-bar-label", this.hideClass),
                      r.div(w).css("at-custom-mobile-bar-btns")
                    )
                    .id(this.elementSelector.slice(1))
                    .css("at-custom-mobile-bar", a, g)
          ...
          generateCounter: function (e, t) {
            var a = l(e, 0.4);
            return (
              (this.shareCountSumElement = r
                .div()
                .css("at-custom-mobile-bar-count")
                .style("color:" + e).element),
              (this.shareCountWrapperElement = r
                .div(
                  this.shareCountSumElement,
                  r
                    .div(t)
                    .css("at-custom-mobile-bar-text")
                    .style("color:" + a)
                )
                .css("at-custom-mobile-bar-counter").element),
              this.shareCountWrapperElement
            );
          },
          renderShareCounts: function (t) {
    ...
    (n = [a(662), a(674), a(651), a(660), a(681)]),
      (i = function (e, t, a, n, i) {
        ...
        return t.addthisWidget("customsidebar", {
              ...
              v = s(b, function (e) {
                var t = e.svc,
                  ...
                  s = r
                    ...
                    .css("at4-share-count-container", g);
                return (
                ...
                .div(
                  r
                    .div(
                      r
                        .div("AddThis Sharing")
                        .css("at-custom-sidebar-label", this.hideClass),
                      r.div(v).css("at-custom-sidebar-btns")
                    )
                    .id(this.elementSelector.slice(1))
                    .css("at-custom-sidebar", a)
          ...
          renderShareCounts: function (e) {
            this.showTotalCounts() && this.renderTotalCounts(e),
              this.showIndividualCounts() &&
                this.renderIndividualShareCounts(e);
          },
          renderTotalCounts: function (t) {
            for (var a = 0, n = 0; n < t.length; n++)
              t[n].error || (a += Number(t[n].count));
            var i = 0;
            this.options.shareCountThreshold &&
              e.isNumber(this.options.shareCountThreshold) &&
              (i = this.options.shareCountThreshold),
              a < i &&
                e.setCSSAttr(this.shareCountWrapperElement, "display", "none"),
              (this.shareCountSumElement.innerHTML = e.truncateCount(a));
          ...
          renderIndividualShareCounts: function (t) {
            ...
            for (var f = 0; f < t.length; f++) {
              ...
              if (
                ...
                b > 0 &&
                b >= p &&
                ((a = n(h + " .at-svc-" + g + " .at4-share-count")[0]),
                !a &&
                  m[g] &&
                  (a = n(h + " .at-svc-" + m[g] + " .at4-share-count")[0]),
                e.isElement(a))
              ) {
                if (
                  ((i = _ate.util.parent(a, ".at-share-btn")),
                  0 === g.indexOf("pinterest"))
                ) {
                  if (u) continue;
                  u = !0;
                }
                i !== c &&
                  ...
                  e.isElement(i) &&
                  e.addClass("at4-share-count-anchor", i),
                  a.appendChild(c.createTextNode(e.truncateCount(b)));
              }
            }
            (o = n(h + " .at4-share-count-container")),
              o.length &&
                o.forEach(function (t) {
                  e.removeClass(l, t),
                    r.show(t, "fadeIn", function () {
        ...
        return t.addthisWidget("imagesharingtool", {
          ...
          generateElement: function () {
            ...
            var u = this.getShareServices(),
              p = c(u, function (e) {
                ...
                return l
                  .a(s)
                  .role("button")
                  .attr("tabIndex", f.getATConfig("ui_tabindex", 0))
                  .title(r)
                  .css("at-share-btn", "at-svc-" + t).element;
              });
            if (this.showMobile) {
            ...
            return l
              .div(
                l
                  .div("AddThis Sharing")
                  .css("at-image-sharing-tool-label", this.hideClass),
                l.div(p).css("at-image-sharing-tool-btns", h)
              )
              .id(this.elementSelector.slice(1))
              .aria("labelledby", "at-image-sharing-tool-label")
              .role("region")
              .css(
                "at-image-sharing-tool",
                m,
                this.showMobile ? "at-image-sharing-tool-size-mobile" : ""
              ).element;
          },
          finalize: function () {
          ...
          createMobileIconsAndListeners: function () {
            var t,
              ...
              c = function (t, a) {
                this.showTool(a),
                  d && e.removeClass(this.hideClass, d),
                  e.addClass(this.hideClass, t),
                  (d = t);
              },
              h = function (t) {
            ...
            for (n = 0; n < o.length; n++)
              if (((t = o[n]), this.validateImage(t))) {
                ...
                s.push({
                  ...
                  r.push(u),
                  m(u, "click", c.bind(this, u, t)),
                  m(t, "click", h.bind(this, u));
              }
            setInterval(function () {
              ...
              s.forEach(function (n) {
                if (
                  0 !== n.image.offsetWidth &&
                  0 !== n.image.offsetHeight &&
                  ((e = g(a, i.parentElement)), !b(n.boundingRect, e))
                )
                  return (n.boundingRect = e), (t = !0), !1;
              }),
                t && i.updateToolPosition();
            }, 200),
              (this.mobileIconImages = s),
              (this.mobileElement = l
                .div(r)
                .id("at-image-sharing-mobile-icons")
                .css("at-image-sharing-mobile-icons").element),
              this.parentElement.appendChild(this.mobileElement);
          },
          ...
          showTool: function (e) {
            return (
              !(!this.showMobile && this.element.__isAnimating) &&
              (this.selectedImage && this.selectedImage === e
          ...
          updateMobileIconPositions: function () {
            var e,
              ...
              n,
              i = p(this.element);
            for (n = 0; n < this.mobileIconImages.length; n++)
              (e = this.mobileIconImages[n]),
                (t = e.mobileIcon),
                (a = e.image),
                this.updatePosition(t, a, i, 10, a.offsetWidth - 60);
          },
          updateToolPosition: function () {
            ...
            if (n) {
              this.showMobile
                ...
                : ("horizontal" === t.orientation ? n.width : n.height) <
                  this.largeImageBreakpoint
                ? e.removeClass("at-image-sharing-tool-size-big", a)
                : e.addClass("at-image-sharing-tool-size-big", a);
          ...
          validateImage: function (e) {
            return (
              ...
              this.validateImageSize(e, this.smallImageBreakpoint) &&
              this.validateQuerySelector(e, this.options.querySelector)
            );
          },
          validateImageSize: function (e, t) {
            var a = e.width < t || e.height < t,
              n =
                "naturalWidth" in e &&
                (e.naturalWidth < t || e.naturalHeight < t);
            return !(a || n);
          },
          ...
          getShareTitle: function () {
            return this.getShareAttribute(
              ["data-title", "title", "alt"],
              "getShareTitle"
            );
          },
          getShareDescription: function () {
  ...
  733: function (e, t, a) {
    (t = e.exports = a(329)()),
      t.push([
        e.id,
        ".at-image-sharing-mobile-icon{position:absolute;background:#000 url(" +
          a(734) +
          ") no-repeat top center;background-color:rgba(0,0,0,.9);background-image:url(" +
          a(735) +
  ...
  736: function (e, t) {
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      (t.default = ["pinterest", "facebook", "email", "link"]),
      (e.exports = t.default);
  },
  737: function (e, t) {
    "use strict";
    e.exports = function (e, t) {
      for (var a = 0, n = 0, i = e; i && i !== t; )
        (a += i.offsetTop), (n += i.offsetLeft), (i = i.offsetParent);
      return {
        offsetTop: a,
        offsetLeft: n,
      };
  ...
  738: function (e, t) {
    ...
    e.exports = function (e) {
      var t,
        a,
        n = !e.style.display || "none" === e.style.display,
        i = e.style.cssText;
      return (
        n &&
          (e.style.cssText +=
        ...
        return t.addthisWidget("expandingsharebutton", {
          create: function () {
            n.create.call(this),
              ...
              (this.options.numPreferredServices = this.options
                .numPreferredServices
                ? this.options.numPreferredServices + 1
                : this.numServices + 1);
          },
          pco: "esb-1.0",
          device: "both",
          ...
          events: {
            ...
            ".at-share-btn keydown": function (e) {
              ...
              t && e.target.tabIndex === this.options.numPreferredServices
                ? this.collapseWithDelay()
                : (n || i) &&
                  (this.collapseWithDelay(),
                  a.commonEventHandlers.share.buttonClick.apply(
                    this,
                    arguments
                  ));
            },
            ".at-expanding-share-button-toggle-btn keydown": function (e) {
              ...
              (!t && !a) ||
                h(this.element, "at-expanding-share-button-show-icons") ||
                (e.preventDefault(), this.showIcons());
            },
            ".at-expanding-share-button-toggle-btn click": function (e) {
              return (
                ...
                !this.isMobile ||
                h(this.element, "at-expanding-share-button-show-icons")
                  ? (this.collapseWithDelay(), this.share("more", this.pco))
                  : (this.animateTapFlash(), void this.showIcons())
              );
            },
            ".at-share-btn click": function (e) {
              e.preventDefault(),
                this.collapseWithDelay(),
                a.commonEventHandlers.share.buttonClick.apply(this, arguments);
            },
            "addthis.layers.scroll": function () {
              var t = e.scrollBottomPercentage(),
                n =
          ...
          generateElement: function () {
            for (
              var e = this.options || {},
                t = e.numPreferredServices || 1,
                a = e.position || "bottom-right",
                n = e.emotion || "basic",
                i = e.themeColor || b,
                o = c(this.getShareServices(), function (e, t) {
                  return !s(t.svc);
                }),
              ...
              r.totalDelayMs = r.totalDelayMs + l * r.delayMs;
            /\-left$/.test(a) &&
              ((e.showAnimation = "slideInLeft"),
              (e.hideAnimation = "slideOutLeft"));
            var d = this.getMainLabel(),
              h = this.getToggleButton(i),
              m = this.getShareButtonsList(o, e.themeColor ? i : "default");
            return (
              (r.toggleButton = h.element),
              this.getElement({
                position: a,
                emotion: n,
                mainLabel: d,
          ...
          getMainLabel: function () {
            return l
              .label("AddThis Sharing")
              .id("at-expanding-share-button-label")
              .css(this.hideClass);
          },
          getToggleButton: function (e) {
            var t = l
              .div()
              .css("at-expanding-share-button-click-flash")
              .style("transition-duration: " + this.flashAnimation.ms + "ms");
            return (
              (this.flashAnimation.element = t.element),
              l
                .a(
                  l
                    .div(t, l.span().style("background-color: " + e))
                    .css("at-expanding-share-button-toggle-bg")
                )
                .href("#")
                .role("button")
                .attr("title", "Toggle Sharing Icons")
                .attr("tabIndex", f.getATConfig("ui_tabindex", 0))
                .data("name", "More")
                .css("at-expanding-share-button-toggle-btn")
            );
          },
          getShareButtonsList: function (e, t) {
            var a = d(e, function (a, n) {
              var i = a.svc,
                ...
                d = l
                  .a(s)
                  .css("at-share-btn", "at-svc-" + i)
                  .data("name", r)
                  .attr("title", "Share to " + r)
                  .attr("tabIndex", e.length - n + 1)
                  .role("button")
                  .href("#");
              return l.li(d);
            });
            return (
              (this.iconAnimations.elements = d(a, function (e) {
                return e.element;
              })),
            ...
            var n,
              ...
              s = l
                .div(
                  t.mainLabel,
                  t.shareButtonsList,
                  l.div(t.toggleButton).css("at-expanding-share-button-toggle")
                )
                .css(a, "at-expanding-share-button")
                .id(this.elementSelector.slice(1))
                .aria("labelledby", "at-expanding-share-button-label")
                .role("region")
              ...
              t.isMobile &&
                ((n = l
                  ...
                  .css(
                    ...
                    "at-expanding-share-button-hidden"
                  )
                  .style(
                    "transition-duration: " +
                      this.mobileOverlayAnimation.ms +
                      "ms"
                  )),
                (this.mobileOverlayAnimation.element = n.element),
                (s = l
                  .div(s, n)
                  .css("at-expanding-share-button-mobile-container"))),
              r && this.css(s.element.className, this.hideClass),
              s.element
            );
          },
          finalize: function () {
            return (
              this.superMethod("finalize"),
              this.isMobile &&
                p.listen(
                  this.mobileOverlayAnimation.element,
                  "click",
                  this.collapseWithDelay.bind(this)
                ),
              this
            );
          },
          collapseWithDelay: function () {
            this.animateIcons(!1),
              this.isMobile && this.animateMobileOverlay(!1);
          },
          showIcons: function () {
            this.isMobile && this.animateMobileOverlay(!0),
              this.animateIcons(!0);
          },
          animateIcons: function (e) {
            ...
            clearTimeout(i.timeoutId),
              e
                ? (u(i.toggleButton, "at-expanding-share-button-hidden"),
                  (i.timeoutId = setTimeout(function () {
                    o.forEach(function (e, t) {
                      var a = (n - parseInt(t, 10) + 1) * l + "ms";
                      e.style.animation = r + " " + a;
                    }),
                      m(t, "at-expanding-share-button-show-icons"),
                      m(t, "at-expanding-share-button-animate-in");
                  }, 0)))
                : (o.forEach(function (e, t) {
                  ...
                  (i.timeoutId = setTimeout(function () {
                    u(t, "at-expanding-share-button-show-icons"),
                      m(i.toggleButton, "at-expanding-share-button-hidden");
                  }, i.totalDelayMs)),
                  u(t, "at-expanding-share-button-animate-in"));
          },
          animateMobileOverlay: function (e) {
            var t = this.mobileOverlayAnimation;
            e
              ? (clearTimeout(t.timeoutId),
                u(t.element, "at-expanding-share-button-hidden"))
          ...
          animateTapFlash: function () {
            ...
            clearTimeout(e.timeoutId),
              ...
              m(t, "at-expanding-share-button-click-flash-animate"),
        ...
        return o.default
          .div(
            o.default
              .div(
                o.default.p(
                  o.default.span(v).style("font-size: " + y + "; color: " + k)
                )
              )
              .css("at-tjin-title"),
            o.default
              .div(
                  ...
                  return o.default
                    .a(
                      ...
                      o.default
                        ...
                        .css("addthis_tjin_label")
                    )
                    .css("at300b", "at-tjin-btn")
                    .data("svc", a)
                    .data("svc-id", n)
                    .attr("title", "Tip with " + i)
                    .attr(
                      "href",
                      (0, h.default)(r, {
                        pco: e.pco,
                ...
                o.default.div().css("atclear")
              )
              .css("addthis_toolbox", _)
          )
          .id(i.substring(1))
          .css("at-tjin-element").element;
      },
      events: {
        "a click": function () {
          var e =
