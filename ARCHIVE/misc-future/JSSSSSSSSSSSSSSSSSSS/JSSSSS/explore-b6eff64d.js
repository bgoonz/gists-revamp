  ...
  return {
    ...
    l(n) {
      ...
      (G = d(x, w)),
        ...
        (I = f(p, "DIV", { class: !0 }));
      var E = m(I);
      (b = f(E, "IMG", { src: !0, alt: !0 })),
        (S = g(E)),
        (V = f(E, "IMG", { src: !0, class: !0, alt: !0 })),
        E.forEach(u),
        p.forEach(u),
        this.h();
    },
    h() {
      $(e, "class", "h1"),
        ...
        b.src !== (D = "/images/illustration-grid.jpg") &&
          $(b, "src", "/images/illustration-grid.jpg"),
        $(b, "alt", "Gitpod in a Nutshell"),
        V.src !== (k = "/images/illustration-small.jpg") &&
          $(V, "src", "/images/illustration-small.jpg"),
        $(V, "class", "small"),
