!(function () {
  ...
  !(function () {
    var e = (function () {
        ...
        return (
          (e.getCurrentUrl = function () {
            ...
            if (t && t._url_beforeSendHook)
              try {
                r = t._url_beforeSendHook(r);
              } catch (o) {
                console.warn(
                  "Could not modify url with url:beforeSend method",
                  o
                );
              }
    ...
    function s(e) {
          ...
          var t = !1,
            ...
            o = function (n) {
              t ||
                ...
                r.removeEventListener("click", o, !0),
                r.removeEventListener("keypress", o, !0),
                r.removeEventListener("touchmove", o, !0),
                r.removeEventListener("drag", o, !0),
                r.removeEventListener("wheel", o, {
                  capture: !0,
                }),
                e());
            };
          r.addEventListener("mousemove", o, !0),
            r.addEventListener("click", o, !0),
            r.addEventListener("keypress", o, !0),
            r.addEventListener("touchmove", o, !0),
            r.addEventListener("drag", o, !0),
      ...
      "interactive" !== window.document.readyState
        ? window.document.addEventListener("DOMContentLoaded", t, !1)
        : t();
    }
    var a,
      u = "SL_L_23361dd035530_VID",
    ...
    var h = (function () {
        ...
        return (
              ...
              (a = (function (e) {
                for (
                  var t = e.document,
                    r = t.domain,
                    o = r.split("."),
                    n = "f0189a22486d" + Date.now(),
                    i = 0;
                  i < o.length - 1 && -1 === t.cookie.indexOf(n + "=" + n);
          ...
          (e.persistSessionId = function (t) {
            if (
              (t.sessionId
                ? localStorage.setItem(l, t.sessionId)
          ...
          (e.persistVisitorId = function (t) {
            if (
              (t.visitorId
                ? localStorage.setItem(u, t.visitorId)
          ...
          (e.persistProjectKey = function (t) {
            if (
              (t.projectKey
                ? localStorage.setItem(c, t.projectKey)
      ...
      v = (function () {
        ...
        return (
          (e.prototype.setSessionId = function (e) {
            (this.smartlook.sessionId = e),
              (this.smartlook.sid = e),
              h.persistSessionId({
                sessionId: e,
          ...
          (e.prototype.setVisitorId = function (e) {
            (this.smartlook.visitorId = e),
              (this.smartlook.vid = e),
              h.persistVisitorId({
                visitorId: e,
                cookies: this.smartlook.cookies,
              });
          ...
          (e.prototype.setProjectKey = function (e) {
            (this.smartlook.projectKey = e),
              (this.smartlook.key = e),
              h.persistProjectKey({
                projectKey: e,
                cookies: this.smartlook.cookies,
              });
          ...
          (e.prototype.getStoredSidVid = function (t) {
            ...
            if (a && t !== a) {
              ...
              u.setSessionId(void 0),
                u.setVisitorId(void 0),
                u.setProjectKey(void 0),
                (o = null),
                (n = null);
            }
            return {
          ...
          (e.prototype.loadDebugMode = function () {
            localStorage.getItem("smartlook_debug") &&
              (this.smartlook.debug = !0);
          }),
          (e.prototype.setOptions = function (e) {
            this.smartlook.options || (this.smartlook.options = {});
            var t = this.smartlook.options;
            e.storeGroup && !t.storeGroup && (t.storeGroup = e.storeGroup),
              e.recordConsole && !t.recordConsole && (t.recordConsole = !0),
              e.recordNetwork && !t.recordNetwork && (t.recordNetwork = !0),
              e.disableForms && !t.disableForms && (t.disableForms = !0),
              e.disableApi && !t.disableApi && (t.disableApi = !0),
              e.maskEmails && !t.maskEmails && (t.maskEmails = !0),
              e.maskNumbers && !t.maskNumbers && (t.maskNumbers = !0),
              e.signedDpa && !t.signedDpa && (t.signedDpa = !0);
          }),
          (e.prototype.setConsentSettings = function (e) {
            (this.smartlook.consent.forms = e.forms),
              (this.smartlook.consent.api = e.api),
              (this.smartlook.consent.ip = e.ip);
          }),
          (e.prototype.setAnalyticsSettings = function (e) {
            this.smartlook.analytics || (this.smartlook.analytics = {}),
              e.host &&
                !this.smartlook.analytics.host &&
                (this.smartlook.analytics.host = e.host),
              (e.host && !e.error && e.ok) ||
                (this.smartlook.analytics = void 0);
          }),
          (e.prototype.setRecordingSettings = function (e) {
            ...
            (t.hostDefault = e.hostDefault),
              t.host || (t.host = e.hostDefault),
              e.assetsHost && !t.assetsHost && (t.assetsHost = e.assetsHost),
              (t.host && !e.error) || (this.smartlook.recording = void 0);
          }),
          ...
          (e.prototype.log = function () {
            ...
            if (this.debug)
              try {
                console.log.apply(
                  console,
                  y(["%c " + this.prefix + " ", this.prefixStyle], e)
                );
              } catch (r) {}
          }),
        ...
        function (e, t) {
          ...
          if ("srcset" === e) {
            for (
              ...
              (_.test(i[0].trim()) && !i[0].trim().startsWith("//")) ||
                (C && ((C.href = i[0].trim()), (i[0] = C.href))),
                r.push(i.join(" "));
            }
            return r.join(", ");
          }
          return t.startsWith("blob:") || t.startsWith("file:")
            ? ""
            : t.startsWith("#") || (_.test(t) && !t.startsWith("//")) || !C
            ? t
            : ((C.href = t), C.href);
        }
      );
    ...
    var te,
      re =
        /^([:A-Z_a-z\xc0-\xd6\xd8-\xf6\xf8-\xff]){1}([:A-Z_a-z\xc0-\xd6\xd8-\xf6\xf8-\xff\-\.0-9\xb7])*$/m;
    ...
    var ne = (function () {
        function e(e) {
          (this.id = 0),
            (this.formsDisabled = e.formsDisabled || !1),
            (this.maskEmails = e.maskEmails || !1),
            (this.maskNumbers = e.maskNumbers || !1),
            (this.w = e.w),
            (this.filters = [L, I]),
            (this.nameConverters = [M]),
            (this.valueConverters = [R(e.w), P, x(e.w)]);
        }
        return (
          (e.prototype.getJson = function (e) {
            ...
            r.hasAttribute &&
              r.getAttribute &&
              (r.hasAttribute("data-recording-ignore") &&
                (d =
                  r.getAttribute("data-recording-ignore") === te.Mask
                    ? te.Mask
                    : te.All),
              r.hasAttribute("data-recording-disable") && (c = !0),
              r.hasAttribute("data-recording-sensitive") && (f = !0),
              r.hasAttribute("data-recording-gdpr-safe") && (p = !0)),
              (this.formsDisabled ||
                ee(r) ||
                (function (e) {
                  return (
                    !(
                      !e.attributes || "number" !== typeof e.attributes.length
                    ) &&
                    "INPUT" === e.nodeName &&
                    "password" === e.type
                  );
          ...
          (e.prototype.gdprSensitive = function (e) {
            if (
              e &&
              e.__smartlook &&
              ((e.__smartlook.gdprSensitive = !0), e.childNodes)
            )
              for (var t = 0; t < e.childNodes.length; t += 1)
                this.gdprSensitive(e.childNodes[t]);
          }),
          ...
          (e.prototype.ignoreElement = function (e, t) {
            if ((void 0 === t && (t = te.All), e && e.__smartlook)) {
              ...
              if (this.isDisabled(e)) r = te.All;
                ...
                o.hasAttribute &&
                  o.getAttribute &&
                  o.hasAttribute("data-recording-ignore") &&
                  (r =
                    o.getAttribute("data-recording-ignore") === te.Mask
                      ? te.Mask
                      : te.All);
              }
              if (((e.__smartlook.ignore = r), e.childNodes))
                for (var n = 0; n < e.childNodes.length; n += 1)
                  this.ignoreElement(e.childNodes[n], r);
            }
          }),
          (e.prototype.isIgnored = function (e) {
            return this.formsDisabled
              ? te.All
              : e && e.__smartlook
              ? e.__smartlook.disabled || e.__smartlook.gdprSensitive
                ? te.All
          ...
          (e.prototype.__getElementProps = function (e) {
            ...
            if (t.getAttributeNames && t.getAttribute)
              for (var s = t.getAttributeNames(), a = 0; a < s.length; a++) {
                var u = s[a];
                (c = this.__processAttributeNameAndValue(
                  u,
                  t.getAttribute(u),
                  i,
                  t,
              ...
              for (var l = 0; l < t.attributes.length; l += 1) {
                var c,
                  d = t.attributes[l];
                (c = this.__processAttribute(d, i, t, o)) &&
                  (n[c.name] = c.value);
              }
            return Object.assign(
              {},
          ...
          (e.prototype.__processAttribute = function (e, t, r, o) {
            return this.__processAttributeNameAndValue(
              e.name,
              e.value,
              t,
              r,
          ...
          (e.prototype.__processAttributeNameAndValue = function (
            e,
            t,
            r,
            o,
            ...
            if (!oe(e)) return null;
            for (var i = !1, s = 0; s < this.filters.length; s += 1)
              i = this.filters[s](e) || i;
            if (i) {
              var a = e;
              if (!r)
                for (var u = 0; u < this.nameConverters.length; u += 1)
                  a = this.nameConverters[u](a);
              for (var l = t, c = 0; c < this.valueConverters.length; c += 1)
                l = this.valueConverters[c](e, l, n, o);
              return {
                name: a,
                value: l,
              };
          ...
          (e.prototype.__getElementLegacyProps = function (e) {
            ...
            if (e.getAttributeNames && e.getAttribute)
              for (var r = e.getAttributeNames(), o = 0; o < r.length; o++) {
                var n = r[o];
                (s = this.__processLegacyAttributeNameAndValue(
                  n,
                  e.getAttribute(n)
                )) && (t[s.name] = s.value);
              }
          ...
          (e.prototype.__processLegacyAttributeNameAndValue = function (e, t) {
            ...
            if ($(e)) {
              for (
                var r = e, o = t, n = 0;
                n < this.valueConverters.length;
                n += 1
              )
                o = this.valueConverters[n](e, o);
              return {
                name: r,
                value: o,
              };
                ...
                (function (e) {
                  ...
                  return (
                    "#comment" === c
                      ? (d = "")
                      : "#text" === c
                      ? (d = t.nodeValue || t.value)
                      : c.startsWith("#") && ((c = "#comment"), (d = "")),
                    Object.prototype.hasOwnProperty.call(G, c) && (c = G[c]),
                    !d || a
                      ? {
                          type: c,
                        }
          ...
          (e.prototype.enableRecordingForms = function () {
            (this.formsDisabled = !1),
              this.ignoreElement(this.w.document.body, te.None);
          }),
          e
        );
      })(),
          ...
          (this.callback = null),
            ...
            (this.absoluteImports = function (e) {
              ...
              return (r = (r = r.replace(
                ...
                function (e, r) {
                  var o = r.trim();
                  return o.startsWith("data:") || o.startsWith("blob:")
                    ? e
                    : ((o = t.modifyUrl(o)),
                      t.callback &&
                        t.callback({
            ...
            (this.w = e),
            (this.startTimeElapsed = S.getElapsedTime()),
        ...
        return (
                ...
                if (o)
                  if ("characterData" === o.type)
                    o.target &&
                      ...
                      (("STYLE" !== o.target.parentElement.nodeName &&
                        "style" !== o.target.parentElement.nodeName) ||
                        t.__sendStylesheetAndStyle(o.target.parentElement));
                  else {
                    if (o.addedNodes)
                      for (var n = 0; n < o.addedNodes.length; n += 1)
                        t.__sendStylesheetAndStyle(o.addedNodes[n]);
                    if (o.removedNodes)
                      for (n = 0; n < o.removedNodes.length; n += 1)
                        t.__removeStylesheetAndStyle(o.removedNodes[n]);
                  }
              }
              t.mutationsQueue.length > 0
                ? (t.workerTimeout = t.w.setTimeout(r, 0))
                : (t.w.clearTimeout(t.workerTimeout),
                  (t.workerTimeout = void 0));
            };
            (this.htmlObserver = new MutationObserver(function (e) {
              var o;
              (o = t.mutationsQueue).push.apply(o, e),
                t.workerTimeout || (t.workerTimeout = t.w.setTimeout(r, 0));
            })),
              ...
              (this.insertRuleCall = this.w.CSSStyleSheet.prototype.insertRule),
                (this.w.CSSStyleSheet.prototype.insertRule = function () {
                  ...
                  if (
                    ...
                    return o.insertRuleCall.apply(this, t);
                }),
                (this.deleteRuleCall =
                  this.w.CSSStyleSheet.prototype.deleteRule),
          ...
          (e.prototype.stop = function () {
            this.htmlObserver &&
              ...
              this.w.clearTimeout(this.workerTimeout),
              (this.workerTimeout = void 0),
              (this.mutationsQueue = []));
            try {
              (this.w.CSSStyleSheet.prototype.deleteRule = this.deleteRuleCall),
                (this.w.CSSStyleSheet.prototype.insertRule =
                  this.insertRuleCall);
            } catch (e) {}
          }),
          ...
          (e.prototype.__removeStylesheetAndStyle = function (e) {
            ...
            if ("LINK" === e.nodeName) {
              var r = e.href && e.href,
                o = "css2";
              if (
                (r && r.startsWith("blob:") && (o = "style2"), e.__smartlook)
              ) {
                t = e.__smartlook.id;
                this.callback &&
                  this.callback({
          ...
          (e.prototype.__sendStylesheetAndStyle = function (e) {
            ...
            if (
              (e.nodeType === Node.TEXT_NODE &&
                e.parentElement &&
                "STYLE" === e.parentElement.nodeName &&
                (e = e.parentElement),
              "STYLE" === e.nodeName || "LINK" === e.nodeName)
            ) {
              e.__smartlook ||
                (e.__smartlook = {
                  id: T.generate(),
                      ...
                      Array.from(o.sheet.cssRules).forEach(function (e, n) {
                        t.callback &&
                          t.callback({
                            ...
                            createdAt: S.now(),
                            previousElementId:
                              t.getPreviousElementId(o) || void 0,
                          });
                      });
                    } catch (c) {}
              }
                    ...
                    try {
                      ...
                      this.callback &&
                        this.callback({
                          ...
                          createdAt: S.now(),
                          previousElementId:
                            this.getPreviousElementId(i) || void 0,
                        });
                    } catch (c) {}
                  else
                    this.callback &&
            ...
            this.__sendAllAttributes(e),
              (this.observer = new MutationObserver(function (r) {
                r.forEach(function (r) {
                  ...
                  oe(n) &&
                    ((L(n) || $(n)) &&
                      (o = i.attributes[n] && (i.attributes[n].value || "")),
                    i.attributes[n] || (o = null),
                    e({
                      type: "html",
                      name: n,
                      value: o,
      ...
      fe = (function (e) {
        function t(t, r, o, n) {
          ...
          return (
            (i.name =
              t.target.nodeName.indexOf("-") >= 0
                ? t.attributeName
                : M(t.attributeName || "")),
            (i.target = t.target),
            (i.legacy = $(t.attributeName)),
            (i.attributeName = t.attributeName),
            (i.styleConverter = R(o)),
            (i.sourceConverter = x(o)),
            (i.time = t.time),
            (i.disableForms = n),
            i
          );
        ...
        return (
          ...
          (t.prototype.getJson = function () {
            ...
            if (!this.target.hasAttribute || !this.target.getAttribute)
              return null;
            if (
              "value" === this.attributeName &&
              "input" === this.target.nodeName.toLowerCase()
            ) {
            ...
            if (this.target.hasAttribute("data-recording-ignore")) {
              var r =
                this.target.getAttribute("data-recording-ignore") === te.Mask
                  ? te.Mask
                  : te.All;
              this.elementToTreeModel.ignoreElement(this.target, r);
            }
            this.target.hasAttribute("data-recording-gdpr-safe") &&
              this.elementToTreeModel.gdprSafe(this.target),
              this.target.hasAttribute("data-recording-sensitive") &&
                this.elementToTreeModel.gdprSensitive(this.target);
            ...
            o &&
              ...
              (o = this.styleConverter(this.attributeName, o)),
              (o = this.sourceConverter(this.attributeName, o)));
            var n = {
              type: "A",
              name: this.name,
              value: o,
      ...
      he = (function (e) {
        ...
        return (
          ...
          (t.prototype.getJson = function () {
            ...
            if (this.elementToTreeModel.isDisabled(this.target)) return null;
            if (this.value)
              if (this.elementToTreeModel.isGdprSensitive(this.target))
      ...
      ve = (function (e) {
        function t(t, r) {
          ...
          return (
            (o.removed = Array.from(t.removedNodes)),
            (o.added = Array.from(t.addedNodes)),
            (o.previous = t.previousSibling),
            (o.next = t.nextSibling),
            (o.target = t.target),
            (o.time = t.time),
            o
          );
        ...
        return (
          ...
          (t.prototype.getJson = function () {
            ...
            if (!t) return null;
            if (this.elementToTreeModel.isDisabled(this.target)) return null;
            if (!this.target.getAttribute || !this.target.hasAttribute)
              return null;
            if (this.target.hasAttribute("data-recording-disable"))
              return this.elementToTreeModel.disableElement(this.target), null;
            this.target.hasAttribute("data-recording-ignore") &&
            ...
            if (
              (this.added.length > 0 &&
                (n.added = this.added.reduce(function (t, n) {
              ...
              this.removed.length > 0 &&
                (n.removed = this.removed.reduce(function (t, r) {
                  var o = e.elementToTreeModel.findId(r);
                  return (
                    null !== o && (e.elementToTreeModel.removeId(r), t.push(o)),
                    t
                  );
                }, [])),
              this.previous)
            ...
            return (n.added && 0 !== n.added.length) ||
              (n.removed && 0 !== n.removed.length)
              ? n
              : null;
          }),
          t
      ...
      ye = (function () {
        function e(e, t, r, o) {
          (this.observer = null),
            ...
            (this.startTimeElapsed = S.getElapsedTime()),
            (this.mutationsQueue = []),
            (this.formsDisabled = t),
            (this.maskEmails = r),
            (this.maskNumbers = o),
            (this.elementToTreeModelJson = new ne({
              w: e,
              formsDisabled: t,
              maskEmails: r,
              maskNumbers: o,
              ...
              for (var r = 0; r < 5; r += 1) {
                ...
                if (n) {
                  ...
                  switch (n.type) {
                    ...
                    case "childList":
                      Q(n.target) &&
                        (i = new ve(n, t.elementToTreeModelJson).getJson());
                  }
                  i && e(i);
                }
              }
              t.mutationsQueue.length > 0
                ? (t.workerTimeout = t.w.setTimeout(o, 0))
                : (t.w.clearTimeout(t.workerTimeout),
                  (t.workerTimeout = void 0));
            };
            (this.observer = new MutationObserver(function (e) {
              var r,
                n = S.getElapsedTime() - t.startTimeElapsed,
                i = e.map(function (e) {
                  return (e.time = n), e;
                });
              (r = t.mutationsQueue).push.apply(r, i),
                t.workerTimeout || (t.workerTimeout = t.w.setTimeout(o, 0));
            })),
              this.observer.observe(this.w.document.body, {
                attributes: !0,
                childList: !0,
        ...
        function e(e, t, r) {
          ...
          (this.callback = null),
                  ...
                  if (n) {
                    ...
                    if (i.nodeName)
                      if ("checkbox" !== n) {
                        ...
                        o.isSupportedInputElement(i) &&
                          o.handleTextInputChange(i, t, r);
                      } else {
                        var l = {
                          type: "A",
                          name: "checked",
            ...
            (this.inputListener = function (e) {
              if (e.target) {
                ...
                if (t && o.isSupportedInputElement(e.target)) {
                  var r = be(e.target);
                  r === te.All
                    ? r === te.All && o.handleStartTypingEvent(t)
                    : o.handleTextInputChange(e.target, t, r);
                }
              }
            }),
            (this.handleTextInputChange = function (e, t, r) {
              ...
              "password" === e.type
                ? (n = Array(16).join("*"))
                : r === te.Mask && (n = Array(n.length + 1).join("*"));
              var i = {
                type: "A",
                name: "value",
                value: n,
            ...
            (this.handleStartTypingEvent = function (e) {
              if (!Object.prototype.hasOwnProperty.call(o.typingTimeouts, e)) {
                ...
                o.callback && o.callback(t),
                  Object.keys(o.typingTimeouts).forEach(function (t) {
                    if (t !== e) {
              ...
              r && o.w.clearTimeout(r),
                (o.typingTimeouts[e] = window.setTimeout(
                  o.handleEndTypingEvent.bind(o, e),
                  2500
                ));
            }),
            ...
            (this.isSupportedInputElement = function (e) {
              ...
              return (
                "textarea" === t ||
                ("input" === t && Object.prototype.hasOwnProperty.call(pe, r))
              );
            }),
            (this.w = e),
            (this.domRecorder = t),
            (this.startTimeElapsed = S.getElapsedTime()),
            (this.pastRadios = []),
            (this.typingTimeouts = Object.create(null)),
            (this.logger = r);
        }
        return (
          (e.prototype.start = function (e) {
          ...
          (e.prototype.stop = function () {
            ...
            this.w.document.removeEventListener(
              ...
              Object.keys(this.typingTimeouts).forEach(function (t) {
        ...
        return (
          (e.prototype.start = function (e) {
            (this.callback = e),
              this.w.document.addEventListener(
                "mouseenter",
                this.mouseOverListenter,
                !0
              ),
              this.w.document.addEventListener(
                "mouseleave",
                this.mouseLeaveListenter,
                !0
              );
          }),
          (e.prototype.stop = function () {
      ...
      xe = (function () {
        ...
        return (
          (e.prototype.setDataToSend = function (e, t) {
            try {
              ...
              this.logger.log(
                "RecordingsLateDataSender - Could not save data to send",
                r
              );
            }
          }),
          (e.prototype.sendPendingData = function () {
            ...
            if (t) {
              ...
              try {
                ...
                "object" === r.type && (r.data = new Uint8Array(r.data)),
                  Ae({
                    method: "POST",
                    url: r.url,
                    headers: {
                    ...
                    onSuccess: function () {
                      e.logger.log(
                        "RecordingsLateDataSender - Send later beacon data",
                        r
                      );
                    },
                    onError: function () {
                      e.logger.log(
                        "RecordingsLateDataSender - Could not send later beacon data",
                        r
                      );
                    },
                  });
      ...
      Be = function (e, t) {
        var r = "[" + e.join(",") + "]\n";
        if (!t)
          return window.LZUTF8.compress(r, {
            outputEncoding: Le.getCompressFormat(),
          });
        window.LZUTF8.compressAsync(
          r,
          {
            outputEncoding: Le.getCompressFormat(),
            useWebWorker: !0,
      ...
      Ue = function (e) {
        ...
        (this.vid = null),
          ...
          (this.focusRecorder = null),
          (this.mouseEnterLeaveRecorder = null),
          (this.disposables = []),
          (this.stopped = !1),
          (this.onMouseSubscriber = function (e) {
            var r = k(
              Object.assign({}, e, {
                createdAt: void 0,
                elements: void 0,
          ...
          (this.getUrl = function (e, r, o) {
            ...
            return (
              ...
              t.host !== t.apiHost &&
                0 === e &&
                (i += "&serverHost=" + encodeURIComponent(t.apiHost)),
              t.group && (i += "&group=" + t.group),
              0 === e &&
                (i +=
                  "&version=" +
                  "5c49d3ebf3f06260901fbfa4a1bbb123b6cd689a".substring(0, 10)),
              i
            );
          }),
          (this.stopRecording = function () {
            (t.stopped = !0),
              clearInterval(t.sendingInterval),
              window.removeEventListener("unload", t.unloadEvent, !1),
              clearInterval(t.mutationsCollector),
              clearInterval(t.scrollCollector),
              t.domRecorder && t.domRecorder.stop(),
              t.valuesRecorder && t.valuesRecorder.stop(),
              t.scrollRecorder && t.scrollRecorder.stop(),
              t.bodyAttributesRecorder && t.bodyAttributesRecorder.stop(),
              t.htmlAttributesRecorder && t.htmlAttributesRecorder.stop(),
              t.cssRecorder && t.cssRecorder.stop(),
              t.documentStateRecorder && t.documentStateRecorder.stop(),
              t.focusRecorder && t.focusRecorder.stop(),
              t.mouseEnterLeaveRecorder && t.mouseEnterLeaveRecorder.stop(),
          ...
          (this.startOtherRecorders = function () {
            t.stopped ||
              (t.disableForms ||
                (t.w.smartlook.startRecordingForms = function () {
                  t.domRecorder && t.domRecorder.enableRecordingForms(),
                    (t.w.smartlook.startRecordingForms = void 0);
                }),
              t.domRecorder &&
                ((t.valuesRecorder = new we(t.w, t.domRecorder, t.logger)),
                t.valuesRecorder.start(function (e) {
                  var r = k(e);
                  r && t.all.push(r);
                }),
                (t.scrollRecorder = new ae(window, t.domRecorder)),
                t.scrollRecorder.start(function (e) {
                  return t.changesScroll.push(e);
                }),
                (t.mouseEnterLeaveRecorder = new Te(window, t.domRecorder)),
                t.mouseEnterLeaveRecorder.start(function (e) {
                  var r = k(e);
                  r && t.all.push(r);
                })),
              (t.bodyAttributesRecorder = new ue(window)),
              t.bodyAttributesRecorder.start(function (e) {
                var r = k(e);
                r && t.all.push(r);
              }),
              (t.htmlAttributesRecorder = new le(window)),
              t.htmlAttributesRecorder.start(function (e) {
                var r = k(e);
                r && t.all.push(r);
              }),
              (t.cssRecorder = new ie(window)),
              t.cssRecorder.start(function (e) {
                switch (e.type) {
                  case "url":
              ...
              (t.documentStateRecorder = new ke(window)),
              t.documentStateRecorder.start(function (e) {
                var r = k(e);
                r && t.all.push(r);
              }),
              t.w.smartlook.onMouse &&
                t.w.smartlook.onMouse._recorder &&
                (t.disposables.push(t.w.smartlook.onMouse(t.onMouseSubscriber)),
                t.w.smartlook.onMouse._recorder.start()),
              t.w.smartlook.onResize &&
                t.w.smartlook.onResize._recorder &&
                (t.disposables.push(
                  t.w.smartlook.onResize(t.onResizeSubscriber)
                ),
                t.w.smartlook.onResize._recorder.start()),
              t.w.smartlook.onConsole &&
                t.w.smartlook.onConsole._recorder &&
                (t.disposables.push(
                  t.w.smartlook.onConsole(t.onConsoleSubscriber)
                ),
                t.w.smartlook.onConsole._recorder.start()),
              t.w.smartlook.onError &&
                t.w.smartlook.onError._recorder &&
                (t.disposables.push(t.w.smartlook.onError(t.onErrorSubscriber)),
                t.w.smartlook.onError._recorder.start()),
              t.w.smartlook.onUrl &&
                t.w.smartlook.onUrl._recorder &&
                (t.disposables.push(t.w.smartlook.onUrl(t.onUrlSubscriber)),
                t.w.smartlook.onUrl._recorder.start()),
              t.w.smartlook.onCustomEvent &&
                t.disposables.push(
                  t.w.smartlook.onCustomEvent(t.onCustomEventSubscriber)
                ),
              t.w.smartlook.onCustomError &&
                t.disposables.push(
                  t.w.smartlook.onCustomError(t.onCustomErrorSubscriber)
                ),
              t.w.smartlook.onCustomUrl &&
                t.disposables.push(
                  t.w.smartlook.onCustomUrl(t.onCustomUrlSubscriber)
                ),
              t.w.smartlook.onText &&
                t.w.smartlook.onText._recorder &&
                (t.disposables.push(t.w.smartlook.onText(t.onTextSubscriber)),
                t.w.smartlook.onText._recorder.start()),
              t.w.smartlook.onFocus &&
                t.w.smartlook.onFocus._recorder &&
                (t.disposables.push(t.w.smartlook.onFocus(t.onFocusSubscriber)),
                t.w.smartlook.onFocus._recorder.start()),
              t.w.smartlook.onPerformanceEntry &&
                t.w.smartlook.onPerformanceEntry._recorder &&
                (t.disposables.push(
                  t.w.smartlook.onPerformanceEntry(
                    t.onPerformanceEntrySubscriber
                  )
                ),
                t.w.smartlook.onPerformanceEntry._recorder.start()),
              t.logger.log("All recorders were started"));
          }),
          (this.sendData = function (e) {
            ...
            if (!t.stopped) {
              ...
              var s = i.length > 0;
              if (!s && S.getElapsedTime() - (t.lastSend || 0) < 6e4)
                return (
                  t.logger.log(
                    "No data, not sending",
                    S.getElapsedTime() - (t.lastSend || 0)
                  ),
                  void (
                    "hidden" === window.document.visibilityState &&
                    (t.logger.log("Hidden, stop"), t.unload(), t.onReload())
                  )
                );
              (t.requestPending = !0),
                Be(i, function (e, r) {
                  if (!e)
                    return (
                      t.logger.error("Could not compress data", r),
                    ...
                    Ae({
                      ...
                      onError: function (e) {
                        if (
                          (t.logger.error(
                            t.rid,
                            t.sendIndex - 1,
                            "Chunk write failed after 2 retries",
                            "status:",
                            e.status,
                            "statusText:",
                            e.statusText,
                          ...
                          t.stopRecording(),
                          !t.w.smartlook_stopped)
                        )
                          return 422 === e.status
                            ? (t.logger.log("Recovery after sleep"),
                              void t.onReload(!0))
                            : void 0;
                      },
                      onSuccess: function (e) {
                        if (
                          ...
                          return S.getElapsedTime() > t.startTimeElapsed + Ce
                            ? (t.logger.log("Reset after 10 minutes"),
                              t.unload(),
                              void t.onReload(!0))
                            : "hidden" === window.document.visibilityState
                            ? (t.logger.log("Hidden, stop"),
                              t.unload(),
                              void t.onReload())
                            : void 0;
                      },
          ...
          (this.start = function (e) {
            if ((t.recordingsLateDataSender.sendPendingData(), !t.stopped)) {
              (t.startTimeElapsed = S.getElapsedTime()),
                (t.requestPending = !1),
                (t.lastSend = 0),
                (t.sendIndex = 0),
                (t.sendingInterval = window.setInterval(function () {
                  t.w.smartlook_stopped
                    ? t.unload()
                    : t.requestPending || t.sendData();
                }, 7499)),
                window.addEventListener("unload", t.unloadEvent, !1),
                window.addEventListener("beforeunload", t.unloadEvent, !1),
                window.addEventListener("pagehide", t.unloadEvent, !1);
              var r = !!t.disableForms || !t.w.smartlook.consent.forms;
              (t.domRecorder = new ye(window, r, t.maskEmails, t.maskNumbers)),
                t.domRecorder.start(function (o) {
                  if ("tree" === o.type) {
                    var n = k(o);
                    n &&
                      t.sendData({
          ...
          (this.unload = function (e) {
            if (
              (void 0 === e && (e = !1),
              t.stopped || t.stopRecording(),
              !t.requestPending && !t.closed)
            ) {
              window.removeEventListener("unload", t.unloadEvent, !1),
                window.removeEventListener("beforeunload", t.unloadEvent, !1),
                window.removeEventListener("pagehide", t.unloadEvent, !1),
                (t.requestPending = !0),
                (t.closed = !0);
              var r = t.all.slice(),
                o = r.length > 0;
              ...
              var i = function (r) {
                navigator.sendBeacon && navigator.sendBeacon(n, r)
                  ? t.logger.log("Beacon sent", r)
                  : e
                  ? (t.recordingsLateDataSender.setDataToSend(n, r),
                    t.logger.log("Could not send beacon, saving data to LS"))
                  : Ae({
                      method: "POST",
                      url: n,
                      numberOfRetries: 2,
                      ...
                      onError: function () {
                        t.logger.log(
                          "Recorder - could not sent beacon like request",
                          r
                        );
                      },
                    });
          ...
          (this.startDataSender = function () {
            t.stopped ||
              ((t.mutationsCollector = window.setInterval(function () {
                ...
                if (e.length > 0) {
                  ...
                  for (s = 0; s < l.length; s++)
                    (a = u[l[s]]), (f = k(a[a.length - 1])) && c.push(f);
                  ...
                  p.length > 0 && r.push.apply(r, p),
                    i.length > 0 && r.push.apply(r, i),
                    c.length > 0 && r.push.apply(r, c);
                }
                t.all = t.all.concat(r);
              }, 200)),
              (t.scrollCollector = window.setInterval(function () {
          ...
          this.w.smartlook.recording &&
            ...
            (this.w.smartlook.recording.startTimeElapsed =
              this.startTimeElapsed)),
          e.assetsHost &&
            (this.cssSender = new _e({
              host: e.assetsHost,
              logger: e.logger,
            })),
          (this.recordingsLateDataSender = new xe(e.logger)),
          (this.onReload = e.onReload);
      },
      Me = (function () {
        function e() {}
        return (
      ...
      Pe = (function () {
        function e() {}
        return (
          (e.reporting = function (e, t, r, o) {
            var n = window;
            n.Raven &&
              n.Raven.setDataCallback &&
              "function" === typeof n.Raven.setDataCallback &&
              n.Raven.setDataCallback(function (n) {
                return (
                  (n.extra.playUrl = e),
                  (n.extra.sessionId = t),
                  (n.extra.visitorId = r),
              ...
              n.Sentry &&
                n.Sentry.configureScope &&
                "function" === typeof n.Sentry.configureScope &&
                n.Sentry.configureScope(function (n) {
                  n.setExtra("playUrl", e),
                    n.setExtra("sessionId", t),
                    n.setExtra("visitorId", r),
                    n.setExtra("recordId", o);
                });
          }),
          e
        );
      ...
      We = (function () {
        ...
        return (
          (e.analytics = function (e, t) {
            e.piwik && e.piwik.enabled && Re.analytics(e.piwik.playUrl || t),
              e.intercom &&
                e.intercom.enabled &&
                Ne.analytics(e.intercom.playUrl || t),
              e.ga && e.ga.enabled && Me.analytics(e.ga.playUrl || t),
              e.segment &&
                e.segment.enabled &&
                je.analytics(e.segment.playUrl || t),
              e.zendesk &&
                e.zendesk.enabled &&
                Fe.analytics(e.zendesk.playUrl || t);
          }),
          (e.reporting = function (e, t, r, o, n) {
            e.sentry &&
              e.sentry.enabled &&
              Pe.reporting(e.sentry.playUrl || t, r, o, n),
              e.mixpanel &&
                e.mixpanel.enabled &&
                De.reporting(e.mixpanel.playUrl || t),
              e.ga && e.ga.enabled && Me.reporting();
          }),
          e
        );
      })(),
      ...
      Ze = (function (e) {
            ...
            (t.rejectionHandler = function (e) {
              ...
              if (0 !== t.listeners.length && e && e.reason) {
                var n = {
                  ...
                  colno: 0,
                  value:
                    null !== (r = e.reason.message) && void 0 !== r ? r : "",
        ...
        return (
          ...
          (t.prototype.start = function () {
            (this.throttleCollection = Object.create(null)),
          ...
          return (
            (t.handleChange = function () {
              t.publish({
                ...
                (t.resizeTimeout = void 0);
            }),
            (t.listener = function () {
              0 !== t.listeners.length &&
                (t.resizeTimeout ||
                  (t.resizeTimeout = window.setTimeout(t.handleChange, 500)));
            }),
            t
          );
        }
        ...
        return (
          ...
          (e.prototype.generate = function (e) {
            for (var t = e, r = []; t; ) {
              ...
              (o.classes = Array.from(t.classList || [])),
                (o.tagName = t.tagName),
                (o.id = "string" === typeof t.id ? t.id : ""),
                n && ((o.nthOfType = n.nthOfType), (o.nthChild = n.nthChild)),
                r.push(o),
                (t = t.parentElement);
            }
            return r;
      ...
      et = (function (e) {
        function t() {
          var t = (null !== e && e.apply(this, arguments)) || this;
          return (
            (t.elementsPathGenerator = null),
            (t.changeListener = function (e) {
              if (
                0 !== t.listeners.length &&
                e.target &&
                t.elementsPathGenerator
              ) {
                ...
                if (r) {
                  ...
                  if (
                    "textarea" === r ||
                    ("input" === r &&
                      Object.prototype.hasOwnProperty.call(Ke, o))
                  ) {
                    var n = $e(e.target);
                    if (n) {
                      var i = {
        ...
        return (
          Qe(t, e),
          (t.prototype.start = function () {
            (this.elementsPathGenerator = new Xe()),
              ...
              if (o) {
                ...
                if (
                  (t.hasAttribute &&
                    ...
                    t.hasAttribute("id") &&
                    (n = t.getAttribute("id")),
                  n && "string" === typeof n && /^[^0-9].*$/gim.test(n))
                ) {
                  var i = "#" + n;
                  r.push(i);
                  break;
      ...
      ut = (function (e) {
        function t(t) {
          ...
          return (
            ...
            (r.moveListener = function (e) {
              ("boolean" !== typeof e.isTrusted || e.isTrusted) &&
                ((r.mouseMoveX = e.clientX),
                (r.mouseMoveY = e.clientY),
                (r.mouseMoveOX = e.offsetX),
                (r.mouseMoveOY = e.offsetY),
                e.target !== r.mouseMoveElement &&
                  ((r.mouseMoveElement = e.target),
                  (r.mouseMoveElementSelector = r.selectorGenerator.generate(
                    e.target
                  ))));
            }),
            (r.clickListener = function (e) {
              if ("boolean" !== typeof e.isTrusted || e.isTrusted) {
                ...
                u && (i.elementId = u),
                  ...
                  0 === Object.keys(i.props || {}).length && delete i.props,
                  r.publish(i),
                  r.handleRageClicks(t);
              }
            }),
            (r.generateDataDotDataProps = function (e, t) {
              ...
              if (e.hasAttribute(at) || e.hasAttribute(st)) {
                ...
                if (o)
                  try {
                    for (
                      var n = JSON.parse(o), i = Object.keys(n || {}), s = 0;
                      s < i.length;
                      s++
                    ) {
                      var a = i[s];
              ...
              return (
                e.parentElement &&
                  Object.assign(
                    t,
                    r.generateDataDotDataProps(e.parentElement, t)
                  ),
                t
              );
            }),
            ...
            (r.handleRageClicks = function (e) {
              if (r.rageClicks) {
                if (
                  (r.rageClicks.push(S.getElapsedTime()),
                  r.rageClicks[3] && r.rageClicks[3] - r.rageClicks[0] < 500)
                ) {
                  var t = {
                    type: "rage_click",
                    time: S.getElapsedTime() - r.startTimeElapsed,
                  ...
                  return (
                    r.publish(t),
                    (r.rageClicks = null),
                    void (r.rageClicksTimeout = window.setTimeout(function () {
                      r && (r.rageClicks = []);
                    }, 1e4))
                  );
                }
            ...
            (r.rageClicks = []),
            (r.selectorGenerator = new ot()),
            (r.elementsPathGenerator = new Xe()),
            (r.maskEmails =
              !t.smartlook.options || !!t.smartlook.options.maskEmails),
            (r.maskNumbers =
      ...
      dt = (function (e) {
        function t(t) {
          var r = e.call(this, t) || this;
          return (
            (r.focusListener = function (e) {
              var t = e.target;
              if (t) {
                var o = t.nodeName.toLowerCase();
                if (
                  Object.prototype.hasOwnProperty.call(ct, o) &&
                  "submit" !== t.type &&
                  "button" !== t.type
                ) {
                  var n = {
      ...
      mt = (function (e) {
        function t(t) {
          ...
          return (
            ...
            (r.start = function () {
              if (
                r.w.performance &&
                r.w.performance.timing &&
                r.w.performance.getEntriesByType
              ) {
                if (
                  ("function" === typeof window.PerformanceObserver &&
                    (r.observer = new PerformanceObserver(function (e) {
                      for (var t = e.getEntries(), o = 0; o < t.length; o++)
                        r.processRecord(t[o]);
                    })),
                  !ft)
                )
                  r.processLoadMetrics(),
                    r.w.performance
            ...
            (r.processRecord = function (e) {
              var t = {
                ...
                time: Math.round(
                  Math.max(
                    0,
                    S.getElapsedTime() - r.startTimeElapsed - e.duration
                  )
                ),
              };
              e.decodedBodySize && (t.decodedBodySize = 0 | e.decodedBodySize),
                e.encodedBodySize &&
                  (t.encodedBodySize = 0 | e.encodedBodySize),
                e.transferSize && (t.transferSize = 0 | e.transferSize);
            ...
            (r.getBlockingTime = function (e) {
              var t = 0;
              return (
                e.connectEnd && e.connectEnd === e.fetchStart
                  ? (t = e.requestStart - e.connectEnd)
                  : e.domainLookupStart &&
                    (t = e.domainLookupStart - e.fetchStart),
                t
              );
            }),
            (r.isCacheHit = function (e) {
              return (
                !(e.transferSize > 0) &&
                (e.decodedBodySize > 0 || e.duration < 30)
              );
            }),
            (r.is304 = function (e) {
              return (
        ...
        return (
          pt(t, e),
          (t.prototype.processLoadMetrics = function () {
            ft || (ft = !0);
          }),
          t
        );
      ...
      ht = function (e) {
        ...
        (t.onMouse = function (e) {
          ...
          (t.onMouse._recorder = d),
          t.onFocus && t.onFocus._recorder && t.onFocus._recorder.stop();
        var p = new dt(i);
        if (
          ...
          (t.onFocus._recorder = p),
          o)
        ) {
          t.onPerformanceEntry &&
            t.onPerformanceEntry._recorder &&
            t.onPerformanceEntry._recorder.stop();
          var f = new mt(i);
      ...
      gt = (function () {
        function e() {}
        return (
          (e.getMergedValidProps = function (e, t) {
        ...
        return (
          ...
          (t.prototype.sendEvent = function (t) {
            ...
            if (!this.w.smartlook_stopped) {
              ...
              if (o)
                if (
                  (t.props && (t.props = gt.getMergedValidProps(t.props)),
                  "url" !== t.type && (t.pageUrl = e.getCurrentUrl()),
                  this.w.smartlook._identityUid &&
                    (t.internalProps || (t.internalProps = {}),
                    (t.internalProps.uid = this.w.smartlook._identityUid)),
                  this.w.smartlook._globalProps &&
                    (t.props || (t.props = {}),
                    Object.assign(t.props, this.w.smartlook._globalProps)),
                  this.w.smartlook._identityProps &&
                    (t.props || (t.props = {}),
                    Object.assign(t.props, this.w.smartlook._identityProps)),
                  t.time > 66e4)
                )
                  this.logger.error("Invalid time of event", t);
                else {
                  0 === Object.keys(t.props || {}).length && delete t.props,
                    (t.time = Math.round(t.time));
                  var n = k([t]);
                  n
                    ? navigator.sendBeacon && navigator.sendBeacon(o, n)
                      ? this.logger &&
                        this.logger.log("Sent event using beacon", t)
                      : Ae({
                          method: "POST",
                          url: o,
                          body: n,
                    ...
                    : this.logger.error(
                        "Could not create a stringify body of event",
                        t
                      );
                }
            ...
            if (o && t && n) {
              ...
              e.onError(function (e) {
                ...
                e.onCustomError(function (t) {
                  var r = 0;
                  e.recording &&
                    e.recording.startTime &&
                    (r = Math.max(0, t.createdAt - e.recording.startTime)),
                    s.addError(
                      wt(wt({}, t), {
                        time: r,
                      })
                ...
                e.onMouse(function (e) {
                  "click" === e.type && s.addClick(e),
                    "rage_click" === e.type && s.addRageClick(e);
                }),
                e.onPerformanceEntry &&
                  e.onPerformanceEntry(function (e) {
                    ("domcomplete" !== e.type &&
                      "domcontentloaded" !== e.type) ||
                      s.addPerformanceEntry(e);
                  }),
                i.log("Analytics is subscribed to onEvents hooks");
            } else
              console.warn("Analytics host, key or store group is not defined");
          }
    ...
    !(function () {
      ...
      if (e.recorderJSLoaded && !e.mainJSLoaded) {
        ...
        (e._restart = function (e, t) {
          ...
          i &&
            ((i._recorderRunning = !1),
            (i.sid = void 0),
            a ||
              (Tt && (Tt.unload(t), (Tt = null)),
              r.setRecordId(void 0),
              i._recorderPaused ||
                s(function () {
                  return o(e);
                })));
          ...
          (e._resume = function () {
            ...
            t &&
              !r &&
              (t._recorderRunning ||
                ((t._recorderPaused = !1), t._restart && t._restart()));
          });
        var o = function (e) {
          void 0 === e && (e = !1);
          var o = window,
          ...
          if (
            ...
            if (
              ...
              !s ||
                ...
                !s.recording.host ||
                !s.options ||
                !s.options.storeGroup)
            )
              return (
                console.warn("Missing smartlook init data"), void (Et = !1)
              );
            var a = new b(!!s.debug),
              ...
              Ae({
                ...
                onSuccess: function (t) {
                  try {
                    ...
                    if (!r.rid || !r.vid || !r.sid)
                      return (
                        a.log("Init not ok", r),
                        i("Init not ok - " + JSON.stringify(r)),
                        void (Et = !1)
                      );
                    var o = new v(s),
                      n = !1,
                      u = v.getSessionId();
                    (u && u === s.sid) || (n = !0),
                      o.setPlayUrl(r.playUrl),
                      o.setRecordId(r.rid),
                      o.setSessionId(r.sid),
                      o.setVisitorId(r.vid),
                      ht({
                        smartlook: s,
                        recordConsole:
                          (s.options && s.options.recordConsole) || !1,
                        recordNetwork:
                          (s.options && s.options.recordNetwork) || !1,
                        useQueueEvents: !!n || !e,
                      });
                    var l = s.playUrl;
                    l &&
                      ...
                      setTimeout(function () {
                        s.integrations &&
                          We.reporting(s.integrations, l, s.sid, s.vid, s.rid);
                      }, 750));
                    var c = {
                      sid: s.sid,
                      rid: s.rid,
                ...
                onError: function (e) {
                  r.setRecordId(void 0),
                    a.log("Init error", e.status, e.statusText, e.response),
                    i(
                      "Init error - " +
                        e.statusText +
                        " " +
