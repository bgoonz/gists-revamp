...
function I(s) {
  ...
  return (
    (t = new G({ props: { screencast: s[0], screencastNumber: s[1] } })),
    {
      ...
      h() {
        h(j, "class", "svelte-1gv8tr3"),
          h(I, "class", "svelte-1gv8tr3"),
          h(e, "class", "svelte-1gv8tr3");
      },
      m(s, r) {
        u(s, e, r),
          g(t, e, null),
...
function T(s, e, t) {
  ...
  return (
    (s.$$set = (s) => {
      "screencast" in s && t(0, (n = s.screencast)),
        "screencastNumber" in s && t(1, (c = s.screencastNumber));
    }),
    (s.$$.update = () => {
      1 & s.$$.dirty && t(2, (r = Math.floor(n.duration / 60))),
        1 & s.$$.dirty && t(3, (a = n.duration % 60));
    }),
    [n, c, r, a]
  );
}
      ...
      p(s, [e]) {
        ...
        if ((8 & e && (t.$$scope = { dirty: e, ctx: s }), c.$set(t), 0 & e)) {
          ...
          for (I = S, t = 0; t < I.length; t += 1) {
            ...
            T[t]
              ? (T[t].p(r, e), b(T[t], 1))
              : ((T[t] = M(r)), T[t].c(), b(T[t], 1), T[t].m(p, null));
          }
